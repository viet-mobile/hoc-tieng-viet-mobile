# -*- coding: utf-8 -*-
"""
Adapter for 'Enjoy Life Forever!' (행복한 삶을 영원히).
Ingests enjoy_life_forever_data.json full 12-language rows.
"""
...
class EnjoyLifeForeverAdapter(BaseSourceAdapter):
    def __init__(self, json_path: str = "enjoy_life_forever_data.json"):
        self.json_path = json_path

    @property
    def source_type(self) -> str:
        return "enjoyLifeForever"
