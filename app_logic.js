(function () {
  ...
  // buttons" CSS section). Once given, a slot is never revisited, so a button's color stays
  // stable across re-renders. A MutationObserver keeps re-scanning for newly-created buttons this app renders
  ...
  // The hue is the control's position within its own row (1st = 자주, 2nd = 분홍, ...), the
  // same rule for the top tabs and for every lower menu row (subtabs, review scopes, their
  // dropdowns, study modes), so e.g. every row's first button shares the top row's first hue.
  var PASTEL_SLOT_COUNT = 10;
  var PASTEL_SLOT_SELECTOR = ".tab-btn, .subtab-btn, .study-mode-btn, .foot-btn, .review-dd";
  function assignPastelSlots() {
    document.querySelectorAll(PASTEL_SLOT_SELECTOR).forEach(function (el) {
      ...
      for (var i = 0; i < siblings.length; i++) {
        if (siblings[i].matches(PASTEL_SLOT_SELECTOR)) position += 1;
        if (siblings[i] === el) break;
      }
      el.setAttribute("data-pastel", String(((position - 1) % PASTEL_SLOT_COUNT) + 1));
    });
  }
  assignPastelSlots();
  ...
  var I18N_UI = {
    ...
    "파수대 주차 선택": {"vi": "Chọn tuần Tháp Canh", "cs": "Vybrat týden Strážné věže", "zh_cn": "选择守望台周次", "zh": "選擇守望台週次", "en": "Select Watchtower Week", "fr": "Choisir la semaine de La Tour de Garde", "de": "Wachtturm-Woche wählen", "hu": "Őrtorony-hét kiválasztása", "id": "Pilih Minggu Menara Pengawal", "ja": "ものみの塔の週を選択", "pl": "Wybierz tydzień Strażnicy"},
    "주차": {"vi": "Tuần", "cs": "Týden", "zh_cn": "周", "zh": "週", "en": "Week", "fr": "Semaine", "de": "Woche", "hu": "Hét", "id": "Minggu ke-", "ja": "週目", "pl": "Tydzień"},
    "방학": {"vi": "Nghỉ", "cs": "Prázdniny", "zh_cn": "休假", "zh": "休假", "en": "Break", "fr": "Pause", "de": "Pause", "hu": "Szünet", "id": "Libur", "ja": "休み", "pl": "Przerwa"},
    "전체 주차": {"vi": "Tất cả các tuần", "cs": "Všechny týdny", "zh_cn": "全部周次", "zh": "全部週次", "en": "All Weeks", "fr": "Toutes les semaines", "de": "Alle Wochen", "hu": "Összes hét", "id": "Semua minggu", "ja": "全週", "pl": "Wszystkie tygodnie"},
    "원문 (한국어)": {"vi": "Nguyên văn (tiếng Hàn)", "cs": "Originál (korejsky)", "zh_cn": "原文（韩语）", "zh": "原文（韓語）", "en": "Original (Korean)", "fr": "Texte original (coréen)", "de": "Originaltext (Koreanisch)", "hu": "Eredeti szöveg (koreai)", "id": "Teks asli (bahasa Korea)", "ja": "原文（韓国語）", "pl": "Tekst oryginalny (koreański)"},
    ...
    "한국어": {"vi": "Tiếng Hàn", "cs": "한국어", "zh_cn": "한국어", "zh": "한국어", "en": "한국어", "fr": "한국어", "de": "한국어", "hu": "한국어", "id": "Bahasa Korea", "ja": "한국어", "pl": "한국어"},
    ...
    "전주 학습반": {"vi": "Lớp học Jeonju", "cs": "Kurz Jeonju", "zh_cn": "全州越南语班", "zh": "全州越南語班", "en": "Jeonju Class", "fr": "Cours de Jeonju", "de": "Jeonju-Kurs", "hu": "Jeonju tanfolyam", "id": "Kelas Jeonju", "ja": "チョンジュ学習班", "pl": "Kurs w Jeonju"},
    ...
    "어휘": {"vi": "Từ vựng", "cs": "Slovní zásoba", "zh_cn": "词汇", "zh": "詞彙", "en": "Vocabulary", "fr": "Vocabulaire", "de": "Wortschatz", "hu": "Szókincs", "id": "Kosakata", "ja": "語彙", "pl": "Słownictwo"},
    ...
    "예습": {"vi": "Chuẩn bị bài", "cs": "Příprava", "zh_cn": "预习", "zh": "預習", "en": "Preview", "fr": "Aperçu", "de": "Vorschau", "hu": "Előzetes áttekintés", "id": "Pratinjau", "ja": "予習", "pl": "Zapowiedź"},
    "주간 수행 과제": {"vi": "Bài tập hằng tuần", "cs": "Týdenní úkol", "zh_cn": "每周学习作业", "zh": "每週學習作業", "en": "Weekly Assignment", "fr": "Tâche hebdomadaire", "de": "Wöchentliche Aufgaben", "hu": "Heti feladat", "id": "Tugas Mingguan", "ja": "週間の課題", "pl": "Zadanie tygodniowe"},
    "시간": {"vi": "Thời gian", "cs": "Čas", "zh_cn": "时间", "zh": "時間", "en": "Time", "fr": "Heure", "de": "Uhrzeit", "hu": "Idő", "id": "Waktu", "ja": "時間", "pl": "Czas"},
    "요일, 날짜": {"vi": "Thứ, ngày", "cs": "Dny v týdnu, datum", "zh_cn": "星期、日期", "zh": "星期、日期", "en": "Days, Dates", "fr": "Jours et dates", "de": "Wochentage, Datum", "hu": "Napok, dátumok", "id": "Hari, Tanggal", "ja": "曜日、日付", "pl": "Dni i daty"},
    "달, 계절": {"vi": "Tháng, mùa", "cs": "Měsíce, roční období", "zh_cn": "月份、季节", "zh": "月份、季節", "en": "Months, Seasons", "fr": "Mois et saisons", "de": "Monate, Jahreszeiten", "hu": "Hónapok, évszakok", "id": "Bulan, Musim", "ja": "月、季節", "pl": "Miesiące i pory roku"},
    "시": {"vi": "Giờ", "cs": "Hodin", "zh_cn": "点", "zh": "點", "en": "Hours", "fr": "Heures", "de": "Uhr", "hu": "Óra", "id": "Jam", "ja": "時", "pl": "Godzina"},
    "시간대": {"vi": "Buổi trong ngày", "cs": "Části dne", "zh_cn": "时段", "zh": "時段", "en": "Times of Day", "fr": "Moments de la journée", "de": "Tageszeiten", "hu": "Napszakok", "id": "Waktu Hari", "ja": "時間帯", "pl": "Pory dnia"},
    "시간 표현 예시": {"vi": "Ví dụ cách nói thời gian", "cs": "Příklady vyjádření času", "zh_cn": "时间表达范例", "zh": "時間表達範例", "en": "Time Expression Examples", "fr": "Exemples d'expressions de temps", "de": "Beispiele für Zeitangaben", "hu": "Időkifejezések példái", "id": "Contoh Ungkapan Waktu", "ja": "時間表現の例", "pl": "Przykłady określeń czasu"},
    "오늘 학습할 범위": {"vi": "Phạm vi học hôm nay", "cs": "Rozsah dnešního studia", "zh_cn": "今天要学习的范围", "zh": "今天要學習的範圍", "en": "Today's study range", "fr": "Programme d'étude d'aujourd'hui", "de": "Heutiger Lernbereich", "hu": "A mai tanulmányozási anyag", "id": "Materi Belajar Hari Ini", "ja": "今日学習する範囲", "pl": "Dzisiejszy zakres nauki"},
    "전체 보기": {"vi": "Xem tất cả", "cs": "Zobrazit vše", "zh_cn": "查看全部", "zh": "查看全部", "en": "Show all", "fr": "Tout afficher", "de": "Alle anzeigen", "hu": "Összes megtekintése", "id": "Lihat Semua", "ja": "すべて見る", "pl": "Pokaż wszystko"},
    "학습반 교과 자료": {"vi": "Tài liệu giáo trình của lớp", "cs": "Studijní materiály kurzu", "zh_cn": "学习班教材资料", "zh": "學習班教材資料", "en": "Class Curriculum Materials", "fr": "Supports du cours de langue", "de": "Unterrichtsmaterialien", "hu": "A kurzus tananyagai", "id": "Materi kurikulum kelas", "ja": "学習会教材資料", "pl": "Materiały kursu językowego"},
    "16주 과정 목차, 베트남 문화 이야기, 기도와 노래까지 — 학습반 교재의 자료를 모아 뒀어요. 제공 연설은 대화 탭, 성경 인명 사전·기본 단어는 어휘 탭, 범용 언어 생성표·문법 특강은 문법 탭에 있어요.": {"vi": "Từ mục lục khóa học, những câu chuyện về văn hóa Việt Nam đến lời cầu nguyện và bài hát — mọi tài liệu của lớp học đều được tập hợp tại đây. Các bài trình bày nằm ở thẻ Hội thoại, từ điển tên người trong Kinh Thánh và từ cơ bản nằm ở thẻ Từ vựng, bảng tạo câu và các bài ngữ pháp chuyên đề nằm ở thẻ Ngữ pháp.", "cs": "Od osnovy kurzu přes vyprávění o vietnamské kultuře až po modlitby a písně — všechny materiály kurzu jsou shromážděny zde. Nabídkové rozhovory najdete na kartě Dialog, slovník biblických jmen a základní slovní zásobu na kartě Slova a tabulku tvorby vět a speciální lekce gramatiky na kartě Gramatika.", "zh_cn": "从16周课程目录、越南文化故事，到祷告与歌曲——这里收集了学习班教材的所有资料。提供见证的内容在「对话」分页，圣经人名辞典和基本词汇在「词汇」分页，通用语言生成表和文法特別课程在「文法」分页。", "zh": "從16週課程目錄、越南文化故事，到禱告與歌曲——這裡收集了學習班教材的所有資料。提供見證的內容在「對話」分頁，聖經人名辭典和基本詞彙在「詞彙」分頁，通用語言生成表和文法特別課程在「文法」分頁。", "en": "From the 16-week course outline and stories about Vietnamese culture to prayers and songs — all the class materials are gathered here. The offer talks are under the Dialogue tab, the Bible name dictionary and basic vocabulary are under the Vocabulary tab, and the general sentence-pattern chart and grammar features are under the Grammar tab.", "fr": "Du programme de cours en 16 semaines aux récits culturels vietnamiens, prières et cantiques : tous les supports pédagogiques sont réunis ici. Les présentations modèles sont sous l'onglet Dialogue, le dictionnaire des noms bibliques et le vocabulaire de base sous Vocabulaire, et le tableau de génération de phrases sous Grammaire.", "de": "Vom Inhaltsverzeichnis des 16-Wochen-Kurses über vietnamesische Kultur bis hin zu Gebeten und Liedern – alle Kursmaterialien sind hier versammelt. Gesprächsvorschläge finden sich im Tab Dialog, das biblische Namenslexikon und Grundwörter im Tab Wortschatz, die Satzbautabelle und Grammatiklektionen im Tab Grammatik.", "hu": "A kurzus tartalomjegyzékétől a vietnami kultúráról szóló történeteken át az imákig és énekekig — a kurzus minden anyaga itt található. A felajánló beszélgetések a Beszélgetés fülön, a bibliai névszótár és az alapszavak a Szavak fülön, a mondatalkotó táblázat és a nyelvtani különórák a Nyelvtan fülön vannak.", "id": "Mulai dari daftar isi kursus, kisah tentang budaya Vietnam, hingga doa dan lagu — semua materi kelas dikumpulkan di sini. Contoh presentasi ada di tab Dialog, kamus nama Alkitab dan kosakata dasar ada di tab Kata, dan tabel pembentuk kalimat serta pelajaran tata bahasa khusus ada di tab Tata Bahasa.", "ja": "16週間コースの目次、ベトナムの文化についての話、祈りと歌まで――学習会教材の資料がここにまとめられています。提供のことばは「会話」タブに、聖書人名辞典と基本単語は「語彙」タブに、汎用文型表と文法特別レッスンは「文法」タブにあります。", "pl": "Od spisu treści 16-tygodniowego kursu, przez opisy wietnamskiej kultury, po modlitwy i pieśni — zebrano tu wszystkie materiały kursowe. Wzory rozmów znajdują się w zakładce Rozmowy, słownik imion biblijnych i podstawowe słownictwo w Słownictwie, a tabela tworzenia zdań w Gramatyce."},
    ...
    "기도": {"vi": "Cầu nguyện", "cs": "Modlitba", "zh_cn": "祷告", "zh": "禱告", "en": "Prayer", "fr": "Prière", "de": "Gebet", "hu": "Ima", "id": "Doa", "ja": "祈り", "pl": "Modlitwa"},
    "노래·기도": {"vi": "Bài hát · Cầu nguyện", "cs": "Písně a modlitba", "zh_cn": "歌曲‧祷告", "zh": "歌曲‧禱告", "en": "Songs & Prayer", "fr": "Chants et prières", "de": "Lieder & Gebet", "hu": "Énekek és ima", "id": "Lagu & Doa", "ja": "歌・祈り", "pl": "Pieśni i modlitwy"},
    "사용설명": {"vi": "Hướng dẫn sử dụng", "cs": "Návod k použití", "zh_cn": "使用说明", "zh": "使用說明", "en": "Usage Guide", "fr": "Guide d'utilisation", "de": "Anleitung", "hu": "Használati útmutató", "id": "Panduan Penggunaan", "ja": "使い方ガイド", "pl": "Instrukcja obsługi"},
    "공통 기능": {"vi": "Chức năng chung", "cs": "Společné funkce", "zh_cn": "通用功能", "zh": "通用功能", "en": "Common Features", "fr": "Fonctions communes", "de": "Allgemeine Funktionen", "hu": "Közös funkciók", "id": "Fitur Umum", "ja": "共通機能", "pl": "Wspólne funkcje"},
    "베트남 사람을 만났을 때": {"vi": "Khi gặp người Việt Nam", "cs": "Když potkáte Vietnamce", "zh_cn": "遇到越南人的时候", "zh": "遇到越南人的時候", "en": "When You Meet a Vietnamese Person", "fr": "Rencontrer une personne vietnamienne", "de": "Wenn Sie einer vietnamesischen Person begegnen", "hu": "Amikor vietnamival találkozik", "id": "Saat Bertemu Orang Vietnam", "ja": "ベトナム人に会ったとき", "pl": "Gdy spotkasz osobę z Wietnamu"},
    "몇 가지만 답하면, 첫인사부터 자기소개·연락처 교환·재방문·집회 초대·성서 연구 사회까지 실제로 쓸 수 있는 베트남어 대화문을 보여 드려요.": {"vi": "Chỉ cần trả lời vài câu hỏi, bạn sẽ có những đoạn hội thoại tiếng Việt dùng được trong thực tế — từ lời chào đầu tiên, tự giới thiệu, trao đổi thông tin liên lạc, thăm lại, mời dự buổi nhóm họp cho đến điều khiển buổi học Kinh Thánh.", "cs": "Stačí odpovědět na pár otázek a získáte skutečné vietnamské rozhovory, které můžete použít — od prvního pozdravu a představení se přes výměnu kontaktů, opětovné návštěvy a pozvání na shromáždění až po vedení biblického studia.", "zh_cn": "只要回答几个问题，就能看到从打招呼、自我介绍、交换联络方式，到重访、邀请聚会、主持圣经研究都能实际使用的越南语对话。", "zh": "只要回答幾個問題，就能看到從打招呼、自我介紹、交換聯絡方式，到重訪、邀請聚會、主持聖經研究都能實際使用的越南語對話。", "en": "Answer just a few questions and you'll get real Vietnamese dialogues you can use — from the first greeting and self-introduction to exchanging contact info, callbacks, meeting invitations, and even conducting a Bible study.", "fr": "Répondez simplement à quelques questions pour obtenir des dialogues réels en vietnamien : des premières salutations à la présentation de soi, l'échange de coordonnées, les nouvelles visites, l'invitation aux réunions et la conduite d'un cours biblique.", "de": "Beantworten Sie ein paar kurze Fragen, und Sie erhalten praktische vietnamesische Dialoge – von der Begrüßung und Vorstellung über den Kontakttausch, Rückbesuche und Zusammenkunftseinladungen bis hin zum Leiten eines Bibelstudiums.", "hu": "Csak néhány kérdésre kell válaszolnia, és a valóságban is használható vietnami párbeszédeket kap — az első köszönéstől és bemutatkozástól az elérhetőségek cseréjén, az újralátogatáson és az összejövetelre való meghíváson át egészen a bibliatanulmányozás vezetéséig.", "id": "Cukup jawab beberapa pertanyaan, dan Anda akan mendapatkan percakapan bahasa Vietnam yang benar-benar bisa dipakai — mulai dari salam pertama, perkenalan diri, bertukar kontak, kunjungan kembali, undangan ke perhimpunan, hingga memimpin pelajaran Alkitab.", "ja": "いくつか質問に答えるだけで、最初のあいさつから自己紹介・連絡先交換・再訪問・集会への招待・聖書研究の司会まで、実際に使えるベトナム語の会話文をご紹介します。", "pl": "Odpowiedz na kilka pytań, aby otrzymać praktyczne dialogi po wietnamsku — od powitania i przedstawienia się, przez wymianę kontaktów, odwiedziny ponowne i zaproszenie na zebranie, aż po prowadzenie studium biblijnego."},
    "복습 게임으로 연습하기": {"vi": "Luyện tập bằng trò chơi ôn tập", "cs": "Procvičovat pomocí opakovacích her", "zh_cn": "用复习游戏来练习", "zh": "用複習遊戲來練習", "en": "Practice with Review Games", "fr": "S'entraîner avec les jeux de révision", "de": "Mit Wiederholungsspielen üben", "hu": "Gyakorlás ismétlő játékokkal", "id": "Berlatih dengan permainan ulasan", "ja": "復習ゲームで練習する", "pl": "Ćwicz z grami powtórkowymi"},
    "전체 범위 복습 게임": {"vi": "Trò chơi ôn tập (toàn bộ từ vựng)", "cs": "Opakovací hra (veškerá slovní zásoba)", "zh_cn": "全范围复习游戏", "zh": "全範圍複習遊戲", "en": "Review Game (All Vocabulary)", "fr": "Jeu de révision (tout le vocabulaire)", "de": "Wiederholungsspiel (Gesamter Wortschatz)", "hu": "Ismétlő játék (teljes szókincs)", "id": "Permainan ulasan (semua kosakata)", "ja": "全範囲の復習ゲーム", "pl": "Gra powtórkowa (całe słownictwo)"},
    "학습 범위내 복습 게임": {"vi": "Trò chơi ôn tập (chỉ phạm vi này)", "cs": "Hra na opakování v rozsahu", "zh_cn": "本范围复习游戏", "zh": "本範圍複習遊戲", "en": "Review Game (This Range Only)", "fr": "Jeu de révision (cette sélection)", "de": "Wiederholungsspiel (Nur dieser Bereich)", "hu": "Áttekintő játék ezen a tartományon", "id": "Permainan Ulasan dalam Cakupan", "ja": "この範囲だけの復習ゲーム", "pl": "Gra powtórkowa (tylko ten zakres)"},
    "호칭": {"vi": "Cách xưng hô", "cs": "Oslovení", "zh_cn": "称呼", "zh": "稱呼", "en": "Terms of Address", "fr": "Termes d'adresse", "de": "Anredeformen", "hu": "Megszólítások", "id": "Panggilan", "ja": "呼び方", "pl": "Formy grzecznościowe"},
    ...
    "참여자 정보": {"vi": "Thông tin người tham gia", "cs": "Informace o účastníkovi", "zh_cn": "参与者资讯", "zh": "參與者資訊", "en": "Participant Info", "fr": "Informations sur les interlocuteurs", "de": "Teilnehmer-Info", "hu": "Résztvevő adatai", "id": "Informasi Peserta", "ja": "参加者情報", "pl": "Informacje o rozmówcach"},
    "(입력하면 대화·제공 연설에 자동 반영돼요)": {"vi": "(Thông tin đã nhập sẽ tự động áp dụng vào Hội thoại và Bài trình bày)", "cs": "(při zadání se automaticky promítne do rozhovorů)", "zh_cn": "（输入后会自动套用到对话与提供见证）", "zh": "（輸入後會自動套用到對話與提供見證）", "en": "(Enter these and they'll automatically apply to Dialogue and Offer Talks)", "fr": "(Ces informations s'appliquent automatiquement aux dialogues et présentations)", "de": "(Wird automatisch in Dialoge und Gesprächsvorschläge übernommen)", "hu": "(megadás esetén automatikusan megjelenik a beszélgetésekben)", "id": "(jika diisi, akan otomatis diterapkan ke percakapan)", "ja": "（入力すると会話・提供のことばに自動的に反映されます）", "pl": "(Wprowadzone dane automatycznie dostosują dialogi i wzory rozmów)"},
    "나": {"vi": "Tôi", "cs": "Já", "zh_cn": "我", "zh": "我", "en": "Me", "fr": "Moi", "de": "Ich", "hu": "Én", "id": "Saya", "ja": "自分", "pl": "Ja"},
    "한국어 이름": {"vi": "Tên", "cs": "Jméno", "zh_cn": "中文姓名", "zh": "中文姓名", "en": "Name", "fr": "Nom", "de": "Name", "hu": "Név", "id": "Nama", "ja": "日本語の名前", "pl": "Imię"},
    "베트남어 이름": {"vi": "Tên tiếng Việt", "cs": "Vietnamské jméno", "zh_cn": "越南语姓名", "zh": "越南語姓名", "en": "Vietnamese Name", "fr": "Nom vietnamien", "de": "Vietnamesischer Name", "hu": "Vietnámi név", "id": "Nama Vietnam", "ja": "ベトナム語の名前", "pl": "Wietnamskie imię"},
    "성별": {"vi": "Giới tính", "cs": "Pohlaví", "zh_cn": "性別", "zh": "性別", "en": "Gender", "fr": "Genre", "de": "Geschlecht", "hu": "Nem", "id": "Jenis Kelamin", "ja": "性別", "pl": "Płeć"},
    "형제": {"vi": "Anh", "cs": "Bratr", "zh_cn": "弟兄", "zh": "弟兄", "en": "Brother", "fr": "Frère", "de": "Bruder", "hu": "Testvér", "id": "Saudara", "ja": "兄弟", "pl": "Brat"},
    "자매": {"vi": "Chị", "cs": "Sestra", "zh_cn": "姐妹", "zh": "姐妹", "en": "Sister", "fr": "Sœur", "de": "Schwester", "hu": "Testvérnő", "id": "Saudari", "ja": "姉妹", "pl": "Siostra"},
    "나이": {"vi": "Tuổi", "cs": "Věk", "zh_cn": "年龄", "zh": "年齡", "en": "Age", "fr": "Âge", "de": "Alter", "hu": "Életkor", "id": "Usia", "ja": "年齢", "pl": "Wiek"},
    "전화번호": {"vi": "Số điện thoại", "cs": "Telefonní číslo", "zh_cn": "电话号碼", "zh": "電話號碼", "en": "Phone Number", "fr": "Numéro de téléphone", "de": "Telefonnummer", "hu": "Telefonszám", "id": "Nomor Telepon", "ja": "電話番号", "pl": "Numer telefonu"},
    "결혼": {"vi": "Tình trạng hôn nhân", "cs": "Sňatek", "zh_cn": "婚姻状况", "zh": "婚姻狀況", "en": "Marital Status", "fr": "État civil", "de": "Familienstand", "hu": "Házasság", "id": "Pernikahan", "ja": "結婚", "pl": "Stan cywilny"},
    "미혼": {"vi": "Độc thân", "cs": "Svobodný/á", "zh_cn": "未婚", "zh": "未婚", "en": "Single", "fr": "Célibataire", "de": "Ledig", "hu": "Egyedülálló", "id": "Belum Menikah", "ja": "未婚", "pl": "Stan wolny"},
    "기혼": {"vi": "Đã kết hôn", "cs": "Ženatý/Vdaná", "zh_cn": "已婚", "zh": "已婚", "en": "Married", "fr": "Marié(e)", "de": "Verheiratet", "hu": "Házas", "id": "Menikah", "ja": "既婚", "pl": "W związku małżeńskim"},
    "봉사짝": {"vi": "Bạn cùng rao giảng", "cs": "Spolupracovník ve službě", "zh_cn": "传道夥伴", "zh": "傳道夥伴", "en": "Ministry Companion", "fr": "Compagnon de prédication", "de": "Dienstpartner", "hu": "Szolgálati társ", "id": "Rekan Dinas", "ja": "奉仕の相手", "pl": "Współgłosiciel"},
    "베트남어를 잘하는 형제·자매": {"vi": "Anh chị giỏi tiếng Việt", "cs": "Bratr nebo sestra plynně hovořící vietnamsky", "zh_cn": "越南语流利的弟兄姐妹", "zh": "越南語流利的弟兄姐妹", "en": "A brother or sister who speaks Vietnamese well", "fr": "Un frère ou une sœur qui parle bien vietnamien", "de": "Ein Bruder / eine Schwester mit guten Vietnamesischkenntnissen", "hu": "Vietnámiul jól beszélő testvér vagy testvérnő", "id": "Saudara/saudari yang lancar berbahasa Vietnam", "ja": "ベトナム語が上手な兄弟姉妹", "pl": "Brat lub siostra dobrze mówiący po wietnamsku"},
    "상대방의 이름은?": {"vi": "Tên của người đối diện là gì?", "cs": "Jaké je jméno druhé osoby?", "zh_cn": "对方的名字是？", "zh": "對方的名字是？", "en": "What is the other person's name?", "fr": "Quel est le nom de l'interlocuteur ?", "de": "Wie heißt die andere Person?", "hu": "Mi a másik fél neve?", "id": "Siapa nama lawan bicara?", "ja": "相手の名前は？", "pl": "Jak ma na imię rozmówca?"},
    "상대방의 성별은?": {"vi": "Giới tính của người đối diện?", "cs": "Jaké je pohlaví druhé osoby?", "zh_cn": "对方的性別是？", "zh": "對方的性別是？", "en": "What is the other person's gender?", "fr": "Quel est le genre de l'interlocuteur ?", "de": "Welches Geschlecht hat die andere Person?", "hu": "Milyen nemű a másik fél?", "id": "Apa jenis kelamin lawan bicara?", "ja": "相手の性別は？", "pl": "Jakiej płci jest rozmówca?"},
    "남성": {"vi": "Nam", "cs": "Muž", "zh_cn": "男性", "zh": "男性", "en": "Male", "fr": "Homme", "de": "Männlich", "hu": "Férfi", "id": "Pria", "ja": "男性", "pl": "Mężczyzna"},
    "여성": {"vi": "Nữ", "cs": "Žena", "zh_cn": "女性", "zh": "女性", "en": "Female", "fr": "Femme", "de": "Weiblich", "hu": "Nő", "id": "Wanita", "ja": "女性", "pl": "Kobieta"},
    "상대방의 나이는 나와 비교하면?": {"vi": "Tuổi của người đối diện so với bạn thế nào?", "cs": "Jaký je věk druhé osoby v porovnání s vámi?", "zh_cn": "对方的年龄跟我相比？", "zh": "對方的年齡跟我相比？", "en": "How does the other person's age compare to yours?", "fr": "Quel est l'âge de l'interlocuteur par rapport au vôtre ?", "de": "Wie ist das Alter im Vergleich zu Ihnen?", "hu": "Milyen a másik fél kora Önhöz képest?", "id": "Bagaimana usia lawan bicara dibanding Anda?", "ja": "相手の年齢は自分と比べてどうですか？", "pl": "Ile lat ma rozmówca w porównaniu z Tobą?"},
    "나보다 어림 — 동생뻘": {"vi": "Nhỏ tuổi hơn tôi — như em", "cs": "Mladší než já — jako mladší bratr/sestra", "zh_cn": "比我小——像弟妹一样", "zh": "比我小——像弟妹一樣", "en": "Younger than me — like a younger sibling", "fr": "Plus jeune que moi — comme un petit frère/petite sœur", "de": "Jünger als ich – wie ein jüngeres Geschwister", "hu": "Fiatalabb nálam — mint egy fiatalabb testvér", "id": "Lebih muda dari saya — seusia adik", "ja": "自分より年下 — 弟や妹のような存在", "pl": "Młodszy ode mnie — jak młodszy brat/młodsza siostra"},
    "나와 비슷함 — 동갑": {"vi": "Xấp xỉ tuổi tôi — bạn đồng trang lứa", "cs": "Podobný věk — stejně staří", "zh_cn": "跟我差不多——同年龄", "zh": "跟我差不多——同年齡", "en": "About the same as me — peers", "fr": "À peu près du même âge — pairs", "de": "Etwa mein Alter – gleichaltrig", "hu": "Hasonló korú — egykorúak", "id": "Sebaya — seusia", "ja": "自分と同じくらい — 同い年", "pl": "W podobnym wieku — rówieśnik"},
    "나보다 많음 — 형·오빠·누나·언니뻘": {"vi": "Lớn tuổi hơn tôi — như anh chị", "cs": "Starší než já — jako starší bratr/sestra", "zh_cn": "比我大——像哥哥姐姐一样", "zh": "比我大——像哥哥姐姐一樣", "en": "Older than me — like an older sibling", "fr": "Plus âgé que moi — comme un grand frère/grande sœur", "de": "Älter als ich – wie ein älteres Geschwister", "hu": "Idősebb nálam — mint egy idősebb testvér", "id": "Lebih tua dari saya — seusia kakak", "ja": "自分より年上 — 兄や姉のような存在", "pl": "Starszy ode mnie — jak starszy brat/starsza siostra"},
    "나보다 훨씬 많음 — 삼촌·이모뻘": {"vi": "Lớn tuổi hơn tôi nhiều — như cô chú", "cs": "Mnohem starší než já — ve věku strýce/tety", "zh_cn": "比我大很多——像叔叔阿姨一样", "zh": "比我大很多——像叔叔阿姨一樣", "en": "Much older than me — like an aunt or uncle", "fr": "Bien plus âgé que moi — de l'âge d'un oncle/d'une tante", "de": "Viel älter als ich – wie Onkel/Tante", "hu": "Sokkal idősebb nálam — mint egy nagybácsi/nagynéni", "id": "Jauh lebih tua dari saya — seusia paman/bibi", "ja": "自分よりずっと年上 — おじやおばのような存在", "pl": "Dużo starszy ode mnie — jak wujek/ciocia"},
    "내 부모님보다는 젊은 분": {"vi": "Trẻ hơn bố mẹ tôi", "cs": "Mladší než moji rodiče", "zh_cn": "比我父母年轻的长辈", "zh": "比我父母年輕的長輩", "en": "Younger than my parents", "fr": "Plus jeune que mes parents", "de": "Jünger als meine Eltern", "hu": "Fiatalabb, mint a szüleim", "id": "Lebih muda dari orang tua saya", "ja": "自分の両親より若い方", "pl": "Młodszy od moich rodziców"},
    "내 부모님 또래이거나 더 많음": {"vi": "Bằng tuổi bố mẹ tôi hoặc lớn hơn", "cs": "Věk mých rodičů nebo starší", "zh_cn": "跟我父母差不多或更年长", "zh": "跟我父母差不多或更年長", "en": "About my parents' age or older", "fr": "De l'âge de mes parents ou plus âgé", "de": "Im Alter meiner Eltern oder älter", "hu": "Szüleim korabeli vagy idősebb", "id": "Sebaya orang tua saya atau lebih tua", "ja": "自分の両親と同じ世代か、それ以上", "pl": "W wieku moich rodziców lub starszy"},
    "내가 상대방의 삼촌, 이모뻘": {"vi": "Tôi như cô chú của người đó", "cs": "Jsem ve věku jejich strýce či tety", "zh_cn": "我像对方的叔叔、阿姨一样", "zh": "我像對方的叔叔、阿姨一樣", "en": "I'm like an aunt or uncle to them", "fr": "Je suis de l'âge d'un oncle ou d'une tante pour lui/elle", "de": "Ich bin im Onkel-/Tanten-Alter der Person", "hu": "Nagybácsi/nagynéni korú vagyok hozzájuk képest", "id": "Saya sebaya paman/bibi mereka", "ja": "自分が相手にとっておじやおばのような存在", "pl": "Jestem w wieku wujka/cioci dla rozmówcy"},
    "내가 상대보다 훨씬 연장자": {"vi": "Tôi lớn tuổi hơn người đó nhiều", "cs": "Jsem mnohem starší než oni", "zh_cn": "我比对方年长很多", "zh": "我比對方年長很多", "en": "I'm much older than them", "fr": "Je suis bien plus âgé que la personne", "de": "Ich bin viel älter als die Person", "hu": "Sokkal idősebb vagyok náluk", "id": "Saya jauh lebih tua dari mereka", "ja": "自分が相手よりずっと年上", "pl": "Jestem znacznie starszy od rozmówcy"},
    "내가 상대방의 부모보다 나이가 많음": {"vi": "Tôi lớn tuổi hơn bố mẹ của người đó", "cs": "Jsem starší než jejich rodiče", "zh_cn": "我比对方的父母年长", "zh": "我比對方的父母年長", "en": "I'm older than their parents", "fr": "Je suis plus âgé que ses parents", "de": "Ich bin älter als die Eltern der Person", "hu": "Idősebb vagyok a szüleinél", "id": "Saya lebih tua dari orang tua mereka", "ja": "自分が相手の両親より年上", "pl": "Jestem starszy od jego/jej rodziców"},
    "처음 만나서 나이를 잘 모름": {"vi": "Mới gặp lần đầu, chưa rõ tuổi", "cs": "První setkání, věk není znám", "zh_cn": "初次见面，不太清楚年龄", "zh": "初次見面，不太清楚年齡", "en": "Just met, don't know their age well", "fr": "Premier contact, âge inconnu", "de": "Erstes Treffen, Alter unbekannt", "hu": "Első találkozás, ismeretlen életkor", "id": "Pertama bertemu, belum tahu usia", "ja": "初対面で、年齢がよくわからない", "pl": "Pierwsze spotkanie, wiek nieznany"},
    "아직 친하지 않아 거리를 두고 예의를 차릴 때": {"vi": "Chưa thân nên giữ khoảng cách lịch sự", "cs": "Když se ještě dobře neznáte a zachováváte zdvořilý odstup", "zh_cn": "还不熟，需要保持距离、有礼貌相待时", "zh": "還不熟，需要保持距離、有禮貌相待時", "en": "Not close yet, so keeping a polite distance", "fr": "Pas encore familiers, distance polie", "de": "Noch distanziert, höflicher Abstand", "hu": "Amikor még nem ismerik egymást jól, és udvarias távolságot tartanak", "id": "Saat belum akrab dan menjaga jarak sopan", "ja": "まだ親しくなく、距離を置いて丁寧に接するとき", "pl": "Jeszcze nie blisko, uprzejmy dystans"},
    "상대방의 연령대는요?": {"vi": "Người đối diện khoảng bao nhiêu tuổi?", "cs": "Přibližný věk druhé osoby?", "zh_cn": "对方大概是哪个年龄层？", "zh": "對方大概是哪個年齡層？", "en": "What's the other person's approximate age range?", "fr": "Quelle est la tranche d'âge approximative de l'interlocuteur ?", "de": "Welche Altersgruppe hat die andere Person?", "hu": "Körülbelül milyen korú a másik fél?", "id": "Kira-kira berapa usia lawan bicara?", "ja": "相手の年齢層は？", "pl": "W jakim przybliżonym wieku jest rozmówca?"},
    "20~30대로 보임": {"vi": "Trông khoảng 20–30 tuổi", "cs": "Vypadá na 20–30 let", "zh_cn": "看起来20～30多岁", "zh": "看起來20～30多歲", "en": "Looks to be in their 20s–30s", "fr": "Semble avoir entre 20 et 30 ans", "de": "Scheint in den 20ern bis 30ern zu sein", "hu": "20–30 évesnek tűnik", "id": "Tampak berusia 20–30an", "ja": "20～30代に見える", "pl": "Wygląda na 20–30 lat"},
    "40~70대로 보임": {"vi": "Trông khoảng 40–70 tuổi", "cs": "Vypadá na 40–70 let", "zh_cn": "看起来40～70多岁", "zh": "看起來40～70多歲", "en": "Looks to be in their 40s–70s", "fr": "Semble avoir entre 40 et 70 ans", "de": "Scheint in den 40ern bis 70ern zu sein", "hu": "40–70 évesnek tűnik", "id": "Tampak berusia 40–70an", "ja": "40～70代に見える", "pl": "Wygląda na 40–70 lat"},
    "80대 이상으로 보임": {"vi": "Trông từ 80 tuổi trở lên", "cs": "Vypadá na 80 a více let", "zh_cn": "看起来80岁以上", "zh": "看起來80歲以上", "en": "Looks to be 80 or older", "fr": "Semble avoir 80 ans ou plus", "de": "Scheint 80 Jahre oder älter zu sein", "hu": "80 év felettinek tűnik", "id": "Tampak berusia 80 ke atas", "ja": "80代以上に見える", "pl": "Wygląda na 80 lat lub więcej"},
    "베트남인은 상대방과 친해질 생각이 전혀 없는 경우가 아니라면 신속히 통성명하고, 나이를 묻고, 상대방과 나의 나이 차이에 따른 호칭을 사용하는 것이 아주 일상적이에요. 계속 \"나\"·\"tôi\"라는 단어를 사용한다면 상대방과 친해지기 어려워요.": {"vi": "Trừ khi hoàn toàn không muốn làm quen, người Việt thường nhanh chóng hỏi tên, hỏi tuổi và dùng cách xưng hô phù hợp với chênh lệch tuổi tác. Nếu cứ xưng \"tôi\" thì rất khó trở nên thân thiết với người đối diện.", "cs": "Ve Vietnamu je zcela běžné si rychle vyměnit jména, zeptat se na věk a používat oslovení podle věkového rozdílu. Neustálé používání slova „já / tôi“ může bránit sblížení.", "zh_cn": "除非完全没有与对方拉近关系的打算，否则越南人通常会迅速通报姓名、询问年龄，并根据双方年龄差距使用相应的称谓。", "zh": "越南人只要不是完全不想跟對方熟識，通常都會很快互相報上姓名、詢問年齡，並依照彼此的年齡差距使用相應的稱呼，這是非常普遍的做法。如果一直使用「我」·「tôi」這個字，會很難跟對方拉近距離。", "en": "Unless a Vietnamese person has no interest at all in getting to know someone, it's very common for them to quickly exchange names, ask each other's age, and then use the term of address that fits their age difference. If you keep using the plain word for \"I\" — \"tôi\" — it's hard to grow close to the other person.", "fr": "Pour les Vietnamiens, il est très naturel d'échanger rapidement les noms, de demander l'âge et d'utiliser les termes d'adresse adaptés à la différence d'âge — sauf si l'on ne souhaite aucun lien. Continuer à utiliser le pronom neutre « tôi » rend difficile l'établissement d'une relation chaleureuse.", "de": "Für Vietnamesen ist es ganz alltäglich, sich schnell vorzustellen, nach dem Alter zu fragen und je nach Altersunterschied passende Anredeformen zu verwenden – es sei denn, man möchte überhaupt keinen Kontakt aufbauen. Wenn man stets nur das neutrale „tôi“ (ich) verwendet, ist es schwer, eine herzliche Beziehung aufzubauen.", "hu": "Vietnámban nagyon megszokott, hogy gyorsan bemutatkoznak, megkérdezik egymás életkorát, és a korkülönbségnek megfelelő megszólítást használják. A „tôi” (én) szó folyamatos használata gátolhatja a közeledést.", "id": "Di Vietnam, bertukar nama, menanyakan usia, dan menggunakan sebutan kekerabatan sesuai perbedaan usia adalah hal yang sangat lumrah.", "ja": "ベトナムの人は、相手と親しくなるつもりが全くない場合でない限り、すぐに名前を名乗り合い、年齢を尋ね合い、お互いの年齢差に応じた呼び方を使うのがとても一般的です。ずっと「私」・「tôi」という言葉を使い続けると、相手と親しくなりにくくなります。", "pl": "Wietnamczycy powszechnie wymieniają się imionami, pytają o wiek i używają form grzecznościowych zależnych od różnicy wieku."},
    "상대방은 베트남 어느 지역 사람인가요?": {"vi": "Người đối diện đến từ vùng nào của Việt Nam?", "cs": "Ze které oblasti Vietnamu druhá osoba pochází?", "zh_cn": "对方是越南哪个地区的人？", "zh": "對方是越南哪個地區的人？", "en": "Which region of Vietnam is the other person from?", "fr": "De quelle région du Vietnam est l'interlocuteur ?", "de": "Aus welcher Region Vietnams stammt die Person?", "hu": "Vietnám melyik részéről származik a másik fél?", "id": "Dari wilayah Vietnam mana lawan bicara Anda berasal?", "ja": "相手はベトナムのどの地域の方ですか？", "pl": "Z jakiego regionu Wietnamu pochodzi rozmówca?"},
    "북부": {"vi": "Miền Bắc", "cs": "Sever", "zh_cn": "北部", "zh": "北部", "en": "North", "fr": "Nord", "de": "Norden", "hu": "Észak", "id": "Utara", "ja": "北部", "pl": "Północ"},
    "하노이 등": {"vi": "Hà Nội, v.v.", "cs": "Hanoj a okolí", "zh_cn": "河内等地", "zh": "河內等地", "en": "Hanoi, etc.", "fr": "Hanoï, etc.", "de": "Hanoi usw.", "hu": "Hanoi stb.", "id": "Hanoi, dll.", "ja": "ハノイなど", "pl": "Hanoi itd."},
    "(남)": {"vi": "(Nam)", "cs": "(muž)", "zh_cn": "（南部）", "zh": "（南部）", "en": "(south)", "fr": "(Sud)", "de": "(Süd)", "hu": "(férfi)", "id": "(pria)", "ja": "（南部）", "pl": "(Południe)"},
    "남부": {"vi": "Miền Nam", "cs": "Jih", "zh_cn": "南部", "zh": "南部", "en": "South", "fr": "Sud", "de": "Süden", "hu": "Dél", "id": "Selatan", "ja": "南部", "pl": "Południe"},
    "호찌민 등": {"vi": "TP. Hồ Chí Minh, v.v.", "cs": "Ho Či Minovo Město a okolí", "zh_cn": "胡志明市等地", "zh": "胡志明市等地", "en": "Ho Chi Minh City, etc.", "fr": "Hô Chi Minh, etc.", "de": "Ho-Chi-Minh-Stadt usw.", "hu": "Ho Si Minh-város stb.", "id": "Kota Ho Chi Minh, dll.", "ja": "ホーチミンなど", "pl": "Ho Chi Minh itd."},
    "상황별 호칭을 한눈에 확인할 수 있어요. 굵은 글씨가 상대를 부르는 말, 그 옆이 나를 가리키는 말입니다.": {"vi": "Xem nhanh cách xưng hô theo từng tình huống. Chữ in đậm là cách gọi người đối diện, bên cạnh là cách xưng của bản thân.", "cs": "Přehled oslovení pro každou situaci. Tučně je oslovení druhé osoby, vedle něj označení sebe sama.", "zh_cn": "可以一目瞭然地查看各种情境下的称呼。粗体字是称呼对方的用语，旁边是称呼自己的用语。", "zh": "可以一目瞭然地查看各種情境下的稱呼。粗體字是稱呼對方的用語，旁邊是稱呼自己的用語。", "en": "See the terms of address for every situation at a glance. The bold word is what you call the other person; next to it is what you call yourself.", "fr": "Visualisez d'un coup d'œil les termes d'adresse selon la situation. En gras le terme pour s'adresser à autrui, à côté celui pour se désigner soi-même.", "de": "Hier sehen Sie die Anredeformen für jede Situation auf einen Blick. Fettgedruckt ist die Anrede für das Gegenüber, daneben die Selbstbezeichnung.", "hu": "Tekintse át a helyzetnek megfelelő megszólításokat. A félkövér szöveg a másikat szólítja meg, mellette a saját magára utaló szó.", "id": "Lihat sebutan untuk setiap situasi sekilas. Huruf tebal adalah panggilan untuk orang lain, di sebelahnya untuk diri sendiri.", "ja": "状況別の呼び方が一目でわかります。太字が相手を呼ぶ言葉、その横が自分を指す言葉です。", "pl": "Przejrzyste zestawienie form adresatywnych w zależności od sytuacji. Pogrubione to zwrot do rozmówcy, obok zwrot o sobie."},
    "아래에서 나와 상대방의 관계를 선택하면, 제공 연설 대화문 속 \"저는(tôi)\"·\"당신은(bạn)\" 표현이 실제 상황에 맞는 호칭으로 자동으로 바뀌어요. 아직 선택하지 않았다면 원문 그대로 tôi·bạn으로 표시돼요.": {"vi": "Khi bạn chọn mối quan hệ giữa bạn và người đối diện ở bên dưới, các từ \"tôi\" và \"bạn\" trong bài trình bày sẽ tự động đổi thành cách xưng hô phù hợp với tình huống thực tế. Nếu chưa chọn, chúng vẫn hiển thị nguyên văn là tôi và bạn.", "cs": "Když níže vyberete vztah mezi vámi a druhou osobou, slova „tôi“ (já) a „bạn“ (vy) v nabídkovém rozhovoru se automaticky změní na oslovení odpovídající skutečné situaci. Dokud nevyberete, zůstanou v původní podobě tôi a bạn.", "zh_cn": "在下面选择我和对方的关系后，提供见证对话中的「我(tôi)」·「您(bạn)」用语就会自动换成符合实际情境的称呼。如果还没选择，就会维持原文的 tôi·bạn。", "zh": "在下面選擇我和對方的關係後，提供見證對話中的「我(tôi)」·「您(bạn)」用語就會自動換成符合實際情境的稱呼。如果還沒選擇，就會維持原文的 tôi·bạn。", "en": "Choose the relationship between you and the other person below, and the words \"I (tôi)\" and \"you (bạn)\" in the offer-talk dialogue will automatically switch to the terms of address that fit the actual situation. Until you choose, they'll stay as the original tôi and bạn.", "fr": "Choisissez la relation entre vous et l'interlocuteur ci-dessous pour que les pronoms « tôi » (je) et « bạn » (vous) dans les présentations modèles s'adaptent automatiquement. Tant qu'aucun choix n'est fait, le texte d'origine tôi/bạn est conservé.", "de": "Wenn Sie unten die Beziehung zwischen Ihnen und der Person auswählen, werden Ausdrücke wie „ich (tôi)“ und „Sie/du (bạn)“ im Gesprächsvorschlag automatisch durch die situationsgerechte Anrede ersetzt. Bis dahin bleibt der Originaltext tôi/bạn.", "hu": "Ha alább kiválasztja az Ön és a másik személy közötti viszonyt, a felajánló beszélgetésben szereplő „tôi” (én) és „bạn” (ön) szavak automatikusan a valós helyzetnek megfelelő megszólításra változnak. Amíg nem választ, eredeti formájukban (tôi, bạn) jelennek meg.", "id": "Jika Anda memilih hubungan antara Anda dan lawan bicara di bawah ini, kata \"tôi\" (saya) dan \"bạn\" (Anda) dalam contoh presentasi akan otomatis berubah menjadi sapaan yang sesuai dengan situasi sebenarnya. Selama belum dipilih, keduanya tetap ditampilkan sesuai aslinya, yaitu tôi dan bạn.", "ja": "下で自分と相手の関係を選ぶと、提供トークの会話文にある「私は(tôi)」・「あなたは(bạn)」という表現が、実際の状況に合った呼び方に自動的に変わります。まだ選択していない場合は、原文のまま tôi・bạn と表示されます。", "pl": "Wybierz poniżej relację między Tobą a rozmówcą, aby zaimki „tôi” (ja) i „bạn” (pan/pani) we wzorach rozmów automatycznie dostosowały się do sytuacji. Jeśli nie dokonasz wyboru, pozostaną oryginalne formy tôi i bạn."},
    "나는 어느 쪽인가요?": {"vi": "Bạn thuộc bên nào?", "cs": "Na které straně jste vy?", "zh_cn": "我是哪一边？", "zh": "我是哪一邊？", "en": "Which side are you on?", "fr": "Quelle est votre situation ?", "de": "Welche Rolle haben Sie?", "hu": "Ön melyik oldalon áll?", "id": "Anda termasuk yang mana?", "ja": "自分はどちらですか？", "pl": "Jaka jest Twoja rola?"},
    "다시 선택": {"vi": "Chọn lại", "cs": "Zvolit znovu", "zh_cn": "重新选择", "zh": "重新選擇", "en": "Choose Again", "fr": "Choisir à nouveau", "de": "Erneut auswählen", "hu": "Újraválasztás", "id": "Pilih Ulang", "ja": "選び直す", "pl": "Wybierz ponownie"},
    "베트남어 어휘": {"vi": "Từ vựng tiếng Việt", "cs": "Vietnamská slovní zásoba", "zh_cn": "越南语词汇", "zh": "越南語詞彙", "en": "Vietnamese Vocabulary", "fr": "Vocabulaire vietnamien", "de": "Vietnamesischer Wortschatz", "hu": "Vietnami szókincs", "id": "Kosakata bahasa Vietnam", "ja": "ベトナム語彙", "pl": "Słownictwo wietnamskie"},
    "한자어 대응표, 신권 용어, 자주 사용하는 단어까지 어휘 학습 자료를 한곳에 모았어요. 한국 한자음과 대응하는 경우가 많아, 알고 나면 새 단어를 훨씬 쉽게 외울 수 있어요.": {"vi": "Bảng đối chiếu từ Hán Việt, thuật ngữ thần quyền và các từ thường dùng — mọi tài liệu học từ vựng đều được tập hợp ở một nơi.", "cs": "Tabulky sino-vietnamských slov, teokratické výrazy i běžná každodenní slova — všechny materiály ke slovní zásobě na jednom místě.", "zh_cn": "从汉字对应表、圣工用语，到常用单字，词汇学习资料都集中在这里。", "zh": "從漢字對應表、聖工用語，到常用單字，詞彙學習資料都集中在這裡。", "en": "Hanja-cognate charts, theocratic terms, and common everyday words — all the vocabulary material is gathered in one place.", "fr": "Tableaux de correspondance sino-vietnamiens, vocabulaire théocratique et mots fréquents du quotidien : toutes les ressources lexicales réunies au même endroit.", "de": "Entsprechungstabellen, theokratische Begriffe und häufige Wörter des Alltags – alle Wortschatzmaterialien an einem Ort.", "hu": "Kínai eredetű szavak táblázatai, teokratikus kifejezések és gyakori mindennapi szavak — minden szókincsanyag egy helyen.", "id": "Tabel padanan kata Sino-Vietnam, istilah teokratis, dan kata sehari-hari yang sering dipakai — semua materi kosakata dikumpulkan di satu tempat.", "ja": "漢字語対応表や神権用語から、よく使う単語まで、語彙学習の資料をここに集めました。日本語の漢字音と対応することが多く、覚えると新しい単語をぐっと覚えやすくなります。", "pl": "Tabele odpowiedników sino-wietnamskich, słownictwo teokratyczne i popularne słowa codzienne — wszystkie materiały leksykalne w jednym miejscu."},
    "한자음": {"vi": "Hán Việt", "cs": "Sino-vietnamština", "zh_cn": "汉字音", "zh": "漢字音", "en": "Sino-Vietnamese", "fr": "Sino-vietnamien", "de": "Sino-Vietnamesisch", "hu": "Sino-vietnámi", "id": "Sino-Vietnam", "ja": "漢越音", "pl": "Sino-wietnamski"},
    "동일음": {"vi": "Đồng âm", "cs": "Homofony", "zh_cn": "同音字", "zh": "同音字", "en": "Same Sound", "fr": "Homophones", "de": "Gleichlautend", "hu": "Azonos hangzás", "id": "Homofon", "ja": "同音", "pl": "Homofony"},
    "기본": {"vi": "Cơ bản", "cs": "Základní", "zh_cn": "基本", "zh": "基本", "en": "Base", "fr": "Bases", "de": "Grundlagen", "hu": "Alapvető", "id": "Dasar", "ja": "基本", "pl": "Podstawowe"},
    "반의": {"vi": "Trái nghĩa", "cs": "Antonyma", "zh_cn": "反义", "zh": "反義", "en": "Antonyms", "fr": "Antonymes", "de": "Gegenteile", "hu": "Ellentétek", "id": "Antonim", "ja": "反意語", "pl": "Antonimy"},
    "상용": {"vi": "Thông dụng", "cs": "Běžné", "zh_cn": "常用", "zh": "常用", "en": "Frequent", "fr": "Fréquent", "de": "Häufig", "hu": "Gyakori", "id": "Umum", "ja": "常用", "pl": "Częste"},
    "신권": {"vi": "Thần quyền", "cs": "Teokratické", "zh_cn": "属灵词汇", "zh": "屬靈詞彙", "en": "Theocratic", "fr": "Théocratique", "de": "Theokratisch", "hu": "Teokratikus", "id": "Teokratis", "ja": "神権", "pl": "Teokratyczne"},
    "인명": {"vi": "Tên người", "cs": "Jména", "zh_cn": "人名", "zh": "人名", "en": "Names", "fr": "Noms", "de": "Namen", "hu": "Nevek", "id": "Nama", "ja": "人名", "pl": "Imiona"},
    "끝말": {"vi": "Nối từ", "cs": "Slovní řetězec", "zh_cn": "字尾", "zh": "字尾", "en": "Word Chain", "fr": "Chaîne de mots", "de": "Wortketten", "hu": "Szólánc", "id": "Rantai Kata", "ja": "しりとり", "pl": "Łańcuch słów"},
    "남북 단어": {"vi": "Từ Bắc/Nam", "cs": "Severní/jižní slova", "zh_cn": "南北用词", "zh": "南北用詞", "en": "North/South Words", "fr": "Mots Nord/Sud", "de": "Nord/Süd-Wörter", "hu": "Északi/déli szavak", "id": "Kata Utara/Selatan", "ja": "南北の単語", "pl": "Północ/Południe"},
    "파수대": {"vi": "Tháp Canh", "cs": "Strážná věž", "zh_cn": "守望台", "zh": "守望台", "en": "Watchtower", "fr": "La Tour de Garde", "de": "Wachtturm", "hu": "Őrtorony", "id": "Menara Pengawal", "ja": "ものみの塔", "pl": "Strażnica"},
    "다운로드 필요": {"vi": "Cần tải xuống", "cs": "Nutno stáhnout", "zh_cn": "需要下载", "zh": "需要下載", "en": "Download needed", "fr": "Téléchargement requis", "de": "Download erforderlich", "hu": "Letöltés szükséges", "id": "Perlu Unduhan", "ja": "ダウンロードが必要", "pl": "Wymaga pobrania"},
    "다운로드 필요라고 표시된 음성은 아직 이 기기에 설치돼 있지 않아요. 설정 > 손쉬운 사용 > 읽기 및 말하기(또는 콘텐츠 말하기) > 음성에서 해당 언어를 찾아 다운로드하면 선택할 수 있어요.": {"vi": "Các giọng đọc được đánh dấu \"Cần tải xuống\" chưa được cài trên thiết bị này. Vào Cài đặt > Trợ năng > Nội dung được đọc > Giọng nói, tìm ngôn ngữ đó và tải giọng đọc về để có thể chọn.", "cs": "Hlasy označené jako „Nutno stáhnout“ nejsou v zařízení nainstalovány. Přejděte do Nastavení > Zpřístupnění > Předčítání obsahu > Hlasy a stáhněte je.", "zh_cn": "标示「需要下载」的语音尚未安装在此装置上。请到 设定 > 辅助使用 > 朗读内容（或内容朗读）> 语音，找到该语言并下载后即可选用。", "zh": "標示「需要下載」的語音尚未安裝在此裝置上。請到 設定 > 輔助使用 > 朗讀內容（或內容朗讀）> 語音，找到該語言並下載後即可選用。", "en": "Voices marked \"Download needed\" aren't installed on this device yet. Go to Settings > Accessibility > Spoken Content > Voices, find that language, and download the voice to select it.", "fr": "Les voix marquées « Téléchargement requis » ne sont pas encore installées sur cet appareil. Allez dans Réglages > Accessibilité > Contenu énoncé > Voix, trouvez cette langue et téléchargez la voix pour pouvoir la sélectionner.", "de": "Stimmen mit dem Hinweis „Download erforderlich“ sind noch nicht auf diesem Gerät installiert. Gehen Sie zu Einstellungen > Bedienungshilfen > Gesprochene Inhalte > Stimmen, suchen Sie die Sprache und laden Sie die Stimme herunter.", "hu": "A „Letöltés szükséges” jelzésű hangok nincsenek telepítve. Lépjen a Beállítások > Kisegítő lehetőségek > Beszéd > Hangok menübe és töltse le őket.", "id": "Suara bertanda 'Perlu Unduhan' belum terpasang di perangkat. Buka Pengaturan > Aksesibilitas > Konten Lisan > Suara untuk mengunduhnya.", "ja": "「ダウンロードが必要」と表示されている音声は、まだこの端末にインストールされていません。設定 > アクセシビリティ > 読み上げコンテンツ（または「コンテンツの読み上げ」）> 声 でその言語を探してダウンロードすると選択できます。", "pl": "Głosy oznaczone jako „Wymaga pobrania” nie są jeszcze zainstalowane na tym urządzeniu. Przejdź do Ustawienia > Dostępność > Zawartość mówiona > Głosy, znajdź język i pobierz głos."},
    "이미 기기에 다운로드한 음성인데도 여기에 보이지 않는다면, 이 브라우저 앱을 완전히 종료했다가 다시 열거나 기기를 재시작해 보세요. 특히 '고품질' 음성은 iOS/사파리에서 바로 인식되지 않는 경우가 있어요.": {"vi": "Nếu giọng đọc đã tải về thiết bị mà vẫn không hiện ở đây, hãy thoát hẳn ứng dụng trình duyệt rồi mở lại, hoặc khởi động lại thiết bị. Đặc biệt các giọng \"Nâng cao\" đôi khi không được nhận ngay trên iOS/Safari.", "cs": "Pokud se stažený hlas nezobrazuje, zkuste prohlížeč úplně zavřít a znovu otevřít nebo restartovat zařízení. Zejména hlasy v 'vysoké kvalitě' nemusí být v iOS/Safari ihned rozpoznány.", "zh_cn": "如果已在装置上下载的语音却没有出现在这里,请试着完全关闭此浏览器 App 后重新开启,或重新启动装置。尤其是「高品质」语音,有时在 iOS／Safari 上不会立即被辨识。", "zh": "如果已在裝置上下載的語音卻沒有出現在這裡,請試著完全關閉此瀏覽器 App 後重新開啟,或重新啟動裝置。尤其是「高品質」語音,有時在 iOS／Safari 上不會立即被辨識。", "en": "If a voice you've already downloaded on this device doesn't show up here, try fully quitting and reopening this browser app, or restarting the device. \"Enhanced\"/\"Premium\" voices in particular sometimes aren't recognized right away on iOS/Safari.", "fr": "Si une voix déjà téléchargée n'apparaît pas ici, quittez complètement et rouvrez cette application de navigation, ou redémarrez l'appareil. Les voix de haute qualité ne sont parfois pas reconnues immédiatement sous iOS/Safari.", "de": "Wenn eine bereits heruntergeladene Stimme hier nicht angezeigt wird, schließen Sie den Browser vollständig und öffnen Sie ihn erneut oder starten Sie das Gerät neu. Besonders hochwertige Stimmen werden unter iOS/Safari manchmal nicht sofort erkannt.", "hu": "Ha a már letöltött hang nem jelenik meg, zárja be teljesen és nyissa meg újra a böngészőt, vagy indítsa újra a készüléket. Különösen a 'kiváló minőségű' hangok esetén fordulhat elő, hogy az iOS/Safari nem ismeri fel azonnal.", "id": "Jika suara yang sudah diunduh tidak muncul di sini, coba tutup sepenuhnya lalu buka kembali aplikasi browser atau mulai ulang perangkat. Terutama suara 'kualitas tinggi' terkadang tidak langsung dikenali di iOS/Safari.", "ja": "端末にすでにダウンロード済みの音声がここに表示されない場合は、このブラウザアプリを完全に終了してから開き直すか、端末を再起動してみてください。特に「高品質」の音声は、iOS/Safariですぐには認識されないことがあります。", "pl": "Jeśli pobrany głos nie wyświetla się tutaj, zamknij całkowicie przeglądarkę i otwórz ją ponownie lub zrestartuj urządzenie. Głosy ulepszone/premium w systemie iOS/Safari bywają rozpoznawane z opóźnieniem."},
    ...
    "문자": {"vi": "Chữ cái", "cs": "Písmeno", "zh_cn": "文字", "zh": "文字", "en": "Alphabet", "fr": "Alphabet", "de": "Buchstaben", "hu": "Betű", "id": "Huruf", "ja": "文字", "pl": "Litery"},
    "모음": {"vi": "Nguyên âm", "cs": "Samohlásky", "zh_cn": "母音", "zh": "母音", "en": "Vowels", "fr": "Voyelles", "de": "Vokale", "hu": "Magánhangzók", "id": "Vokal", "ja": "母音", "pl": "Samogłoski"},
    "자음": {"vi": "Phụ âm", "cs": "Souhlásky", "zh_cn": "子音", "zh": "子音", "en": "Consonants", "fr": "Consonnes", "de": "Konsonanten", "hu": "Mássalhangzók", "id": "Konsonan", "ja": "子音", "pl": "Spółgłoski"},
    "성조": {"vi": "Thanh điệu", "cs": "Tóny", "zh_cn": "声调", "zh": "聲調", "en": "Tones", "fr": "Tons", "de": "Töne", "hu": "Tónusok", "id": "Nada", "ja": "声調", "pl": "Tony"},
    "연속 성조": {"vi": "Cặp thanh điệu", "cs": "Dvojice tónů", "zh_cn": "声调组合", "zh": "聲調組合", "en": "Tone Pairs", "fr": "Paires de tons", "de": "Tonkombinationen", "hu": "Tónuspárok", "id": "Pasangan Nada", "ja": "声調の組み合わせ", "pl": "Pary tonów"},
    "남북 발음": {"vi": "Phát âm Bắc/Nam", "cs": "Severní/jižní výslovnost", "zh_cn": "南北发音", "zh": "南北發音", "en": "North/South Pronunciation", "fr": "Prononciation Nord/Sud", "de": "Nord/Süd-Aussprache", "hu": "Északi/déli kiejtés", "id": "Pelafalan Utara/Selatan", "ja": "南北の発音", "pl": "Wymowa Północ/Południe"},
    "성경 책 이름 · 숫자 읽기": {"vi": "Tên các sách Kinh Thánh · Cách đọc số", "cs": "Názvy biblických knih a čtení čísel", "zh_cn": "圣经书卷名称‧数字读法", "zh": "聖經書卷名稱‧數字讀法", "en": "Bible Book Names & Number Reading", "fr": "Noms des livres bibliques et lecture des nombres", "de": "Bibelbuchnamen & Zahlen lesen", "hu": "A bibliai könyvek nevei és a számok olvasása", "id": "Nama kitab Alkitab & cara membaca angka", "ja": "聖書の書名・数字の読み方", "pl": "Nazwy ksiąg biblijnych i odczytywanie liczb"},
    "신세계역 성경의 베트남어와 한국어 책 이름을 나란히 두고 발음을 들어 보세요. 숫자 탭에는 1~100, 1,000~10억까지 숫자 읽는 법이 있어요.": {"vi": "Xem tên các sách Kinh Thánh bản Thế Giới Mới bằng tiếng Việt đặt cạnh nhau và nghe phát âm. Thẻ Số hướng dẫn cách đọc số từ 1–100 và từ 1.000 đến 1 tỷ.", "cs": "Podívejte se na názvy biblických knih Překladu nového světa ve vietnamštině vedle sebe a poslechněte si výslovnost. Karta Čísla ukazuje, jak číst čísla 1–100 a od 1 000 do 1 miliardy.", "zh_cn": "把《新世界译本》圣经的越南语和中文书卷名称并列，听听看发音。「数字」分页里有1～100、1,000～10亿的读法。", "zh": "把《新世界譯本》聖經的越南語和中文書卷名稱並列，聽聽看發音。「數字」分頁裡有1～100、1,000～10億的讀法。", "en": "See the Vietnamese and English New World Translation Bible book names side by side and listen to the pronunciation. The Numbers tab covers how to read 1–100 and 1,000 to 1 billion.", "fr": "Comparez les noms des livres bibliques de la Traduction du monde nouveau en vietnamien et en français, et écoutez leur prononciation. L'onglet Nombres explique comment lire de 1 à 100 et de 1 000 à 1 milliard.", "de": "Vergleichen Sie die vietnamesischen und deutschen Bibelbuchnamen der Neuen-Welt-Übersetzung nebeneinander und hören Sie die Aussprache. Im Tab Zahlen lernen Sie Zahlen von 1 bis 100 und von 1.000 bis 1 Milliarde.", "hu": "Nézze meg egymás mellett az Új világ fordítás bibliai könyveinek vietnami nevét, és hallgassa meg a kiejtést. A Számok fül bemutatja, hogyan kell olvasni az 1–100 közötti számokat és az 1000-től 1 milliárdig terjedő számokat.", "id": "Lihat nama-nama kitab Alkitab Terjemahan Dunia Baru dalam bahasa Vietnam secara berdampingan dan dengarkan pelafalannya. Tab Angka berisi cara membaca angka 1–100 dan 1.000 sampai 1 miliar.", "ja": "「新世界訳」聖書のベトナム語と日本語の書名を並べて表示し、発音を聞くことができます。「数字」タブには1～100、1,000～10億までの数字の読み方があります。", "pl": "Zestawienie nazw ksiąg biblijnych z Przekładu Nowego Świata po wietnamsku i polsku z możliwością odsłuchu wymowy. W zakładce Liczby znajduje się odczytywanie od 1 do 100 oraz od 1000 do 1 miliarda."},
    "숫자": {"vi": "Chữ số", "cs": "Čísla", "zh_cn": "数字", "zh": "數字", "en": "Numbers", "fr": "Nombres", "de": "Zahlen", "hu": "Számok", "id": "Angka", "ja": "数字", "pl": "Liczby"},
    "달과 요일": {"vi": "Tháng và thứ trong tuần", "cs": "Měsíce a dny", "zh_cn": "月份与星期", "zh": "月份與星期", "en": "Months & Days", "fr": "Mois et jours", "de": "Monate & Wochentage", "hu": "Hónapok és napok", "id": "Bulan & hari", "ja": "月と曜日", "pl": "Miesiące i dni"},
    "문법 및 작문 연습": {"vi": "Luyện ngữ pháp và đặt câu", "cs": "Gramatika a procvičování vět", "zh_cn": "文法与造句练习", "zh": "文法與造句練習", "en": "Grammar & Sentence Practice", "fr": "Exercices de grammaire et de phrases", "de": "Grammatik & Satzbau-Übungen", "hu": "Nyelvtan és mondatalkotás gyakorlása", "id": "Latihan tata bahasa & kalimat", "ja": "文法・作文練習", "pl": "Ćwiczenia gramatyczne i tworzenie zdań"},
    "가장 짧은 문장에서 시작해 한 단어씩 늘려 가며, 한국어와 베트남어의 어순 차이를 몸에 익혀요.": {"vi": "Bắt đầu từ câu ngắn nhất và thêm từng từ một để làm quen với sự khác biệt về trật tự từ giữa ngôn ngữ của bạn và tiếng Việt.", "cs": "Začněte nejkratšími větami a přidávejte po jednom slově, abyste si osvojili rozdíly ve slovosledu mezi vaším jazykem a vietnamštinou.", "zh_cn": "从最短的句子开始，一个字一个字地增加，亲身体会中文和越南语语序的差异。", "zh": "從最短的句子開始，一個字一個字地增加，親身體會中文和越南語語序的差異。", "en": "Start with the shortest sentences and add one word at a time, so you get a feel for the word-order differences between your language and Vietnamese.", "fr": "Commencez par des phrases très courtes et ajoutez un mot à la fois pour vous familiariser avec l'ordre des mots en vietnamien.", "de": "Beginnen Sie mit kurzen Sätzen und erweitern Sie sie Schritt für Schritt, um ein Gefühl für die vietnamesische Wortstellung zu entwickeln.", "hu": "Kezdje a legrövidebb mondatokkal, és szavanként bővítse őket, hogy ráérezzen a saját nyelve és a vietnami szórendje közötti különbségekre.", "id": "Mulailah dari kalimat terpendek dan tambahkan satu kata demi satu kata, agar terbiasa dengan perbedaan susunan kata antara bahasa Anda dan bahasa Vietnam.", "ja": "一番短い文から始めて、一語ずつ増やしながら、日本語とベトナム語の語順の違いを体で覚えましょう。", "pl": "Zacznij od najkrótszych zdań i dodawaj po jednym słowie, aby oswoić się z wietnamskim szykiem wyrazów."},
    ...
    "범용 언어 생성표": {"vi": "Bảng tạo câu tổng quát", "cs": "Univerzální tabulka vět", "zh_cn": "通用语言生成表", "zh": "通用語言生成表", "en": "General Sentence Chart", "fr": "Tableau de génération de phrases", "de": "Satzbautabelle", "hu": "Általános mondattáblázat", "id": "Tabel Pembentukan Kalimat", "ja": "汎用文生成表", "pl": "Tabela tworzenia zdań"},
    "문장 생성기": {"vi": "Công cụ tạo câu", "cs": "Generátor vět", "zh_cn": "造句產生器", "zh": "造句產生器", "en": "Sentence Builder", "fr": "Générateur de phrases", "de": "Satzgenerator", "hu": "Mondatgenerátor", "id": "Pembuat Kalimat", "ja": "文章ジェネレーター", "pl": "Generator zdań"},
    "단어를 카테고리별로 골라 보세요. 비워 두면(선택 안 함) 그 부분 없이 문장이 만들어져요. 완성을 누르면 한국어 어순에서 베트남어 어순으로 단어가 자동으로 움직이는 걸 볼 수 있어요.": {"vi": "Hãy chọn từ theo từng nhóm. Nếu để trống (không chọn), câu sẽ được tạo mà không có phần đó. Nhấn Hoàn thành để xem các từ tự động chuyển từ trật tự từ trong ngôn ngữ của bạn sang trật tự từ tiếng Việt.", "cs": "Vyberte slova podle kategorií. Pokud některé pole necháte prázdné, věta se vytvoří bez něj. Po dokončení uvidíte, jak se slova automaticky přesunou do vietnamského slovosledu.", "zh_cn": "请依类別挑选单字。如果留白（不选）就会做出没有那个部分的句子。按下完成后，可以看到单字自动从原本的语序移动到越南语语序。", "zh": "請依類別挑選單字。如果留白（不選）就會做出沒有那個部分的句子。按下完成後，可以看到單字自動從原本的語序移動到越南語語序。", "en": "Pick words by category. Leave a category blank and the sentence is built without that part. Press Done to see the words automatically move from your language's word order into Vietnamese word order.", "fr": "Sélectionnez des mots par catégorie. Si vous laissez un champ vide, la phrase est formée sans cet élément. Appuyez sur Générer pour voir les mots s'agencer automatiquement dans l'ordre de la syntaxe vietnamienne.", "de": "Wählen Sie Wörter nach Kategorien. Wenn Sie eine Kategorie leer lassen, wird der Satz ohne diesen Teil gebildet. Tippen Sie auf Fertig, um zu sehen, wie sich die Wörter automatisch in die vietnamesische Wortstellung bewegen.", "hu": "Válasszon szavakat kategóriánként. Ha üresen hagyja, a mondat a nélkül jön létre. A befejezés gombra kattintva láthatja, ahogy a szavak automatikusan vietnámi szórendre váltanak.", "id": "Pilih kata berdasarkan kategori. Jika dikosongkan, kalimat akan dibuat tanpanya. Tekan selesai untuk melihat kata-kata berpindah ke susunan bahasa Vietnam secara otomatis.", "ja": "カテゴリーごとに単語を選んでください。空欄のまま（選択しない）にすると、その部分を除いた文が作られます。「完成」を押すと、日本語の語順からベトナム語の語順へ単語が自動的に移動する様子を見ることができます。", "pl": "Wybierz słowa według kategorii. Pozostawienie pola pustego utworzy zdanie bez tego elementu. Naciśnij Generuj, aby zobaczyć, jak słowa układają się w wietnamskim szyku."},
    "문장 만들기": {"vi": "Tạo câu", "cs": "Vytvořit větu", "zh_cn": "造句", "zh": "造句", "en": "Build a Sentence", "fr": "Générer la phrase", "de": "Satzbau-Übung", "hu": "Mondat létrehozása", "id": "Buat Kalimat", "ja": "文章を作る", "pl": "Utwórz zdanie"},
    "복습 게임": {"vi": "Trò chơi ôn tập", "cs": "Opakovací hry", "zh_cn": "复习游戏", "zh": "複習遊戲", "en": "Review Games", "fr": "Jeux de révision", "de": "Wiederholungsspiele", "hu": "Ismétlő játékok", "id": "Permainan ulasan", "ja": "復習ゲーム", "pl": "Gry powtórkowe"},
    "플래시카드·보기·듣기·어순 배열·받아쓰기로 배운 내용을 복습하세요. 아래에서 복습할 영역을 먼저 골라 보세요.": {"vi": "Ôn lại những gì đã học bằng thẻ ghi nhớ, đọc, nghe, sắp xếp trật tự từ và chính tả. Trước hết hãy chọn phần muốn ôn tập ở bên dưới.", "cs": "Opakujte naučené pomocí kartiček, čtení, poslechu, řazení slov a diktátu. Nejprve níže vyberte oblast, kterou chcete opakovat.", "zh_cn": "透过字卡、阅读、听力、排列语序、听写来复习所学内容。请先在下面选择要复习的范围。", "zh": "透過字卡、閱讀、聽力、排列語序、聽寫來複習所學內容。請先在下面選擇要複習的範圍。", "en": "Review what you've learned with flashcards, reading, listening, word-order arrangement, and dictation. First pick which area to review below.", "fr": "Révisez ce que vous avez appris grâce aux cartes mémoire, à la lecture, à l'écoute, à l'ordonnancement des mots et à la dictée. Choisissez d'abord le domaine à réviser ci-dessous.", "de": "Wiederholen Sie das Gelernte mit Karteikarten, Lesen, Hören, Wortstellung und Diktat. Wählen Sie unten zuerst den Lernbereich aus.", "hu": "Ismételje át a tanultakat szókártyákkal, olvasással, hallgatással, szórend-rendezéssel és diktálással. Először válassza ki alább az ismételni kívánt területet.", "id": "Ulangi apa yang telah dipelajari dengan kartu kilat, membaca, mendengarkan, menyusun kata, dan dikte. Pilih dulu bagian yang ingin diulang di bawah ini.", "ja": "フラッシュカード、読解、聞き取り、語順並べ替え、書き取りで学んだ内容を復習しましょう。まず下から復習する分野を選んでください。", "pl": "Powtarzaj materiał za pomocą fiszek, czytania, słuchania, układania szyku i dyktanda. Wybierz poniżej zakres powtórki."},
    ...
    "베트남어 단어나 한국어 뜻으로 검색": {"vi": "Tìm theo từ tiếng Việt hoặc nghĩa", "cs": "Hledat vietnamské slovo nebo význam", "zh_cn": "用越南语单字或中文意思搜寻", "zh": "用越南語單字或中文意思搜尋", "en": "Search by Vietnamese word or English meaning", "fr": "Rechercher par mot vietnamien ou sens en français", "de": "Nach vietnamesischem Wort oder Bedeutung suchen", "hu": "Keresés vietnámi szóra vagy jelentésre", "id": "Cari kata Vietnam atau artinya", "ja": "ベトナム語の単語または日本語の意味で検索", "pl": "Szukaj według wietnamskiego słowa lub znaczenia"},
    "성경책 이름으로 검색 (베트남어·한국어)": {"vi": "Tìm theo tên sách Kinh Thánh", "cs": "Hledat podle názvu biblické knihy", "zh_cn": "用圣经书卷名称搜寻（越南语‧中文）", "zh": "用聖經書卷名稱搜尋（越南語‧中文）", "en": "Search by Bible book name (Vietnamese/English)", "fr": "Rechercher un livre biblique (vietnamien/français)", "de": "Nach Bibelbuch suchen (Vietnamesisch/Deutsch)", "hu": "Keresés bibliai könyv neve szerint", "id": "Cari berdasarkan nama kitab Alkitab", "ja": "聖書の書名で検索（ベトナム語・日本語）", "pl": "Szukaj księgi biblijnej (wietnamski/polski)"},
    "문법 특강 검색 (베트남어·한국어)": {"vi": "Tìm chủ đề ngữ pháp", "cs": "Hledat v mluvnických tématech", "zh_cn": "搜寻文法特別课程（越南语‧中文）", "zh": "搜尋文法特別課程（越南語‧中文）", "en": "Search grammar topics (Vietnamese/English)", "fr": "Rechercher dans les leçons de grammaire (vietnamien/français)", "de": "Nach Grammatikthemen suchen", "hu": "Keresés a nyelvtani témákban", "id": "Cari topik tata bahasa", "ja": "文法特別講座を検索（ベトナム語・日本語）", "pl": "Szukaj w lekcjach gramatyki (wietnamski/polski)"},
    "예: ": {"vi": "Ví dụ: ", "cs": "např. ", "zh_cn": "例：", "zh": "例：", "en": "e.g. ", "fr": "ex. : ", "de": "z. B. ", "hu": "pl. ", "id": "contoh: ", "ja": "例：", "pl": "np. "},
    "예: 예나": {"vi": "Ví dụ: Lan", "cs": "např. Anna", "zh_cn": "例：雅婷", "zh": "例：雅婷", "en": "e.g. Amy", "fr": "ex. : Sarah", "de": "z. B. Anna", "hu": "pl. Anna", "id": "contoh: Anita", "ja": "例：花子", "pl": "np. Anna"},
    "예: Trang Thanh": {"vi": "Ví dụ: Trang Thanh", "cs": "např. Trang Thanh", "zh_cn": "例：Trang Thanh", "zh": "例：Trang Thanh", "en": "e.g. Trang Thanh", "fr": "ex. : Trang Thanh", "de": "z. B. Trang Thanh", "hu": "pl. Trang Thanh", "id": "contoh: Trang Thanh", "ja": "例：Trang Thanh", "pl": "np. Trang Thanh"},
    "예: 25": {"vi": "Ví dụ: 25", "cs": "např. 25", "zh_cn": "例：25", "zh": "例：25", "en": "e.g. 25", "fr": "ex. : 25", "de": "z. B. 25", "hu": "pl. 25", "id": "contoh: 25", "ja": "例：25", "pl": "np. 25"},
    "예: 민수": {"vi": "Ví dụ: Tuấn", "cs": "např. Petr", "zh_cn": "例：志豪", "zh": "例：志豪", "en": "e.g. Michael", "fr": "ex. : Thomas", "de": "z. B. Michael", "hu": "pl. Péter", "id": "contoh: Michael", "ja": "例：太郎", "pl": "np. Michał"},
    "예: Minh": {"vi": "Ví dụ: Minh", "cs": "např. Minh", "zh_cn": "例：Minh", "zh": "例：Minh", "en": "e.g. Minh", "fr": "ex. : Minh", "de": "z. B. Minh", "hu": "pl. Minh", "id": "contoh: Minh", "ja": "例：Minh", "pl": "np. Minh"},
    "예: 30": {"vi": "Ví dụ: 30", "cs": "např. 30", "zh_cn": "例：30", "zh": "例：30", "en": "e.g. 30", "fr": "ex. : 30", "de": "z. B. 30", "hu": "pl. 30", "id": "contoh: 30", "ja": "例：30", "pl": "np. 30"},
    "예: 김철수": {"vi": "Ví dụ: Nguyễn Văn An", "cs": "např. Jan Novák", "zh_cn": "例：王大明", "zh": "例：王大明", "en": "e.g. John Smith", "fr": "ex. : Jean Dupont", "de": "z. B. Thomas Weber", "hu": "pl. Kovács János", "id": "contoh: Budi Santoso", "ja": "例：山田太郎", "pl": "np. Jan Kowalski"},
    "예: Long": {"vi": "Ví dụ: Long", "cs": "např. Long", "zh_cn": "例：Long", "zh": "例：Long", "en": "e.g. Long", "fr": "ex. : Long", "de": "z. B. Long", "hu": "pl. Long", "id": "contoh: Long", "ja": "例：Long", "pl": "np. Long"},
    "예: 45": {"vi": "Ví dụ: 45", "cs": "např. 45", "zh_cn": "例：45", "zh": "例：45", "en": "e.g. 45", "fr": "ex. : 45", "de": "z. B. 45", "hu": "pl. 45", "id": "contoh: 45", "ja": "例：45", "pl": "np. 45"},
    "예: 박영희": {"vi": "Ví dụ: Trần Thị Mai", "cs": "např. Marie Nováková", "zh_cn": "例：林美惠", "zh": "例：林美惠", "en": "e.g. Sarah Johnson", "fr": "ex. : Marie Martin", "de": "z. B. Sarah Müller", "hu": "pl. Kiss Éva", "id": "contoh: Siti Aminah", "ja": "例：山田花子", "pl": "np. Maria Nowak"},
    "예: Hoa": {"vi": "Ví dụ: Hoa", "cs": "např. Hoa", "zh_cn": "例：Hoa", "zh": "例：Hoa", "en": "e.g. Hoa", "fr": "ex. : Hoa", "de": "z. B. Hoa", "hu": "pl. Hoa", "id": "contoh: Hoa", "ja": "例：Hoa", "pl": "np. Hoa"},
    "예: 40": {"vi": "Ví dụ: 40", "cs": "např. 40", "zh_cn": "例：40", "zh": "例：40", "en": "e.g. 40", "fr": "ex. : 40", "de": "z. B. 40", "hu": "pl. 40", "id": "contoh: 40", "ja": "例：40", "pl": "np. 40"},
    "동생뻘": {"vi": "như em", "cs": "jako mladší sourozenec", "zh_cn": "弟妹辈", "zh": "弟妹輩", "en": "like a younger sibling", "fr": "comme un petit frère/petite sœur", "de": "wie ein jüngeres Geschwister", "hu": "mint egy fiatalabb testvér", "id": "seperti adik", "ja": "弟・妹くらい", "pl": "jak młodsze rodzeństwo"},
    "동갑": {"vi": "bằng tuổi", "cs": "vrstevník", "zh_cn": "同辈", "zh": "同輩", "en": "peer", "fr": "du même âge (pairs)", "de": "gleichaltrig", "hu": "kortárs", "id": "sebaya", "ja": "同い年", "pl": "rówieśnik"},
    "형·오빠·누나·언니뻘": {"vi": "như anh chị", "cs": "jako starší sourozenec", "zh_cn": "哥哥姐姐辈", "zh": "哥哥姐姐輩", "en": "like an older sibling", "fr": "comme un grand frère/grande sœur", "de": "wie ein älteres Geschwister", "hu": "mint egy idősebb testvér", "id": "seperti kakak", "ja": "兄・姉くらい", "pl": "jak starsze rodzeństwo"},
    "삼촌·이모뻘(상대가 연장자)": {"vi": "như cô chú (người đó lớn tuổi hơn)", "cs": "jako teta/strýc (je starší)", "zh_cn": "叔叔阿姨辈（对方年长）", "zh": "叔叔阿姨輩（對方年長）", "en": "like an aunt/uncle (they're older)", "fr": "comme un oncle/tante (interlocuteur plus âgé)", "de": "wie Onkel/Tante (Gegenüber ist älter)", "hu": "mint egy nagynéni/nagybácsi (ő az idősebb)", "id": "seperti bibi/paman (dia lebih tua)", "ja": "おじ・おばくらい（相手が年上）", "pl": "jak wujek/ciocia (rozmówca starszy)"},
    "부모님 또래 이상(상대가 연장자)": {"vi": "bằng tuổi bố mẹ trở lên (người đó lớn tuổi hơn)", "cs": "věk rodičů nebo starší (je starší)", "zh_cn": "父母辈以上（对方年长）", "zh": "父母輩以上（對方年長）", "en": "parents' age or older (they're older)", "fr": "de l'âge des parents ou plus âgé", "de": "im Alter der Eltern oder älter", "hu": "a szülők korosztálya vagy idősebb (ő az idősebb)", "id": "seusia orang tua atau lebih (dia lebih tua)", "ja": "親世代以上（相手が年上）", "pl": "w wieku rodziców lub starszy"},
    "삼촌·이모뻘(내가 연장자)": {"vi": "như cô chú (tôi lớn tuổi hơn)", "cs": "jako teta/strýc (já jsem starší)", "zh_cn": "叔叔阿姨辈（我年长）", "zh": "叔叔阿姨輩（我年長）", "en": "like an aunt/uncle (I'm older)", "fr": "comme un oncle/tante (je suis plus âgé)", "de": "wie Onkel/Tante (ich bin älter)", "hu": "mint egy nagynéni/nagybácsi (én vagyok az idősebb)", "id": "seperti bibi/paman (saya lebih tua)", "ja": "おじ・おばくらい（自分が年上）", "pl": "jak wujek/ciocia (ja jestem starszy)"},
    "부모님뻘(내가 연장자)": {"vi": "như bố mẹ (tôi lớn tuổi hơn)", "cs": "věk rodičů (já jsem starší)", "zh_cn": "父母辈（我年长）", "zh": "父母輩（我年長）", "en": "parents' age (I'm older)", "fr": "de l'âge des parents (je suis plus âgé)", "de": "im Alter der Eltern (ich bin älter)", "hu": "a szülők korosztálya (én vagyok az idősebb)", "id": "seusia orang tua (saya lebih tua)", "ja": "親世代くらい（自分が年上）", "pl": "w wieku rodziców (ja jestem starszy)"},
    "초면·예의를 갖춤": {"vi": "lần đầu gặp, lịch sự", "cs": "první setkání, zdvořile", "zh_cn": "初次见面‧有礼貌", "zh": "初次見面‧有禮貌", "en": "first meeting, polite", "fr": "premier contact, poli", "de": "Erstes Treffen, höflich", "hu": "első találkozás, udvariasan", "id": "pertemuan pertama, sopan", "ja": "初対面・丁寧に", "pl": "pierwsze spotkanie, uprzejmie"},
    "형·오빠": {"vi": "anh", "cs": "starší bratr", "zh_cn": "哥哥", "zh": "哥哥", "en": "older brother", "fr": "grand frère", "de": "älterer Bruder", "hu": "báty", "id": "kakak laki-laki", "ja": "兄", "pl": "starszy brat"},
    "누나·언니": {"vi": "chị", "cs": "starší sestra", "zh_cn": "姐姐", "zh": "姐姐", "en": "older sister", "fr": "grande sœur", "de": "ältere Schwester", "hu": "nővér", "id": "kakak perempuan", "ja": "姉", "pl": "starsza siostra"},
    "조카뻘": {"vi": "như cháu", "cs": "jako neteř/synovec", "zh_cn": "晚辈（侄辈）", "zh": "晚輩（姪輩）", "en": "like a niece/nephew", "fr": "comme un neveu/une nièce", "de": "wie Nichte/Neffe", "hu": "mint egy unokahúg/unokaöcs", "id": "seperti keponakan", "ja": "甥・姪くらい", "pl": "jak bratanek/siostrzenica"},
    "자녀뻘(남부)": {"vi": "như con (miền Nam)", "cs": "jako vlastní dítě (jih)", "zh_cn": "晚辈（南部，子女辈）", "zh": "晚輩（南部，子女輩）", "en": "like one's child (South)", "fr": "comme son enfant (Sud)", "de": "im Alter eines Kindes (Süden)", "hu": "mint a saját gyermek (dél)", "id": "seperti anak sendiri (Selatan)", "ja": "子どもくらい（南部）", "pl": "jak dziecko (Południe)"},
    "삼촌·아저씨뻘": {"vi": "như chú", "cs": "jako strýc", "zh_cn": "叔叔‧大叔辈", "zh": "叔叔‧大叔輩", "en": "like an uncle", "fr": "comme un oncle / homme d'âge mûr", "de": "wie ein Onkel / Herr mittleren Alters", "hu": "mint egy nagybácsi", "id": "seperti paman", "ja": "おじさんくらい", "pl": "jak wujek / pan w średnim wieku"},
    "이모·고모·아주머니뻘": {"vi": "như cô", "cs": "jako teta", "zh_cn": "阿姨‧姑姑辈", "zh": "阿姨‧姑姑輩", "en": "like an aunt", "fr": "comme une tante / femme d'âge mûr", "de": "wie eine Tante / Dame mittleren Alters", "hu": "mint egy nagynéni", "id": "seperti bibi", "ja": "おばさんくらい", "pl": "jak ciocia / pani w średnim wieku"},
    "큰아버지·큰어머니뻘 어르신": {"vi": "như bác (người lớn tuổi đáng kính)", "cs": "jako vážený starší (strýc/teta)", "zh_cn": "伯父‧伯母辈长者", "zh": "伯父‧伯母輩長者", "en": "like a respected elder (uncle/aunt)", "fr": "personne âgée très respectée (aîné)", "de": "wie ein hochgeachteter älterer Onkel / Tante", "hu": "mint egy tisztelt idős rokon (nagybácsi/nagynéni)", "id": "seperti orang tua yang dihormati (paman/bibi)", "ja": "伯父・伯母くらいの年配の方", "pl": "starsza osoba darzona szacunkiem"},
    "나(또래·북부)": {"vi": "tôi (bạn bè, miền Bắc)", "cs": "já (vrstevník, sever)", "zh_cn": "我（同辈‧北部）", "zh": "我（同輩‧北部）", "en": "I (peer, North)", "fr": "moi (pairs, Nord)", "de": "ich (gleichaltrig, Norden)", "hu": "én (kortárs, észak)", "id": "saya (sebaya, Utara)", "ja": "私（同い年・北部）", "pl": "ja (rówieśnik, Północ)"},
    "너(또래·북부)": {"vi": "bạn (bạn bè, miền Bắc)", "cs": "ty (vrstevník, sever)", "zh_cn": "你（同辈‧北部）", "zh": "你（同輩‧北部）", "en": "you (peer, North)", "fr": "toi (pairs, Nord)", "de": "du (gleichaltrig, Norden)", "hu": "te (kortárs, észak)", "id": "kamu (sebaya, Utara)", "ja": "あなた（同い年・北部）", "pl": "ty (rówieśnik, Północ)"},
    "나(또래·남부)": {"vi": "tôi (bạn bè, miền Nam)", "cs": "já (vrstevník, jih)", "zh_cn": "我（同辈‧南部）", "zh": "我（同輩‧南部）", "en": "I (peer, South)", "fr": "moi (pairs, Sud)", "de": "ich (gleichaltrig, Süden)", "hu": "én (kortárs, dél)", "id": "saya (sebaya, Selatan)", "ja": "私（同い年・南部）", "pl": "ja (rówieśnik, Południe)"},
    "너(또래·남부)": {"vi": "bạn (bạn bè, miền Nam)", "cs": "ty (vrstevník, jih)", "zh_cn": "你（同辈‧南部）", "zh": "你（同輩‧南部）", "en": "you (peer, South)", "fr": "toi (pairs, Sud)", "de": "du (gleichaltrig, Süden)", "hu": "te (kortárs, dél)", "id": "kamu (sebaya, Selatan)", "ja": "あなた（同い年・南部）", "pl": "ty (rówieśnik, Południe)"},
    "나(중립·예의)": {"vi": "tôi (trung tính, lịch sự)", "cs": "já (neutrálně, zdvořile)", "zh_cn": "我（中立‧礼貌）", "zh": "我（中立‧禮貌）", "en": "I (neutral, polite)", "fr": "moi (neutre, poli)", "de": "ich (neutral, höflich)", "hu": "én (semleges, udvarias)", "id": "saya (netral, sopan)", "ja": "私（中立・丁寧）", "pl": "ja (neutralnie, uprzejmie)"},
    "나보다 어린 사람 — 동생뻘": {"vi": "Người nhỏ tuổi hơn tôi — như em", "cs": "Někdo mladší než já — jako mladší sourozenec", "zh_cn": "比我小的人——弟妹辈", "zh": "比我小的人——弟妹輩", "en": "Someone younger than me — like a younger sibling", "fr": "Plus jeune que moi — comme un petit frère/petite sœur", "de": "Jünger als ich – wie ein jüngeres Geschwister", "hu": "Nálam fiatalabb — mint egy fiatalabb testvér", "id": "Orang yang lebih muda dari saya — seperti adik", "ja": "自分より年下の人 — 弟・妹くらい", "pl": "Osoba młodsza ode mnie — jak młodsze rodzeństwo"},
    "나와 동갑 — 원자료에 없어 새로 구성": {"vi": "Bạn bằng tuổi — không có trong tài liệu gốc, được soạn mới", "cs": "Moji vrstevníci — v původním materiálu chybí, nově sestaveno", "zh_cn": "跟我同辈——原始资料没有，另行编写", "zh": "跟我同輩——原始資料沒有，另行編寫", "en": "My peers — not in the original material, newly composed", "fr": "Du même âge — pairs (adapté pour les apprenants)", "de": "Gleichaltrig mit mir – neu zusammengestellt", "hu": "Velem egykorúak — az eredeti anyagban nem szerepel, újonnan összeállítva", "id": "Teman sebaya — tidak ada dalam materi asli, disusun baru", "ja": "私と同い年 — 元の資料にないため、新たに作成", "pl": "Rówieśnicy — zestawienie dla uczących się"},
    "나보다 손위 — 형·오빠·누나·언니뻘": {"vi": "Người lớn tuổi hơn tôi — như anh chị", "cs": "Někdo starší než já — jako starší sourozenec", "zh_cn": "比我年长的人——哥哥姐姐辈", "zh": "比我年長的人——哥哥姐姐輩", "en": "Someone older than me — like an older sibling", "fr": "Plus âgé que moi — comme un grand frère/grande sœur", "de": "Älter als ich – wie ein älteres Geschwister", "hu": "Nálam idősebb — mint egy idősebb testvér", "id": "Orang yang lebih tua dari saya — seperti kakak", "ja": "私より年上 — 兄や姉にあたる人", "pl": "Osoba starsza ode mnie — jak starsze rodzeństwo"},
    "삼촌·이모뻘 — 내 아버지·어머니보다는 젊은 분(상대가 연장자)": {"vi": "Như cô chú — trẻ hơn bố mẹ tôi (người đó lớn tuổi hơn)", "cs": "Jako teta/strýc — mladší než moji rodiče (je starší)", "zh_cn": "叔叔阿姨辈——比我父母年轻的长辈（对方年长）", "zh": "叔叔阿姨輩——比我父母年輕的長輩（對方年長）", "en": "Like an aunt/uncle — younger than my parents (they're older)", "fr": "Comme un oncle/une tante — plus jeune que mes parents (interlocuteur plus âgé)", "de": "Wie Onkel/Tante – jünger als meine Eltern (Gegenüber ist älter)", "hu": "Mint egy nagynéni/nagybácsi — fiatalabb a szüleimnél (ő az idősebb)", "id": "Seperti bibi/paman — lebih muda dari orang tua saya (dia lebih tua)", "ja": "おじ・おばにあたる方 — 私の父母より若い方（相手が年上）", "pl": "W wieku wujka/cioci — młodszy od moich rodziców (rozmówca starszy)"},
    "부모님 또래이거나 더 많으신 분(상대가 연장자)": {"vi": "Bằng tuổi bố mẹ tôi hoặc lớn hơn (người đó lớn tuổi hơn)", "cs": "Ve věku mých rodičů nebo starší (je starší)", "zh_cn": "跟父母同辈或更年长（对方年长）", "zh": "跟父母同輩或更年長（對方年長）", "en": "About my parents' age or older (they're older)", "fr": "De l'âge de mes parents ou plus âgé (interlocuteur plus âgé)", "de": "Im Alter meiner Eltern oder älter (Gegenüber ist älter)", "hu": "A szüleim korosztálya vagy idősebb (ő az idősebb)", "id": "Seusia orang tua saya atau lebih tua (dia lebih tua)", "ja": "両親と同世代か、それ以上の方（相手が年上）", "pl": "W wieku moich rodziców lub starszy (rozmówca starszy)"},
    "삼촌·이모뻘 — 내가 상대방보다 훨씬 연장자": {"vi": "Như cô chú — tôi lớn tuổi hơn người đó nhiều", "cs": "Jako teta/strýc — jsem mnohem starší než oni", "zh_cn": "叔叔阿姨辈——我比对方年长很多", "zh": "叔叔阿姨輩——我比對方年長很多", "en": "Like an aunt/uncle — I'm much older than them", "fr": "Comme un oncle/une tante — je suis bien plus âgé", "de": "Wie Onkel/Tante – ich bin viel älter als das Gegenüber", "hu": "Mint egy nagynéni/nagybácsi — sokkal idősebb vagyok náluk", "id": "Seperti bibi/paman — saya jauh lebih tua dari mereka", "ja": "おじ・おばにあたる方 — 私が相手よりずっと年上", "pl": "W wieku wujka/cioci — jestem znacznie starszy"},
    "내가 상대방 부모보다 나이가 많음": {"vi": "Tôi lớn tuổi hơn bố mẹ của người đó", "cs": "Jsem starší než jejich rodiče", "zh_cn": "我比对方的父母年长", "zh": "我比對方的父母年長", "en": "I'm older than their parents", "fr": "Je suis plus âgé que ses parents", "de": "Ich bin älter als die Eltern der Person", "hu": "Idősebb vagyok a szüleiknél", "id": "Saya lebih tua dari orang tua mereka", "ja": "私が相手の親より年上", "pl": "Jestem starszy od rodziców rozmówcy"},
    "내가 형제일 때": {"vi": "Khi tôi là anh em nam", "cs": "Když jsem bratr", "zh_cn": "我是弟兄时", "zh": "我是弟兄時", "en": "When I'm a brother", "fr": "Quand je suis un frère", "de": "Wenn ich ein Bruder bin", "hu": "Ha fivér vagyok", "id": "Jika saya saudara laki-laki", "ja": "私が兄弟の場合", "pl": "Gdy jestem bratem"},
    "내가 자매일 때": {"vi": "Khi tôi là chị em nữ", "cs": "Když jsem sestra", "zh_cn": "我是姐妹时", "zh": "我是姐妹時", "en": "When I'm a sister", "fr": "Quand je suis une sœur", "de": "Wenn ich eine Schwester bin", "hu": "Ha nővér vagyok", "id": "Jika saya saudara perempuan", "ja": "私が姉妹の場合", "pl": "Gdy jestem siostrą"},
    "상대가 남성일 때": {"vi": "Khi người đó là nam", "cs": "Když je to muž", "zh_cn": "对方是男性时", "zh": "對方是男性時", "en": "When they're male", "fr": "Quand l'interlocuteur est un homme", "de": "Wenn die Person männlich ist", "hu": "Ha férfi", "id": "Jika dia laki-laki", "ja": "相手が男性の場合", "pl": "Gdy rozmówca jest mężczyzną"},
    "상대가 여성일 때": {"vi": "Khi người đó là nữ", "cs": "Když je to žena", "zh_cn": "对方是女性时", "zh": "對方是女性時", "en": "When they're female", "fr": "Quand l'interlocuteur est une femme", "de": "Wenn die Person weiblich ist", "hu": "Ha nő", "id": "Jika dia perempuan", "ja": "相手が女性の場合", "pl": "Gdy rozmówca jest kobietą"},
    "상대가 남성 · 북부": {"vi": "Nam · miền Bắc", "cs": "Muž · sever", "zh_cn": "对方是男性‧北部", "zh": "對方是男性‧北部", "en": "Male, North", "fr": "Homme, Nord", "de": "Männlich, Norden", "hu": "Férfi · észak", "id": "Laki-laki · Utara", "ja": "相手が男性・北部", "pl": "Mężczyzna, Północ"},
    "상대가 남성 · 남부": {"vi": "Nam · miền Nam", "cs": "Muž · jih", "zh_cn": "对方是男性‧南部", "zh": "對方是男性‧南部", "en": "Male, South", "fr": "Homme, Sud", "de": "Männlich, Süden", "hu": "Férfi · dél", "id": "Laki-laki · Selatan", "ja": "相手が男性・南部", "pl": "Mężczyzna, Południe"},
    "상대가 여성 · 북부": {"vi": "Nữ · miền Bắc", "cs": "Žena · sever", "zh_cn": "对方是女性‧北部", "zh": "對方是女性‧北部", "en": "Female, North", "fr": "Femme, Nord", "de": "Weiblich, Norden", "hu": "Nő · észak", "id": "Perempuan · Utara", "ja": "相手が女性・北部", "pl": "Kobieta, Północ"},
    "상대가 여성 · 남부": {"vi": "Nữ · miền Nam", "cs": "Žena · jih", "zh_cn": "对方是女性‧南部", "zh": "對方是女性‧南部", "en": "Female, South", "fr": "Femme, Sud", "de": "Weiblich, Süden", "hu": "Nő · dél", "id": "Perempuan · Selatan", "ja": "相手が女性・南部", "pl": "Kobieta, Południe"},
    "내가 남성 · 북부": {"vi": "Tôi là nam · miền Bắc", "cs": "Jsem muž · sever", "zh_cn": "我是男性‧北部", "zh": "我是男性‧北部", "en": "I'm male, North", "fr": "Je suis un homme, Nord", "de": "Ich bin männlich, Norden", "hu": "Férfi vagyok · észak", "id": "Saya laki-laki · Utara", "ja": "私が男性・北部", "pl": "Jestem mężczyzną, Północ"},
    "내가 남성 · 남부": {"vi": "Tôi là nam · miền Nam", "cs": "Jsem muž · jih", "zh_cn": "我是男性‧南部", "zh": "我是男性‧南部", "en": "I'm male, South", "fr": "Je suis un homme, Sud", "de": "Ich bin männlich, Süden", "hu": "Férfi vagyok · dél", "id": "Saya laki-laki · Selatan", "ja": "私が男性・南部", "pl": "Jestem mężczyzną, Południe"},
    "내가 여성 · 북부": {"vi": "Tôi là nữ · miền Bắc", "cs": "Jsem žena · sever", "zh_cn": "我是女性‧北部", "zh": "我是女性‧北部", "en": "I'm female, North", "fr": "Je suis une femme, Nord", "de": "Ich bin weiblich, Norden", "hu": "Nő vagyok · észak", "id": "Saya perempuan · Utara", "ja": "私が女性・北部", "pl": "Jestem kobietą, Północ"},
    "내가 여성 · 남부": {"vi": "Tôi là nữ · miền Nam", "cs": "Jsem žena · jih", "zh_cn": "我是女性‧南部", "zh": "我是女性‧南部", "en": "I'm female, South", "fr": "Je suis une femme, Sud", "de": "Ich bin weiblich, Süden", "hu": "Nő vagyok · dél", "id": "Saya perempuan · Selatan", "ja": "私が女性・南部", "pl": "Jestem kobietą, Południe"},
    "상대가 20~30대 남성": {"vi": "Nam, 20–30 tuổi", "cs": "Muž, 20–30 let", "zh_cn": "对方是20～30多岁男性", "zh": "對方是20～30多歲男性", "en": "Male, 20s–30s", "fr": "Homme, 20–30 ans", "de": "Männlich, 20er–30er Jahre", "hu": "Férfi, 20–30 éves", "id": "Laki-laki, 20–30-an", "ja": "相手が20~30代の男性", "pl": "Mężczyzna, 20–30 lat"},
    "상대가 20~30대 여성": {"vi": "Nữ, 20–30 tuổi", "cs": "Žena, 20–30 let", "zh_cn": "对方是20～30多岁女性", "zh": "對方是20～30多歲女性", "en": "Female, 20s–30s", "fr": "Femme, 20–30 ans", "de": "Weiblich, 20er–30er Jahre", "hu": "Nő, 20–30 éves", "id": "Perempuan, 20–30-an", "ja": "相手が20~30代の女性", "pl": "Kobieta, 20–30 lat"},
    "상대가 40~70대 남성": {"vi": "Nam, 40–70 tuổi", "cs": "Muž, 40–70 let", "zh_cn": "对方是40～70多岁男性", "zh": "對方是40～70多歲男性", "en": "Male, 40s–70s", "fr": "Homme, 40–70 ans", "de": "Männlich, 40er–70er Jahre", "hu": "Férfi, 40–70 éves", "id": "Laki-laki, 40–70-an", "ja": "相手が40~70代の男性", "pl": "Mężczyzna, 40–70 lat"},
    "상대가 40~70대 여성": {"vi": "Nữ, 40–70 tuổi", "cs": "Žena, 40–70 let", "zh_cn": "对方是40～70多岁女性", "zh": "對方是40～70多歲女性", "en": "Female, 40s–70s", "fr": "Femme, 40–70 ans", "de": "Weiblich, 40er–70er Jahre", "hu": "Nő, 40–70 éves", "id": "Perempuan, 40–70-an", "ja": "相手が40~70代の女性", "pl": "Kobieta, 40–70 lat"},
    "상대가 80대 이상": {"vi": "Từ 80 tuổi trở lên", "cs": "80 let a více", "zh_cn": "对方是80岁以上", "zh": "對方是80歲以上", "en": "80 or older", "fr": "80 ans ou plus", "de": "80 Jahre oder älter", "hu": "80 éves vagy idősebb", "id": "80 tahun ke atas", "ja": "相手が80代以上", "pl": "80 lat lub więcej"},
    "상대를 부를 때": {"vi": "Khi gọi người đó", "cs": "Při oslovení druhé osoby", "zh_cn": "称呼对方时", "zh": "稱呼對方時", "en": "When addressing them", "fr": "Pour s'adresser à l'interlocuteur", "de": "Anrede für das Gegenüber", "hu": "A másik fél megszólításakor", "id": "Saat memanggil lawan bicara", "ja": "相手を呼ぶとき", "pl": "Zwrot do rozmówcy"},
    "나를 가리킬 때": {"vi": "Khi tự xưng", "cs": "Když mluvím o sobě", "zh_cn": "称呼自己时", "zh": "稱呼自己時", "en": "When referring to yourself", "fr": "Pour se désigner soi-même", "de": "Selbstbezeichnung (Ich)", "hu": "Amikor magamra utalok", "id": "Saat merujuk diri sendiri", "ja": "自分を指すとき", "pl": "Określenie siebie"},
    "문장 끝: ": {"vi": "Cuối câu: ", "cs": "Konec věty: ", "zh_cn": "句尾：", "zh": "句尾：", "en": "End of sentence: ", "fr": "Fin de phrase : ", "de": "Satzende: ", "hu": "Mondat vége: ", "id": "Akhir kalimat: ", "ja": "文末: ", "pl": "Koniec zdania: "},
    "대답 시작: ": {"vi": "Đầu câu trả lời: ", "cs": "Začátek odpovědi: ", "zh_cn": "回答开头：", "zh": "回答開頭：", "en": "Start of reply: ", "fr": "Début de réponse : ", "de": "Antwortbeginn: ", "hu": "Válasz kezdete: ", "id": "Awal tanggapan: ", "ja": "返事の始め: ", "pl": "Początek odpowiedzi: "},
    "<b>ạ</b> (존대)": {"vi": "<b>ạ</b> (lễ phép)", "cs": "<b>ạ</b> (zdvořile)", "zh_cn": "<b>ạ</b>（敬语）", "zh": "<b>ạ</b>（敬語）", "en": "<b>ạ</b> (polite)", "fr": "<b>ạ</b> (poli)", "de": "<b>ạ</b> (höflich)", "hu": "<b>ạ</b> (udvarias)", "id": "<b>ạ</b> (sopan)", "ja": "<b>ạ</b>（敬語）", "pl": "<b>ạ</b> (uprzejmie)"},
    "<b>없음</b> (편하게)": {"vi": "<b>Không có</b> (thân mật)", "cs": "<b>Nic</b> (neformálně)", "zh_cn": "<b>没有</b>（随意）", "zh": "<b>沒有</b>（隨意）", "en": "<b>None</b> (casual)", "fr": "<b>Aucun</b> (familier)", "de": "<b>Keine</b> (umgangssprachlich)", "hu": "<b>Nincs</b> (közvetlen)", "id": "<b>Tidak ada</b> (santai)", "ja": "<b>なし</b>（気軽に）", "pl": "<b>Brak</b> (swobodnie)"},
    "<b>없음</b>": {"vi": "<b>Không có</b>", "cs": "<b>Nic</b>", "zh_cn": "<b>没有</b>", "zh": "<b>沒有</b>", "en": "<b>None</b>", "fr": "<b>Aucun</b>", "de": "<b>Keine</b>", "hu": "<b>Nincs</b>", "id": "<b>Tidak ada</b>", "ja": "<b>なし</b>", "pl": "<b>Brak</b>"},
    "<b>dạ</b> (네)": {"vi": "<b>dạ</b> (vâng)", "cs": "<b>dạ</b> (ano)", "zh_cn": "<b>dạ</b>（是）", "zh": "<b>dạ</b>（是）", "en": "<b>dạ</b> (yes)", "fr": "<b>dạ</b> (oui)", "de": "<b>dạ</b> (ja)", "hu": "<b>dạ</b> (igen)", "id": "<b>dạ</b> (ya)", "ja": "<b>dạ</b>（はい）", "pl": "<b>dạ</b> (tak)"},
    ...
    "눌러서 뜻 보기": {"vi": "Nhấn để xem nghĩa", "cs": "Klepnutím zobrazit význam", "zh_cn": "点一下看意思", "zh": "點一下看意思", "en": "Tap to reveal meaning", "fr": "Appuyer pour afficher le sens", "de": "Tippen für Bedeutung", "hu": "Koppintson a jelentéshez", "id": "Ketuk untuk melihat arti", "ja": "タップして意味を見る", "pl": "Dotknij, aby zobaczyć znaczenie"},
    "눌러서 가리기": {"vi": "Nhấn để ẩn", "cs": "Klepnutím skrýt", "zh_cn": "点一下遮住", "zh": "點一下遮住", "en": "Tap to hide", "fr": "Appuyer pour masquer", "de": "Tippen zum Verbergen", "hu": "Koppintson az elrejtéshez", "id": "Ketuk untuk menyembunyikan", "ja": "タップして隠す", "pl": "Dotknij, aby ukryć"},
    "남성 형제": {"vi": "một anh", "cs": "bratr", "zh_cn": "男性弟兄", "zh": "男性弟兄", "en": "a brother", "fr": "un frère", "de": "ein Bruder", "hu": "egy fivér", "id": "saudara laki-laki", "ja": "男性の兄弟", "pl": "brat"},
    "여성 자매": {"vi": "một chị", "cs": "sestra", "zh_cn": "女性姐妹", "zh": "女性姐妹", "en": "a sister", "fr": "une sœur", "de": "eine Schwester", "hu": "egy nővér", "id": "saudari", "ja": "女性の姉妹", "pl": "siostra"},
    "장로 형제": {"vi": "Anh trưởng lão", "cs": "Bratr starší", "zh_cn": "长老弟兄", "zh": "長老弟兄", "en": "Elder Brother", "fr": "un ancien", "de": "ein Ältester", "hu": "Vén testvér", "id": "Saudara penatua", "ja": "長老の兄弟", "pl": "starszy zboru"},
    "파이오니아 자매": {"vi": "Chị tiên phong", "cs": "Sestra průkopnice", "zh_cn": "先驱姐妹", "zh": "先驅姐妹", "en": "Pioneer Sister", "fr": "une pionnière", "de": "eine Pionierschwester", "hu": "Úttörő testvérnő", "id": "Saudari perintis", "ja": "開拓者の姉妹", "pl": "pionierka"},
    "이성과의 만남이에요. 인사와 소개 후에는 같은 성별의 동료(": {"vi": "Đây là cuộc gặp với người khác giới. Sau khi chào hỏi và giới thiệu, tốt nhất là chuyển thông tin liên lạc cho một người bạn đồng hành cùng giới (", "cs": "Setkání s osobou opačného pohlaví. Po pozdravu a představení předejte kontakt spolupracovníkovi stejného pohlaví (", "zh_cn": "这是异性会面。打过招呼、做完自我介绍后，最好把联络方式转交给同性別的同伴（", "zh": "這是異性會面。打過招呼、做完自我介紹後，最好把聯絡方式轉交給同性別的同伴（", "en": "This is a meeting with someone of the opposite sex. After greeting and introducing yourself, it's best to hand off contact info to a same-gender companion (", "fr": "Il s'agit d'une rencontre avec une personne du sexe opposé. Après les salutations et la présentation, il est préférable de transmettre les coordonnées à un compagnon du même sexe (", "de": "Dies ist ein Treffen mit einer Person des anderen Geschlechts. Nach der Begrüßung und Vorstellung empfiehlt es sich, die Kontaktdaten an einen gleichgeschlechtlichen Dienstpartner (", "hu": "Találkozás ellenkező nemű személlyel. Üdvözlés és bemutatkozás után adja át a kapcsolatot egy azonos nemű társnak (", "id": "Pertemuan dengan lawan jenis. Setelah menyapa dan memperkenalkan diri, serahkan kontak ke rekan yang berjenis kelamin sama (", "ja": "異性との面会です。挨拶と自己紹介を済ませたら、同性の奉仕の仲間（", "pl": "To spotkanie z osobą przeciwnej płci. Po powitaniu i przedstawieniu się warto przekazać kontakt współpracownikowi tej samej płci ("},
    ")에게 연락처를 전달하고, 재방문·성서 연구는 그 동료와 함께 진행하는 것이 좋아요.": {"vi": ") và cùng người đó thực hiện việc thăm lại và học Kinh Thánh.", "cs": ") a opětovné návštěvy a biblická studia vést společně s tímto spolupracovníkem.", "zh_cn": "），并和该同伴一起进行重访和圣经研究。", "zh": "），並和該同伴一起進行重訪和聖經研究。", "en": ") and have that person join you for the callback and Bible study.", "fr": ") et d'effectuer les nouvelles visites et le cours biblique avec ce compagnon.", "de": ") weiterzugeben und Rückbesuche sowie das Bibelstudium gemeinsam durchzuführen.", "hu": "), és az újralátogatásokat és a bibliatanulmányozást vele együtt érdemes folytatni.", "id": ") dan melanjutkan kunjungan kembali serta pelajaran Alkitab bersama rekan tersebut.", "ja": "）に連絡先を渡し、再訪問・聖書研究はその仲間と一緒に行うとよいでしょう。", "pl": ") i prowadzić odwiedziny ponowne oraz studium biblijne razem z nim."},
    "봉사짝 호칭: ": {"vi": "Cách xưng hô với bạn cùng rao giảng: ", "cs": "Oslovení spolupracovníka: ", "zh_cn": "传道夥伴称呼：", "zh": "傳道夥伴稱呼：", "en": "Companion's term of address: ", "fr": "Terme d'adresse du compagnon : ", "de": "Anrede des Dienstpartners: ", "hu": "Szolgálati társ megszólítása: ", "id": "Panggilan rekan: ", "ja": "奉仕の仲間の呼び方： ", "pl": "Forma do współgłosiciela: "},
    "이전 단계": {"vi": "Bước trước", "cs": "Předchozí krok", "zh_cn": "上一步", "zh": "上一步", "en": "Previous", "fr": "Étape précédente", "de": "Vorheriger Schritt", "hu": "Előző lépés", "id": "Langkah Sebelumnya", "ja": "前へ", "pl": "Poprzedni krok"},
    "다음 단계": {"vi": "Bước tiếp", "cs": "Další krok", "zh_cn": "下一步", "zh": "下一步", "en": "Next", "fr": "Étape suivante", "de": "Nächster Schritt", "hu": "Következő lépés", "id": "Langkah Berikutnya", "ja": "次へ", "pl": "Następny krok"},
    "아직 참여자 정보가 입력되지 않았어요. 입력하면 위 대화문의 이름·전화번호·나이·호칭이 자동으로 채워져요.": {"vi": "Chưa nhập thông tin người tham gia. Khi nhập, tên, số điện thoại, tuổi và cách xưng hô trong đoạn hội thoại ở trên sẽ được tự động điền vào.", "cs": "Zatím nebyly zadány žádné informace o účastníkovi. Po jejich vyplnění se jméno, telefonní číslo, věk a oslovení ve výše uvedeném dialogu doplní automaticky.", "zh_cn": "还没输入参与者资讯。输入后，上面对话中的姓名‧电话号碼‧年龄‧称呼会自动填入。", "zh": "還沒輸入參與者資訊。輸入後，上面對話中的姓名‧電話號碼‧年齡‧稱呼會自動填入。", "en": "No participant info entered yet. Fill it in and the name, phone number, age, and terms of address in the dialogue above will fill in automatically.", "fr": "Les informations sur les interlocuteurs n'ont pas encore été saisies. Une fois renseignées, le nom, le numéro de téléphone, l'âge et les formules d'adresse dans les dialogues s'adapteront automatiquement.", "de": "Noch keine Teilnehmerdaten eingegeben. Nach der Eingabe werden Name, Telefonnummer, Alter und Anredeformen oben automatisch ausgefüllt.", "hu": "Még nincsenek megadva a résztvevő adatai. Ha kitölti, a fenti beszélgetésben a név, telefonszám, életkor és megszólítás automatikusan kitöltődik.", "id": "Belum ada informasi peserta yang dimasukkan. Jika diisi, nama, nomor telepon, usia, dan panggilan dalam percakapan di atas akan terisi otomatis.", "ja": "まだ参加者情報が入力されていません。入力すると、上の会話文の名前・電話番号・年齢・呼び方が自動的に入力されます。", "pl": "Nie wprowadzono jeszcze informacji o rozmówcach. Po ich podaniu imię, numer telefonu, wiek i formy grzecznościowe w dialogu uzupełnią się automatycznie."},
    "대화 탭에서 참여자 정보 입력하기 →": {"vi": "Nhập thông tin người tham gia ở thẻ Hội thoại →", "cs": "Zadat informace o účastníkovi na kartě Rozhovory →", "zh_cn": "到「对话」分页输入参与者资讯 →", "zh": "到「對話」分頁輸入參與者資訊 →", "en": "Enter participant info in the Dialogue tab →", "fr": "Saisir les informations sous l'onglet Dialogue →", "de": "Teilnehmerdaten im Tab Dialog eingeben →", "hu": "Résztvevő adatainak megadása a Beszélgetések lapon →", "id": "Masukkan info peserta di tab Percakapan →", "ja": "「会話」タブで参加者情報を入力する →", "pl": "Wprowadź informacje w zakładce Rozmowy →"},
    "대화 탭에서 참여자 정보 수정하기 →": {"vi": "Sửa thông tin người tham gia ở thẻ Hội thoại →", "cs": "Upravit informace o účastníkovi na kartě Rozhovory →", "zh_cn": "到「对话」分页修改参与者资讯 →", "zh": "到「對話」分頁修改參與者資訊 →", "en": "Edit participant info in the Dialogue tab →", "fr": "Modifier les informations sous l'onglet Dialogue →", "de": "Teilnehmerdaten im Tab Dialog bearbeiten →", "hu": "Résztvevő adatainak szerkesztése a Beszélgetések lapon →", "id": "Ubah info peserta di tab Percakapan →", "ja": "「会話」タブで参加者情報を編集する →", "pl": "Edytuj informacje w zakładce Rozmowy →"},
    "이름 미입력": {"vi": "Chưa nhập tên", "cs": "Jméno nezadáno", "zh_cn": "尚未输入姓名", "zh": "尚未輸入姓名", "en": "No name entered", "fr": "Nom non renseigné", "de": "Kein Name eingegeben", "hu": "Nincs megadva név", "id": "Nama belum diisi", "ja": "名前未入力", "pl": "Brak imienia"},
    "호칭 ": {"vi": "Xưng hô: ", "cs": "Oslovení: ", "zh_cn": "称呼 ", "zh": "稱呼 ", "en": "Address: ", "fr": "Adresse : ", "de": "Anrede: ", "hu": "Megszólítás: ", "id": "Panggilan: ", "ja": "呼び方 ", "pl": "Forma: "},
    "세": {"vi": " tuổi", "cs": " let", "zh_cn": "岁", "zh": "歲", "en": " y/o", "fr": " ans", "de": " Jahre", "hu": " éves", "id": " thn", "ja": "歳", "pl": " lat"},
    "이전 카드": {"vi": "Thẻ trước", "cs": "Předchozí karta", "zh_cn": "上一张卡片", "zh": "上一張卡片", "en": "Previous card", "fr": "Carte précédente", "de": "Vorherige Karte", "hu": "Előző kártya", "id": "Kartu Sebelumnya", "ja": "前のカード", "pl": "Poprzednia karta"},
    "다시 듣기": {"vi": "Nghe lại", "cs": "Přehrát znovu", "zh_cn": "重新播放", "zh": "重新播放", "en": "Play again", "fr": "Réécouter", "de": "Erneut anhören", "hu": "Újrahallgatás", "id": "Putar Ulang", "ja": "もう一度聞く", "pl": "Odtwórz ponownie"},
    "섞기": {"vi": "Xáo trộn", "cs": "Zamíchat", "zh_cn": "洗牌", "zh": "洗牌", "en": "Shuffle", "fr": "Mélanger", "de": "Mischen", "hu": "Keverés", "id": "Acak", "ja": "シャッフル", "pl": "Wymieszaj"},
    "다음 카드": {"vi": "Thẻ tiếp", "cs": "Další karta", "zh_cn": "下一张卡片", "zh": "下一張卡片", "en": "Next card", "fr": "Carte suivante", "de": "Nächste Karte", "hu": "Következő kártya", "id": "Kartu Berikutnya", "ja": "次のカード", "pl": "Następna karta"},
    "듣고 알맞은 뜻을 고르세요": {"vi": "Nghe và chọn nghĩa đúng", "cs": "Poslechněte si a vyberte správný význam", "zh_cn": "听发音，选出正确的意思", "zh": "聽發音，選出正確的意思", "en": "Listen and choose the correct meaning", "fr": "Écoutez et choisissez le bon sens", "de": "Hören und die richtige Bedeutung wählen", "hu": "Hallgassa meg és válassza ki a helyes jelentést", "id": "Dengarkan dan pilih arti yang benar", "ja": "聞いて正しい意味を選んでください", "pl": "Posłuchaj i wybierz właściwe znaczenie"},
    "보고 알맞은 뜻을 고르세요": {"vi": "Xem từ và chọn nghĩa đúng", "cs": "Podívejte se na slovo a vyberte správný význam", "zh_cn": "看单字，选出正确的意思", "zh": "看單字，選出正確的意思", "en": "Look at the word and choose the correct meaning", "fr": "Regardez le mot et choisissez le bon sens", "de": "Wort ansehen und die richtige Bedeutung wählen", "hu": "Nézze meg a szót, és válassza ki a helyes jelentést", "id": "Lihat kata dan pilih arti yang benar", "ja": "見て正しい意味を選んでください", "pl": "Spójrz na słowo i wybierz właściwe znaczenie"},
    "다음 문제 →": {"vi": "Câu tiếp →", "cs": "Další otázka →", "zh_cn": "下一题 →", "zh": "下一題 →", "en": "Next →", "fr": "Question suivante →", "de": "Nächste Frage →", "hu": "Következő kérdés →", "id": "Pertanyaan Berikutnya →", "ja": "次の問題 →", "pl": "Następne pytanie →"},
    ...
    "정답이에요! 🎉": {"vi": "Chính xác! 🎉", "cs": "Správně! 🎉", "zh_cn": "答对了！🎉", "zh": "答對了！🎉", "en": "Correct! 🎉", "fr": "Bonne réponse ! 🎉", "de": "Richtig! 🎉", "hu": "Helyes! 🎉", "id": "Benar! 🎉", "ja": "正解です！🎉", "pl": "Prawidłowo! 🎉"},
    "순서가 달라요. 다시 시도해 보세요.": {"vi": "Sai thứ tự — hãy thử lại.", "cs": "Špatný slovosled — zkuste to znovu.", "zh_cn": "顺序不对，请再试一次。", "zh": "順序不對，請再試一次。", "en": "Wrong order — try again.", "fr": "L'ordre n'est pas correct. Réessayez.", "de": "Falsche Reihenfolge – bitte noch einmal versuchen.", "hu": "Helytelen sorrend — próbálja újra.", "id": "Urutan salah — coba lagi.", "ja": "順序が違います。もう一度試してください。", "pl": "Nieprawidłowa kolejność — spróbuj ponownie."},
    ...
    "현재 대화문: 상대를 부를 때 “": {"vi": "Hội thoại hiện tại: gọi người đối diện là “", "cs": "Aktuální dialog: oslovení druhé osoby „", "zh_cn": "目前对话文：称呼对方时用「", "zh": "目前對話文：稱呼對方時用「", "en": "Current dialogue: addressing the other person as \"", "fr": "Dialogue actuel : s'adresser à l'interlocuteur avec « ", "de": "Aktueller Dialog: Anrede für das Gegenüber „", "hu": "Jelenlegi beszélgetés: a másik megszólítása: „", "id": "Percakapan saat ini: memanggil lawan bicara: “", "ja": "現在の会話文：相手を呼ぶときは「", "pl": "Bieżący dialog: zwracanie się do rozmówcy jako „"},
    "”, 나를 가리킬 때 “": {"vi": "”, tự xưng là “", "cs": "“, pro sebe „", "zh_cn": "」，称呼自己时用「", "zh": "」，稱呼自己時用「", "en": "\", and referring to yourself as \"", "fr": " », et se désigner soi-même avec « ", "de": "“, Selbstbezeichnung „", "hu": "”, saját magára: „", "id": "”, untuk diri sendiri: “", "ja": "」、自分を指すときは「", "pl": "”, a określanie siebie jako „"},
    "” 로 표시돼요.": {"vi": "”.", "cs": "“ se zobrazí.", "zh_cn": "」来显示。", "zh": "」來顯示。", "en": "\".", "fr": " ».", "de": "“.", "hu": "” formában jelenik meg.", "id": "” ditampilkan.", "ja": "」と表示されます。", "pl": "”."},
    "<p class=\"p-desc\">iOS/iPadOS의 내장 기능을 사용하면 별도의 앱 설치 없이 베트남어 텍스트를 읽게 할 수 있어요.</p><h4>1단계: 베트남어 TTS 음성 다운로드하기</h4><ol><li>설정 앱을 엽니다.</li><li><b>손쉬운 사용</b> 메뉴로 이동합니다.</li><li><b>읽기 및 말하기</b>(또는 iOS 버전에 따라 <b>콘텐츠 말하기</b>)를 선택합니다.</li><li><b>음성</b>을 탭합니다.</li><li>스크롤을 내려 <b>베트남어</b>를 선택합니다.</li><li>원하는 목소리(예: Linh) 옆의 구름 모양(다운로드) 아이콘을 눌러 음성 데이터를 다운로드합니다. ‘고품질’ 버전을 다운로드하면 훨씬 자연스러운 AI 음성으로 들을 수 있어요.</li></ol><h4>2단계: 화면의 베트남어 텍스트 읽히기 (사용 방법)</h4><p class=\"p-desc\">다운로드가 완료되면 다음 두 가지 방법으로 베트남어를 읽게 만들 수 있어요. 동일하게 설정 &gt; 손쉬운 사용 &gt; 콘텐츠 말하기 메뉴에서 활성화할 수 있습니다.</p><h4>방법 A: 선택 항목 말하기 (추천)</h4><ol><li>설정 방법: ‘선택 항목 말하기’ 기능을 켭니다.</li><li>사용 방법: 웹서핑이나 텍스트 앱에서 베트남어 단어·문장을 길게 눌러 블록을 지정한 후, 팝업 메뉴에서 ‘말하기’를 누르면 베트남어로 읽어줘요.</li></ol><h4>방법 B: 화면 말하기</h4><ol><li>설정 방법: ‘화면 말하기’ 기능을 켭니다.</li><li>사용 방법: 베트남어로 된 뉴스나 전자책 화면에서 두 손가락으로 화면 상단에서 아래로 쓸어내리면 화면 전체의 텍스트를 자동으로 인식해 처음부터 끝까지 읽어줘요.</li></ol>": {"vi": "<p class=\"p-desc\">Bạn có thể dùng tính năng có sẵn của iOS/iPadOS để đọc to văn bản tiếng Việt mà không cần cài thêm ứng dụng.</p><h4>Bước 1: Tải giọng đọc tiếng Việt (TTS)</h4><ol><li>Mở ứng dụng Cài đặt.</li><li>Vào mục <b>Trợ năng</b>.</li><li>Chọn <b>Nội dung được đọc</b> (hoặc <b>Đọc màn hình &amp; nội dung</b>, tùy phiên bản iOS).</li><li>Chạm vào <b>Giọng nói</b>.</li><li>Cuộn xuống và chọn <b>Tiếng Việt</b>.</li><li>Chạm vào biểu tượng đám mây (tải xuống) bên cạnh giọng đọc bạn muốn (ví dụ: Linh) để tải dữ liệu giọng đọc. Nếu tải bản \"Nâng cao\", bạn sẽ nghe được giọng AI tự nhiên hơn nhiều.</li></ol><h4>Bước 2: Cho máy đọc văn bản tiếng Việt trên màn hình (cách dùng)</h4><p class=\"p-desc\">Khi tải xong, có hai cách để máy đọc tiếng Việt. Cả hai đều có thể bật trong Cài đặt &gt; Trợ năng &gt; Nội dung được đọc.</p><h4>Cách A: Đọc mục chọn (khuyên dùng)</h4><ol><li>Cài đặt: Bật tính năng \"Đọc mục chọn\".</li><li>Cách dùng: Khi lướt web hoặc dùng ứng dụng văn bản, nhấn giữ một từ hoặc câu tiếng Việt để chọn, rồi chạm \"Đọc\" trong menu bật lên để nghe đọc bằng tiếng Việt.</li></ol><h4>Cách B: Đọc màn hình</h4><ol><li>Cài đặt: Bật tính năng \"Đọc màn hình\".</li><li>Cách dùng: Trên màn hình tin tức hoặc sách điện tử tiếng Việt, vuốt hai ngón tay từ trên xuống, toàn bộ văn bản trên màn hình sẽ được tự động nhận diện và đọc từ đầu đến cuối.</li></ol>", "cs": "<p class=\"p-desc\">Pomocí vestavěných funkcí iOS/iPadOS si můžete nechat vietnamský text přečíst nahlas bez instalace další aplikace.</p><h4>Krok 1: Stáhněte vietnamský hlas (TTS)</h4><ol><li>Otevřete aplikaci Nastavení.</li><li>Přejděte do nabídky <b>Zpřístupnění</b>.</li><li>Vyberte <b>Mluvený obsah</b> (nebo <b>Předčítání obrazovky a obsahu</b>, podle verze iOS).</li><li>Klepněte na <b>Hlasy</b>.</li><li>Sjeďte dolů a vyberte <b>vietnamštinu</b>.</li><li>Klepněte na ikonu mráčku (stáhnout) vedle požadovaného hlasu (např. Linh) a stáhněte hlasová data. Verze „Vylepšená“ zní mnohem přirozeněji.</li></ol><h4>Krok 2: Nechte si přečíst vietnamský text na obrazovce (použití)</h4><p class=\"p-desc\">Po stažení máte dva způsoby, jak si nechat vietnamštinu přečíst. Oba lze zapnout v Nastavení &gt; Zpřístupnění &gt; Mluvený obsah.</p><h4>Způsob A: Předčítat výběr (doporučeno)</h4><ol><li>Nastavení: Zapněte funkci „Předčítat výběr“.</li><li>Použití: Při prohlížení webu nebo v textové aplikaci podržte vietnamské slovo či větu, označte je a v nabídce klepněte na „Předčítat“.</li></ol><h4>Způsob B: Předčítat obrazovku</h4><ol><li>Nastavení: Zapněte funkci „Předčítat obrazovku“.</li><li>Použití: Na obrazovce s vietnamskými zprávami nebo e-knihou přejeďte dvěma prsty od horního okraje dolů a celý text na obrazovce se automaticky přečte od začátku do konce.</li></ol>", "zh_cn": "<p class=\"p-desc\">使用 iOS/iPadOS 的内置功能，无需另外安装 App，就能让设备朗读越南语文字。</p><h4>步骤一：下载越南语 TTS 语音</h4><ol><li>打开“设置”App。</li><li>进入<b>辅助功能</b>菜单。</li><li>选择<b>朗读内容</b>（或视 iOS 版本为<b>朗读屏幕与内容</b>）。</li><li>点击<b>声音</b>。</li><li>向下滚动并选择<b>越南语</b>。</li><li>点击所需语音（例如 Linh）旁边的云朵（下载）图标，下载语音数据。下载“增强/优化”版本可以听到自然得多的 AI 语音。</li></ol><h4>步骤二：让设备朗读屏幕上的越南语文字（使用方法）</h4><p class=\"p-desc\">下载完成后，可以用以下两种方式朗读越南语。两者都可以在 设置 &gt; 辅助功能 &gt; 朗读内容 中开启。</p><h4>方法 A：朗读所选项（推荐）</h4><ol><li>设置方法：开启“朗读所选项”功能。</li><li>使用方法：浏览网页或使用文字 App 时，长按越南语单词或句子并选取，然后在弹出菜单中点击“朗读”，即可用越南语朗读。</li></ol><h4>方法 B：朗读屏幕</h4><ol><li>设置方法：开启“朗读屏幕”功能。</li><li>使用方法：在越南语新闻或电子书画面上，用两根手指从屏幕顶部向下轻扫，就会自动识别整个屏幕的文字并从头到尾朗读。</li></ol>", "zh": "<p class=\"p-desc\">使用 iOS/iPadOS 的內建功能，不需另外安裝 App，就能讓裝置朗讀越南語文字。</p><h4>步驟一：下載越南語 TTS 語音</h4><ol><li>開啟「設定」App。</li><li>前往<b>輔助使用</b>選單。</li><li>選擇<b>語音內容</b>（或依 iOS 版本為<b>朗讀螢幕與內容</b>）。</li><li>點一下<b>聲音</b>。</li><li>向下捲動並選擇<b>越南文</b>。</li><li>點一下想要的聲音（例如 Linh）旁的雲朵（下載）圖示，下載語音資料。下載「增強版」可以聽到自然許多的 AI 語音。</li></ol><h4>步驟二：讓裝置朗讀螢幕上的越南語文字（使用方法）</h4><p class=\"p-desc\">下載完成後，可以用以下兩種方式朗讀越南語。兩者都可以在 設定 &gt; 輔助使用 &gt; 語音內容 中開啟。</p><h4>方法 A：朗讀所選範圍（推薦）</h4><ol><li>設定方法：開啟「朗讀所選範圍」功能。</li><li>使用方法：瀏覽網頁或使用文字 App 時，長按越南語單字或句子並選取，然後在彈出選單中點一下「朗讀」，即可以越南語朗讀。</li></ol><h4>方法 B：朗讀螢幕</h4><ol><li>設定方法：開啟「朗讀螢幕」功能。</li><li>使用方法：在越南語新聞或電子書畫面上，用兩指從螢幕頂端向下滑動，就會自動辨識整個螢幕的文字並從頭到尾朗讀。</li></ol>", "en": "<p class=\"p-desc\">You can use the built-in features of iOS/iPadOS to have Vietnamese text read aloud, without installing a separate app.</p><h4>Step 1: Download a Vietnamese TTS Voice</h4><ol><li>Open the Settings app.</li><li>Go to the <b>Accessibility</b> menu.</li><li>Select <b>Spoken Content</b> (or <b>Speak Screen &amp; Content</b>, depending on your iOS version).</li><li>Tap <b>Voices</b>.</li><li>Scroll down and select <b>Vietnamese</b>.</li><li>Tap the cloud (download) icon next to the voice you want (e.g., Linh) to download the voice data. Downloading the \"Premium\" (high-quality) version gives you a much more natural-sounding AI voice.</li></ol><h4>Step 2: Have On-Screen Vietnamese Text Read Aloud (How to Use)</h4><p class=\"p-desc\">Once the download is complete, there are two ways to have Vietnamese read aloud. Both can also be turned on from Settings &gt; Accessibility &gt; Spoken Content.</p><h4>Method A: Speak Selection (Recommended)</h4><ol><li>Setup: Turn on the \"Speak Selection\" feature.</li><li>How to use: While browsing the web or using a text app, press and hold a Vietnamese word or sentence to select it, then tap \"Speak\" in the pop-up menu to hear it read aloud in Vietnamese.</li></ol><h4>Method B: Speak Screen</h4><ol><li>Setup: Turn on the \"Speak Screen\" feature.</li><li>How to use: On a screen showing Vietnamese news or an e-book, swipe down from the top of the screen with two fingers, and all the text on screen will be automatically recognized and read aloud from start to finish.</li></ol>", "fr": "<p class=\"p-desc\">Grâce aux fonctions intégrées d'iOS/iPadOS, vous pouvez faire lire du texte vietnamien à voix haute sans installer d'application supplémentaire.</p><h4>Étape 1 : télécharger une voix vietnamienne (TTS)</h4><ol><li>Ouvrez l'app Réglages.</li><li>Allez dans le menu <b>Accessibilité</b>.</li><li>Sélectionnez <b>Contenu énoncé</b> (ou <b>Énoncer l'écran et le contenu</b>, selon la version d'iOS).</li><li>Touchez <b>Voix</b>.</li><li>Faites défiler vers le bas et sélectionnez <b>Vietnamien</b>.</li><li>Touchez l'icône en forme de nuage (téléchargement) à côté de la voix souhaitée (par ex. Linh) pour télécharger les données vocales. La version « Premium » offre une voix IA bien plus naturelle.</li></ol><h4>Étape 2 : faire lire le texte vietnamien affiché (utilisation)</h4><p class=\"p-desc\">Une fois le téléchargement terminé, deux méthodes permettent de faire lire le vietnamien. Toutes deux s'activent dans Réglages &gt; Accessibilité &gt; Contenu énoncé.</p><h4>Méthode A : Énoncer la sélection (recommandée)</h4><ol><li>Réglage : activez « Énoncer la sélection ».</li><li>Utilisation : sur le web ou dans une app de texte, maintenez le doigt sur un mot ou une phrase en vietnamien pour le sélectionner, puis touchez « Énoncer » dans le menu contextuel.</li></ol><h4>Méthode B : Énoncer l'écran</h4><ol><li>Réglage : activez « Énoncer l'écran ».</li><li>Utilisation : sur un écran d'actualités ou de livre numérique en vietnamien, balayez vers le bas avec deux doigts depuis le haut de l'écran ; tout le texte affiché est reconnu et lu du début à la fin.</li></ol>", "de": "<p class=\"p-desc\">Mit den integrierten Funktionen von iOS/iPadOS können Sie sich vietnamesischen Text vorlesen lassen, ohne eine separate App zu installieren.</p><h4>Schritt 1: Vietnamesische TTS-Stimme herunterladen</h4><ol><li>Öffnen Sie die App <b>Einstellungen</b>.</li><li>Gehen Sie zum Menü <b>Bedienungshilfen</b>.</li><li>Wählen Sie <b>Gesprochene Inhalte</b>.</li><li>Tippen Sie auf <b>Stimmen</b>.</li><li>Scrollen Sie nach unten und wählen Sie <b>Vietnamesisch</b>.</li><li>Tippen Sie auf das Wolkensymbol (Download) neben der gewünschten Stimme (z. B. Linh), um die Sprachdaten herunterzuladen. Die „Erweiterte“ Version bietet eine besonders natürliche Stimme.</li></ol><h4>Schritt 2: Vietnamesischen Text auf dem Bildschirm vorlesen lassen</h4><p class=\"p-desc\">Nach dem Download gibt es zwei Möglichkeiten zum Vorlesen. Beide lassen sich unter Einstellungen &gt; Bedienungshilfen &gt; Gesprochene Inhalte aktivieren.</p><h4>Methode A: Auswahl vorlesen (Empfohlen)</h4><ol><li>Einrichtung: Aktivieren Sie „Auswahl vorlesen“.</li><li>Verwendung: Halten Sie beim Surfen oder in Text-Apps ein vietnamesisches Wort oder einen Satz gedrückt, um den Text auszuwählen, und tippen Sie im Menü auf „Sprechen“.</li></ol><h4>Methode B: Bildschirminhalt sprechen</h4><ol><li>Einrichtung: Aktivieren Sie „Bildschirminhalt sprechen“.</li><li>Verwendung: Streichen Sie mit zwei Fingern vom oberen Bildschirmrand nach unten, um den gesamten Text auf dem Bildschirm vorlesen zu lassen.</li></ol>", "hu": "<p class=\"p-desc\">Az iOS/iPadOS beépített funkcióival külön alkalmazás telepítése nélkül felolvastathatja a vietnami szöveget.</p><h4>1. lépés: Vietnami hang (TTS) letöltése</h4><ol><li>Nyissa meg a Beállítások alkalmazást.</li><li>Lépjen a <b>Kisegítő lehetőségek</b> menübe.</li><li>Válassza a <b>Felolvasott tartalom</b> lehetőséget (iOS-verziótól függően <b>Képernyő és tartalom felolvasása</b>).</li><li>Koppintson a <b>Hangok</b> elemre.</li><li>Görgessen le, és válassza a <b>vietnami</b> nyelvet.</li><li>Koppintson a kívánt hang (pl. Linh) melletti felhő (letöltés) ikonra a hangadatok letöltéséhez. A „Bővített” változat sokkal természetesebben szól.</li></ol><h4>2. lépés: A képernyőn lévő vietnami szöveg felolvastatása (használat)</h4><p class=\"p-desc\">A letöltés után kétféleképpen olvastathatja fel a vietnami szöveget. Mindkettő bekapcsolható a Beállítások &gt; Kisegítő lehetőségek &gt; Felolvasott tartalom menüben.</p><h4>A módszer: Kijelölés felolvasása (ajánlott)</h4><ol><li>Beállítás: Kapcsolja be a „Kijelölés felolvasása” funkciót.</li><li>Használat: Böngészés közben vagy egy szöveges alkalmazásban tartsa lenyomva a vietnami szót vagy mondatot a kijelöléshez, majd a felugró menüben koppintson a „Felolvasás” gombra.</li></ol><h4>B módszer: Képernyő felolvasása</h4><ol><li>Beállítás: Kapcsolja be a „Képernyő felolvasása” funkciót.</li><li>Használat: Vietnami hírek vagy e-könyv képernyőjén két ujjal húzzon lefelé a képernyő tetejéről, és a teljes szöveg automatikusan felolvasásra kerül az elejétől a végéig.</li></ol>", "id": "<p class=\"p-desc\">Dengan fitur bawaan iOS/iPadOS, Anda dapat membuat teks bahasa Vietnam dibacakan tanpa memasang aplikasi lain.</p><h4>Langkah 1: Unduh suara TTS bahasa Vietnam</h4><ol><li>Buka aplikasi Pengaturan.</li><li>Masuk ke menu <b>Aksesibilitas</b>.</li><li>Pilih <b>Konten Lisan</b> (atau <b>Ucapkan Layar &amp; Konten</b>, tergantung versi iOS).</li><li>Ketuk <b>Suara</b>.</li><li>Gulir ke bawah dan pilih <b>Bahasa Vietnam</b>.</li><li>Ketuk ikon awan (unduh) di samping suara yang diinginkan (mis. Linh) untuk mengunduh data suara. Versi \"Premium\" terdengar jauh lebih alami.</li></ol><h4>Langkah 2: Membacakan teks bahasa Vietnam di layar (cara pakai)</h4><p class=\"p-desc\">Setelah unduhan selesai, ada dua cara untuk membacakan bahasa Vietnam. Keduanya dapat diaktifkan di Pengaturan &gt; Aksesibilitas &gt; Konten Lisan.</p><h4>Cara A: Ucapkan Pilihan (disarankan)</h4><ol><li>Pengaturan: Aktifkan fitur \"Ucapkan Pilihan\".</li><li>Cara pakai: Saat menjelajah web atau di aplikasi teks, tekan lama kata atau kalimat bahasa Vietnam untuk memilihnya, lalu ketuk \"Ucapkan\" di menu yang muncul.</li></ol><h4>Cara B: Ucapkan Layar</h4><ol><li>Pengaturan: Aktifkan fitur \"Ucapkan Layar\".</li><li>Cara pakai: Pada layar berita atau e-book berbahasa Vietnam, usap ke bawah dengan dua jari dari atas layar, maka seluruh teks di layar akan otomatis dibacakan dari awal sampai akhir.</li></ol>", "ja": "<p class=\"p-desc\">iOS/iPadOSの内蔵機能を使えば、別途アプリをインストールしなくてもベトナム語のテキストを読み上げさせることができます。</p><h4>ステップ1：ベトナム語のTTS音声をダウンロードする</h4><ol><li>「設定」アプリを開きます。</li><li><b>アクセシビリティ</b>メニューに移動します。</li><li><b>読み上げコンテンツ</b>（iOSのバージョンによっては<b>画面の読み上げとコンテンツ</b>）を選択します。</li><li><b>声</b>をタップします。</li><li>下にスクロールして<b>ベトナム語</b>を選択します。</li><li>希望する声（例：Linh）の横にある雲の形（ダウンロード）のアイコンをタップして音声データをダウンロードします。「拡張」版をダウンロードすると、ずっと自然なAI音声で聞けます。</li></ol><h4>ステップ2：画面上のベトナム語テキストを読み上げさせる（使い方）</h4><p class=\"p-desc\">ダウンロードが完了すると、次の2つの方法でベトナム語を読み上げさせることができます。どちらも 設定 &gt; アクセシビリティ &gt; 読み上げコンテンツ でオンにできます。</p><h4>方法A：選択項目の読み上げ（おすすめ）</h4><ol><li>設定方法：「選択項目の読み上げ」をオンにします。</li><li>使い方：Webやテキストアプリで、ベトナム語の単語・文を長押しして選択し、ポップアップメニューで「読み上げ」をタップするとベトナム語で読み上げます。</li></ol><h4>方法B：画面の読み上げ</h4><ol><li>設定方法：「画面の読み上げ」をオンにします。</li><li>使い方：ベトナム語のニュースや電子書籍の画面で、2本指で画面上部から下にスワイプすると、画面全体のテキストを自動で認識して最初から最後まで読み上げます。</li></ol>", "pl": "<p class=\"p-desc\">Dzięki wbudowanym funkcjom iOS/iPadOS możesz słuchać czytanego tekstu wietnamskiego bez instalowania dodatkowych aplikacji.</p><h4>Krok 1: Pobierz głos syntezatora mowy (TTS) dla wietnamskiego</h4><ol><li>Otwórz aplikację <b>Ustawienia</b>.</li><li>Przejdź do menu <b>Dostępność</b>.</li><li>Wybierz <b>Zawartość mówiona</b>.</li><li>Dotknij <b>Głosy</b>.</li><li>Przewiń w dół i wybierz <b>Wietnamski</b>.</li><li>Dotknij ikony chmury (pobieranie) obok wybranego głosu (np. Linh). Wersja ulepszona zapewnia bardziej naturalny głos.</li></ol><h4>Krok 2: Odczytywanie tekstu z ekranu</h4><p class=\"p-desc\">Po pobraniu możesz korzystać z dwóch metod odczytu tekstu:</p><h4>Metoda A: Przeczytaj zaznaczone (Zalecane)</h4><ol><li>Włącz funkcję „Przeczytaj zaznaczone”.</li><li>Zaznacz tekst wietnamski w przeglądarce i dotknij „Mów” w menu podręcznym.</li></ol><h4>Metoda B: Przeczytaj ekran</h4><ol><li>Włącz funkcję „Przeczytaj ekran”.</li><li>Przesuń dwoma palcami od góry ekranu w dół, aby odczytać całą zawartość ekranu.</li></ol>"},
    "<h4>1. Google 음성 엔진에서 베트남어 추가 (공통)</h4><p class=\"p-desc\">대부분의 안드로이드 기기에 내장된 구글 엔진에 베트남어 음성 팩을 다운로드하는 방법이에요.</p><ol><li>스마트폰 <b>설정</b> 앱을 엽니다.</li><li><b>접근성</b> ➡️ <b>텍스트 음성 변환 출력</b>(또는 ‘글자 읽어주기’) 메뉴로 이동합니다.</li><li>기본 엔진이 <b>Google 음성 인식 및 합성</b>(또는 Speech Services by Google)으로 선택되어 있는지 확인합니다.</li><li>기본 엔진 옆에 있는 <b>설정(톱니바퀴 아이콘)</b>을 누릅니다.</li><li><b>음성 데이터 설치</b>를 선택합니다.</li><li>목록에서 <b>베트남어</b>(또는 Vietnamese)를 찾아 다운로드 버튼을 누릅니다.</li><li>다운로드가 완료되면 뒤로 돌아와 <b>언어</b>를 <b>베트남어</b>로 지정합니다.</li></ol><h4>2. 삼성 갤럭시 기기에서 베트남어 추가</h4><p class=\"p-desc\">삼성 갤럭시 스마트폰을 사용 중이라면 삼성 전용 고품질 베트남어 TTS를 추가할 수 있어요.</p><ol><li>스마트폰 <b>설정</b> 앱을 엽니다.</li><li><b>일반</b> ➡️ <b>글자 읽어주기</b>(또는 텍스트 음성 변환) 메뉴로 이동합니다.</li><li>기본 엔진을 <b>삼성 TTS 엔진</b>으로 설정합니다.</li><li>엔진 옆의 <b>설정(톱니바퀴 아이콘)</b>을 누릅니다.</li><li><b>음성 데이터 설치</b>를 누르고 목록에서 <b>베트남어</b>를 찾아 다운로드합니다.</li></ol><div class=\"tts-tip\">※ 갤럭시 스토어에서 직접 Samsung TTS Vietnamese Voice 팩을 검색해 설치할 수도 있어요.</div>": {"vi": "<h4>1. Thêm tiếng Việt vào công cụ giọng nói của Google (chung)</h4><p class=\"p-desc\">Cách tải gói giọng nói tiếng Việt cho công cụ của Google có sẵn trên hầu hết các thiết bị Android.</p><ol><li>Mở ứng dụng <b>Cài đặt</b> trên điện thoại.</li><li>Vào <b>Hỗ trợ tiếp cận</b> ➡️ <b>Chuyển văn bản thành giọng nói</b>.</li><li>Kiểm tra công cụ mặc định đã được chọn là <b>Dịch vụ lời nói của Google</b> (Speech Services by Google).</li><li>Nhấn <b>Cài đặt (biểu tượng bánh răng)</b> bên cạnh công cụ mặc định.</li><li>Chọn <b>Cài đặt dữ liệu giọng nói</b>.</li><li>Tìm <b>Tiếng Việt</b> (Vietnamese) trong danh sách và nhấn nút tải xuống.</li><li>Khi tải xong, quay lại và chọn <b>Ngôn ngữ</b> là <b>Tiếng Việt</b>.</li></ol><h4>2. Thêm tiếng Việt trên thiết bị Samsung Galaxy</h4><p class=\"p-desc\">Nếu dùng điện thoại Samsung Galaxy, bạn có thể thêm giọng đọc tiếng Việt chất lượng cao của Samsung.</p><ol><li>Mở ứng dụng <b>Cài đặt</b> trên điện thoại.</li><li>Vào <b>Quản lý chung</b> ➡️ <b>Chuyển văn bản thành giọng nói</b>.</li><li>Đặt công cụ mặc định là <b>Công cụ TTS của Samsung</b>.</li><li>Nhấn <b>Cài đặt (biểu tượng bánh răng)</b> bên cạnh công cụ.</li><li>Nhấn <b>Cài đặt dữ liệu giọng nói</b>, tìm <b>Tiếng Việt</b> trong danh sách và tải xuống.</li></ol><div class=\"tts-tip\">※ Bạn cũng có thể tìm và cài gói Samsung TTS Vietnamese Voice trực tiếp từ Galaxy Store.</div>", "cs": "<h4>1. Přidání vietnamštiny do hlasového modulu Google (obecně)</h4><p class=\"p-desc\">Postup stažení vietnamského hlasového balíčku pro modul Google, který je součástí většiny zařízení s Androidem.</p><ol><li>Otevřete v telefonu aplikaci <b>Nastavení</b>.</li><li>Přejděte do <b>Přístupnost</b> ➡️ <b>Převod textu na řeč</b>.</li><li>Zkontrolujte, že výchozím modulem jsou <b>Hlasové služby Google</b> (Speech Services by Google).</li><li>Klepněte na <b>Nastavení (ikona ozubeného kola)</b> vedle výchozího modulu.</li><li>Vyberte <b>Instalovat hlasová data</b>.</li><li>Najděte v seznamu <b>vietnamštinu</b> (Vietnamese) a klepněte na tlačítko stažení.</li><li>Po stažení se vraťte zpět a nastavte <b>Jazyk</b> na <b>vietnamštinu</b>.</li></ol><h4>2. Přidání vietnamštiny na zařízení Samsung Galaxy</h4><p class=\"p-desc\">Pokud používáte telefon Samsung Galaxy, můžete přidat vlastní vysoce kvalitní vietnamský hlas Samsung.</p><ol><li>Otevřete v telefonu aplikaci <b>Nastavení</b>.</li><li>Přejděte do <b>Obecná správa</b> ➡️ <b>Převod textu na řeč</b>.</li><li>Nastavte výchozí modul na <b>Samsung TTS</b>.</li><li>Klepněte na <b>Nastavení (ikona ozubeného kola)</b> vedle modulu.</li><li>Klepněte na <b>Instalovat hlasová data</b>, najděte <b>vietnamštinu</b> a stáhněte ji.</li></ol><div class=\"tts-tip\">※ Balíček Samsung TTS Vietnamese Voice můžete také vyhledat a nainstalovat přímo z Galaxy Store.</div>", "zh_cn": "<h4>1. 在 Google 语音引擎中添加越南语（通用）</h4><p class=\"p-desc\">为大多数 Android 设备内置的 Google 引擎下载越南语语音包的方法。</p><ol><li>打开手机的<b>设置</b>App。</li><li>进入<b>无障碍</b> ➡️ <b>文字转语音输出</b>菜单。</li><li>确认默认引擎为<b>Google 语音识别和合成</b>（Speech Services by Google）。</li><li>点击默认引擎旁的<b>设置（齿轮图标）</b>。</li><li>选择<b>安装语音数据</b>。</li><li>在列表中找到<b>越南语</b>（Vietnamese）并点击下载按钮。</li><li>下载完成后返回，将<b>语言</b>设为<b>越南语</b>。</li></ol><h4>2. 在三星 Galaxy 设备上添加越南语</h4><p class=\"p-desc\">如果使用三星 Galaxy 手机，可以添加三星专用的高品质越南语 TTS。</p><ol><li>打开手机的<b>设置</b>App。</li><li>进入<b>常规管理</b> ➡️ <b>文字转语音</b>菜单。</li><li>将默认引擎设为<b>三星 TTS 引擎</b>。</li><li>点击引擎旁的<b>设置（齿轮图标）</b>。</li><li>点击<b>安装语音数据</b>，在列表中找到<b>越南语</b>并下载。</li></ol><div class=\"tts-tip\">※ 也可以在 Galaxy Store 中直接搜索并安装 Samsung TTS Vietnamese Voice 语音包。</div>", "zh": "<h4>1. 在 Google 語音引擎中新增越南語（通用）</h4><p class=\"p-desc\">為大多數 Android 裝置內建的 Google 引擎下載越南語語音包的方法。</p><ol><li>開啟手機的<b>設定</b>App。</li><li>前往<b>無障礙設定</b> ➡️ <b>文字轉語音輸出</b>選單。</li><li>確認預設引擎為<b>Google 語音辨識和合成</b>（Speech Services by Google）。</li><li>點一下預設引擎旁的<b>設定（齒輪圖示）</b>。</li><li>選擇<b>安裝語音資料</b>。</li><li>在清單中找到<b>越南文</b>（Vietnamese）並點一下下載按鈕。</li><li>下載完成後返回，將<b>語言</b>設為<b>越南文</b>。</li></ol><h4>2. 在三星 Galaxy 裝置上新增越南語</h4><p class=\"p-desc\">如果使用三星 Galaxy 手機，可以新增三星專用的高品質越南語 TTS。</p><ol><li>開啟手機的<b>設定</b>App。</li><li>前往<b>一般管理</b> ➡️ <b>文字轉語音</b>選單。</li><li>將預設引擎設為<b>三星 TTS 引擎</b>。</li><li>點一下引擎旁的<b>設定（齒輪圖示）</b>。</li><li>點一下<b>安裝語音資料</b>，在清單中找到<b>越南文</b>並下載。</li></ol><div class=\"tts-tip\">※ 也可以在 Galaxy Store 中直接搜尋並安裝 Samsung TTS Vietnamese Voice 語音包。</div>", "en": "<h4>1. Add Vietnamese to the Google Speech Engine (Common)</h4><p class=\"p-desc\">How to download the Vietnamese voice pack for the Google engine built into most Android devices.</p><ol><li>Open the <b>Settings</b> app on your phone.</li><li>Go to <b>Accessibility</b> ➡️ <b>Text-to-speech output</b>.</li><li>Check that the default engine is <b>Speech Services by Google</b>.</li><li>Tap <b>Settings (gear icon)</b> next to the default engine.</li><li>Select <b>Install voice data</b>.</li><li>Find <b>Vietnamese</b> in the list and tap the download button.</li><li>Once the download finishes, go back and set the <b>Language</b> to <b>Vietnamese</b>.</li></ol><h4>2. Add Vietnamese on a Samsung Galaxy Device</h4><p class=\"p-desc\">If you're using a Samsung Galaxy phone, you can add Samsung's own high-quality Vietnamese TTS.</p><ol><li>Open the <b>Settings</b> app on your phone.</li><li>Go to <b>General management</b> ➡️ <b>Text-to-speech</b>.</li><li>Set the default engine to <b>Samsung TTS engine</b>.</li><li>Tap <b>Settings (gear icon)</b> next to the engine.</li><li>Tap <b>Install voice data</b>, find <b>Vietnamese</b> in the list, and download it.</li></ol><div class=\"tts-tip\">※ You can also search for and install the Samsung TTS Vietnamese Voice pack directly from the Galaxy Store.</div>", "fr": "<h4>1. Ajouter le vietnamien dans le moteur vocal Google (Android en général)</h4><p class=\"p-desc\">Voici comment télécharger le pack vocal vietnamien pour le moteur Google intégré à la plupart des appareils Android.</p><ol><li>Ouvrez l'application <b>Paramètres</b> de votre téléphone.</li><li>Allez dans <b>Accessibilité</b> ➡️ <b>Sortie de synthèse vocale</b>.</li><li>Vérifiez que le moteur préféré est <b>Reconnaissance et synthèse vocales Google</b>.</li><li>Appuyez sur l'icône d'engrenage (paramètres) à côté du moteur.</li><li>Sélectionnez <b>Installer les données vocales</b>.</li><li>Recherchez <b>Vietnamien</b> dans la liste et appuyez sur Télécharger.</li><li>Une fois téléchargé, revenez en arrière et réglez la langue sur <b>Vietnamien</b>.</li></ol><h4>2. Ajouter le vietnamien sur les appareils Samsung Galaxy</h4><p class=\"p-desc\">Si vous utilisez un smartphone Samsung Galaxy, vous pouvez installer la voix TTS vietnamienne haute définition de Samsung.</p><ol><li>Ouvrez <b>Paramètres</b>.</li><li>Allez dans <b>Gestion globale</b> ➡️ <b>Synthèse vocale</b>.</li><li>Définissez le moteur préféré sur <b>Moteur de synthèse vocale Samsung</b>.</li><li>Appuyez sur l'engrenage à côté du moteur.</li><li>Appuyez sur <b>Installer les données vocales</b> et téléchargez le vietnamien.</li></ol>", "de": "<h4>1. Vietnamesisch zur Google-Sprachausgabe hinzufügen (Allgemein)</h4><p class=\"p-desc\">So laden Sie das vietnamesische Sprachpaket für die Google-Engine auf den meisten Android-Geräten herunter.</p><ol><li>Öffnen Sie die App <b>Einstellungen</b>.</li><li>Gehen Sie zu <b>Bedienungshilfen</b> ➡️ <b>Text-in-Sprache-Ausgabe</b>.</li><li>Stellen Sie sicher, dass als bevorzugte Engine <b>Google Sprachausgabe</b> eingestellt ist.</li><li>Tippen Sie auf das <b>Zahnrad-Symbol</b> neben der Engine.</li><li>Wählen Sie <b>Sprachdaten installieren</b>.</li><li>Suchen Sie in der Liste nach <b>Vietnamesisch</b> und tippen Sie auf Herunterladen.</li><li>Gehen Sie nach dem Download zurück und wählen Sie als Sprache <b>Vietnamesisch</b>.</li></ol><h4>2. Vietnamesisch auf Samsung-Galaxy-Geräten hinzufügen</h4><p class=\"p-desc\">Auf Samsung Galaxy-Smartphones können Sie die hochwertige Samsung-eigene vietnamesische TTS-Stimme hinzufügen.</p><ol><li>Öffnen Sie <b>Einstellungen</b>.</li><li>Gehen Sie zu <b>Allgemeine Verwaltung</b> ➡️ <b>Text-zu-Sprache</b>.</li><li>Wählen Sie als bevorzugte Engine <b>Samsung Text-zu-Sprache-Engine</b>.</li><li>Tippen Sie auf das <b>Zahnrad-Symbol</b> neben der Engine.</li><li>Tippen Sie auf <b>Sprachdaten installieren</b> und laden Sie <b>Vietnamesisch</b> herunter.</li></ol><div class=\"tts-tip\">※ Sie können das Sprachpaket „Samsung TTS Vietnamese Voice“ auch direkt im Galaxy Store suchen und installieren.</div>", "hu": "<h4>1. Vietnami nyelv hozzáadása a Google beszédmotorhoz (általános)</h4><p class=\"p-desc\">Így töltheti le a vietnami hangcsomagot a legtöbb Android-eszközbe beépített Google-motorhoz.</p><ol><li>Nyissa meg a telefon <b>Beállítások</b> alkalmazását.</li><li>Lépjen a <b>Kisegítő lehetőségek</b> ➡️ <b>Szövegfelolvasó</b> menübe.</li><li>Ellenőrizze, hogy az alapértelmezett motor a <b>Google Beszédszolgáltatások</b> (Speech Services by Google).</li><li>Koppintson az alapértelmezett motor melletti <b>Beállítások (fogaskerék ikon)</b> elemre.</li><li>Válassza a <b>Hangadatok telepítése</b> lehetőséget.</li><li>Keresse meg a listában a <b>vietnami</b> (Vietnamese) nyelvet, és koppintson a letöltés gombra.</li><li>A letöltés után lépjen vissza, és állítsa a <b>Nyelv</b> értékét <b>vietnamira</b>.</li></ol><h4>2. Vietnami nyelv hozzáadása Samsung Galaxy eszközön</h4><p class=\"p-desc\">Samsung Galaxy telefonon a Samsung saját, kiváló minőségű vietnami hangját is hozzáadhatja.</p><ol><li>Nyissa meg a telefon <b>Beállítások</b> alkalmazását.</li><li>Lépjen az <b>Általános kezelés</b> ➡️ <b>Szövegfelolvasó</b> menübe.</li><li>Állítsa az alapértelmezett motort <b>Samsung TTS</b>-re.</li><li>Koppintson a motor melletti <b>Beállítások (fogaskerék ikon)</b> elemre.</li><li>Koppintson a <b>Hangadatok telepítése</b> elemre, keresse meg a <b>vietnami</b> nyelvet, és töltse le.</li></ol><div class=\"tts-tip\">※ A Samsung TTS Vietnamese Voice csomagot közvetlenül a Galaxy Store-ból is megkeresheti és telepítheti.</div>", "id": "<h4>1. Menambahkan bahasa Vietnam di mesin suara Google (umum)</h4><p class=\"p-desc\">Cara mengunduh paket suara bahasa Vietnam untuk mesin Google yang sudah terpasang di sebagian besar perangkat Android.</p><ol><li>Buka aplikasi <b>Setelan</b> di ponsel.</li><li>Masuk ke <b>Aksesibilitas</b> ➡️ <b>Output teks ke ucapan</b>.</li><li>Pastikan mesin default adalah <b>Layanan Ucapan oleh Google</b> (Speech Services by Google).</li><li>Ketuk <b>Setelan (ikon roda gigi)</b> di samping mesin default.</li><li>Pilih <b>Instal data suara</b>.</li><li>Cari <b>Bahasa Vietnam</b> (Vietnamese) di daftar dan ketuk tombol unduh.</li><li>Setelah selesai, kembali dan atur <b>Bahasa</b> ke <b>Bahasa Vietnam</b>.</li></ol><h4>2. Menambahkan bahasa Vietnam di perangkat Samsung Galaxy</h4><p class=\"p-desc\">Jika Anda memakai ponsel Samsung Galaxy, Anda dapat menambahkan TTS bahasa Vietnam berkualitas tinggi milik Samsung.</p><ol><li>Buka aplikasi <b>Setelan</b> di ponsel.</li><li>Masuk ke <b>Manajemen umum</b> ➡️ <b>Teks ke ucapan</b>.</li><li>Atur mesin default ke <b>Mesin TTS Samsung</b>.</li><li>Ketuk <b>Setelan (ikon roda gigi)</b> di samping mesin.</li><li>Ketuk <b>Instal data suara</b>, cari <b>Bahasa Vietnam</b>, lalu unduh.</li></ol><div class=\"tts-tip\">※ Anda juga dapat mencari dan memasang paket Samsung TTS Vietnamese Voice langsung dari Galaxy Store.</div>", "ja": "<h4>1. Google音声エンジンにベトナム語を追加する（共通）</h4><p class=\"p-desc\">ほとんどのAndroid端末に内蔵されているGoogleエンジンにベトナム語の音声パックをダウンロードする方法です。</p><ol><li>スマートフォンの<b>設定</b>アプリを開きます。</li><li><b>ユーザー補助</b> ➡️ <b>テキスト読み上げの出力</b>メニューに移動します。</li><li>優先するエンジンが<b>Google 音声認識と合成</b>（Speech Services by Google）になっていることを確認します。</li><li>エンジンの横にある<b>設定（歯車アイコン）</b>をタップします。</li><li><b>音声データのインストール</b>を選択します。</li><li>一覧から<b>ベトナム語</b>（Vietnamese）を探し、ダウンロードボタンをタップします。</li><li>ダウンロードが終わったら戻り、<b>言語</b>を<b>ベトナム語</b>に設定します。</li></ol><h4>2. Samsung Galaxy端末でベトナム語を追加する</h4><p class=\"p-desc\">Samsung Galaxyスマートフォンをお使いの場合は、Samsung独自の高品質なベトナム語TTSを追加できます。</p><ol><li>スマートフォンの<b>設定</b>アプリを開きます。</li><li><b>一般管理</b> ➡️ <b>テキスト読み上げ</b>メニューに移動します。</li><li>優先するエンジンを<b>Samsung TTSエンジン</b>に設定します。</li><li>エンジンの横にある<b>設定（歯車アイコン）</b>をタップします。</li><li><b>音声データのインストール</b>をタップし、一覧から<b>ベトナム語</b>を探してダウンロードします。</li></ol><div class=\"tts-tip\">※ Galaxy StoreでSamsung TTS Vietnamese Voiceパックを直接検索してインストールすることもできます。</div>", "pl": "<h4>1. Dodawanie wietnamskiego w syntezatorze mowy Google (Android)</h4><p class=\"p-desc\">Instrukcja pobierania pakietu mowy wietnamskiej dla silnika Google.</p><ol><li>Otwórz <b>Ustawienia</b> w telefonie.</li><li>Przejdź do <b>Ułatwienia dostępu</b> ➡️ <b>Zamiana tekstu na mowę</b>.</li><li>Upewnij się, że preferowanym mechanizmem są <b>Usługi mowy Google</b>.</li><li>Dotknij ikony koła zębatego obok mechanizmu.</li><li>Wybierz <b>Zainstaluj dane głosowe</b>.</li><li>Znajdź <b>Wietnamski</b> i pobierz go.</li></ol><h4>2. Dodawanie wietnamskiego na urządzeniach Samsung Galaxy</h4><p class=\"p-desc\">Na telefonach Samsung Galaxy możesz zainstalować wysokiej jakości głos Samsung.</p><ol><li>Otwórz <b>Ustawienia</b> ➡️ <b>Zarządzanie ogólne</b> ➡️ <b>Zamiana tekstu na mowę</b>.</li><li>Ustaw preferowany mechanizm na <b>Mechanizm zamiany tekstu na mowę Samsung</b>.</li><li>Dotknij koła zębatego i zainstaluj dane głosowe dla języka wietnamskiego.</li></ol>"},
    "<p class=\"p-desc\">별도의 프로그램 설치 없이 Mac 시스템 설정에서 바로 다운로드할 수 있어요.</p><h4>1단계: 베트남어 TTS 음성 추가하기</h4><ol><li>Mac 화면 왼쪽 상단의 Apple 메뉴( ) &gt; <b>시스템 설정</b>을 선택합니다.</li><li>사이드바에서 <b>손쉬운 사용</b>을 클릭한 뒤, <b>읽기 및 말하기</b>(또는 macOS 버전에 따라 <b>콘텐츠 말하기</b>)를 선택합니다.</li><li>‘시스템 음성’ 오른쪽에 있는 ⓘ(정보) 버튼 또는 팝업 메뉴를 클릭합니다.</li><li>왼쪽 언어 목록에서 <b>베트남어(Vietnamese)</b>를 찾아 선택합니다.</li><li>원하는 음성(예: Linh 등) 옆의 구름 모양 다운로드 아이콘을 클릭하여 설치합니다.</li><li>다운로드가 완료되면 <b>완료</b>(또는 승인)를 누릅니다.</li></ol><h4>2단계: 시스템 말하기 언어 변경하기</h4><ol><li>‘읽기 및 말하기’ 설정 화면으로 돌아와 ‘시스템 말하기 언어’ 팝업 메뉴를 베트남어로 변경합니다.</li><li>‘시스템 음성’ 메뉴에서 방금 다운로드한 베트남어 음성을 지정합니다.</li><li>아래의 ‘선택 항목 말하기’ 토글을 켜서 활성화합니다.</li></ol><h4>3단계: 단축키로 베트남어 텍스트 읽기</h4><ol><li>웹페이지나 문서에서 베트남어 텍스트를 마우스로 드래그하여 블록 지정(선택)합니다.</li><li>키보드 단축키인 <b>Option + Esc</b>를 동시에 누르면 선택한 베트남어가 원어민 발음으로 재생돼요. (중단하고 싶을 때 다시 누르면 멈춰요.)</li></ol>": {"vi": "<p class=\"p-desc\">Không cần cài thêm phần mềm — bạn có thể tải trực tiếp trong Cài đặt hệ thống của Mac.</p><h4>Bước 1: Thêm giọng đọc tiếng Việt (TTS)</h4><ol><li>Nhấp vào menu Apple ( ) ở góc trên bên trái màn hình Mac &gt; chọn <b>Cài đặt hệ thống</b>.</li><li>Nhấp <b>Trợ năng</b> ở thanh bên, rồi chọn <b>Nội dung được đọc</b> (hoặc <b>Lời nói</b>, tùy phiên bản macOS).</li><li>Nhấp vào nút ⓘ (thông tin) hoặc menu bật lên bên cạnh \"Giọng hệ thống\".</li><li>Tìm và chọn <b>Tiếng Việt</b> trong danh sách ngôn ngữ bên trái.</li><li>Nhấp biểu tượng đám mây tải xuống bên cạnh giọng đọc bạn muốn (ví dụ: Linh) để cài đặt.</li><li>Khi tải xong, nhấp <b>Xong</b> (hoặc Chấp nhận).</li></ol><h4>Bước 2: Đổi ngôn ngữ đọc của hệ thống</h4><ol><li>Quay lại màn hình cài đặt Nội dung được đọc và đổi menu ngôn ngữ \"Giọng hệ thống\" sang tiếng Việt.</li><li>Trong menu \"Giọng hệ thống\", chọn giọng tiếng Việt vừa tải.</li><li>Bật công tắc \"Đọc mục chọn\" ở bên dưới.</li></ol><h4>Bước 3: Dùng phím tắt để đọc văn bản tiếng Việt</h4><ol><li>Kéo chuột để chọn (tô sáng) văn bản tiếng Việt trên trang web hoặc tài liệu.</li><li>Nhấn cùng lúc phím tắt <b>Option + Esc</b> để nghe văn bản đã chọn được đọc bằng giọng bản ngữ. (Nhấn lại để dừng.)</li></ol>", "cs": "<p class=\"p-desc\">Není potřeba instalovat žádný program — hlas stáhnete přímo v Nastavení systému na Macu.</p><h4>Krok 1: Přidejte vietnamský hlas (TTS)</h4><ol><li>Klikněte na nabídku Apple ( ) v levém horním rohu obrazovky Macu &gt; vyberte <b>Nastavení systému</b>.</li><li>V postranním panelu klikněte na <b>Zpřístupnění</b> a pak vyberte <b>Mluvený obsah</b> (nebo <b>Řeč</b>, podle verze macOS).</li><li>Klikněte na tlačítko ⓘ (informace) nebo místní nabídku vedle položky „Hlas systému“.</li><li>V seznamu jazyků vlevo najděte a vyberte <b>vietnamštinu</b>.</li><li>Klikněte na ikonu mráčku vedle požadovaného hlasu (např. Linh) a nainstalujte jej.</li><li>Po stažení klikněte na <b>Hotovo</b> (nebo Schválit).</li></ol><h4>Krok 2: Změňte jazyk předčítání systému</h4><ol><li>Vraťte se na obrazovku Mluvený obsah a v místní nabídce jazyka „Hlas systému“ nastavte vietnamštinu.</li><li>V nabídce „Hlas systému“ vyberte právě stažený vietnamský hlas.</li><li>Zapněte níže přepínač „Předčítat výběr“.</li></ol><h4>Krok 3: Čtení vietnamského textu klávesovou zkratkou</h4><ol><li>Na webové stránce nebo v dokumentu označte myší vietnamský text.</li><li>Stiskněte současně klávesovou zkratku <b>Option + Esc</b> a označený text se přečte rodilou výslovností. (Dalším stiskem čtení zastavíte.)</li></ol>", "zh_cn": "<p class=\"p-desc\">无需安装任何程序，直接在 Mac 的“系统设置”中下载即可。</p><h4>步骤一：添加越南语 TTS 语音</h4><ol><li>点击 Mac 屏幕左上角的苹果菜单（ ）&gt; 选择<b>系统设置</b>。</li><li>在边栏中点击<b>辅助功能</b>，然后选择<b>朗读内容</b>（或视 macOS 版本为<b>语音</b>）。</li><li>点击“系统嗓音”右侧的 ⓘ（信息）按钮或弹出菜单。</li><li>在左侧语言列表中找到并选择<b>越南语</b>。</li><li>点击所需语音（例如 Linh）旁的云朵下载图标进行安装。</li><li>下载完成后点击<b>完成</b>（或好）。</li></ol><h4>步骤二：更改系统朗读语言</h4><ol><li>回到“朗读内容”设置画面，将“系统嗓音”的语言弹出菜单改为越南语。</li><li>在“系统嗓音”菜单中选择刚下载的越南语语音。</li><li>打开下方的“朗读所选项”开关。</li></ol><h4>步骤三：用快捷键朗读越南语文字</h4><ol><li>在网页或文档中用鼠标拖动选取越南语文字。</li><li>同时按下快捷键 <b>Option + Esc</b>，所选越南语就会以母语发音播放。（再按一次即可停止。）</li></ol>", "zh": "<p class=\"p-desc\">不需安裝任何程式，直接在 Mac 的「系統設定」中下載即可。</p><h4>步驟一：新增越南語 TTS 語音</h4><ol><li>點一下 Mac 螢幕左上角的蘋果選單（ ）&gt; 選擇<b>系統設定</b>。</li><li>在側邊欄點一下<b>輔助使用</b>，然後選擇<b>語音內容</b>（或依 macOS 版本為<b>語音</b>）。</li><li>點一下「系統聲音」右側的 ⓘ（資訊）按鈕或彈出式選單。</li><li>在左側語言清單中找到並選擇<b>越南文</b>。</li><li>點一下想要的聲音（例如 Linh）旁的雲朵下載圖示進行安裝。</li><li>下載完成後點一下<b>完成</b>（或好）。</li></ol><h4>步驟二：變更系統朗讀語言</h4><ol><li>回到「語音內容」設定畫面，將「系統聲音」的語言彈出式選單改為越南文。</li><li>在「系統聲音」選單中選擇剛下載的越南語聲音。</li><li>開啟下方的「朗讀所選範圍」開關。</li></ol><h4>步驟三：用快速鍵朗讀越南語文字</h4><ol><li>在網頁或文件中用滑鼠拖曳選取越南語文字。</li><li>同時按下快速鍵 <b>Option + Esc</b>，所選越南語就會以母語發音播放。（再按一次即可停止。）</li></ol>", "en": "<p class=\"p-desc\">No separate app is needed — you can download the voice directly in Mac System Settings.</p><h4>Step 1: Add a Vietnamese TTS Voice</h4><ol><li>Click the Apple menu ( ) at the top-left of your Mac screen &gt; select <b>System Settings</b>.</li><li>Click <b>Accessibility</b> in the sidebar, then select <b>Spoken Content</b> (or <b>Speech</b>, depending on your macOS version).</li><li>Click the ⓘ (info) button or pop-up menu next to \"System voice\".</li><li>Find and select <b>Vietnamese</b> in the language list on the left.</li><li>Click the cloud download icon next to the voice you want (e.g. Linh) to install it.</li><li>When the download finishes, click <b>Done</b> (or OK).</li></ol><h4>Step 2: Change the System Speaking Language</h4><ol><li>Return to the Spoken Content settings and change the \"System voice\" language pop-up menu to Vietnamese.</li><li>In the \"System voice\" menu, select the Vietnamese voice you just downloaded.</li><li>Turn on the \"Speak selection\" toggle below.</li></ol><h4>Step 3: Read Vietnamese Text with a Keyboard Shortcut</h4><ol><li>Drag with your mouse to select Vietnamese text on a web page or document.</li><li>Press <b>Option + Esc</b> together to hear the selected Vietnamese read aloud with native pronunciation. (Press it again to stop.)</li></ol>", "fr": "<p class=\"p-desc\">Aucun programme à installer : vous pouvez télécharger la voix directement dans les Réglages Système du Mac.</p><h4>Étape 1 : ajouter une voix vietnamienne (TTS)</h4><ol><li>Cliquez sur le menu Pomme ( ) en haut à gauche de l'écran &gt; choisissez <b>Réglages Système</b>.</li><li>Cliquez sur <b>Accessibilité</b> dans la barre latérale, puis choisissez <b>Contenu énoncé</b> (ou <b>Parole</b>, selon la version de macOS).</li><li>Cliquez sur le bouton ⓘ (informations) ou le menu local à côté de « Voix du système ».</li><li>Dans la liste des langues à gauche, trouvez et sélectionnez <b>Vietnamien</b>.</li><li>Cliquez sur l'icône de nuage à côté de la voix souhaitée (par ex. Linh) pour l'installer.</li><li>Une fois le téléchargement terminé, cliquez sur <b>Terminé</b> (ou OK).</li></ol><h4>Étape 2 : changer la langue d'énonciation du système</h4><ol><li>Revenez aux réglages Contenu énoncé et réglez le menu de langue « Voix du système » sur le vietnamien.</li><li>Dans le menu « Voix du système », choisissez la voix vietnamienne que vous venez de télécharger.</li><li>Activez l'option « Énoncer la sélection » en dessous.</li></ol><h4>Étape 3 : lire du texte vietnamien avec un raccourci clavier</h4><ol><li>Sélectionnez à la souris du texte vietnamien sur une page web ou dans un document.</li><li>Appuyez simultanément sur <b>Option + Échap</b> pour entendre le texte sélectionné avec une prononciation native. (Appuyez de nouveau pour arrêter.)</li></ol>", "de": "<p class=\"p-desc\">Sie können vietnamesische Stimmen direkt in den Mac-Systemeinstellungen herunterladen, ohne zusätzliche Software zu installieren.</p><h4>Schritt 1: Vietnamesische TTS-Stimme hinzufügen</h4><ol><li>Wählen Sie das Apple-Menü ( ) &gt; <b>Systemeinstellungen</b>.</li><li>Klicken Sie in der Seitenleiste auf <b>Bedienungshilfen</b> und dann auf <b>Gesprochene Inhalte</b>.</li><li>Klicken Sie auf das ⓘ-Symbol oder das Menü neben „Systemstimme“.</li><li>Wählen Sie in der Sprachenliste <b>Vietnamesisch</b> aus.</li><li>Klicken Sie auf das Download-Symbol neben der gewünschten Stimme (z. B. Linh), um sie zu installieren.</li><li>Klicken Sie nach Abschluss auf <b>Fertig</b>.</li></ol><h4>Schritt 2: Sprachausgabe konfigurieren</h4><ol><li>Wählen Sie als Systemstimme die heruntergeladene vietnamesische Stimme aus.</li><li>Aktivieren Sie die Option „Auswahl sprechen“.</li></ol><h4>Schritt 3: Text per Kurzbefehl vorlesen</h4><ol><li>Markieren Sie vietnamesischen Text auf einer Webseite oder in einem Dokument.</li><li>Drücken Sie <b>Wahltaste (Option) + Esc</b>, um den Text anzuhören. Ein erneuter Tastendruck stoppt die Wiedergabe.</li></ol>", "hu": "<p class=\"p-desc\">Nincs szükség külön program telepítésére — közvetlenül a Mac Rendszerbeállításaiból letöltheti.</p><h4>1. lépés: Vietnami hang (TTS) hozzáadása</h4><ol><li>Kattintson a Mac képernyőjének bal felső sarkában lévő Apple menüre ( ) &gt; válassza a <b>Rendszerbeállítások</b> lehetőséget.</li><li>Az oldalsávon kattintson a <b>Kisegítő lehetőségek</b> elemre, majd válassza a <b>Felolvasott tartalom</b> lehetőséget (macOS-verziótól függően <b>Beszéd</b>).</li><li>Kattintson a „Rendszerhang” melletti ⓘ (információ) gombra vagy előugró menüre.</li><li>A bal oldali nyelvlistában keresse meg és válassza ki a <b>vietnami</b> nyelvet.</li><li>A telepítéshez kattintson a kívánt hang (pl. Linh) melletti felhő letöltés ikonra.</li><li>A letöltés után kattintson a <b>Kész</b> (vagy Jóváhagyás) gombra.</li></ol><h4>2. lépés: A rendszer felolvasási nyelvének módosítása</h4><ol><li>Térjen vissza a Felolvasott tartalom képernyőre, és a „Rendszerhang” nyelvi menüjében állítsa be a vietnamit.</li><li>A „Rendszerhang” menüben válassza ki az imént letöltött vietnami hangot.</li><li>Kapcsolja be alul a „Kijelölés felolvasása” kapcsolót.</li></ol><h4>3. lépés: Vietnami szöveg felolvasása billentyűparanccsal</h4><ol><li>Jelölje ki az egérrel a vietnami szöveget egy weboldalon vagy dokumentumban.</li><li>Nyomja le egyszerre az <b>Option + Esc</b> billentyűkombinációt, és a kijelölt szöveget anyanyelvi kiejtéssel hallhatja. (Újbóli megnyomással leállíthatja.)</li></ol>", "id": "<p class=\"p-desc\">Tidak perlu memasang program lain — Anda dapat mengunduhnya langsung dari Pengaturan Sistem Mac.</p><h4>Langkah 1: Menambahkan suara TTS bahasa Vietnam</h4><ol><li>Klik menu Apple ( ) di kiri atas layar Mac &gt; pilih <b>Pengaturan Sistem</b>.</li><li>Klik <b>Aksesibilitas</b> di bar samping, lalu pilih <b>Konten Lisan</b> (atau <b>Ucapan</b>, tergantung versi macOS).</li><li>Klik tombol ⓘ (info) atau menu pop-up di samping \"Suara Sistem\".</li><li>Cari dan pilih <b>Bahasa Vietnam</b> di daftar bahasa sebelah kiri.</li><li>Klik ikon awan unduh di samping suara yang diinginkan (mis. Linh) untuk memasangnya.</li><li>Setelah selesai, klik <b>Selesai</b> (atau Setujui).</li></ol><h4>Langkah 2: Mengubah bahasa ucapan sistem</h4><ol><li>Kembali ke layar pengaturan Konten Lisan dan ubah menu bahasa \"Suara Sistem\" ke bahasa Vietnam.</li><li>Di menu \"Suara Sistem\", pilih suara bahasa Vietnam yang baru diunduh.</li><li>Aktifkan sakelar \"Ucapkan Pilihan\" di bawahnya.</li></ol><h4>Langkah 3: Membacakan teks bahasa Vietnam dengan pintasan</h4><ol><li>Seret mouse untuk memilih teks bahasa Vietnam di halaman web atau dokumen.</li><li>Tekan pintasan keyboard <b>Option + Esc</b> bersamaan untuk mendengar teks yang dipilih dibacakan dengan pelafalan penutur asli. (Tekan lagi untuk berhenti.)</li></ol>", "ja": "<p class=\"p-desc\">別途プログラムをインストールしなくても、Macのシステム設定から直接ダウンロードできます。</p><h4>ステップ1：ベトナム語のTTS音声を追加する</h4><ol><li>Mac画面左上のAppleメニュー（ ）&gt;<b>システム設定</b>を選択します。</li><li>サイドバーで<b>アクセシビリティ</b>をクリックし、<b>読み上げコンテンツ</b>（macOSのバージョンによっては<b>スピーチ</b>）を選択します。</li><li>「システムの声」の右にあるⓘ（情報）ボタンまたはポップアップメニューをクリックします。</li><li>左の言語一覧から<b>ベトナム語</b>を探して選択します。</li><li>希望する声（例：Linh）の横にある雲の形のダウンロードアイコンをクリックしてインストールします。</li><li>ダウンロードが終わったら<b>完了</b>（またはOK）をクリックします。</li></ol><h4>ステップ2：システムの読み上げ言語を変更する</h4><ol><li>「読み上げコンテンツ」の設定画面に戻り、「システムの声」の言語ポップアップメニューをベトナム語に変更します。</li><li>「システムの声」メニューで、ダウンロードしたベトナム語の声を選択します。</li><li>下の「選択項目の読み上げ」をオンにします。</li></ol><h4>ステップ3：ショートカットキーでベトナム語テキストを読み上げる</h4><ol><li>Webページや文書のベトナム語テキストをマウスでドラッグして選択します。</li><li>キーボードショートカット<b>Option + Esc</b>を同時に押すと、選択したベトナム語がネイティブの発音で再生されます。（もう一度押すと停止します。）</li></ol>", "pl": "<p class=\"p-desc\">Możesz pobrać głosy wietnamskie bezpośrednio w Ustawieniach systemowych komputera Mac.</p><h4>Krok 1: Dodaj głos wietnamski</h4><ol><li>Wybierz menu Apple  &gt; <b>Ustawienia systemowe</b>.</li><li>Kliknij <b>Dostępność</b>, a następnie <b>Zawartość mówiona</b>.</li><li>Wybierz język <b>Wietnamski</b> i pobierz preferowany głos.</li><li>Włącz funkcję „Mów zaznaczone”.</li><li>Zaznacz tekst wietnamski i naciśnij skrót <b>Option + Esc</b>, aby odsłuchać wymowę.</li></ol>"},
    "<h4>⚙️ Windows 11에서 베트남어 TTS 추가하기</h4><ol><li>설정 열기: 키보드에서 <b>Win + I</b> 단축키를 누릅니다.</li><li>음성 메뉴 이동: 왼쪽 메뉴에서 <b>시간 및 언어</b> ➔ 오른쪽에서 <b>음성</b>을 클릭합니다.</li><li>음성 추가: ‘음성 관리’ 항목에 있는 <b>음성 추가</b> 버튼을 누릅니다.</li><li>베트남어 설치: 검색창에 베트남어를 검색해 선택한 후, <b>추가</b>(또는 설치) 버튼을 누르면 다운로드가 시작돼요.</li><li>기본 음성 설정: 다운로드가 끝나면 상단의 ‘음성 선택’ 드롭다운 메뉴에서 설치된 베트남어 음성을 기본값으로 지정할 수 있어요.</li></ol>": {"vi": "<h4>⚙️ Thêm giọng đọc tiếng Việt (TTS) trên Windows 11</h4><ol><li>Mở Cài đặt: Nhấn tổ hợp phím <b>Win + I</b>.</li><li>Vào mục Giọng nói: Ở menu bên trái, nhấp <b>Thời gian và ngôn ngữ</b> ➔ rồi nhấp <b>Giọng nói</b> ở bên phải.</li><li>Thêm giọng nói: Trong mục \"Quản lý giọng nói\", nhấn nút <b>Thêm giọng nói</b>.</li><li>Cài tiếng Việt: Tìm \"tiếng Việt\" trong ô tìm kiếm, chọn rồi nhấn <b>Thêm</b> (hoặc Cài đặt) để bắt đầu tải.</li><li>Đặt giọng mặc định: Khi tải xong, bạn có thể đặt giọng tiếng Việt đã cài làm mặc định trong menu thả xuống \"Chọn giọng nói\" ở phía trên.</li></ol>", "cs": "<h4>⚙️ Přidání vietnamského hlasu (TTS) ve Windows 11</h4><ol><li>Otevřete Nastavení: Stiskněte klávesovou zkratku <b>Win + I</b>.</li><li>Přejděte do nabídky Řeč: V levé nabídce klikněte na <b>Čas a jazyk</b> ➔ a vpravo na <b>Řeč</b>.</li><li>Přidejte hlas: V části „Spravovat hlasy“ klikněte na tlačítko <b>Přidat hlasy</b>.</li><li>Nainstalujte vietnamštinu: Vyhledejte vietnamštinu, vyberte ji a klikněte na <b>Přidat</b> (nebo Instalovat), čímž začne stahování.</li><li>Nastavte výchozí hlas: Po stažení můžete v rozevírací nabídce „Zvolit hlas“ nahoře nastavit nainstalovaný vietnamský hlas jako výchozí.</li></ol>", "zh_cn": "<h4>⚙️ 在 Windows 11 中添加越南语 TTS</h4><ol><li>打开设置：按下键盘快捷键 <b>Win + I</b>。</li><li>进入语音菜单：在左侧菜单点击<b>时间和语言</b> ➔ 再点击右侧的<b>语音</b>。</li><li>添加语音：在“管理语音”中点击<b>添加语音</b>按钮。</li><li>安装越南语：在搜索框中搜索越南语并选择，然后点击<b>添加</b>（或安装）开始下载。</li><li>设置默认语音：下载完成后，可在上方的“选择语音”下拉菜单中将越南语语音设为默认。</li></ol>", "zh": "<h4>⚙️ 在 Windows 11 中新增越南語 TTS</h4><ol><li>開啟設定：按下鍵盤快速鍵 <b>Win + I</b>。</li><li>前往語音選單：在左側選單點一下<b>時間與語言</b> ➔ 再點一下右側的<b>語音</b>。</li><li>新增語音：在「管理語音」中點一下<b>新增語音</b>按鈕。</li><li>安裝越南語：在搜尋框中搜尋越南文並選擇，然後點一下<b>新增</b>（或安裝）開始下載。</li><li>設定預設語音：下載完成後，可在上方的「選擇語音」下拉式選單中將越南語語音設為預設。</li></ol>", "en": "<h4>⚙️ Adding a Vietnamese TTS Voice in Windows 11</h4><ol><li>Open Settings: Press <b>Win + I</b> on your keyboard.</li><li>Go to Speech: In the left menu, click <b>Time & language</b> ➔ then click <b>Speech</b> on the right.</li><li>Add a voice: Under \"Manage voices\", click the <b>Add voices</b> button.</li><li>Install Vietnamese: Search for Vietnamese, select it, then click <b>Add</b> (or Install) to start the download.</li><li>Set the default voice: When the download finishes, you can make the installed Vietnamese voice the default in the \"Choose a voice\" drop-down menu at the top.</li></ol>", "fr": "<h4>⚙️ Ajouter une voix vietnamienne (TTS) sous Windows 11</h4><ol><li>Ouvrez les Paramètres : appuyez sur <b>Win + I</b>.</li><li>Allez dans Voix : dans le menu de gauche, cliquez sur <b>Heure et langue</b> ➔ puis sur <b>Voix</b> à droite.</li><li>Ajoutez une voix : sous « Gérer les voix », cliquez sur le bouton <b>Ajouter des voix</b>.</li><li>Installez le vietnamien : recherchez le vietnamien, sélectionnez-le puis cliquez sur <b>Ajouter</b> (ou Installer) pour lancer le téléchargement.</li><li>Définissez la voix par défaut : une fois le téléchargement terminé, vous pouvez choisir la voix vietnamienne installée comme voix par défaut dans le menu déroulant « Choisir une voix » en haut.</li></ol>", "de": "<h4>⚙️ Vietnamesische Stimme (TTS) unter Windows 11 hinzufügen</h4><ol><li>Einstellungen öffnen: Drücken Sie <b>Win + I</b>.</li><li>Zur Sprachausgabe: Klicken Sie links auf <b>Zeit und Sprache</b> ➔ und rechts auf <b>Sprache</b>.</li><li>Stimme hinzufügen: Klicken Sie unter „Stimmen verwalten“ auf <b>Stimmen hinzufügen</b>.</li><li>Vietnamesisch installieren: Suchen Sie nach Vietnamesisch, wählen Sie es aus und klicken Sie auf <b>Hinzufügen</b> (oder Installieren), um den Download zu starten.</li><li>Standardstimme festlegen: Nach dem Download können Sie die installierte vietnamesische Stimme oben im Dropdown-Menü „Stimme auswählen“ als Standard festlegen.</li></ol>", "hu": "<h4>⚙️ Vietnami hang (TTS) hozzáadása Windows 11 alatt</h4><ol><li>A Beállítások megnyitása: Nyomja meg a <b>Win + I</b> billentyűkombinációt.</li><li>A Beszéd menü: A bal oldali menüben kattintson az <b>Idő és nyelv</b> ➔ majd jobb oldalon a <b>Beszéd</b> elemre.</li><li>Hang hozzáadása: A „Hangok kezelése” résznél kattintson a <b>Hangok hozzáadása</b> gombra.</li><li>A vietnami telepítése: Keressen rá a vietnamira, válassza ki, majd kattintson a <b>Hozzáadás</b> (vagy Telepítés) gombra a letöltés indításához.</li><li>Alapértelmezett hang: A letöltés után a felső „Hang kiválasztása” legördülő menüben a telepített vietnami hangot alapértelmezetté teheti.</li></ol>", "id": "<h4>⚙️ Menambahkan suara TTS bahasa Vietnam di Windows 11</h4><ol><li>Buka Pengaturan: Tekan pintasan <b>Win + I</b>.</li><li>Masuk ke menu Ucapan: Di menu kiri klik <b>Waktu & bahasa</b> ➔ lalu klik <b>Ucapan</b> di kanan.</li><li>Tambahkan suara: Di bagian \"Kelola suara\", klik tombol <b>Tambahkan suara</b>.</li><li>Pasang bahasa Vietnam: Cari bahasa Vietnam di kotak pencarian, pilih, lalu klik <b>Tambahkan</b> (atau Instal) untuk mulai mengunduh.</li><li>Atur suara default: Setelah selesai, Anda dapat menjadikan suara bahasa Vietnam yang terpasang sebagai default di menu tarik-turun \"Pilih suara\" di bagian atas.</li></ol>", "ja": "<h4>⚙️ Windows 11でベトナム語TTSを追加する</h4><ol><li>設定を開く：キーボードで<b>Win + I</b>を押します。</li><li>音声メニューへ移動：左のメニューで<b>時刻と言語</b> ➔ 右側の<b>音声</b>をクリックします。</li><li>音声の追加：「音声の管理」にある<b>音声の追加</b>ボタンをクリックします。</li><li>ベトナム語のインストール：検索ボックスでベトナム語を検索して選択し、<b>追加</b>（またはインストール）をクリックするとダウンロードが始まります。</li><li>既定の音声の設定：ダウンロードが終わったら、上部の「音声の選択」ドロップダウンメニューでインストールしたベトナム語の音声を既定に設定できます。</li></ol>", "pl": "<h4>⚙️ Dodawanie wietnamskiego głosu (TTS) w Windows 11</h4><ol><li>Otwórz Ustawienia: naciśnij <b>Win + I</b>.</li><li>Przejdź do Mowy: w menu po lewej kliknij <b>Czas i język</b> ➔ a następnie po prawej <b>Mowa</b>.</li><li>Dodaj głos: w sekcji „Zarządzaj głosami” kliknij przycisk <b>Dodaj głosy</b>.</li><li>Zainstaluj wietnamski: wyszukaj język wietnamski, wybierz go i kliknij <b>Dodaj</b> (lub Zainstaluj), aby rozpocząć pobieranie.</li><li>Ustaw domyślny głos: po zakończeniu pobierania możesz ustawić zainstalowany wietnamski głos jako domyślny w menu rozwijanym „Wybierz głos” u góry.</li></ol>"},
    "<h4>⚙️ 접근성 &gt; 내레이터에서 고급 음성 데이터 추가하기 (대안)</h4><p class=\"p-desc\">위 방법으로 원하는 음성이 안 보이거나 더 다양한 고급 음성을 설치하고 싶다면, 내레이터 메뉴를 통해서도 같은 음성 데이터를 추가할 수 있어요. 여기서 설치한 음성도 이 화면을 포함해 컴퓨터의 다른 프로그램에서 똑같이 사용할 수 있습니다.</p><ol><li>설정 열기: <b>Win + I</b> 단축키를 누릅니다.</li><li>왼쪽 메뉴에서 <b>접근성</b>을 클릭합니다.</li><li>오른쪽 목록에서 <b>내레이터</b>를 클릭합니다.</li><li>‘내레이터 음성’ 항목에서 <b>음성 추가</b> 버튼을 누릅니다.</li><li><b>추가</b> 버튼을 누른 뒤, 목록에서 원하는 언어(예: 베트남어)를 선택합니다.</li><li>해당 언어로 다운로드할 수 있는 음성 목록이 뜨면 원하는 음성을 선택하고 <b>다운로드 및 설치</b> 버튼을 누릅니다.</li><li>설치가 끝나면 상단의 ‘음성 선택’ 드롭다운 메뉴에서 방금 설치한 음성을 기본값으로 지정할 수 있어요.</li></ol>": {"vi": "<h4>⚙️ Thêm dữ liệu giọng nói nâng cao trong Trợ năng &gt; Trình tường thuật (cách khác)</h4><p class=\"p-desc\">Nếu cách trên không hiện giọng bạn muốn hoặc bạn muốn cài thêm nhiều giọng nâng cao hơn, bạn cũng có thể thêm cùng dữ liệu giọng nói đó qua menu Trình tường thuật. Giọng cài ở đây cũng dùng được như nhau trong các chương trình khác trên máy tính, kể cả màn hình này.</p><ol><li>Mở Cài đặt: Nhấn <b>Win + I</b>.</li><li>Ở menu bên trái, nhấp <b>Trợ năng</b>.</li><li>Trong danh sách bên phải, nhấp <b>Trình tường thuật</b>.</li><li>Trong mục \"Giọng nói của Trình tường thuật\", nhấn nút <b>Thêm giọng nói</b>.</li><li>Nhấn nút <b>Thêm</b>, rồi chọn ngôn ngữ bạn muốn (ví dụ: tiếng Việt) trong danh sách.</li><li>Khi danh sách giọng có thể tải cho ngôn ngữ đó hiện ra, hãy chọn giọng bạn muốn và nhấn <b>Tải xuống và cài đặt</b>.</li><li>Khi cài xong, bạn có thể đặt giọng vừa cài làm mặc định trong menu thả xuống \"Chọn giọng nói\" ở phía trên.</li></ol>", "cs": "<h4>⚙️ Přidání pokročilých hlasových dat v Usnadnění &gt; Předčítání (alternativa)</h4><p class=\"p-desc\">Pokud se požadovaný hlas výše uvedeným postupem nezobrazí nebo chcete nainstalovat více pokročilých hlasů, můžete stejná hlasová data přidat také přes nabídku Předčítání. Takto nainstalovaný hlas lze stejně používat i v ostatních programech v počítači, včetně této obrazovky.</p><ol><li>Otevřete Nastavení: Stiskněte <b>Win + I</b>.</li><li>V levé nabídce klikněte na <b>Usnadnění</b>.</li><li>V seznamu vpravo klikněte na <b>Předčítání</b>.</li><li>V části „Hlas Předčítání“ klikněte na tlačítko <b>Přidat hlasy</b>.</li><li>Klikněte na <b>Přidat</b> a v seznamu vyberte požadovaný jazyk (např. vietnamštinu).</li><li>Až se zobrazí seznam hlasů, které lze pro daný jazyk stáhnout, vyberte požadovaný hlas a klikněte na <b>Stáhnout a nainstalovat</b>.</li><li>Po dokončení instalace můžete v rozevírací nabídce „Zvolit hlas“ nahoře nastavit právě nainstalovaný hlas jako výchozí.</li></ol>", "zh_cn": "<h4>⚙️ 在辅助功能 &gt; 讲述人中添加高级语音数据（替代方法）</h4><p class=\"p-desc\">如果用上面的方法看不到想要的语音，或想安装更多高级语音，也可以通过讲述人菜单添加同样的语音数据。在这里安装的语音同样可以在包括本页面在内的电脑上其他程序中使用。</p><ol><li>打开设置：按下 <b>Win + I</b>。</li><li>在左侧菜单点击<b>辅助功能</b>。</li><li>在右侧列表中点击<b>讲述人</b>。</li><li>在“讲述人语音”中点击<b>添加语音</b>按钮。</li><li>点击<b>添加</b>按钮，然后在列表中选择想要的语言（例如：越南语）。</li><li>出现该语言可下载的语音列表后，选择想要的语音并点击<b>下载并安装</b>。</li><li>安装完成后，可在上方的“选择语音”下拉菜单中将刚安装的语音设为默认。</li></ol>", "zh": "<h4>⚙️ 在協助工具 &gt; 朗讀程式中新增進階語音資料（替代方法）</h4><p class=\"p-desc\">如果用上面的方法看不到想要的語音，或想安裝更多進階語音，也可以透過朗讀程式選單新增同樣的語音資料。在這裡安裝的語音同樣可以在包括本畫面在內的電腦上其他程式中使用。</p><ol><li>開啟設定：按下 <b>Win + I</b>。</li><li>在左側選單點一下<b>協助工具</b>。</li><li>在右側清單中點一下<b>朗讀程式</b>。</li><li>在「朗讀程式語音」中點一下<b>新增語音</b>按鈕。</li><li>點一下<b>新增</b>按鈕，然後在清單中選擇想要的語言（例如：越南文）。</li><li>出現該語言可下載的語音清單後，選擇想要的語音並點一下<b>下載並安裝</b>。</li><li>安裝完成後，可在上方的「選擇語音」下拉式選單中將剛安裝的語音設為預設。</li></ol>", "en": "<h4>⚙️ Adding Advanced Voice Data via Accessibility &gt; Narrator (Alternative)</h4><p class=\"p-desc\">If the voice you want doesn't appear with the method above, or you'd like to install more advanced voices, you can also add the same voice data through the Narrator menu. Voices installed here can be used in the same way by other programs on your computer, including this screen.</p><ol><li>Open Settings: Press <b>Win + I</b>.</li><li>In the left menu, click <b>Accessibility</b>.</li><li>In the list on the right, click <b>Narrator</b>.</li><li>Under \"Narrator's voice\", click the <b>Add voices</b> button.</li><li>Click <b>Add</b>, then choose the language you want (e.g. Vietnamese) from the list.</li><li>When the list of voices available for that language appears, choose the voice you want and click <b>Download and install</b>.</li><li>When installation finishes, you can make the voice you just installed the default in the \"Choose a voice\" drop-down menu at the top.</li></ol>", "fr": "<h4>⚙️ Ajouter des données vocales avancées via Accessibilité &gt; Narrateur (alternative)</h4><p class=\"p-desc\">Si la voix souhaitée n'apparaît pas avec la méthode ci-dessus, ou si vous voulez installer davantage de voix avancées, vous pouvez aussi ajouter les mêmes données vocales depuis le menu Narrateur. Les voix installées ici sont utilisables de la même façon par les autres programmes de l'ordinateur, y compris cet écran.</p><ol><li>Ouvrez les Paramètres : appuyez sur <b>Win + I</b>.</li><li>Dans le menu de gauche, cliquez sur <b>Accessibilité</b>.</li><li>Dans la liste de droite, cliquez sur <b>Narrateur</b>.</li><li>Sous « Voix du Narrateur », cliquez sur le bouton <b>Ajouter des voix</b>.</li><li>Cliquez sur <b>Ajouter</b>, puis choisissez la langue souhaitée (par ex. le vietnamien) dans la liste.</li><li>Lorsque la liste des voix disponibles pour cette langue s'affiche, choisissez la voix voulue et cliquez sur <b>Télécharger et installer</b>.</li><li>Une fois l'installation terminée, vous pouvez définir cette voix par défaut dans le menu déroulant « Choisir une voix » en haut.</li></ol>", "de": "<h4>⚙️ Erweiterte Sprachdaten über Barrierefreiheit &gt; Sprachausgabe hinzufügen (Alternative)</h4><p class=\"p-desc\">Wenn die gewünschte Stimme mit der obigen Methode nicht erscheint oder Sie weitere erweiterte Stimmen installieren möchten, können Sie dieselben Sprachdaten auch über das Menü der Sprachausgabe hinzufügen. Hier installierte Stimmen können ebenso von anderen Programmen auf dem Computer genutzt werden, auch von dieser Seite.</p><ol><li>Einstellungen öffnen: Drücken Sie <b>Win + I</b>.</li><li>Klicken Sie im linken Menü auf <b>Barrierefreiheit</b>.</li><li>Klicken Sie rechts in der Liste auf <b>Sprachausgabe</b>.</li><li>Klicken Sie unter „Stimme der Sprachausgabe“ auf <b>Stimmen hinzufügen</b>.</li><li>Klicken Sie auf <b>Hinzufügen</b> und wählen Sie die gewünschte Sprache (z. B. Vietnamesisch) aus der Liste.</li><li>Sobald die Liste der für diese Sprache verfügbaren Stimmen erscheint, wählen Sie die gewünschte Stimme und klicken Sie auf <b>Herunterladen und installieren</b>.</li><li>Nach der Installation können Sie die neue Stimme oben im Dropdown-Menü „Stimme auswählen“ als Standard festlegen.</li></ol>", "hu": "<h4>⚙️ Speciális hangadatok hozzáadása: Akadálymentesség &gt; Narrátor (alternatíva)</h4><p class=\"p-desc\">Ha a fenti módszerrel nem jelenik meg a kívánt hang, vagy több speciális hangot szeretne telepíteni, ugyanezeket a hangadatokat a Narrátor menüjén keresztül is hozzáadhatja. Az itt telepített hangokat a számítógép többi programja – ezt a képernyőt is beleértve – ugyanúgy használhatja.</p><ol><li>A Beállítások megnyitása: Nyomja meg a <b>Win + I</b> billentyűket.</li><li>A bal oldali menüben kattintson az <b>Akadálymentesség</b> elemre.</li><li>A jobb oldali listában kattintson a <b>Narrátor</b> elemre.</li><li>A „Narrátor hangja” résznél kattintson a <b>Hangok hozzáadása</b> gombra.</li><li>Kattintson a <b>Hozzáadás</b> gombra, majd válassza ki a listából a kívánt nyelvet (pl. vietnami).</li><li>Amikor megjelenik az adott nyelvhez letölthető hangok listája, válassza ki a kívánt hangot, és kattintson a <b>Letöltés és telepítés</b> gombra.</li><li>A telepítés után a felső „Hang kiválasztása” legördülő menüben az imént telepített hangot alapértelmezetté teheti.</li></ol>", "id": "<h4>⚙️ Menambahkan data suara lanjutan lewat Aksesibilitas &gt; Narator (alternatif)</h4><p class=\"p-desc\">Jika suara yang Anda inginkan tidak muncul dengan cara di atas, atau Anda ingin memasang lebih banyak suara lanjutan, Anda juga dapat menambahkan data suara yang sama melalui menu Narator. Suara yang dipasang di sini juga dapat digunakan oleh program lain di komputer, termasuk layar ini.</p><ol><li>Buka Pengaturan: Tekan <b>Win + I</b>.</li><li>Di menu kiri, klik <b>Aksesibilitas</b>.</li><li>Di daftar sebelah kanan, klik <b>Narator</b>.</li><li>Di bagian \"Suara Narator\", klik tombol <b>Tambahkan suara</b>.</li><li>Klik <b>Tambahkan</b>, lalu pilih bahasa yang diinginkan (misalnya bahasa Vietnam) dari daftar.</li><li>Saat daftar suara yang dapat diunduh untuk bahasa itu muncul, pilih suara yang diinginkan lalu klik <b>Unduh dan instal</b>.</li><li>Setelah selesai, Anda dapat menjadikan suara yang baru dipasang sebagai default di menu tarik-turun \"Pilih suara\" di bagian atas.</li></ol>", "ja": "<h4>⚙️ アクセシビリティ &gt; ナレーターから高度な音声データを追加する（別の方法）</h4><p class=\"p-desc\">上の方法で希望の音声が表示されない場合や、より多くの高度な音声をインストールしたい場合は、ナレーターのメニューからも同じ音声データを追加できます。ここでインストールした音声も、この画面を含むパソコン上のほかのプログラムで同じように使えます。</p><ol><li>設定を開く：<b>Win + I</b>を押します。</li><li>左のメニューで<b>アクセシビリティ</b>をクリックします。</li><li>右側の一覧で<b>ナレーター</b>をクリックします。</li><li>「ナレーターの音声」で<b>音声の追加</b>ボタンをクリックします。</li><li><b>追加</b>ボタンをクリックし、一覧から希望の言語（例：ベトナム語）を選びます。</li><li>その言語でダウンロードできる音声の一覧が表示されたら、希望の音声を選んで<b>ダウンロードしてインストール</b>をクリックします。</li><li>インストールが終わったら、上部の「音声の選択」ドロップダウンメニューで、インストールした音声を既定に設定できます。</li></ol>", "pl": "<h4>⚙️ Dodawanie zaawansowanych danych głosowych w Ułatwienia dostępu &gt; Narrator (alternatywa)</h4><p class=\"p-desc\">Jeśli powyższą metodą nie widać wybranego głosu albo chcesz zainstalować więcej zaawansowanych głosów, te same dane głosowe możesz dodać także przez menu Narratora. Zainstalowane tu głosy mogą być tak samo używane przez inne programy na komputerze, w tym przez ten ekran.</p><ol><li>Otwórz Ustawienia: naciśnij <b>Win + I</b>.</li><li>W menu po lewej kliknij <b>Ułatwienia dostępu</b>.</li><li>Na liście po prawej kliknij <b>Narrator</b>.</li><li>W sekcji „Głos Narratora” kliknij przycisk <b>Dodaj głosy</b>.</li><li>Kliknij <b>Dodaj</b>, a następnie wybierz z listy żądany język (np. wietnamski).</li><li>Gdy pojawi się lista głosów dostępnych do pobrania dla tego języka, wybierz głos i kliknij <b>Pobierz i zainstaluj</b>.</li><li>Po zakończeniu instalacji możesz ustawić nowy głos jako domyślny w menu rozwijanym „Wybierz głos” u góry.</li></ol>"},
    "<h4>⚙️ Windows 10에서 베트남어 TTS 추가하기</h4><ol><li>설정 열기: <b>Win + I</b> 단축키를 누릅니다.</li><li>언어 메뉴 이동: <b>시간 및 언어</b> ➔ 왼쪽의 <b>지역 및 언어</b>(또는 언어) 메뉴를 클릭합니다.</li><li>기본 설정 언어 추가: ‘기본 설정 언어’ 아래의 <b>언어 추가</b>를 클릭합니다.</li><li>베트남어 팩 선택: 베트남어(Tiếng Việt)를 검색하여 선택합니다. 이때 반드시 TTS 아이콘(마이크·말풍선 모양)이 포함되어 있는지 확인하고 ‘다음’을 누릅니다.</li><li>TTS 기능 설치: 기본 기능인 ‘텍스트 음성 변환(TTS)’이 체크된 상태로 <b>설치</b>를 누르면 완료돼요.</li></ol><h4>💡 설치 후 팁 및 확인 사항</h4><div class=\"tts-tip\">설정 반영: 음성 팩 설치를 마친 후에는 사용 중이던 텍스트 리더 프로그램이나 설정 앱을 종료 후 다시 실행해야 베트남어 음성이 정상적으로 표시돼요.</div><div class=\"tts-tip\">간편하게 읽기 실행: 윈도우 기본 돋보기 기능(Win + +)을 켜고 Ctrl + Alt + 마우스 좌클릭을 활용하면 원하는 베트남어 텍스트를 바로 TTS 음성으로 들을 수 있어요. 다만 아쉽게도 윈도우에서 지원하는 “자연스러운 음성” 목록에는 베트남어가 없어서, 윈도우를 사용할 경우 베트남어 TTS 음성이 좀 부자연스럽게 느껴질 수 있어요.</div>": {"vi": "<h4>⚙️ Thêm giọng đọc tiếng Việt (TTS) trên Windows 10</h4><ol><li>Mở Cài đặt: Nhấn <b>Win + I</b>.</li><li>Vào mục ngôn ngữ: Nhấp <b>Thời gian và ngôn ngữ</b> ➔ rồi <b>Khu vực và ngôn ngữ</b> (hoặc Ngôn ngữ) ở bên trái.</li><li>Thêm ngôn ngữ ưu tiên: Trong \"Ngôn ngữ ưu tiên\", nhấp <b>Thêm ngôn ngữ</b>.</li><li>Chọn gói tiếng Việt: Tìm và chọn Tiếng Việt. Hãy chắc chắn rằng có biểu tượng TTS (micrô/bong bóng lời nói), rồi nhấn \"Tiếp\".</li><li>Cài tính năng TTS: Để nguyên tùy chọn \"Chuyển văn bản thành giọng nói\" đã được đánh dấu và nhấn <b>Cài đặt</b> là xong.</li></ol><h4>💡 Mẹo và điều cần kiểm tra sau khi cài đặt</h4><div class=\"tts-tip\">Áp dụng cài đặt: Sau khi cài gói giọng nói, hãy đóng rồi mở lại chương trình đọc văn bản hoặc ứng dụng Cài đặt đang dùng để giọng tiếng Việt hiển thị đúng.</div><div class=\"tts-tip\">Cách đọc nhanh: Bật Kính lúp có sẵn của Windows (Win + +), rồi giữ Ctrl + Alt và nhấp chuột trái để nghe ngay văn bản tiếng Việt bằng giọng TTS. Tiếc là danh sách \"giọng nói tự nhiên\" của Windows chưa có tiếng Việt, nên giọng TTS tiếng Việt trên Windows có thể nghe hơi thiếu tự nhiên.</div>", "cs": "<h4>⚙️ Přidání vietnamského hlasu (TTS) ve Windows 10</h4><ol><li>Otevřete Nastavení: Stiskněte <b>Win + I</b>.</li><li>Přejděte do nabídky jazyka: Klikněte na <b>Čas a jazyk</b> ➔ a vlevo na <b>Oblast a jazyk</b> (nebo Jazyk).</li><li>Přidejte upřednostňovaný jazyk: V části „Upřednostňované jazyky“ klikněte na <b>Přidat jazyk</b>.</li><li>Vyberte vietnamský balíček: Vyhledejte a vyberte vietnamštinu (Tiếng Việt). Ujistěte se, že obsahuje ikonu TTS (mikrofon/bublina), a klikněte na „Další“.</li><li>Nainstalujte funkci TTS: Ponechte zaškrtnutou výchozí funkci „Převod textu na řeč“ a klikněte na <b>Instalovat</b>.</li></ol><h4>💡 Tipy a kontrola po instalaci</h4><div class=\"tts-tip\">Použití nastavení: Po instalaci hlasového balíčku zavřete a znovu otevřete program pro čtení textu nebo aplikaci Nastavení — teprve potom se vietnamský hlas zobrazí správně.</div><div class=\"tts-tip\">Rychlé čtení: Zapněte vestavěnou Lupu systému Windows (Win + +), podržte Ctrl + Alt a klikněte levým tlačítkem myši — vybraný vietnamský text se ihned přečte hlasem TTS. Vietnamština bohužel není v seznamu „přirozených hlasů“ Windows, takže vietnamský hlas může ve Windows znít méně přirozeně.</div>", "zh_cn": "<h4>⚙️ 在 Windows 10 中添加越南语 TTS</h4><ol><li>打开设置：按下 <b>Win + I</b>。</li><li>进入语言菜单：点击<b>时间和语言</b> ➔ 左侧的<b>区域和语言</b>（或语言）。</li><li>添加首选语言：在“首选语言”下点击<b>添加语言</b>。</li><li>选择越南语包：搜索并选择越南语（Tiếng Việt），确认包含 TTS 图标（麦克风/对话气泡）后点击“下一步”。</li><li>安装 TTS 功能：保持默认勾选的“文本到语音转换”，点击<b>安装</b>即可。</li></ol><h4>💡 安装后的提示与注意事项</h4><div class=\"tts-tip\">套用设置：安装语音包后，请关闭并重新打开正在使用的朗读程序或设置 App，越南语语音才会正常显示。</div><div class=\"tts-tip\">快速朗读：开启 Windows 内置的放大镜（Win + +），然后按住 Ctrl + Alt 并单击鼠标左键，即可立即以 TTS 语音收听所选越南语文字。可惜 Windows 支持的“自然语音”列表中没有越南语，因此在 Windows 上越南语 TTS 可能听起来不太自然。</div>", "zh": "<h4>⚙️ 在 Windows 10 中新增越南語 TTS</h4><ol><li>開啟設定：按下 <b>Win + I</b>。</li><li>前往語言選單：點一下<b>時間與語言</b> ➔ 左側的<b>地區與語言</b>（或語言）。</li><li>新增慣用語言：在「慣用語言」下點一下<b>新增語言</b>。</li><li>選擇越南語套件：搜尋並選擇越南文（Tiếng Việt），確認包含 TTS 圖示（麥克風/對話框）後點一下「下一步」。</li><li>安裝 TTS 功能：保持預設勾選的「文字轉換語音」，點一下<b>安裝</b>即可。</li></ol><h4>💡 安裝後的提示與注意事項</h4><div class=\"tts-tip\">套用設定：安裝語音套件後，請關閉並重新開啟正在使用的朗讀程式或設定 App，越南語語音才會正常顯示。</div><div class=\"tts-tip\">快速朗讀：開啟 Windows 內建的放大鏡（Win + +），然後按住 Ctrl + Alt 並按一下滑鼠左鍵，即可立即以 TTS 語音收聽所選越南語文字。可惜 Windows 支援的「自然語音」清單中沒有越南語，因此在 Windows 上越南語 TTS 可能聽起來不太自然。</div>", "en": "<h4>⚙️ Adding a Vietnamese TTS Voice in Windows 10</h4><ol><li>Open Settings: Press <b>Win + I</b>.</li><li>Go to the language menu: Click <b>Time & language</b> ➔ then <b>Region & language</b> (or Language) on the left.</li><li>Add a preferred language: Under \"Preferred languages\", click <b>Add a language</b>.</li><li>Choose the Vietnamese pack: Search for and select Vietnamese (Tiếng Việt). Make sure the TTS icon (microphone/speech bubble) is included, then click \"Next\".</li><li>Install the TTS feature: Keep the default \"Text-to-speech\" feature checked and click <b>Install</b>.</li></ol><h4>💡 Tips After Installation</h4><div class=\"tts-tip\">Apply the settings: After installing the voice pack, close and reopen the text reader or Settings app you were using — only then will the Vietnamese voice appear correctly.</div><div class=\"tts-tip\">Quick reading: Turn on the built-in Windows Magnifier (Win + +), then hold Ctrl + Alt and left-click to hear the selected Vietnamese text read aloud right away. Unfortunately, Vietnamese is not in the Windows \"Natural voices\" list, so the Vietnamese TTS voice on Windows may sound a little unnatural.</div>", "fr": "<h4>⚙️ Ajouter une voix vietnamienne (TTS) sous Windows 10</h4><ol><li>Ouvrez les Paramètres : appuyez sur <b>Win + I</b>.</li><li>Allez dans le menu des langues : cliquez sur <b>Heure et langue</b> ➔ puis sur <b>Région et langue</b> (ou Langue) à gauche.</li><li>Ajoutez une langue préférée : sous « Langues préférées », cliquez sur <b>Ajouter une langue</b>.</li><li>Choisissez le module vietnamien : recherchez et sélectionnez le vietnamien (Tiếng Việt). Vérifiez qu'il comporte bien l'icône TTS (micro/bulle), puis cliquez sur « Suivant ».</li><li>Installez la fonction TTS : laissez cochée la fonction par défaut « Synthèse vocale » et cliquez sur <b>Installer</b>.</li></ol><h4>💡 Conseils après l'installation</h4><div class=\"tts-tip\">Appliquer les réglages : après l'installation du module vocal, fermez puis rouvrez le lecteur de texte ou l'application Paramètres que vous utilisiez ; la voix vietnamienne ne s'affichera correctement qu'ensuite.</div><div class=\"tts-tip\">Lecture rapide : activez la Loupe intégrée de Windows (Win + +), puis maintenez Ctrl + Alt et cliquez avec le bouton gauche pour entendre aussitôt le texte vietnamien sélectionné. Malheureusement, le vietnamien ne figure pas dans la liste des « voix naturelles » de Windows ; la voix TTS vietnamienne peut donc sembler un peu artificielle sous Windows.</div>", "de": "<h4>⚙️ Vietnamesische Stimme (TTS) unter Windows 10 hinzufügen</h4><ol><li>Einstellungen öffnen: Drücken Sie <b>Win + I</b>.</li><li>Zum Sprachmenü: Klicken Sie auf <b>Zeit und Sprache</b> ➔ und links auf <b>Region und Sprache</b> (oder Sprache).</li><li>Bevorzugte Sprache hinzufügen: Klicken Sie unter „Bevorzugte Sprachen“ auf <b>Sprache hinzufügen</b>.</li><li>Vietnamesisches Paket auswählen: Suchen und wählen Sie Vietnamesisch (Tiếng Việt). Achten Sie darauf, dass das TTS-Symbol (Mikrofon/Sprechblase) enthalten ist, und klicken Sie auf „Weiter“.</li><li>TTS-Funktion installieren: Lassen Sie die Standardfunktion „Text-zu-Sprache“ aktiviert und klicken Sie auf <b>Installieren</b>.</li></ol><h4>💡 Hinweise nach der Installation</h4><div class=\"tts-tip\">Einstellungen übernehmen: Schließen Sie nach der Installation des Sprachpakets das verwendete Vorleseprogramm oder die Einstellungen-App und öffnen Sie sie erneut – erst dann wird die vietnamesische Stimme korrekt angezeigt.</div><div class=\"tts-tip\">Schnell vorlesen lassen: Schalten Sie die integrierte Windows-Bildschirmlupe ein (Win + +), halten Sie Strg + Alt gedrückt und klicken Sie mit der linken Maustaste, um den ausgewählten vietnamesischen Text sofort vorlesen zu lassen. Leider ist Vietnamesisch nicht in der Windows-Liste der „natürlichen Stimmen“ enthalten, daher kann die vietnamesische TTS-Stimme unter Windows etwas unnatürlich klingen.</div>", "hu": "<h4>⚙️ Vietnami hang (TTS) hozzáadása Windows 10 alatt</h4><ol><li>A Beállítások megnyitása: Nyomja meg a <b>Win + I</b> billentyűket.</li><li>A nyelvi menü: Kattintson az <b>Idő és nyelv</b> ➔ majd bal oldalon a <b>Terület és nyelv</b> (vagy Nyelv) elemre.</li><li>Előnyben részesített nyelv hozzáadása: Az „Előnyben részesített nyelvek” alatt kattintson a <b>Nyelv hozzáadása</b> gombra.</li><li>A vietnami csomag kiválasztása: Keresse meg és válassza ki a vietnamit (Tiếng Việt). Ellenőrizze, hogy szerepel-e a TTS ikon (mikrofon/szövegbuborék), majd kattintson a „Tovább” gombra.</li><li>A TTS funkció telepítése: Hagyja bejelölve az alapértelmezett „Szövegfelolvasás” funkciót, és kattintson a <b>Telepítés</b> gombra.</li></ol><h4>💡 Tippek és ellenőrzés telepítés után</h4><div class=\"tts-tip\">A beállítások érvényesítése: A hangcsomag telepítése után zárja be, majd nyissa meg újra a használt szövegolvasó programot vagy a Beállítások alkalmazást — a vietnami hang csak ezután jelenik meg megfelelően.</div><div class=\"tts-tip\">Gyors felolvasás: Kapcsolja be a Windows beépített Nagyítóját (Win + +), majd a Ctrl + Alt lenyomva tartása mellett kattintson a bal egérgombbal, és a kiválasztott vietnami szöveget azonnal hallhatja. Sajnos a vietnami nem szerepel a Windows „természetes hangjai” között, ezért a vietnami TTS hang Windowson kevésbé természetesnek tűnhet.</div>", "id": "<h4>⚙️ Menambahkan suara TTS bahasa Vietnam di Windows 10</h4><ol><li>Buka Pengaturan: Tekan <b>Win + I</b>.</li><li>Masuk ke menu bahasa: Klik <b>Waktu & bahasa</b> ➔ lalu <b>Wilayah & bahasa</b> (atau Bahasa) di kiri.</li><li>Tambahkan bahasa pilihan: Di bawah \"Bahasa pilihan\", klik <b>Tambahkan bahasa</b>.</li><li>Pilih paket bahasa Vietnam: Cari dan pilih Bahasa Vietnam (Tiếng Việt). Pastikan ada ikon TTS (mikrofon/gelembung ucapan), lalu klik \"Berikutnya\".</li><li>Pasang fitur TTS: Biarkan fitur default \"Teks ke ucapan\" tetap dicentang, lalu klik <b>Instal</b>.</li></ol><h4>💡 Tips dan hal yang perlu diperiksa setelah pemasangan</h4><div class=\"tts-tip\">Terapkan pengaturan: Setelah memasang paket suara, tutup lalu buka kembali program pembaca teks atau aplikasi Pengaturan yang sedang dipakai agar suara bahasa Vietnam tampil dengan benar.</div><div class=\"tts-tip\">Membaca dengan cepat: Aktifkan Kaca Pembesar bawaan Windows (Win + +), lalu tahan Ctrl + Alt dan klik kiri mouse untuk langsung mendengar teks bahasa Vietnam yang dipilih dibacakan TTS. Sayangnya bahasa Vietnam belum termasuk dalam daftar \"suara alami\" Windows, sehingga suara TTS bahasa Vietnam di Windows mungkin terdengar kurang alami.</div>", "ja": "<h4>⚙️ Windows 10でベトナム語TTSを追加する</h4><ol><li>設定を開く：<b>Win + I</b>を押します。</li><li>言語メニューへ移動：<b>時刻と言語</b> ➔ 左側の<b>地域と言語</b>（または言語）をクリックします。</li><li>優先する言語の追加：「優先する言語」の下の<b>言語の追加</b>をクリックします。</li><li>ベトナム語パックの選択：ベトナム語（Tiếng Việt）を検索して選択します。TTSアイコン（マイク・吹き出し）が含まれていることを確認し、「次へ」をクリックします。</li><li>TTS機能のインストール：既定の「音声合成」にチェックが入った状態で<b>インストール</b>をクリックすれば完了です。</li></ol><h4>💡 インストール後のヒントと確認事項</h4><div class=\"tts-tip\">設定の反映：音声パックをインストールしたら、使用中の読み上げプログラムや設定アプリをいったん終了して再起動すると、ベトナム語の音声が正しく表示されます。</div><div class=\"tts-tip\">手軽に読み上げる：Windows標準の拡大鏡（Win + +）をオンにし、Ctrl + Altを押しながらマウスを左クリックすると、選択したベトナム語テキストをすぐにTTS音声で聞けます。ただし残念ながら、Windowsが対応する「自然な音声」の一覧にはベトナム語がないため、WindowsではベトナムTTS音声がやや不自然に感じられることがあります。</div>", "pl": "<h4>⚙️ Dodawanie wietnamskiego głosu (TTS) w Windows 10</h4><ol><li>Otwórz Ustawienia: naciśnij <b>Win + I</b>.</li><li>Przejdź do menu języka: kliknij <b>Czas i język</b> ➔ a następnie po lewej <b>Region i język</b> (lub Język).</li><li>Dodaj preferowany język: w sekcji „Preferowane języki” kliknij <b>Dodaj język</b>.</li><li>Wybierz pakiet wietnamski: wyszukaj i wybierz język wietnamski (Tiếng Việt). Upewnij się, że zawiera ikonę TTS (mikrofon/dymek), i kliknij „Dalej”.</li><li>Zainstaluj funkcję TTS: pozostaw zaznaczoną domyślną funkcję „Zamiana tekstu na mowę” i kliknij <b>Zainstaluj</b>.</li></ol><h4>💡 Wskazówki po instalacji</h4><div class=\"tts-tip\">Zastosowanie ustawień: po zainstalowaniu pakietu głosowego zamknij i ponownie uruchom używany program do czytania tekstu lub aplikację Ustawienia — dopiero wtedy wietnamski głos będzie poprawnie widoczny.</div><div class=\"tts-tip\">Szybkie czytanie: włącz wbudowaną Lupę systemu Windows (Win + +), a następnie przytrzymaj Ctrl + Alt i kliknij lewym przyciskiem myszy, aby od razu usłyszeć zaznaczony tekst wietnamski. Niestety języka wietnamskiego nie ma na liście „naturalnych głosów” Windows, więc wietnamski głos TTS może w Windows brzmieć nieco nienaturalnie.</div>"},
    "발음 듣기 목소리": {"vi": "Giọng đọc phát âm", "cs": "Hlas pro výslovnost", "zh_cn": "发音语音设定", "zh": "發音語音設定", "en": "Pronunciation Playback Voice", "fr": "Voix pour la prononciation", "de": "Stimme für Aussprache", "hu": "Kiejtés felolvasó hangja", "id": "Suara Pelafalan", "ja": "発音再生の音声", "pl": "Głos do odtwarzania wymowy"},
    "베트남어를 읽어줄 목소리를 3종류 중에서 고를 수 있어요: 북부 베트남어, 남부 베트남어, 현재 언어 모드(한국어·中文·English·日本語)의 TTS. 지금 실제로 사용할 지역은 아래 북부/남부 토글로 골라요.": {"vi": "Bạn có thể chọn 1 trong 3 loại giọng đọc tiếng Việt: giọng miền Bắc, giọng miền Nam, và TTS của chế độ ngôn ngữ hiện tại. Vùng thực sự được sử dụng được chọn bằng nút chuyển Bắc/Nam bên dưới.", "cs": "Pro čtení vietnamštiny si můžete vybrat ze 3 druhů hlasu: severní vietnamština, jižní vietnamština a TTS aktuálního jazykového režimu. Oblast, která se skutečně použije, zvolíte přepínačem Sever/Jih níže.", "zh_cn": "可以从3种语音中选择朗读越南语的声音：北部越南语、南部越南语，以及目前语言模式（한국어·中文·English·日本语）的TTS。实际要使用的地区请在下方的北部/南部切换钮中选择。", "zh": "可以從3種語音中選擇朗讀越南語的聲音：北部越南語、南部越南語，以及目前語言模式（한국어·中文·English·日本語）的TTS。實際要使用的地區請在下方的北部/南部切換鈕中選擇。", "en": "You can choose from 3 kinds of voice to read Vietnamese: Northern Vietnamese, Southern Vietnamese, and the TTS of the current language mode (한국어·中文·English·日本語). Pick which region is actually used with the North/South toggle below.", "fr": "Vous pouvez choisir parmi 3 types de voix : vietnamien du Nord, vietnamien du Sud, et la voix TTS de la langue de l'interface. La région active se sélectionne avec le bouton Nord/Sud.", "de": "Sie können zwischen 3 Stimmenarten wählen: Nord-Vietnamesisch, Süd-Vietnamesisch und die TTS-Stimme des aktuellen Sprachmodus (Koreanisch/Chinesisch/Englisch/Japanisch/Deutsch). Die aktuell verwendete Region wählen Sie mit dem Nord/Süd-Schalter.", "hu": "A vietnami felolvasásához 3 hangtípus közül választhat: északi vietnami, déli vietnami, valamint az aktuális nyelvi mód TTS-e. A ténylegesen használt régiót az alábbi Észak/Dél kapcsolóval választhatja ki.", "id": "Anda dapat memilih 3 jenis suara untuk membacakan bahasa Vietnam: Vietnam Utara, Vietnam Selatan, dan TTS dari mode bahasa saat ini. Wilayah yang benar-benar dipakai dipilih dengan tombol Utara/Selatan di bawah.", "ja": "ベトナム語を読み上げる声を3種類から選べます：北部ベトナム語、南部ベトナム語、現在の言語モード（한국어·中文·English·日本語）のTTS。実際に使う地域は下の北部/南部トグルで選びます。", "pl": "Możesz wybrać spośród 3 rodzajów głosów: wietnamski północny, wietnamski południowy oraz syntezator mowy w języku interfejsu. Aktywny region wybiera się przełącznikiem Północ/Południe."},
    "지금 사용할 지역": {"vi": "Vùng đang dùng", "cs": "Aktuálně používaná oblast", "zh_cn": "目前使用的地区", "zh": "目前使用的地區", "en": "Region in use now", "fr": "Région actuellement utilisée", "de": "Aktuell verwendete Region", "hu": "Jelenleg használt régió", "id": "Wilayah yang digunakan saat ini", "ja": "現在使用する地域", "pl": "Aktualnie używany region"},
    "언어 모드": {"vi": "Chế độ ngôn ngữ", "cs": "Jazykový režim", "zh_cn": "语言模式", "zh": "語言模式", "en": "Language mode", "fr": "Langue de l'interface", "de": "Sprachmodus", "hu": "Nyelvi mód", "id": "Mode Bahasa", "ja": "言語モード", "pl": "Język interfejsu"},
    "기기별 베트남어 음성(TTS) 추가 방법": {"vi": "Cách thêm giọng đọc tiếng Việt (TTS) theo từng thiết bị", "cs": "Jak přidat vietnamský hlas (TTS) podle zařízení", "zh_cn": "各装置新增越南语语音（TTS）的方法", "zh": "各裝置新增越南語語音（TTS）的方法", "en": "How to Add Vietnamese Voices (TTS) by Device", "fr": "Comment ajouter des voix vietnamiennes (TTS) par appareil", "de": "Vietnamesische Sprachausgabe (TTS) auf Geräten hinzufügen", "hu": "Vietnámi hang (TTS) hozzáadása eszközönként", "id": "Cara Menambahkan Suara Vietnam (TTS) per Perangkat", "ja": "機器別ベトナム語音声（TTS）の追加方法", "pl": "Jak dodać głosy wietnamskie (TTS) na urządzeniach"},
    "이 학습반 화면의 발음 듣기 버튼은 기기·브라우저에 이미 설치된 베트남어 음성을 사용해요. 아래 기기별 안내를 따라 베트남어 음성을 미리 설치해 두면, 이 화면뿐 아니라 휴대폰·컴퓨터의 다른 앱에서도 베트남어 텍스트를 원어민 발음으로 들을 수 있어요. 항목을 눌러 펼쳐 보세요.": {"vi": "Nút nghe phát âm trên màn hình này dùng giọng tiếng Việt đã được cài sẵn trên thiết bị hoặc trình duyệt. Nếu bạn cài trước giọng tiếng Việt theo hướng dẫn cho từng thiết bị bên dưới, bạn có thể nghe văn bản tiếng Việt bằng giọng bản ngữ không chỉ ở đây mà cả trong các ứng dụng khác trên điện thoại hay máy tính. Nhấn vào từng mục để mở ra.", "cs": "Tlačítko poslechu výslovnosti na této obrazovce používá vietnamský hlas nainstalovaný ve vašem zařízení nebo prohlížeči. Postupujte podle níže uvedených pokynů pro jednotlivá zařízení a nainstalujte si vietnamský hlas předem. Klepnutím rozbalte jednotlivé položky.", "zh_cn": "本学习班画面上的发音播放按钮，使用的是装置或浏览器中已安装的越南语语音。依照下方各装置的说明事先安装越南语语音后，不只在这个画面，在手机、电脑的其他应用程式中也能以母语人士发音听到越南语文字。点选项目即可展开查看。", "zh": "本學習班畫面上的發音播放按鈕，使用的是裝置或瀏覽器中已安裝的越南語語音。依照下方各裝置的說明事先安裝越南語語音後，不只在這個畫面，在手機、電腦的其他應用程式中也能以母語人士發音聽到越南語文字。點選項目即可展開查看。", "en": "The pronunciation playback button on this class screen uses a Vietnamese voice already installed on your device or browser. If you install a Vietnamese voice ahead of time by following the device-specific guides below, you'll be able to hear Vietnamese text read in a native voice not only here, but also in other apps on your phone or computer. Tap an item to expand it.", "fr": "Les boutons d'écoute utilisent les voix vietnamiennes installées sur votre appareil ou votre navigateur. Suivez les instructions ci-dessous pour installer une voix afin de profiter d'une prononciation naturelle partout.", "de": "Die Aussprache-Schaltflächen in diesem Kurs nutzen die auf Ihrem Gerät oder im Browser installierten vietnamesischen Stimmen. Wenn Sie vorab eine vietnamesische Stimme installieren, können Sie vietnamesische Texte überall in natürlicher Aussprache anhören.", "hu": "A kiejtés-meghallgatás gomb a készülékére vagy böngészőjébe telepített vietnámi hangot használja. Kövesse az alábbi útmutatót a vietnámi hang telepítéséhez. Koppintson egy elemre a kibontásához.", "id": "Tombol dengarkan pelafalan di layar ini menggunakan suara bahasa Vietnam yang terpasang di perangkat atau browser Anda. Ikuti petunjuk untuk memasang suara terlebih dahulu. Ketuk item untuk membukanya.", "ja": "この学習会画面の発音再生ボタンは、機器・ブラウザにすでにインストールされているベトナム語の音声を使用します。以下の機器別ガイドに従ってベトナム語の音声を事前にインストールしておくと、この画面だけでなく、スマートフォンやパソコンの他のアプリでもベトナム語のテキストをネイティブの発音で聞くことができます。項目をタップして開いてみてください。", "pl": "Przyciski odsłuchu korzystają z głosów wietnamskich zainstalowanych na Twoim urządzeniu. Postępuj zgodnie z instrukcjami, aby zainstalować głos i słuchać naturalnej wymowy."},
    "아이폰 · 아이패드 (iOS/iPadOS)": {"vi": "iPhone · iPad (iOS/iPadOS)", "cs": "iPhone / iPad (iOS/iPadOS)", "zh_cn": "iPhone・iPad（iOS/iPadOS）", "zh": "iPhone・iPad（iOS/iPadOS）", "en": "iPhone / iPad (iOS/iPadOS)", "fr": "iPhone / iPad (iOS/iPadOS)", "de": "iPhone / iPad (iOS/iPadOS)", "hu": "iPhone / iPad (iOS/iPadOS)", "id": "iPhone / iPad (iOS/iPadOS)", "ja": "iPhone・iPad（iOS/iPadOS）", "pl": "iPhone / iPad (iOS/iPadOS)"},
    "안드로이드 (Android)": {"vi": "Android", "cs": "Android", "zh_cn": "Android（安卓）", "zh": "Android（安卓）", "en": "Android", "fr": "Android", "de": "Android", "hu": "Android", "id": "Android", "ja": "Android（アンドロイド）", "pl": "Android"},
    "글자를 눌러 발음을 들어 보세요.": {"vi": "Nhấn vào chữ cái để nghe phát âm.", "cs": "Klepnutím na písmeno si poslechněte výslovnost.", "zh_cn": "点选字母即可听发音。", "zh": "點選字母即可聽發音。", "en": "Tap a letter to hear its pronunciation.", "fr": "Appuyez sur une lettre pour écouter sa prononciation.", "de": "Tippen Sie auf einen Buchstaben, um die Aussprache zu hören.", "hu": "Koppintson a betűre a kiejtés meghallgatásához.", "id": "Ketuk huruf untuk mendengarkan pelafalan.", "ja": "文字をタップして発音を聞いてみましょう。", "pl": "Dotknij litery, aby usłyszeć jej wymowę."},
    "베트남어 문자": {"vi": "Bảng chữ cái tiếng Việt", "cs": "Vietnamská abeceda", "zh_cn": "越南语文字", "zh": "越南語文字", "en": "Vietnamese Alphabet", "fr": "Alphabet vietnamien", "de": "Vietnamesisches Alphabet", "hu": "A vietnami ábécé", "id": "Abjad bahasa Vietnam", "ja": "ベトナム語の文字", "pl": "Alfabet wietnamski"},
    "베트남어 문자의 명칭": {"vi": "Tên gọi các chữ cái tiếng Việt", "cs": "Názvy vietnamských písmen", "zh_cn": "越南语文字的名称", "zh": "越南語文字的名稱", "en": "Names of the Vietnamese Letters", "fr": "Noms des lettres vietnamiennes", "de": "Bezeichnungen der vietnamesischen Buchstaben", "hu": "A vietnámi betűk elnevezése", "id": "Nama-Nama Huruf Vietnam", "ja": "ベトナム語の文字の名称", "pl": "Nazwy liter wietnamskich"},
    "자음을 읽을 때는 보통 자음 뒤에 ơ 모음을 붙여서 읽습니다. (예: b → bơ)": {"vi": "Khi đọc phụ âm, thường thêm nguyên âm ơ phía sau. (Ví dụ: b → bơ)", "cs": "Při hlasitém čtení souhlásky se za ni obvykle přidává samohláska ơ. (např. b → bơ)", "zh_cn": "念子音时，通常会在子音后面加上母音 ơ 来念。（例：b → bơ）", "zh": "唸子音時，通常會在子音後面加上母音 ơ 來唸。（例：b → bơ）", "en": "When reading a consonant aloud, the vowel ơ is usually added after it. (e.g. b → bơ)", "fr": "Pour prononcer une consonne isolée, on ajoute généralement la voyelle ơ après elle (ex. : b → bơ).", "de": "Beim Aussprechen von Konsonanten wird üblicherweise der Vokal ơ angehängt (z. B. b → bơ).", "hu": "Mássalhangzó kiejtésekor általában egy ơ magánhangzót teszünk mögé. (pl. b → bơ)", "id": "Saat membaca konsonan dengan lantang, vokal ơ biasanya ditambahkan di belakangnya. (contoh: b → bơ)", "ja": "子音を読むときは、通常子音の後に母音 ơ を付けて読みます。（例：b → bơ）", "pl": "Czytając pojedynczą spółgłoskę, zazwyczaj dodaje się po niej samogłoskę ơ (np. b → bơ)."},
    "모음 발음 — 단모음": {"vi": "Phát âm nguyên âm — nguyên âm đơn", "cs": "Výslovnost samohlásek — jednoduché samohlásky", "zh_cn": "母音发音——单母音", "zh": "母音發音——單母音", "en": "Vowel Pronunciation — Single Vowels", "fr": "Prononciation des voyelles — Voyelles simples", "de": "Vokalaussprache — Einfache Vokale", "hu": "Magánhangzók kiejtése — egyszerű magánhangzók", "id": "Pelafalan Vokal — Vokal Tunggal", "ja": "母音の発音 — 単母音", "pl": "Wymowa samogłosek — Samogłoski pojedyncze"},
    "모음 발음 — 복모음": {"vi": "Phát âm nguyên âm — nguyên âm đôi", "cs": "Výslovnost samohlásek — složené samohlásky", "zh_cn": "母音发音——复合母音", "zh": "母音發音——複合母音", "en": "Vowel Pronunciation — Diphthongs", "fr": "Prononciation des voyelles — Diphtongues", "de": "Vokalaussprache — Diphthonge", "hu": "Magánhangzók kiejtése — összetett magánhangzók", "id": "Pelafalan Vokal — Vokal Majemuk", "ja": "母音の発音 — 複合母音", "pl": "Wymowa samogłosek — Dwugłoski"},
    "자음 발음 — 단자음": {"vi": "Phát âm phụ âm — phụ âm đơn", "cs": "Výslovnost souhlásek — jednoduché souhlásky", "zh_cn": "子音发音——单子音", "zh": "子音發音——單子音", "en": "Consonant Pronunciation — Single Consonants", "fr": "Prononciation des consonnes — Consonnes simples", "de": "Konsonantenaussprache — Einfache Konsonanten", "hu": "Mássalhangzók kiejtése — egyszerű mássalhangzók", "id": "Pelafalan Konsonan — Konsonan Tunggal", "ja": "子音の発音 — 単子音", "pl": "Wymowa spółgłosek — Spółgłoski pojedyncze"},
    "자음 발음 — 복자음": {"vi": "Phát âm phụ âm — phụ âm ghép", "cs": "Výslovnost souhlásek — spřežky", "zh_cn": "子音发音——复合子音", "zh": "子音發音——複合子音", "en": "Consonant Pronunciation — Consonant Clusters", "fr": "Prononciation des consonnes — Groupes de consonnes", "de": "Konsonantenaussprache — Konsonantenverbindungen", "hu": "Mássalhangzók kiejtése — összetett mássalhangzók", "id": "Pelafalan Konsonan — Konsonan Ganda", "ja": "子音の発音 — 複合子音", "pl": "Wymowa spółgłosek — Zbitki spółgłoskowe"},
    "성조 (6개)": {"vi": "Thanh điệu (6)", "cs": "Tóny (6)", "zh_cn": "声调（6个）", "zh": "聲調（6個）", "en": "Tones (6)", "fr": "Tons (6)", "de": "Töne (6)", "hu": "Tónusok (6)", "id": "Nada (6)", "ja": "声調（6つ）", "pl": "Tony (6)"},
    "베트남어에는 음의 높낮이를 구별하는 6개의 성조가 있어요. 같은 글자라도 성조에 따라 완전히 다른 단어가 됩니다.": {"vi": "Tiếng Việt có 6 thanh điệu phân biệt độ cao của âm. Cùng một chữ nhưng khác thanh điệu sẽ thành những từ hoàn toàn khác nhau.", "cs": "Vietnamština má 6 tónů rozlišujících výšku hlasu. Stejná písmena mají podle tónu zcela odlišný význam.", "zh_cn": "越南语有6个用来区分音高的声调。就算是同一个字母，依声调不同也会变成完全不同的单字。", "zh": "越南語有6個用來區分音高的聲調。就算是同一個字母，依聲調不同也會變成完全不同的單字。", "en": "Vietnamese has six tones that distinguish pitch. Even the same letters can become completely different words depending on the tone.", "fr": "Le vietnamien compte six tons qui distinguent la hauteur musicale. Les mêmes lettres forment des mots entièrement différents selon le ton.", "de": "Im Vietnamesischen gibt es 6 Töne, die die Tonhöhe bestimmen. Dieselben Buchstaben ergeben je nach Ton völlig unterschiedliche Wörter.", "hu": "A vietnámi nyelvben 6 hangmagasság-megkülönböztető tónus létezik. Ugyanaz a szó tónustól függően teljesen mást jelenthet.", "id": "Bahasa Vietnam memiliki 6 nada yang membedakan tinggi nada. Huruf yang sama dapat menjadi kata yang berbeda tergantung nadanya.", "ja": "ベトナム語には音の高低を区別する6つの声調があります。同じ文字でも声調によって全く違う単語になります。", "pl": "W języku wietnamskim występuje 6 tonów różnicujących wysokość głosu. Te same litery tworzą zupełnie inne słowa w zależności od tonu."},
    "성조 조합 연습 (36가지)": {"vi": "Luyện tổ hợp thanh điệu (36 tổ hợp)", "cs": "Cvičení kombinací tónů (36 kombinací)", "zh_cn": "声调组合练习（36种）", "zh": "聲調組合練習（36種）", "en": "Tone Combination Practice (36 Combinations)", "fr": "Pratique des combinaisons de tons (36 combinaisons)", "de": "Tonkombinationen üben (36 Paare)", "hu": "Tónuskombinációk gyakorlása (36 változat)", "id": "Latihan Kombinasi Nada (36 Variasi)", "ja": "声調の組み合わせ練習（36通り）", "pl": "Ćwiczenie kombinacji tonów (36 par)"},
    "두 음절의 성조를 조합하면 6×6 = 36가지 경우가 나와요. 앞 음절의 성조별로 묶었으니 눌러서 열어 보고, 실생활에서 자주 쓰는 단어로 성조 조합을 듣고 연습해 보세요.": {"vi": "Kết hợp thanh điệu của hai âm tiết sẽ có 6×6 = 36 trường hợp. Các tổ hợp được nhóm theo thanh điệu của âm tiết đầu — hãy nhấn để mở từng nhóm, rồi nghe và luyện tập với những từ thường dùng trong đời sống.", "cs": "Kombinací tónů dvou slabik získáte 6×6 = 36 možných dvojic. Jsou seskupeny podle tónu první slabiky.", "zh_cn": "将两个音节的声调组合起来，会有6×6＝36种情况。已依前一音节的声调分组，点选展开查看，并用日常生活中常用的单字聆听、练习声调组合吧。", "zh": "將兩個音節的聲調組合起來，會有6×6＝36種情況。已依前一音節的聲調分組，點選展開查看，並用日常生活中常用的單字聆聽、練習聲調組合吧。", "en": "Combining the tones of two syllables gives you 6×6 = 36 possible pairs. They're grouped by the first syllable's tone — tap to expand each group, and listen to and practice the tone combinations using words commonly used in everyday life.", "fr": "En combinant les tons de deux syllabes, on obtient 6×6 = 36 possibilités. Regroupées par le ton de la première syllabe, ouvrez chaque groupe pour écouter et pratiquer avec des mots de la vie courante.", "de": "Die Kombination zweier Silbentöne ergibt 6×6 = 36 Möglichkeiten. Sie sind nach dem Ton der ersten Silbe gruppiert – öffnen Sie jede Gruppe und üben Sie mit Wörtern aus dem Alltag.", "hu": "Két szótag tónusainak kombinálásával 6×6 = 36 lehetséges pár jön létre. Az első szótag tónusa szerint vannak csoportosítva.", "id": "Menggabungkan nada dua suku kata menghasilkan 6×6 = 36 pasangan. Dikelompokkan berdasarkan nada suku kata pertama.", "ja": "2つの音節の声調を組み合わせると、6×6＝36通りになります。前の音節の声調ごとにまとめてあるので、タップして開き、日常生活でよく使う単語で声調の組み合わせを聞いて練習してみましょう。", "pl": "Kombinacja tonów dwóch sylab daje 6×6 = 36 możliwości. Pogrupowano je według tonu pierwszej sylaby — rozwiń grupy, aby słuchać i ćwiczyć popularne słowa z życia codziennego."},
    "북부 발음과 남부 발음의 차이": {"vi": "Khác biệt giữa phát âm miền Bắc và miền Nam", "cs": "Rozdíly mezi severní a jižní výslovností", "zh_cn": "北部发音与南部发音的差异", "zh": "北部發音與南部發音的差異", "en": "Differences Between Northern and Southern Pronunciation", "fr": "Différences de prononciation entre Nord et Sud", "de": "Unterschiede zwischen Nord- und Südaussprache", "hu": "Az északi és déli kiejtés közötti különbségek", "id": "Perbedaan Pelafalan Utara dan Selatan", "ja": "北部発音と南部発音の違い", "pl": "Różnice w wymowie między Północą a Południem"},
    "같은 글자라도 지역에 따라 소리가 달라지는 대표적인 5가지 경우예요. 북부(하노이)와 남부(호찌민)를 비교해 보세요.": {"vi": "Đây là 5 trường hợp tiêu biểu mà cùng một chữ nhưng được phát âm khác nhau tùy vùng. Hãy so sánh giọng miền Bắc (Hà Nội) và miền Nam (TP. Hồ Chí Minh).", "cs": "Pět typických případů, kdy se stejná písmena vyslovují v různých oblastech odlišně. Porovnejte sever (Hanoj) a jih (Ho Či Minovo Město).", "zh_cn": "这是同一个字母却因地区不同而发音不同的5个代表性例子。请比较北部（河内）与南部（胡志明市）的发音。", "zh": "這是同一個字母卻因地區不同而發音不同的5個代表性例子。請比較北部（河內）與南部（胡志明市）的發音。", "en": "These are five representative cases where the same letters are pronounced differently depending on the region. Compare the Northern (Hanoi) and Southern (Ho Chi Minh City) pronunciations.", "fr": "Voici 5 cas typiques où les mêmes lettres se prononcent différemment selon la région. Comparez le Nord (Hanoï) et le Sud (Hô Chi Minh-Ville).", "de": "Dies sind fünf typische Fälle, in denen dieselben Buchstaben je nach Region unterschiedlich ausgesprochen werden. Vergleichen Sie Norden (Hanoi) und Süden (Ho-Chi-Minh-Stadt).", "hu": "Öt tipikus eset, amikor ugyanaz a betű régiónként eltérően hangzik. Hasonlítsa össze az északi (Hanoi) és a déli (Ho Si Minh-város) kiejtést.", "id": "Lima kasus umum di mana huruf yang sama diucapkan berbeda tergantung wilayah. Bandingkan wilayah Utara (Hanoi) dan Selatan (Ho Chi Minh).", "ja": "同じ文字でも地域によって発音が異なる代表的な5つの例です。北部（ハノイ）と南部（ホーチミン）を比較してみましょう。", "pl": "Oto 5 typowych przypadków, gdy te same litery brzmią inaczej w zależności od regionu. Porównaj Północ (Hanoi) i Południe (Ho Chi Minh)."},
    "바로가기": {"vi": "Đi tới", "cs": "Přejít", "zh_cn": "前往", "zh": "前往", "en": "Go", "fr": "Accéder", "de": "Direkt zu", "hu": "Ugrás", "id": "Buka", "ja": "移動", "pl": "Przejdź"},
    "주": {"vi": "Tuần", "cs": "Týden", "zh_cn": "周", "zh": "週", "en": "Week", "fr": "Semaine", "de": "Woche", "hu": "Hét", "id": "Minggu", "ja": "週", "pl": "Tydzień"},
    "모든 대화를 구성하는 기본 단어": {"vi": "Những từ cơ bản tạo nên mọi cuộc hội thoại", "cs": "Základní slova tvořící každý rozhovor", "zh_cn": "构成所有对话的基本单字", "zh": "構成所有對話的基本單字", "en": "Basic Words That Make Up Every Dialogue", "fr": "Mots de base composant chaque dialogue", "de": "Grundlegende Wörter aller Dialoge", "hu": "Alapszavak, amelyek minden beszélgetést felépítenek", "id": "Kata Dasar Pembentuk Setiap Percakapan", "ja": "すべての会話を構成する基本単語", "pl": "Podstawowe słowa tworzące każdy dialog"},
    "반의어": {"vi": "Từ trái nghĩa", "cs": "Antonyma", "zh_cn": "反义词", "zh": "反義詞", "en": "Antonyms", "fr": "Antonymes", "de": "Antonyme (Gegenteile)", "hu": "Ellentétek", "id": "Antonim", "ja": "反意語", "pl": "Antonimy"},
    "주어": {"vi": "Chủ ngữ", "cs": "Podmět", "zh_cn": "主词", "zh": "主詞", "en": "Subjects", "fr": "Sujets", "de": "Subjekt", "hu": "Alany", "id": "Subjek", "ja": "主語", "pl": "Podmioty"},
    "조동사 등": {"vi": "Trợ động từ, v.v.", "cs": "Pomocná slovesa apod.", "zh_cn": "助动词等", "zh": "助動詞等", "en": "Modals, etc.", "fr": "Verbes auxiliaires / Modaux", "de": "Modalverben usw.", "hu": "Segédigék stb.", "id": "Kata Kerja Bantu, dll.", "ja": "助動詞など", "pl": "Czasowniki posiłkowe i modalne"},
    "동사": {"vi": "Động từ", "cs": "Sloveso", "zh_cn": "动词", "zh": "動詞", "en": "Verbs", "fr": "Verbes", "de": "Verben", "hu": "Ige", "id": "Kata Kerja", "ja": "動詞", "pl": "Czasowniki"},
    "장소 (ở ~)": {"vi": "Nơi chốn (ở ~)", "cs": "Místo (ở ~)", "zh_cn": "地点（ở ~）", "zh": "地點（ở ~）", "en": "Places (ở ~)", "fr": "Lieux (ở ~)", "de": "Orte (ở ~)", "hu": "Hely (ở ~)", "id": "Tempat (ở ~)", "ja": "場所（ở ~）", "pl": "Miejsca (ở ~)"},
    "유인물 8단계 구성": {"vi": "Cấu trúc tài liệu 8 bước", "cs": "Osmistupňová struktura podkladů", "zh_cn": "讲义8阶段结构", "zh": "講義8階段結構", "en": "8-Stage Handout Structure", "fr": "Structure du document en 8 étapes", "de": "8-stufiger Aufbau des Handzettels", "hu": "A kiosztott anyag 8 lépcsős felépítése", "id": "Struktur handout 8 tahap", "ja": "配布資料の8段階構成", "pl": "8-etapowa struktura materiałów"},
    "줄": {"vi": " dòng", "cs": " řádků", "zh_cn": "列", "zh": "列", "en": " rows", "fr": " lignes", "de": " Zeilen", "hu": " sor", "id": " baris", "ja": "行", "pl": " wierszy"},
    "칸": {"vi": " cột", "cs": " sloupců", "zh_cn": "栏", "zh": "欄", "en": " cols", "fr": " colonnes", "de": " Spalten", "hu": " oszlop", "id": " kolom", "ja": "マス", "pl": " kolumn"},
    "연결사": {"vi": "Từ nối", "cs": "Spojovací výrazy", "zh_cn": "连接词", "zh": "連接詞", "en": "Connectives", "fr": "Conjonctions", "de": "Bindewörter (Konjunktionen)", "hu": "Kötőszavak", "id": "Penghubung", "ja": "接続詞", "pl": "Spójniki"},
    "움직임을 나타내는 동사": {"vi": "Động từ chỉ sự di chuyển", "cs": "Slovesa pohybu", "zh_cn": "表示动作的动词", "zh": "表示動作的動詞", "en": "Verbs of Movement", "fr": "Verbes de mouvement", "de": "Verben der Bewegung", "hu": "Mozgást kifejező igék", "id": "Kata Kerja Gerak", "ja": "動きを表す動詞", "pl": "Czasowniki ruchu"},
    "위치 전치사": {"vi": "Giới từ chỉ vị trí", "cs": "Předložky místa", "zh_cn": "位置介系词", "zh": "位置介系詞", "en": "Location Prepositions", "fr": "Prépositions de lieu", "de": "Präpositionen des Ortes", "hu": "Helyhatározó elöljárók", "id": "Preposisi Tempat", "ja": "位置を表す前置詞", "pl": "Przyimki miejsca"},
    "길찾기 대화문": {"vi": "Hội thoại hỏi đường", "cs": "Dialogy pro orientaci a hledání cesty", "zh_cn": "问路对话", "zh": "問路對話", "en": "Asking-for-Directions Dialogue", "fr": "Dialogues pour demander son chemin", "de": "Wegbeschreibungs-Dialoge", "hu": "Útbaigazítási beszélgetések", "id": "Percakapan Petunjuk Arah", "ja": "道案内の会話文", "pl": "Dialogi dotyczące pytania o drogę"},
    "A–Z 문법 사전": {"vi": "Từ điển ngữ pháp A–Z", "cs": "Mluvnický slovník A–Z", "zh_cn": "A–Z 文法辞典", "zh": "A–Z 文法辭典", "en": "A–Z Grammar Dictionary", "fr": "Dictionnaire de grammaire de A à Z", "de": "A–Z Grammatiklexikon", "hu": "A–Z nyelvtani szótár", "id": "Kamus Tata Bahasa A–Z", "ja": "A–Z 文法辞典", "pl": "Leksykon gramatyczny od A do Z"},
    "왕국 노래": {"vi": "Bài hát Nước Trời", "cs": "Písně Království", "zh_cn": "王国诗歌", "zh": "王國詩歌", "en": "Kingdom Songs", "fr": "Cantiques du Royaume", "de": "Königreichslieder", "hu": "Királyság-énekek", "id": "Lagu Kerajaan", "ja": "王国の歌", "pl": "Pieśni Królestwa"},
    "번": {"vi": "", "cs": "×", "zh_cn": "首", "zh": "首", "en": "", "fr": "", "de": "", "hu": "×", "id": "×", "ja": "番", "pl": ""},
    "기도 준비하기": {"vi": "Chuẩn bị lời cầu nguyện", "cs": "Příprava k modlitbě", "zh_cn": "准备祷告", "zh": "準備禱告", "en": "Preparing a Prayer", "fr": "Préparer une prière", "de": "Ein Gebet vorbereiten", "hu": "Felkészülés az imára", "id": "Mempersiapkan Doa", "ja": "祈りを準備する", "pl": "Przygotowanie modlitwy"},
    "맞음": {"vi": "đúng", "cs": "Správně", "zh_cn": "答对", "zh": "答對", "en": "correct", "fr": "correct", "de": "Richtig", "hu": "Helyes", "id": "Benar", "ja": "正解", "pl": "Prawidłowo"},
    "베트남어로 입력하세요": {"vi": "Nhập bằng tiếng Việt", "cs": "Zadejte ve vietnamštině", "zh_cn": "请输入越南语", "zh": "請輸入越南語", "en": "Type it in Vietnamese", "fr": "Écrivez en vietnamien", "de": "Auf Vietnamesisch eingeben", "hu": "Írja be vietnámiul", "id": "Ketik dalam bahasa Vietnam", "ja": "ベトナム語で入力してください", "pl": "Wpisz po wietnamsku"},
    "단어별 뜻": {"vi": "Nghĩa từng từ", "cs": "Význam jednotlivých slov", "zh_cn": "逐字翻译", "zh": "逐字翻譯", "en": "Word-by-Word Meaning", "fr": "Sens mot à mot", "de": "Bedeutung der einzelnen Wörter", "hu": "Szavankénti jelentés", "id": "Arti Kata demi Kata", "ja": "単語ごとの意味", "pl": "Znaczenie słowo po słowie"},
    "문장 뜻: ": {"vi": "Nghĩa của câu: ", "cs": "Význam věty: ", "zh_cn": "句子意思：", "zh": "句子意思：", "en": "Sentence meaning: ", "fr": "Sens de la phrase : ", "de": "Satzbedeutung: ", "hu": "Mondat jelentése: ", "id": "Arti kalimat: ", "ja": "文の意味：", "pl": "Znaczenie zdania: "},
    "한국어라면 이 순서예요": {"vi": "Theo ngôn ngữ của bạn, thứ tự sẽ như thế này", "cs": "V češtině by to bylo v tomto pořadí", "zh_cn": "如果是中文，语序是这样", "zh": "如果是中文，語序是這樣", "en": "In English, the order would be this", "fr": "En français, l'ordre serait le suivant", "de": "In deutscher Wortstellung wäre es so", "hu": "A szórend így alakulna", "id": "Urutan susunan kalimat", "ja": "日本語ならこの順番です", "pl": "W języku polskim szyk wyglądałby tak"},
    "베트남어는 이 순서로 이동해요!": {"vi": "Trong tiếng Việt, các từ chuyển sang thứ tự này!", "cs": "Ve vietnamštině se posouvá v tomto pořadí!", "zh_cn": "越南语会变成这个顺序！", "zh": "越南語會變成這個順序！", "en": "In Vietnamese, it moves to this order!", "fr": "En vietnamien, les mots s'agencent dans cet ordre !", "de": "Im Vietnamesischen wechselt es in diese Reihenfolge!", "hu": "A vietnámiban ebbe a sorrendbe kerül!", "id": "Dalam bahasa Vietnam, kata berpindah ke urutan ini!", "ja": "ベトナム語ではこの順番に変わります！", "pl": "W wietnamskim słowa przestawiają się w taki szyk!"},
    "동생": {"vi": "Em", "cs": "Mladší sourozenec", "zh_cn": "弟妹", "zh": "弟妹", "en": "Younger Sibling", "fr": "Petit frère / Petite sœur", "de": "Jüngeres Geschwister", "hu": "Fiatalabb testvér", "id": "Adik", "ja": "弟・妹", "pl": "Młodsze rodzeństwo"},
    "초면 · 나이를 잘 모르고 아직 친하지 않아 거리를 둘 때": {"vi": "Lần đầu gặp · chưa rõ tuổi, chưa thân nên giữ khoảng cách lịch sự", "cs": "První setkání · neznáte věk, ještě nejste si blízcí, udržujete uctivý odstup", "zh_cn": "初次见面，不太清楚年龄，还不熟悉，保持一定距离时", "zh": "初次見面，不太清楚年齡，還不熟悉，保持一定距離時", "en": "First meeting, don't know their age well, not yet close, keeping a respectful distance", "fr": "Premier contact, âge inconnu, pas encore familiers, politesse", "de": "Erstes Treffen, Alter unbekannt, respektvoller Abstand", "hu": "Első találkozás · nem ismeri a korát, még nem közeli, tisztelettudó távolságot tart", "id": "Pertemuan pertama · belum tahu usianya, belum akrab, menjaga jarak dengan sopan", "ja": "初対面で年齢がよく分からず、まだ親しくないため距離を置くとき", "pl": "Pierwsze spotkanie, wiek nieznany, uprzejmy dystans"},
    "검색 결과가 없어요.": {"vi": "Không tìm thấy kết quả.", "cs": "Žádné výsledky vyhledávání.", "zh_cn": "没有搜寻结果。", "zh": "沒有搜尋結果。", "en": "No results found.", "fr": "Aucun résultat trouvé.", "de": "Keine Suchergebnisse.", "hu": "Nincs találat.", "id": "Tidak ada hasil pencarian.", "ja": "検索結果がありません。", "pl": "Brak wyników wyszukiwania."},
    "사전어순(베트남어 알파벳순)으로 정리했어요. 한자어에서 온 단어는 괄호 안에 한자를 표시했습니다.": {"vi": "Được sắp xếp theo thứ tự từ điển (thứ tự bảng chữ cái tiếng Việt). Các từ gốc Hán có ghi chữ Hán trong ngoặc.", "cs": "Seřazeno podle abecedy. U slov sino-vietnamského původu jsou znaky uvedeny v závorce.", "zh_cn": "依字典顺序（越南语字母顺序）排列。源自汉字词的单字，括号内会标示汉字。", "zh": "依字典順序（越南語字母順序）排列。源自漢字詞的單字，括號內會標示漢字。", "en": "Sorted in dictionary order (Vietnamese alphabetical order). Words derived from Sino-Vietnamese show the Chinese characters in parentheses.", "fr": "Classé par ordre alphabétique vietnamien. Les mots d'origine sino-vietnamienne indiquent les sinogrammes entre parenthèses.", "de": "In Wörterbuchreihenfolge (vietnamesisches Alphabet) sortiert. Aus dem Sino-Vietnamesischen stammende Wörter zeigen die Schriftzeichen in Klammern.", "hu": "Szótári (vietnámi ábécé) sorrendben rendezve. A sino-vietnámi eredetű szavaknál a karakterek zárójelben szerepelnek.", "id": "Disusun berdasarkan urutan abjad kamus bahasa Vietnam. Kata asal Sino-Vietnam menampilkan karakternya dalam tanda kurung.", "ja": "辞書順（ベトナム語アルファベット順）に整理しました。漢語由来の単語は括弧内に漢字を表示しています。", "pl": "Uporządkowano w kolejności alfabetycznej języka wietnamskiego. Przy słowach pochodzenia sino-wietnamskiego podano znaki chińskie w nawiasach."},
    "총 ": {"vi": "Tổng ", "cs": "Celkem ", "zh_cn": "共 ", "zh": "共 ", "en": "", "fr": "Total : ", "de": "Insgesamt ", "hu": "Összesen ", "id": "Total ", "ja": "全 ", "pl": "Razem: "},
    "개 단어 중 ": {"vi": " từ, tìm thấy ", "cs": " slov z celkových ", "zh_cn": "个单字中，", "zh": "個單字中，", "en": " of ", "fr": " sur ", "de": " von ", "hu": " szó a(z) ", "id": " kata dari ", "ja": "語中、", "pl": " z "},
    "개 검색됨": {"vi": " từ", "cs": " nalezeno", "zh_cn": "个符合搜寻", "zh": "個符合搜尋", "en": " matched", "fr": " mots trouvés", "de": " Wörter gefunden", "hu": " találat", "id": " ditemukan", "ja": "件ヒット", "pl": " znalezionych słów"},
    "4음절 이상 결합어는 그것을 이루는 기본 단어를 먼저 보여준 뒤에 나옵니다.": {"vi": "Từ ghép từ 4 âm tiết trở lên được hiển thị sau khi giới thiệu các từ cơ bản tạo nên chúng.", "cs": "U víceslabičných slov se nejprve zobrazí základní slova, ze kterých se skládají.", "zh_cn": "4音节以上的组合词，会先显示组成它的基本单字，然后才出现该组合词。", "zh": "4音節以上的組合詞，會先顯示組成它的基本單字，然後才出現該組合詞。", "en": "Compound words of four or more syllables are shown after first introducing the basic words that make them up.", "fr": "Les mots composés de 4 syllabes ou plus sont présentés après avoir introduit leurs termes de base.", "de": "Zusammengesetzte Wörter ab vier Silben werden nach ihren Grundbestandteilen aufgeführt.", "hu": "A négyszótagos vagy hosszabb összetett szavaknál először az alapszavak jelennek meg.", "id": "Untuk kata majemuk 4 suku kata atau lebih, kata dasar pembentuknya akan ditampilkan lebih dahulu.", "ja": "4音節以上の合成語は、それを構成する基本単語を先に示してから出てきます。", "pl": "Słowa złożone z 4 lub więcej sylab są prezentowane po przedstawieniu ich słów składowych."},
    "결합어": {"vi": "Từ ghép", "cs": "Složená slova", "zh_cn": "组合词", "zh": "組合詞", "en": "Compound", "fr": "Mots composés", "de": "Komposita", "hu": "Összetett szavak", "id": "Kata Majemuk", "ja": "合成語", "pl": "Wyrazy złożone"},
    "개 단어": {"vi": " từ", "cs": " slov", "zh_cn": "个单字", "zh": "個單字", "en": " words", "fr": " mots", "de": " Wörter", "hu": " szó", "id": " kata", "ja": "語", "pl": " słów"},
    "베트남어 한자어 음절을 받침(끝소리)별로 묶고, 그 받침이 한국 한자음의 어떤 받침과 대응하는지 보여줘요. 안에서 다시 모음별(운) 그룹으로 나누어, 하나의 기본 단어에서 여러 파생 단어의 한국 한자음을 함께 익힐 수 있어요.": {"vi": "Nhóm các âm tiết Hán Việt theo âm cuối và cho thấy âm cuối đó tương ứng với âm cuối nào trong cách đọc chữ Hán. Trong mỗi nhóm lại chia theo vần, để bạn có thể học cùng lúc cách đọc Hán của nhiều từ phái sinh từ một từ cơ bản.", "cs": "Seskupuje sino-vietnamské slabiky podle koncové hlásky a ukazuje vzájemné korespondence.", "zh_cn": "依越南语汉字词音节的收尾音分组，并显示该收尾音对应到中文汉字音的哪个收尾音。组内再依母音（韵）细分，让您能从一个基本词汇一起熟悉多个衍生词的中文汉字音。", "zh": "依越南語漢字詞音節的收尾音分組，並顯示該收尾音對應到中文漢字音的哪個收尾音。組內再依母音（韻）細分，讓您能從一個基本詞彙一起熟悉多個衍生詞的中文漢字音。", "en": "Groups Sino-Vietnamese syllables by their final sound, and shows which final sound in the Chinese reading it corresponds to. Within each group, they're further divided by vowel (rhyme), so you can learn the Chinese readings of several derived words together from one basic word.", "fr": "Regroupe les syllabes sino-vietnamiennes par consonne finale et montre les correspondances phonétiques.", "de": "Gruppiert sino-vietnamesische Silben nach Endlauten und zeigt Entsprechungen auf.", "hu": "A sino-vietnámi szótagokat végződésük szerint csoportosítja, és bemutatja a megfeleléseket.", "id": "Mengelompokkan suku kata Sino-Vietnam berdasarkan bunyi akhirnya dan menunjukkan kesesuaian bunyinya.", "ja": "ベトナム語の漢語音節を語末音別にまとめ、その語末音が中国語の漢字音のどの語末音に対応するかを示します。中ではさらに母音（韻）別のグループに分け、1つの基本単語から複数の派生語の中国語漢字音をまとめて覚えられます。", "pl": "Grupuje sylaby sino-wietnamskie według spółgłoski końcowej i pokazuje odpowiedniości fonetyczne."},
    "[어순반대]": {"vi": "[đảo trật tự]", "cs": "[Obrácený slovosled]", "zh_cn": "［语序相反］", "zh": "［語序相反］", "en": "[reversed order]", "fr": "[ordre inversé]", "de": "[Umgekehrte Wortstellung]", "hu": "[Fordított szórend]", "id": "[Urutan Terbalik]", "ja": "［語順が逆］", "pl": "[odwrócony szyk]"},
    "어순반대": {"vi": "Đảo trật tự", "cs": "Obrácený slovosled", "zh_cn": "语序相反", "zh": "語序相反", "en": "Reversed Order", "fr": "Ordre inversé", "de": "Umgekehrte Wortstellung", "hu": "Fordított szórend", "id": "Urutan Terbalik", "ja": "語順が逆", "pl": "Odwrócony szyk"},
    "베트남어 한자어 중, 한국어·중국어·일본어의 한자 어순과 베트남어 어순이 서로 반대인 단어들을 모았어요.": {"vi": "Tập hợp các từ Hán Việt có trật tự âm tiết tiếng Việt ngược với trật tự chữ Hán trong tiếng Hàn, tiếng Trung và tiếng Nhật.", "cs": "Sbírka sino-vietnamských slov, jejichž vietnamský slovosled je obrácený.", "zh_cn": "收录了越南语汉字词中，韩文·中文·日文的汉字语序与越南语语序相反的单字。", "zh": "收錄了越南語漢字詞中，韓文·中文·日文的漢字語序與越南語語序相反的單字。", "en": "Collects Sino-Vietnamese words whose Vietnamese syllable order is reversed compared to the hanja/hanzi/kanji order used in Korean, Chinese, and Japanese.", "fr": "Rassemble les mots sino-vietnamiens dont l'ordre des syllabes est inversé par rapport au chinois, coréen et japonais.", "de": "Sino-vietnamesische Wörter, deren Silbenreihenfolge im Vietnamesischen umgekehrt ist.", "hu": "Olyan sino-vietnámi szavak gyűjteménye, amelyek szórendje fordított.", "id": "Kumpulan kata Sino-Vietnam yang urutan suku katanya terbalik.", "ja": "ベトナム語の漢語のうち、韓国語・中国語・日本語の漢字語順とベトナム語の語順が逆になっている単語を集めました。", "pl": "Zbiór słów sino-wietnamskich, w których kolejność sylab jest odwrotna niż w językach chińskim, koreańskim i japońskim."},
    "구약 (39권)": {"vi": "Cựu ước (39 sách)", "cs": "Starý zákon (39 knih)", "zh_cn": "旧约（39卷）", "zh": "舊約（39卷）", "en": "Old Testament (39 Books)", "fr": "Écritures hébraïques (39 livres)", "de": "Hebräische Schriften (39 Bücher)", "hu": "Héber-arámi iratok (39 könyv)", "id": "Perjanjian Lama (39 Kitab)", "ja": "旧約（39巻）", "pl": "Pisma Hebrajskie (39 ksiąg)"},
    "신약 (27권)": {"vi": "Tân ước (27 sách)", "cs": "Nový zákon (27 knih)", "zh_cn": "新约（27卷）", "zh": "新約（27卷）", "en": "New Testament (27 Books)", "fr": "Écritures grecques chrétiennes (27 livres)", "de": "Christliche Griechische Schriften (27 Bücher)", "hu": "Keresztény Görög Iratok (27 könyv)", "id": "Perjanjian Baru (27 Kitab)", "ja": "新約（27巻）", "pl": "Chrześcijańskie Pisma Greckie (27 ksiąg)"},
    "숫자 읽기 — 1~10": {"vi": "Đọc số — 1–10", "cs": "Čtení čísel — 1–10", "zh_cn": "数字读法 — 1～10", "zh": "數字讀法 — 1～10", "en": "Reading Numbers — 1–10", "fr": "Lecture des nombres — 1–10", "de": "Zahlen lesen — 1–10", "hu": "Számok olvasása — 1–10", "id": "Membaca Angka — 1–10", "ja": "数字の読み方 — 1〜10", "pl": "Odczytywanie liczb — 1–10"},
    "숫자 읽기 — 11~19": {"vi": "Đọc số — 11–19", "cs": "Čtení čísel — 11–19", "zh_cn": "数字读法 — 11～19", "zh": "數字讀法 — 11～19", "en": "Reading Numbers — 11–19", "fr": "Lecture des nombres — 11–19", "de": "Zahlen lesen — 11–19", "hu": "Számok olvasása — 11–19", "id": "Membaca Angka — 11–19", "ja": "数字の読み方 — 11〜19", "pl": "Odczytywanie liczb — 11–19"},
    "숫자 읽기 — 20~100": {"vi": "Đọc số — 20–100", "cs": "Čtení čísel — 20–100", "zh_cn": "数字读法 — 20～100", "zh": "數字讀法 — 20～100", "en": "Reading Numbers — 20–100", "fr": "Lecture des nombres — 20–100", "de": "Zahlen lesen — 20–100", "hu": "Számok olvasása — 20–100", "id": "Membaca Angka — 20–100", "ja": "数字の読み方 — 20〜100", "pl": "Odczytywanie liczb — 20–100"},
    "숫자 읽기 — 200~900": {"vi": "Đọc số — 200–900", "cs": "Čtení čísel — 200–900", "zh_cn": "数字读法 — 200～900", "zh": "數字讀法 — 200～900", "en": "Reading Numbers — 200–900", "fr": "Lecture des nombres — 200–900", "de": "Zahlen lesen — 200–900", "hu": "Számok olvasása — 200–900", "id": "Membaca Angka — 200–900", "ja": "数字の読み方 — 200〜900", "pl": "Odczytywanie liczb — 200–900"},
    "숫자 읽기 — 1,000 ~ 10억": {"vi": "Đọc số — 1.000 đến 1 tỷ", "cs": "Čtení čísel — 1 000 až 1 miliarda", "zh_cn": "数字读法 — 1,000～10亿", "zh": "數字讀法 — 1,000～10億", "en": "Reading Numbers — 1,000–1 Billion", "fr": "Lecture des nombres — 1 000 à 1 milliard", "de": "Zahlen lesen — 1.000–1 Milliarde", "hu": "Számok olvasása — 1 000-től 1 milliárdig", "id": "Membaca Angka — 1.000 hingga 1 Miliar", "ja": "数字の読み方 — 1,000〜10億", "pl": "Odczytywanie liczb — 1000 do 1 miliarda"},
    "숫자 표기법 — 마침표와 쉼표": {"vi": "Cách viết số — dấu chấm và dấu phẩy", "cs": "Zápis čísel — tečky a čárky", "zh_cn": "数字书写方式 — 句点与逗号", "zh": "數字書寫方式 — 句點與逗號", "en": "Number Formatting — Periods and Commas", "fr": "Notation des nombres — Point et virgule", "de": "Zahlenformatierung — Punkt und Komma", "hu": "Számformátum — pontok és vesszők", "id": "Format Angka — Titik dan Koma", "ja": "数字の表記法 — ピリオドとコンマ", "pl": "Zapis liczb — Kropka i przecinek"},
    "월 (달)": {"vi": "Tháng", "cs": "Měsíce", "zh_cn": "月份", "zh": "月份", "en": "Months", "fr": "Mois", "de": "Monate", "hu": "Hónapok", "id": "Bulan", "ja": "月", "pl": "Miesiące"},
    "요일": {"vi": "Thứ trong tuần", "cs": "Dny v týdnu", "zh_cn": "星期", "zh": "星期", "en": "Days of the Week", "fr": "Jours de la semaine", "de": "Wochentage", "hu": "A hét napjai", "id": "Hari dalam Seminggu", "ja": "曜日", "pl": "Dni tygodnia"},
    "날짜": {"vi": "Ngày", "cs": "Datum", "zh_cn": "日期", "zh": "日期", "en": "Dates", "fr": "Date", "de": "Datum", "hu": "Dátum", "id": "Tanggal", "ja": "日付", "pl": "Data"},
    "계절": {"vi": "Mùa", "cs": "Roční období", "zh_cn": "季节", "zh": "季節", "en": "Seasons", "fr": "Saisons", "de": "Jahreszeiten", "hu": "Évszakok", "id": "Musim", "ja": "季節", "pl": "Pory roku"},
    "연도 읽는 법 — lẻ와 không trăm": {"vi": "Cách đọc năm — lẻ và không trăm", "cs": "Čtení letopočtů — lẻ a không trăm", "zh_cn": "年份的读法 — lẻ 和 không trăm", "zh": "年份的讀法 — lẻ 和 không trăm", "en": "Reading Years — lẻ and không trăm", "fr": "Lecture des années — lẻ et không trăm", "de": "Jahreszahlen lesen — lẻ und không trăm", "hu": "Évszámok olvasása — lẻ és không trăm", "id": "Membaca Tahun — lẻ dan không trăm", "ja": "年の読み方 — lẻ と không trăm", "pl": "Odczytywanie lat — lẻ i không trăm"},
    "이 경우, 호칭이 북부·남부에 따라 달라져요.": {"vi": "Trong trường hợp này, cách xưng hô khác nhau giữa miền Bắc và miền Nam.", "cs": "V tomto případě se oslovení liší mezi severem a jihem.", "zh_cn": "在这种情况下，称呼会因北部、南部而有所不同。", "zh": "在這種情況下，稱呼會因北部、南部而有所不同。", "en": "In this case, the term of address differs between the North and the South.", "fr": "Dans ce cas, la formule d'adresse varie entre le Nord et le Sud.", "de": "In diesem Fall unterscheidet sich die Anrede zwischen Norden und Süden.", "hu": "Ebben az esetben a megszólítás északon és délen eltérő.", "id": "Dalam kasus ini, sebutan berbeda antara wilayah Utara dan Selatan.", "ja": "この場合、呼び方が北部・南部で異なります。", "pl": "W tym przypadku forma grzecznościowa różni się między Północą a Południem."},
    "이 브라우저에서는 베트남어 음성을 찾을 수 없어요. 기본 음성으로 재생을 시도합니다.": {"vi": "Không tìm thấy giọng tiếng Việt trong trình duyệt này. Sẽ thử phát bằng giọng mặc định.", "cs": "V tomto prohlížeči nebyl nalezen žádný vietnamský hlas. Přehrávání se pokusí použít výchozí hlas.", "zh_cn": "此浏览器找不到越南语语音，将尝试以预设语音播放。", "zh": "此瀏覽器找不到越南語語音，將嘗試以預設語音播放。", "en": "No Vietnamese voice was found in this browser. Playback will be attempted with the default voice.", "fr": "Aucune voix vietnamienne n'a été trouvée dans ce navigateur. Tentative de lecture avec la voix par défaut.", "de": "In diesem Browser wurde keine vietnamesische Stimme gefunden. Es wird versucht, mit der Standardstimme abzuspielen.", "hu": "Ebben a böngészőben nem található vietnámi hang. A lejátszás az alapértelmezett hanggal kísérli meg.", "id": "Tidak ada suara bahasa Vietnam di browser ini. Pemutaran akan dicoba dengan suara default.", "ja": "このブラウザではベトナム語の音声が見つかりません。デフォルトの音声で再生を試みます。", "pl": "W tej przeglądarce nie znaleziono wietnamskiego głosu. Nastąpi próba odtworzenia głosem domyślnym."},
    "발음 듣기에 사용할 목소리를 선택하세요. (기기·브라우저에 설치된 베트남어 음성만 표시돼요)": {"vi": "Chọn giọng đọc dùng để nghe phát âm. (Chỉ hiển thị các giọng tiếng Việt đã cài trên thiết bị/trình duyệt)", "cs": "Vyberte hlas pro přehrávání výslovnosti. (Zobrazují se jen vietnamské hlasy nainstalované ve vašem zařízení/prohlížeči)", "zh_cn": "请选择用于发音播放的语音。（仅显示装置、浏览器中已安装的越南语语音）", "zh": "請選擇用於發音播放的語音。（僅顯示裝置、瀏覽器中已安裝的越南語語音）", "en": "Choose a voice for pronunciation playback. (Only Vietnamese voices installed on your device/browser are shown)", "fr": "Choisissez la voix pour la prononciation. (Seules les voix vietnamiennes installées s'affichent)", "de": "Wählen Sie eine Stimme für die Aussprache. (Es werden nur installierte vietnamesische Stimmen angezeigt)", "hu": "Válassza ki a kiejtés lejátszásához használt hangot. (Csak az eszközén/böngészőjében telepített vietnami hangok jelennek meg)", "id": "Pilih suara untuk memutar pelafalan. (Hanya suara bahasa Vietnam yang terpasang di perangkat/peramban Anda yang ditampilkan)", "ja": "発音再生に使う声を選んでください。（機器・ブラウザにインストール済みのベトナム語の声のみ表示されます）", "pl": "Wybierz głos do odsłuchu wymowy. (Wyświetlane są tylko głosy zainstalowane na urządzeniu)"},
    "뜻·해석 읽기 목소리": {"vi": "Giọng đọc nghĩa / bản dịch", "cs": "Hlas pro čtení významu/překladu", "zh_cn": "词义、翻译朗读语音", "zh": "詞義、翻譯朗讀語音", "en": "Meaning/Translation Voice", "fr": "Voix pour le sens et la traduction", "de": "Stimme für Bedeutung/Übersetzung", "hu": "Jelentést/fordítást felolvasó hang", "id": "Suara Pembacaan Arti/Terjemahan", "ja": "意味・訳読み上げの声", "pl": "Głos do odczytu znaczenia i tłumaczenia"},
    "전체 듣기에서 단어 뜻이나 문장 해석도 함께 읽어드려요. 아래에서 현재 언어 모드(한국어·中文·English·日本語)로 읽어줄 목소리를 선택하세요.": {"vi": "Khi \"Nghe tất cả\", nghĩa của từ hoặc bản dịch của câu cũng sẽ được đọc. Hãy chọn bên dưới giọng đọc cho chế độ ngôn ngữ hiện tại.", "cs": "Funkce „Přehrát vše“ přečte také význam slova nebo překlad věty. Níže vyberte hlas, který bude číst v aktuálním jazykovém režimu.", "zh_cn": "在「全部朗读」中，也会一并朗读词义或例句翻译。请在下方选择要用目前语言模式（韩文・中文・English・日本语）朗读的语音。", "zh": "在「全部朗讀」中，也會一併朗讀詞義或例句翻譯。請在下方選擇要用目前語言模式（韓文・中文・English・日本語）朗讀的語音。", "en": "\"Read All\" also reads the word's meaning or the sentence's translation aloud. Choose below which voice should read it in the current language mode (Korean/Chinese/English/Japanese).", "fr": "« Tout écouter » lit également le sens du mot ou la traduction de la phrase. Choisissez ci-dessous la voix correspondant à la langue de l'interface.", "de": "Beim Vorlesen wird auch die Bedeutung oder Übersetzung vorgelesen. Wählen Sie unten eine Stimme im aktuellen Sprachmodus aus.", "hu": "Az „Összes lejátszása” a szó jelentését vagy a mondat fordítását is felolvassa. Válassza ki alább a kívánt hangot.", "id": "Fitur 'Putar Semua' juga membacakan arti kata atau terjemahan kalimat. Pilih suara di bawah ini untuk membaca dalam mode bahasa saat ini.", "ja": "「全部読み上げ」では、単語の意味や文の訳も一緒に読み上げます。下で、現在の言語モード（韓国語・中国語・English・日本語）で読み上げる声を選んでください。", "pl": "Opcja „Odtwórz wszystko” odczytuje także znaczenie słowa lub tłumaczenie zdania. Wybierz poniżej głos dla bieżącego języka interfejsu."},
    "이 브라우저에서는 현재 언어 모드의 음성을 찾을 수 없어요. 뜻·해석 읽기는 기본 음성으로 재생을 시도합니다.": {"vi": "Không tìm thấy giọng đọc phù hợp với chế độ ngôn ngữ hiện tại trong trình duyệt này. Phần đọc nghĩa/bản dịch sẽ thử phát bằng giọng mặc định.", "cs": "V tomto prohlížeči nebyl nalezen hlas odpovídající aktuálnímu jazykovému režimu. Čtení významu/překladu se pokusí použít výchozí hlas.", "zh_cn": "此浏览器找不到符合目前语言模式的语音，词义、翻译朗读将尝试以预设语音播放。", "zh": "此瀏覽器找不到符合目前語言模式的語音，詞義、翻譯朗讀將嘗試以預設語音播放。", "en": "No voice matching the current language mode was found in this browser. Meaning/translation playback will be attempted with the default voice.", "fr": "Aucune voix correspondant à la langue de l'interface n'a été trouvée. Lecture de la traduction avec la voix par défaut.", "de": "In diesem Browser wurde keine Stimme für den aktuellen Sprachmodus gefunden. Die Bedeutung bzw. Übersetzung wird mit der Standardstimme abgespielt.", "hu": "Ebben a böngészőben nem található az aktuális nyelvi módnak megfelelő hang. A jelentés/fordítás felolvasása az alapértelmezett hanggal kísérli meg.", "id": "Tidak ada suara yang cocok dengan mode bahasa saat ini di browser ini. Pembacaan arti/terjemahan akan dicoba dengan suara default.", "ja": "このブラウザでは現在の言語モードに合う音声が見つかりません。意味・訳の読み上げはデフォルトの音声で再生を試みます。", "pl": "W tej przeglądarce nie znaleziono głosu dla bieżącego języka. Tłumaczenie zostanie odczytane głosem domyślnym."},
    "전체 듣기에서 베트남어 다음에 단어 뜻이나 문장 해석을 읽어줄 때 사용할 목소리를 선택하세요. (기기·브라우저에 설치된, 현재 언어 모드에 맞는 음성만 표시돼요)": {"vi": "Chọn giọng dùng để đọc nghĩa của từ hoặc bản dịch của câu ngay sau phần tiếng Việt khi \"Nghe tất cả\". (Chỉ hiển thị các giọng đã cài trên thiết bị/trình duyệt và phù hợp với chế độ ngôn ngữ hiện tại)", "cs": "Vyberte hlas pro čtení významu slova nebo překladu věty po vietnamštině při funkci „Přehrát vše“. (Zobrazují se pouze hlasy nainstalované v zařízení odpovídající aktuálnímu jazyku)", "zh_cn": "请选择「全部朗读」中，念完越南语后接着朗读词义或例句翻译时使用的语音。（仅显示装置、浏览器中已安装、符合目前语言模式的语音）", "zh": "請選擇「全部朗讀」中，唸完越南語後接著朗讀詞義或例句翻譯時使用的語音。（僅顯示裝置、瀏覽器中已安裝、符合目前語言模式的語音）", "en": "Choose the voice used to read the word's meaning or the sentence's translation right after the Vietnamese, during \"Read All\". (Only voices installed on your device/browser that match the current language mode are shown)", "fr": "Choisissez la voix qui lira la traduction après le vietnamien lors de l'écoute globale.", "de": "Wählen Sie die Stimme, die beim Vorlesen nach dem Vietnamesischen die Bedeutung oder Übersetzung vorliest. (Es werden nur Stimmen angezeigt, die zum aktuellen Sprachmodus passen)", "hu": "Válassza ki a vietnámi utáni jelentés/fordítás felolvasásához használandó hangot. (Csak a készülékre telepített, az aktuális nyelvi módnak megfelelő hangok jelennek meg)", "id": "Pilih suara yang digunakan untuk membaca arti kata atau terjemahan tepat setelah bahasa Vietnam saat 'Putar Semua'. (Hanya suara yang terpasang di perangkat yang cocok dengan mode bahasa saat ini yang ditampilkan)", "ja": "「全部読み上げ」でベトナム語の後に単語の意味や文の訳を読み上げる際に使う声を選んでください。（機器・ブラウザにインストール済みの、現在の言語モードに合う声のみ表示されます）", "pl": "Wybierz głos, który odczyta tłumaczenie po tekście wietnamskim podczas pełnego odtwarzania."},
    "여성 추정": {"vi": "có thể là giọng nữ", "cs": "Pravděpodobně žena", "zh_cn": "推测为女性", "zh": "推測為女性", "en": "likely female", "fr": "vraisemblablement femme", "de": "vermutlich weiblich", "hu": "Valószínűleg nő", "id": "Kemungkinan wanita", "ja": "女性と推定", "pl": "prawdopodobnie kobieta"},
    "남성 추정": {"vi": "có thể là giọng nam", "cs": "Pravděpodobně muž", "zh_cn": "推测为男性", "zh": "推測為男性", "en": "likely male", "fr": "vraisemblablement homme", "de": "vermutlich männlich", "hu": "Valószínűleg férfi", "id": "Kemungkinan pria", "ja": "男性と推定", "pl": "prawdopodobnie mężczyzna"},
    "한국어 뜻 가리고 연습하기": {"vi": "Luyện tập với nghĩa được ẩn", "cs": "Cvičit se skrytým významem", "zh_cn": "遮住中文意思来练习", "zh": "遮住中文意思來練習", "en": "Practice with the Meaning Hidden", "fr": "S'entraîner en masquant la traduction", "de": "Bedeutung verdecken und üben", "hu": "Gyakorlás a jelentés elrejtésével", "id": "Latihan dengan menyembunyikan arti", "ja": "日本語の意味を隠して練習する", "pl": "Ćwicz z ukrytym znaczeniem"},
    "상대": {"vi": "Người đối diện", "cs": "Druhá osoba", "zh_cn": "对方", "zh": "對方", "en": "Them", "fr": "Interlocuteur", "de": "Gegenüber", "hu": "Másik fél", "id": "Lawan bicara", "ja": "相手", "pl": "Rozmówca"},
    "문장 종류": {"vi": "Loại câu", "cs": "Druh věty", "zh_cn": "句子种类", "zh": "句子種類", "en": "Sentence Type", "fr": "Type de phrase", "de": "Satzart", "hu": "Mondatfajta", "id": "Jenis Kalimat", "ja": "文の種類", "pl": "Typ zdania"},
    "의문사 선택": {"vi": "Chọn từ để hỏi", "cs": "Výběr tázacího zájmena", "zh_cn": "选择疑问词", "zh": "選擇疑問詞", "en": "Choose a Wh-word", "fr": "Choisir un mot interrogatif", "de": "Fragewort auswählen", "hu": "Kérdőszó kiválasztása", "id": "Pilih Kata Tanya", "ja": "疑問詞を選択", "pl": "Wybierz zaimek pytający"},
    "접속어 (문장 앞에 붙는 연결어)": {"vi": "Từ nối (đặt trước câu)", "cs": "Spojka (spojovací výraz na začátku věty)", "zh_cn": "连接词（放在句子前面的连接语）", "zh": "連接詞（放在句子前面的連接語）", "en": "Connective (linking word before the sentence)", "fr": "Conjonction (mot de liaison en tête de phrase)", "de": "Bindewort (vorangestellte Konjunktion)", "hu": "Kötőszó (összekötő szó a mondat elején)", "id": "Konjungsi (kata hubung di awal kalimat)", "ja": "接続語（文頭につく接続語）", "pl": "Spójnik (słowo łączące na początku zdania)"},
    "사용 안 함": {"vi": "Không dùng", "cs": "Nepoužito", "zh_cn": "不使用", "zh": "不使用", "en": "Not used", "fr": "Non utilisé", "de": "Nicht verwendet", "hu": "Nincs használatban", "id": "Tidak digunakan", "ja": "使用しない", "pl": "Nie używaj"},
    "예: Sau khi": {"vi": "Ví dụ: Sau khi", "cs": "např. Sau khi", "zh_cn": "例：Sau khi", "zh": "例：Sau khi", "en": "e.g. Sau khi", "fr": "ex. : Sau khi", "de": "z. B. Sau khi", "hu": "pl. Sau khi", "id": "mis. Sau khi", "ja": "例：Sau khi", "pl": "np. Sau khi"},
    "예: 그 후에": {"vi": "Ví dụ: sau đó", "cs": "např. potom", "zh_cn": "例：之后", "zh": "例：之後", "en": "e.g. after that", "fr": "ex. : après cela", "de": "z. B. danach", "hu": "pl. azután", "id": "mis. setelah itu", "ja": "例：その後に", "pl": "np. potem, po tym"},
    "주어 (의문사 'ai(누가)'를 쓸 때처럼 주어가 필요 없으면 '사용 안 함')": {"vi": "Chủ ngữ (chọn \"Không dùng\" khi không cần chủ ngữ, như khi dùng từ để hỏi 'ai')", "cs": "Podmět (pokud není potřeba, jako u tázacího zájmena 'ai' (kdo), zvolte 'Nepoužito')", "zh_cn": "主语（像使用疑问词 'ai(谁)' 时那样不需要主语时，选「不使用」）", "zh": "主語（像使用疑問詞 'ai(誰)' 時那樣不需要主語時，選「不使用」）", "en": "Subject (choose \"Not used\" when no subject is needed, like when using the wh-word 'ai' (who))", "fr": "Sujet (choisissez « Non utilisé » si aucun sujet n'est nécessaire, ex. avec « ai » [qui])", "de": "Subjekt (wenn kein Subjekt benötigt wird, wählen Sie „Nicht verwendet“)", "hu": "Alany (ha nincs szükség alanyra, például az 'ai' (ki) kérdőszónál, válassza a 'Nincs használatban' opciót)", "id": "Subjek (pilih 'Tidak digunakan' jika tidak perlu subjek, seperti kata tanya 'ai' (siapa))", "ja": "主語（疑問詞「ai（誰）」を使うときのように主語が要らない場合は「使用しない」）", "pl": "Podmiot (wybierz „Nie używaj”, gdy podmiot nie jest potrzebny, np. przy zaimku 'ai' [kto])"},
    "예: học viên mới": {"vi": "Ví dụ: học viên mới", "cs": "např. học viên mới", "zh_cn": "例：học viên mới", "zh": "例：học viên mới", "en": "e.g. học viên mới", "fr": "ex. : học viên mới", "de": "z. B. học viên mới", "hu": "pl. học viên mới", "id": "mis. học viên mới", "ja": "例：học viên mới", "pl": "np. học viên mới"},
    "예: 새 학습자": {"vi": "Ví dụ: học viên mới", "cs": "např. nový student", "zh_cn": "例：新学习者", "zh": "例：新學習者", "en": "e.g. new student", "fr": "ex. : nouvel étudiant de la Bible", "de": "z. B. neuer Bibelschüler", "hu": "pl. új tanuló", "id": "mis. pelajar baru", "ja": "例：新しい学習者", "pl": "np. nowy zainteresowany"},
    "보조동사": {"vi": "Trợ động từ", "cs": "Pomocné sloveso", "zh_cn": "辅助动词", "zh": "輔助動詞", "en": "Auxiliary Verb", "fr": "Verbe auxiliaire / Modal", "de": "Hilfsverb / Modalverb", "hu": "Segédige", "id": "Kata Kerja Bantu", "ja": "補助動詞", "pl": "Czasownik posiłkowy / modalny"},
    "직접 입력": {"vi": "Tự nhập", "cs": "Vlastní zadání", "zh_cn": "手动输入", "zh": "手動輸入", "en": "Custom input", "fr": "Saisie personnalisée", "de": "Eigene Eingabe", "hu": "Egyéni bevitel", "id": "Input manual", "ja": "直接入力", "pl": "Wpisz własny"},
    "예: định": {"vi": "Ví dụ: định", "cs": "např. định", "zh_cn": "例：định", "zh": "例：định", "en": "e.g. định", "fr": "ex. : định", "de": "z. B. định", "hu": "pl. định", "id": "contoh: định", "ja": "例：định", "pl": "np. định"},
    "예: ~할 예정이다": {"vi": "Ví dụ: định ~", "cs": "např. plánovat dělat ~", "zh_cn": "例：打算~", "zh": "例：打算~", "en": "e.g. plan to ~", "fr": "ex. : avoir l'intention de ~", "de": "z. B. vorhaben zu ~", "hu": "pl. tervezi, hogy ~", "id": "contoh: berencana untuk ~", "ja": "例：~する予定だ", "pl": "np. planować ~"},
    "뜻 패턴: ~하고 싶다": {"vi": "Mẫu nghĩa: muốn ~", "cs": "Vzorec významu: chtít ~", "zh_cn": "意思模式：想要~", "zh": "意思模式：想要~", "en": "Meaning pattern: want to ~", "fr": "Modèle de sens : vouloir ~", "de": "Bedeutungsmuster: möchten ~", "hu": "Jelentésminta: szeretne ~", "id": "Pola arti: ingin ~", "ja": "意味パターン：~したい", "pl": "Wzorzec znaczeniowy: chcieć ~"},
    "~해야 하다": {"vi": "phải ~", "cs": "muset dělat ~", "zh_cn": "必须~", "zh": "必須~", "en": "must ~", "fr": "devoir ~", "de": "müssen ~", "hu": "kell csinálni ~", "id": "harus melakukan ~", "ja": "~しなければならない", "pl": "musieć ~"},
    "~할 수 있다": {"vi": "có thể ~", "cs": "moci dělat ~", "zh_cn": "能~", "zh": "能~", "en": "can ~", "fr": "pouvoir ~", "de": "können ~", "hu": "tud csinálni ~", "id": "bisa melakukan ~", "ja": "~することができる", "pl": "móc / potrafić ~"},
    "~할 수 없다": {"vi": "không thể ~", "cs": "nemoci dělat ~", "zh_cn": "不能~", "zh": "不能~", "en": "cannot ~", "fr": "ne pas pouvoir ~", "de": "nicht können ~", "hu": "nem tud csinálni ~", "id": "tidak bisa melakukan ~", "ja": "~することができない", "pl": "nie móc ~"},
    "~하는 게 좋다": {"vi": "nên ~", "cs": "je lepší dělat ~", "zh_cn": "最好~", "zh": "最好~", "en": "should ~", "fr": "il vaut mieux ~", "de": "sollten ~", "hu": "jobb, ha ~", "id": "sebaiknya ~", "ja": "~したほうがいい", "pl": "lepiej zrobić ~"},
    "~할 것이다(미래)": {"vi": "sẽ ~ (tương lai)", "cs": "bude dělat (budoucnost)", "zh_cn": "将要~（未来）", "zh": "將要~（未來）", "en": "will ~ (future)", "fr": "futur (va ~ / fera ~)", "de": "werden ~ (Zukunft)", "hu": "fog csinálni (jövő idő)", "id": "akan (masa depan)", "ja": "~するだろう（未来）", "pl": "czas przyszły (będzie ~)"},
    "~했다(과거)": {"vi": "đã ~ (quá khứ)", "cs": "dělal (minulost)", "zh_cn": "~了（过去）", "zh": "~了（過去）", "en": "~ed (past)", "fr": "passé (a fait ~)", "de": "hat ~t (Vergangenheit)", "hu": "csinált (múlt idő)", "id": "sudah melakukan (lampau)", "ja": "~した（過去）", "pl": "czas przeszły (zrobił ~)"},
    "~하는 중이다": {"vi": "đang ~", "cs": "právě dělat ~", "zh_cn": "正在~", "zh": "正在~", "en": "be ~ing", "fr": "en train de ~", "de": "gerade dabei sein zu ~", "hu": "éppen csinál ~", "id": "sedang melakukan ~", "ja": "~している", "pl": "w trakcie robienia ~"},
    "~할 필요가 있다": {"vi": "cần ~", "cs": "je třeba dělat ~", "zh_cn": "需要~", "zh": "需要~", "en": "need to ~", "fr": "avoir besoin de ~", "de": "brauchen zu ~", "hu": "szükséges csinálni ~", "id": "perlu melakukan ~", "ja": "~する必要がある", "pl": "potrzebować ~"},
    "~하는 것을 좋아하다": {"vi": "thích ~", "cs": "rád dělat ~", "zh_cn": "喜欢~", "zh": "喜歡~", "en": "like to ~", "fr": "aimer ~", "de": "gerne tun ~", "hu": "szeret csinálni ~", "id": "suka melakukan ~", "ja": "~するのが好き", "pl": "lubić robić ~"},
    "~해라(명령)": {"vi": "hãy ~ (mệnh lệnh)", "cs": "dělej! (rozkaz)", "zh_cn": "~吧（命令）", "zh": "~吧（命令）", "en": "~! (imperative)", "fr": "impératif (fais ~ !)", "de": "Mach ~! (Befehl)", "hu": "csináld! (felszólítás)", "id": "lakukan! (perintah)", "ja": "~しなさい（命令）", "pl": "tryb rozkazujący (zrób ~!)"},
    "가장 뜻이 비슷한 패턴을 골라야 문장이 올바르게 만들어져요.": {"vi": "Hãy chọn mẫu có nghĩa gần nhất để câu được tạo đúng.", "cs": "Vyberte vzor s nejbližším významem, aby se věta vytvořila správně.", "zh_cn": "要选择意思最相近的模式，句子才会正确生成。", "zh": "要選擇意思最相近的模式，句子才會正確生成。", "en": "Pick the pattern closest in meaning so the sentence is generated correctly.", "fr": "Choisissez le modèle le plus proche du sens souhaité pour que la phrase soit générée correctement.", "de": "Wählen Sie das Muster mit der ähnlichsten Bedeutung, damit der Satz korrekt gebildet wird.", "hu": "Válassza a jelentésben legközelebbi mintát, hogy a mondat helyesen jöjjön létre.", "id": "Pilih pola yang maknanya paling mirip agar kalimat terbentuk dengan benar.", "ja": "意味が一番近いパターンを選ぶと、正しい文が作られます。", "pl": "Wybierz wzorzec najbliższy znaczeniowo, aby zdanie zostało utworzone poprawnie."},
    "동사 (베트남어는 형용사만으로도 문장이 완성돼요. 예: Trời lạnh. 날씨가 춥다.)": {"vi": "Động từ (tiếng Việt có thể tạo câu hoàn chỉnh chỉ với tính từ. Ví dụ: Trời lạnh.)", "cs": "Sloveso (ve vietnamštině může větu tvořit i samotné přídavné jméno. Např. Trời lạnh. — Je zima.)", "zh_cn": "动词（越南语光用形容词也能完成句子。例：Trời lạnh. 天气冷。）", "zh": "動詞（越南語光用形容詞也能完成句子。例：Trời lạnh. 天氣冷。）", "en": "Verb (Vietnamese can form a complete sentence with just an adjective. e.g. Trời lạnh. — It's cold.)", "fr": "Verbe (en vietnamien, un adjectif suffit souvent à former une phrase complète, ex. : Trời lạnh. — Il fait froid.)", "de": "Verb (im Vietnamesischen reicht oft schon ein Adjektiv für einen vollständigen Satz, z. B. Trời lạnh. — Das Wetter ist kalt.)", "hu": "Ige (a vietnámiban a mondat pusztán melléknévvel is teljes lehet. Pl. Trời lạnh. — Hideg van.)", "id": "Kata kerja (bahasa Vietnam dapat membentuk kalimat hanya dengan kata sifat. Contoh: Trời lạnh. — Cuaca dingin.)", "ja": "動詞（ベトナム語は形容詞だけでも文が完成します。例：Trời lạnh. 天気が寒い。）", "pl": "Czasownik (w wietnamskim sam przymiotnik może tworzyć pełne zdanie, np. Trời lạnh. — Jest zimno.)"},
    "사용 안 함 (형용사만으로 문장 완성)": {"vi": "Không dùng (câu hoàn chỉnh chỉ với tính từ)", "cs": "Nepoužito (věta tvořena pouze přídavným jménem)", "zh_cn": "不使用（只用形容词完成句子）", "zh": "不使用（只用形容詞完成句子）", "en": "Not used (sentence completed with adjective only)", "fr": "Non utilisé (phrase formée avec l'adjectif seul)", "de": "Nicht verwendet (Satz nur mit Adjektiv)", "hu": "Nincs használatban (a mondat csak melléknévvel egészül ki)", "id": "Tidak digunakan (kalimat lengkap hanya dengan kata sifat)", "ja": "使用しない（形容詞だけで文を完成）", "pl": "Nie używaj (zdanie tylko z przymiotnikiem)"},
    "예: nấu": {"vi": "Ví dụ: nấu", "cs": "např. nấu", "zh_cn": "例：nấu", "zh": "例：nấu", "en": "e.g. nấu", "fr": "ex. : nấu", "de": "z. B. nấu", "hu": "pl. nấu", "id": "contoh: nấu", "ja": "例：nấu", "pl": "np. nấu"},
    "사전형, 예: 요리하다": {"vi": "dạng nguyên thể, ví dụ: 요리하다", "cs": "základní tvar, např. vařit", "zh_cn": "辞典形，例：요리하다", "zh": "辭典形，例：요리하다", "en": "dictionary form, e.g. 요리하다", "fr": "forme du dictionnaire, ex. : cuisiner", "de": "Grundform, z. B. kochen", "hu": "szótári alak, pl. főz", "id": "bentuk kamus, misal: memasak", "ja": "辞書形、例：요리하다", "pl": "forma słownikowa, np. gotować"},
    "자동사 (목적어 없음)": {"vi": "Nội động từ (không có tân ngữ)", "cs": "Nepřechodné (bez předmětu)", "zh_cn": "不及物动词（无受词）", "zh": "不及物動詞（無受詞）", "en": "Intransitive (no object)", "fr": "Intransitif (sans complément d'objet)", "de": "Intransitiv (kein Objekt)", "hu": "Tárgyatlan (nincs tárgy)", "id": "Intransitif (tanpa objek)", "ja": "自動詞（目的語なし）", "pl": "Nieprzechodni (bez dopełnienia)"},
    "타동사 (목적어 있음)": {"vi": "Ngoại động từ (có tân ngữ)", "cs": "Přechodné (s předmětem)", "zh_cn": "及物动词（有受词）", "zh": "及物動詞（有受詞）", "en": "Transitive (has object)", "fr": "Transitif (avec complément d'objet)", "de": "Transitiv (mit Objekt)", "hu": "Tárgyas (van tárgy)", "id": "Transitif (dengan objek)", "ja": "他動詞（目的語あり）", "pl": "Przechodni (z dopełnieniem)"},
    "과거형(선택, 비우면 자동생성) 예: 요리했": {"vi": "dạng quá khứ (tùy chọn, để trống sẽ tự tạo) ví dụ: 요리했", "cs": "minulý čas (volitelné, generuje se automaticky)", "zh_cn": "过去式（可选，留空则自动生成）例：요리했", "zh": "過去式（可選，留空則自動生成）例：요리했", "en": "past form (optional, auto-generated if left blank) e.g. 요리했", "fr": "forme passée (facultatif), ex. : a cuisiné", "de": "Vergangenheitsform (optional), z. B. kochte", "hu": "múlt idő (választható, automatikus)", "id": "bentuk lampau (opsional, otomatis jika kosong)", "ja": "過去形（任意、空欄なら自動生成）例：요리했", "pl": "forma przeszła (opcjonalnie), np. gotował"},
    "목적어 (타동사를 골랐을 때만 적용돼요)": {"vi": "Tân ngữ (chỉ áp dụng khi chọn ngoại động từ)", "cs": "Předmět (platí pouze při volbě přechodného slovesa)", "zh_cn": "受词（只有选了及物动词才会套用）", "zh": "受詞（只有選了及物動詞才會套用）", "en": "Object (applies only when a transitive verb is chosen)", "fr": "Objet (s'applique uniquement avec un verbe transitif)", "de": "Objekt (nur bei transitiven Verben wirksam)", "hu": "Tárgy (csak tárgyas ige választása esetén érvényes)", "id": "Objek (hanya berlaku jika kata kerja transitif dipilih)", "ja": "目的語（他動詞を選んだときのみ適用）", "pl": "Dopełnienie (dotyczy tylko czasowników przechodnich)"},
    "예: bức thư": {"vi": "Ví dụ: bức thư", "cs": "např. bức thư", "zh_cn": "例：bức thư", "zh": "例：bức thư", "en": "e.g. bức thư", "fr": "ex. : bức thư", "de": "z. B. bức thư", "hu": "pl. bức thư", "id": "mis. bức thư", "ja": "例：bức thư", "pl": "np. bức thư"},
    "예: 편지": {"vi": "Ví dụ: lá thư", "cs": "např. dopis", "zh_cn": "例：信", "zh": "例：信", "en": "e.g. letter", "fr": "ex. : lettre", "de": "z. B. Brief", "hu": "pl. levél", "id": "mis. surat", "ja": "例：手紙", "pl": "np. list"},
    "명사 (동사로 'là(이다)'를 골랐을 때, 주어를 설명하는 명사예요: 주어+là+명사)": {"vi": "Danh từ (khi chọn động từ 'là', đây là danh từ mô tả chủ ngữ: chủ ngữ + là + danh từ)", "cs": "Podstatné jméno (při volbě slovesa 'là' (být) toto jméno popisuje podmět: podmět + là + jméno)", "zh_cn": "名词（选了动词 'là(是)' 时，用来说明主语的名词：主语+là+名词）", "zh": "名詞（選了動詞 'là(是)' 時，用來說明主語的名詞：主語+là+名詞）", "en": "Noun (when the verb 'là' (be) is chosen, this noun describes the subject: subject + là + noun)", "fr": "Nom (avec le verbe « là » [être], nom attribut du sujet : sujet + là + nom)", "de": "Nomen (wenn als Verb „là“ (sein) gewählt wurde: Subjekt + là + Nomen)", "hu": "Főnév (ha a 'là' (lenni) igét választja, ez a főnév írja le az alanyt: alany + là + főnév)", "id": "Kata benda (ketika kata kerja 'là' (adalah) dipilih, kata benda ini menerangkan subjek: subjek + là + kata benda)", "ja": "名詞（動詞「là（だ）」を選んだとき、主語を説明する名詞：主語+là+名詞）", "pl": "Rzeczownik (przy czasowniku „là” [być]: podmiot + là + rzeczownik)"},
    "예: người tiên phong": {"vi": "Ví dụ: người tiên phong", "cs": "např. người tiên phong", "zh_cn": "例：người tiên phong", "zh": "例：người tiên phong", "en": "e.g. người tiên phong", "fr": "ex. : người tiên phong", "de": "z. B. người tiên phong", "hu": "pl. người tiên phong", "id": "mis. người tiên phong", "ja": "例：người tiên phong", "pl": "np. người tiên phong"},
    "예: 파이오니아": {"vi": "Ví dụ: người tiên phong", "cs": "např. průkopník", "zh_cn": "例：先锋", "zh": "例：先鋒", "en": "e.g. pioneer", "fr": "ex. : pionnier", "de": "z. B. Pionier", "hu": "pl. úttörő", "id": "mis. perintis", "ja": "例：開拓者", "pl": "np. pionier"},
    "전치사 (với 등)": {"vi": "Giới từ (với, v.v.)", "cs": "Předložka (với apod.)", "zh_cn": "介系词（với 等）", "zh": "介係詞（với 等）", "en": "Preposition (với etc.)", "fr": "Préposition (với etc.)", "de": "Präposition (với usw.)", "hu": "Elöljárószó (với stb.)", "id": "Preposisi (với dll.)", "ja": "前置詞（với など）", "pl": "Przyimek (với itd.)"},
    "예: với anh trai": {"vi": "Ví dụ: với anh trai", "cs": "např. với anh trai", "zh_cn": "例：với anh trai", "zh": "例：với anh trai", "en": "e.g. với anh trai", "fr": "ex. : với anh trai", "de": "z. B. với anh trai", "hu": "pl. với anh trai", "id": "mis. với anh trai", "ja": "例：với anh trai", "pl": "np. với anh trai"},
    "예: 형과": {"vi": "Ví dụ: với anh trai", "cs": "např. se starším bratrem", "zh_cn": "例：跟哥哥", "zh": "例：跟哥哥", "en": "e.g. with older brother", "fr": "ex. : avec le grand frère", "de": "z. B. mit dem älteren Bruder", "hu": "pl. a bátyámmal", "id": "mis. dengan kakak laki-laki", "ja": "例：兄と", "pl": "np. ze starszym bratem"},
    "형용사 (목적어·명사가 있으면 그것을, 없으면 명사 주어를 꾸며요)": {"vi": "Tính từ (bổ nghĩa cho tân ngữ/danh từ nếu có, nếu không thì bổ nghĩa cho chủ ngữ là danh từ)", "cs": "Přídavné jméno (rozvíjí předmět/podstatné jméno, jinak podmět)", "zh_cn": "形容词（若有受词·名词就修饰它，没有的话就修饰名词主语）", "zh": "形容詞（若有受詞·名詞就修飾它，沒有的話就修飾名詞主語）", "en": "Adjective (modifies the object/noun if present, otherwise the noun subject)", "fr": "Adjectif (qualifie l'objet/le nom, ou le sujet nominal sinon)", "de": "Adjektiv (beschreibt das Objekt/Nomen oder das Subjekt)", "hu": "Melléknév (a tárgyat/főnevet módosítja, ha van, egyébként az alanyt)", "id": "Kata sifat (menerangkan objek/kata benda jika ada, jika tidak menerangkan subjek)", "ja": "形容詞（目的語・名詞があればそれを、なければ名詞主語を修飾）", "pl": "Przymiotnik (określa dopełnienie/rzeczownik lub podmiot)"},
    "예: vui": {"vi": "Ví dụ: vui", "cs": "např. vui", "zh_cn": "例：vui", "zh": "例：vui", "en": "e.g. vui", "fr": "ex. : vui", "de": "z. B. vui", "hu": "pl. vui", "id": "contoh: vui", "ja": "例：vui", "pl": "np. vui"},
    "사전형, 예: 기쁘다": {"vi": "dạng nguyên thể, ví dụ: 기쁘다", "cs": "základní tvar, např. mít radost", "zh_cn": "辞典形，例：기쁘다", "zh": "辭典形，例：기쁘다", "en": "dictionary form, e.g. 기쁘다", "fr": "forme du dictionnaire, ex. : être joyeux", "de": "Grundform, z. B. erfreut sein", "hu": "szótári alak, pl. örül", "id": "bentuk kamus, misal: senang", "ja": "辞書形、例：기쁘다", "pl": "forma słownikowa, np. radosny"},
    "관형사형(선택) 예: 기쁜": {"vi": "dạng định ngữ (tùy chọn) ví dụ: 기쁜", "cs": "přívlastkový tvar (volitelné)", "zh_cn": "冠形词形（可选）例：기쁜", "zh": "冠形詞形（可選）例：기쁜", "en": "attributive form (optional) e.g. 기쁜", "fr": "forme épithète (facultatif), ex. : joyeux", "de": "Attributiv (optional), z. B. erfreut", "hu": "melléknévi alak (választható)", "id": "bentuk atributif (opsional)", "ja": "連体形（任意）例：기쁜", "pl": "forma przydawkowa (opcjonalnie), np. radosny"},
    "과거형(선택) 예: 기뻤": {"vi": "dạng quá khứ (tùy chọn) ví dụ: 기뻤", "cs": "minulý čas (volitelné)", "zh_cn": "过去式（可选）例：기뻤", "zh": "過去式（可選）例：기뻤", "en": "past form (optional) e.g. 기뻤", "fr": "forme passée (facultatif), ex. : était joyeux", "de": "Vergangenheit (optional), z. B. war erfreut", "hu": "múlt idő (választható)", "id": "bentuk lampau (opsional)", "ja": "過去形（任意）例：기뻤", "pl": "forma przeszła (opcjonalnie), np. był radosny"},
    "상태부사 (어떻게)": {"vi": "Trạng từ chỉ cách thức (như thế nào)", "cs": "Příslovce způsobu (jak)", "zh_cn": "状态副词（怎么样）", "zh": "狀態副詞（怎麼樣）", "en": "Adverb of manner (how)", "fr": "Adverbe de manière (comment)", "de": "Modaladverb (wie)", "hu": "Módhatározó (hogyan)", "id": "Keterangan cara (bagaimana)", "ja": "様態副詞（どのように）", "pl": "Przysłówek sposobu (jak)"},
    "예: lặng lẽ": {"vi": "Ví dụ: lặng lẽ", "cs": "např. lặng lẽ", "zh_cn": "例：lặng lẽ", "zh": "例：lặng lẽ", "en": "e.g. lặng lẽ", "fr": "ex. : lặng lẽ", "de": "z. B. lặng lẽ", "hu": "pl. lặng lẽ", "id": "mis. lặng lẽ", "ja": "例：lặng lẽ", "pl": "np. lặng lẽ"},
    "예: 조용히": {"vi": "Ví dụ: lặng lẽ", "cs": "např. tiše", "zh_cn": "例：安静地", "zh": "例：安靜地", "en": "e.g. quietly", "fr": "ex. : silencieusement", "de": "z. B. leise", "hu": "pl. csendben", "id": "mis. diam-diam", "ja": "例：静かに", "pl": "np. cicho"},
    "장소부사 (어디에서·어디로) — 장소 명사만 입력하면 동사에 맞는 ở/đến이 자동으로 붙어요": {"vi": "Trạng từ chỉ nơi chốn (ở đâu / đến đâu) — chỉ cần nhập danh từ chỉ nơi chốn, ở/đến sẽ tự động được thêm vào cho phù hợp với động từ", "cs": "Příslovce místa (kde/kam) — stačí zadat název místa, ở/đến se doplní automaticky podle slovesa", "zh_cn": "地点副词（在哪里·去哪里）— 只要输入地点名词，系统会依动词自动加上 ở/đến", "zh": "地點副詞（在哪裡·去哪裡）— 只要輸入地點名詞，系統會依動詞自動加上 ở/đến", "en": "Place adverb (where at / where to) — just enter the place noun; ở/đến is added automatically to match the verb", "fr": "Adverbe de lieu (où / vers où) — saisissez seulement le nom de lieu ; ở/đến s'ajoute automatiquement selon le verbe", "de": "Lokaladverb (wo/wohin) — geben Sie nur das Ortsnomen ein; ở/đến wird passend zum Verb ergänzt", "hu": "Helyhatározó (hol/hová) — csak írja be a helyet, az ở/đến automatikusan illeszkedik az igéhez", "id": "Keterangan tempat (di mana / ke mana) — cukup masukkan tempat, ở/đến otomatis disesuaikan dengan kata kerja", "ja": "場所副詞（どこで・どこへ）— 場所の名詞だけ入力すれば、動詞に合わせて ở/đến が自動で付きます", "pl": "Przysłówek miejsca (gdzie/dokąd) — wpisz tylko nazwę miejsca; ở/đến doda się automatycznie"},
    "장소 명사만, 예: thư viện": {"vi": "chỉ danh từ chỉ nơi chốn, ví dụ: thư viện", "cs": "pouze podstatné jméno místa, např. thư viện", "zh_cn": "只要地点名词，例：thư viện", "zh": "只要地點名詞，例：thư viện", "en": "place noun only, e.g. thư viện", "fr": "nom de lieu seul, ex. : thư viện", "de": "Nur das Ortsnomen, z. B. thư viện", "hu": "csak helyet jelölő főnév, pl. thư viện", "id": "hanya kata benda tempat, mis. thư viện", "ja": "場所の名詞だけ、例：thư viện", "pl": "sama nazwa miejsca, np. thư viện"},
    "예: 도서관": {"vi": "Ví dụ: thư viện", "cs": "např. knihovna", "zh_cn": "例：图书馆", "zh": "例：圖書館", "en": "e.g. library", "fr": "ex. : bibliothèque", "de": "z. B. Bibliothek", "hu": "pl. könyvtár", "id": "mis. perpustakaan", "ja": "例：図書館", "pl": "np. biblioteka"},
    "시간부사 (언제)": {"vi": "Trạng từ chỉ thời gian (khi nào)", "cs": "Příslovce času (kdy)", "zh_cn": "时间副词（何时）", "zh": "時間副詞（何時）", "en": "Adverb of time (when)", "fr": "Adverbe de temps (quand)", "de": "Temporaladverb (wann)", "hu": "Időhatározó (mikor)", "id": "Keterangan waktu (kapan)", "ja": "時間副詞（いつ）", "pl": "Przysłówek czasu (kiedy)"},
    "예: tuần sau": {"vi": "Ví dụ: tuần sau", "cs": "např. tuần sau", "zh_cn": "例：tuần sau", "zh": "例：tuần sau", "en": "e.g. tuần sau", "fr": "ex. : tuần sau", "de": "z. B. tuần sau", "hu": "pl. tuần sau", "id": "mis. tuần sau", "ja": "例：tuần sau", "pl": "np. tuần sau"},
    "예: 다음 주": {"vi": "Ví dụ: tuần sau", "cs": "např. příští týden", "zh_cn": "例：下周", "zh": "例：下週", "en": "e.g. next week", "fr": "ex. : la semaine prochaine", "de": "z. B. nächste Woche", "hu": "pl. jövő héten", "id": "mis. minggu depan", "ja": "例：来週", "pl": "np. w przyszłym tygodniu"},
    "자동사": {"vi": "Nội động từ", "cs": "Nepřechodné sloveso", "zh_cn": "不及物动词", "zh": "不及物動詞", "en": "Intransitive", "fr": "Intransitif", "de": "Intransitiv", "hu": "Tárgyatlan ige", "id": "Intransitif", "ja": "自動詞", "pl": "Czasownik nieprzechodni"},
    "타동사": {"vi": "Ngoại động từ", "cs": "Přechodné sloveso", "zh_cn": "及物动词", "zh": "及物動詞", "en": "Transitive", "fr": "Transitif", "de": "Transitiv", "hu": "Tárgyas ige", "id": "Transitif", "ja": "他動詞", "pl": "Czasownik przechodni"},
    "대명사": {"vi": "Đại từ", "cs": "Zájmeno", "zh_cn": "代名词", "zh": "代名詞", "en": "Pronoun", "fr": "Pronom", "de": "Pronomen", "hu": "Névmás", "id": "Kata Ganti", "ja": "代名詞", "pl": "Zaimek"},
    "명사": {"vi": "Danh từ", "cs": "Podstatné jméno", "zh_cn": "名词", "zh": "名詞", "en": "Noun", "fr": "Nom", "de": "Nomen", "hu": "Főnév", "id": "Kata Benda", "ja": "名詞", "pl": "Rzeczownik"},
    "직접 입력한 동사·형용사·보조동사는 활용이 적용되지 않고, 입력한 뜻 그대로 문장에 표시돼요.": {"vi": "Động từ, tính từ và trợ động từ tự nhập sẽ không được chia, mà hiển thị trong câu đúng như nghĩa bạn đã nhập.", "cs": "Vlastní slovesa, přídavná jména a pomocná slovesa se neskloňují ani nečasují — ve větě se zobrazí přesně tak, jak jste význam napsali.", "zh_cn": "手动输入的动词·形容词·辅助动词不会套用词形变化，会直接以您输入的意思显示在句子里。", "zh": "手動輸入的動詞·形容詞·輔助動詞不會套用詞形變化，會直接以您輸入的意思顯示在句子裡。", "en": "Custom verbs, adjectives, and auxiliary verbs are not conjugated — they appear in the sentence exactly as the meaning you typed.", "fr": "Les verbes, adjectifs et modaux saisis manuellement ne sont pas fléchis et apparaissent exactement tels que saisis.", "de": "Selbst eingegebene Verben, Adjektive und Modalverben werden nicht gebeugt, sondern genau wie eingegeben im Satz angezeigt.", "hu": "A saját maga által megadott igék, melléknevek és segédigék nem ragozódnak — pontosan úgy jelennek meg a mondatban, ahogy a jelentést beírta.", "id": "Kata kerja, kata sifat, dan kata kerja bantu yang diketik sendiri tidak dikonjugasikan — ditampilkan dalam kalimat persis seperti makna yang Anda ketik.", "ja": "直接入力した動詞・形容詞・補助動詞には活用が適用されず、入力した意味がそのまま文に表示されます。", "pl": "Wpisane własne czasowniki, przymiotniki i modale nie podlegają odmianie i pojawiają się dokładnie w podanej formie."},
    "가족 호칭 가계도": {"vi": "Cây gia đình và cách xưng hô", "cs": "Rodokmen rodinných oslovení", "zh_cn": "家族称谓家谱图", "zh": "家族稱謂家譜圖", "en": "Family Address-Term Tree", "fr": "Arbre généalogique des termes de parenté", "de": "Stammbaum der familiären Anredeformen", "hu": "Családi megszólítások fája", "id": "Bagan Sebutan Keluarga", "ja": "家族の呼び方系図", "pl": "Drzewo genealogiczne form pokrewieństwa"},
    "직계 4대(증조부모~증손주)와 혼인으로 맺어지는 사돈 쪽 호칭을 하나의 가계도로 정리했어요.": {"vi": "Một cây gia đình gồm bốn thế hệ trực hệ (từ ông bà cố đến chắt) cùng cách xưng hô với họ hàng bên thông gia.", "cs": "Přehledný rodokmen pokrývající čtyři přímé generace (od pradraodičů po pravnoučata) a příbuzenské vztahy vzniklé sňatkem.", "zh_cn": "把直系四代（曾祖父母~曾孙）以及因婚姻而形成的亲家称谓整理成一张家谱图。", "zh": "把直系四代（曾祖父母~曾孫）以及因婚姻而形成的親家稱謂整理成一張家譜圖。", "en": "One family tree covering four direct generations (great-grandparents to great-grandchildren) plus the in-law terms that come with marriage.", "fr": "Un arbre généalogique complet couvrant 4 générations directes (des arrière-grands-parents aux arrière-petits-enfants) ainsi que les liens par alliance.", "de": "Ein Stammbaum über 4 Generationen (Urgroßeltern bis Urenkel) samt angeheirateten Verwandten.", "hu": "Egyetlen családfa, amely négy közvetlen generációt (dédszülőktől a dédunokákig) és a házassággal létrejött rokoni megszólításokat mutatja be.", "id": "Satu bagan silsilah keluarga yang mencakup empat generasi langsung (buyut hingga cicit) serta sebutan kekerabatan melalui pernikahan.", "ja": "直系四代（曾祖父母~ひ孫）と、結婚によってできる姻戚の呼び方を一つの家系図にまとめました。", "pl": "Jedno drzewo genealogiczne obejmujące 4 pokolenia w linii prostej (od pradziadków do prawnuków) oraz powinowatych."},
    "혼인으로 맺어지는 사돈 쪽 호칭": {"vi": "Cách xưng hô với họ hàng qua hôn nhân", "cs": "Příbuzenská oslovení vzniklá sňatkem", "zh_cn": "因婚姻而形成的亲家称谓", "zh": "因婚姻而形成的親家稱謂", "en": "In-law terms formed through marriage", "fr": "Termes de parenté par alliance (beaux-parents, belle-famille)", "de": "Angeheiratete Verwandtschaft", "hu": "Házasság révén létrejött rokoni megszólítások", "id": "Sebutan kekerabatan yang terbentuk melalui pernikahan", "ja": "結婚で結ばれる姻戚の呼び方", "pl": "Nazwy pokrewieństwa przez małżeństwo (powinowaci)"},
    "증조부모": {"vi": "Ông bà cố", "cs": "Praprarodiče", "zh_cn": "曾祖父母", "zh": "曾祖父母", "en": "Great-grandparents", "fr": "Arrière-grands-parents", "de": "Urgroßeltern", "hu": "Dédszülők", "id": "Kakek-nenek buyut", "ja": "曾祖父母", "pl": "Pradziadkowie"},
    "조부모": {"vi": "Ông bà", "cs": "Prarodiče", "zh_cn": "祖父母", "zh": "祖父母", "en": "Grandparents", "fr": "Grands-parents", "de": "Großeltern", "hu": "Nagyszülők", "id": "Kakek-nenek", "ja": "祖父母", "pl": "Dziadkowie"},
    "부모": {"vi": "Bố mẹ", "cs": "Rodiče", "zh_cn": "父母", "zh": "父母", "en": "Parents", "fr": "Parents", "de": "Eltern", "hu": "Szülők", "id": "Orang tua", "ja": "両親", "pl": "Rodzice"},
    "나·형제자매·배우자": {"vi": "Tôi, anh chị em và vợ/chồng", "cs": "Já, sourozenci a manžel/ka", "zh_cn": "我‧兄弟姊妹‧配偶", "zh": "我‧兄弟姊妹‧配偶", "en": "Me, siblings & spouse", "fr": "Moi, frères et sœurs, conjoint", "de": "Ich, Geschwister & Ehepartner", "hu": "Én, testvérek és házastárs", "id": "Saya, saudara kandung & pasangan", "ja": "私・兄弟姉妹・配偶者", "pl": "Ja, rodzeństwo i współmałżonek"},
    "자녀": {"vi": "Con", "cs": "Děti", "zh_cn": "子女", "zh": "子女", "en": "Children", "fr": "Enfants", "de": "Kinder", "hu": "Gyermekek", "id": "Anak", "ja": "子ども", "pl": "Dzieci"},
    "손주": {"vi": "Cháu", "cs": "Vnoučata", "zh_cn": "孙子女", "zh": "孫子女", "en": "Grandchildren", "fr": "Petits-enfants", "de": "Enkel", "hu": "Unokák", "id": "Cucu", "ja": "孫", "pl": "Wnuki"},
    "증손주": {"vi": "Chắt", "cs": "Pravnoučata", "zh_cn": "曾孙子女", "zh": "曾孫子女", "en": "Great-grandchildren", "fr": "Arrière-petits-enfants", "de": "Urenkel", "hu": "Dédunokák", "id": "Cicit", "ja": "ひ孫", "pl": "Prawnuki"},
    "친가(아버지 쪽)": {"vi": "Bên nội (bên bố)", "cs": "Otcovská strana", "zh_cn": "父系（父亲那边）", "zh": "父系（父親那邊）", "en": "Paternal side (father's side)", "fr": "Côté paternel", "de": "Väterlicherseits", "hu": "Apai ág", "id": "Pihak ayah", "ja": "父方（父の実家）", "pl": "Po mieczu (od strony ojca)"},
    "외가(어머니 쪽)": {"vi": "Bên ngoại (bên mẹ)", "cs": "Mateřská strana", "zh_cn": "母系（母亲那边）", "zh": "母系（母親那邊）", "en": "Maternal side (mother's side)", "fr": "Côté maternel", "de": "Mütterlicherseits", "hu": "Anyai ág", "id": "Pihak ibu", "ja": "母方（母の実家）", "pl": "Po kądzieli (od strony matki)"},
    "형제자매": {"vi": "Anh chị em", "cs": "Sourozenci", "zh_cn": "兄弟姊妹", "zh": "兄弟姊妹", "en": "Siblings", "fr": "Frères et sœurs", "de": "Geschwister", "hu": "Testvérek", "id": "Saudara kandung", "ja": "兄弟姉妹", "pl": "Rodzeństwo"},
    "배우자": {"vi": "Vợ/chồng", "cs": "Manžel/ka", "zh_cn": "配偶", "zh": "配偶", "en": "Spouse", "fr": "Conjoint", "de": "Ehepartner", "hu": "Házastárs", "id": "Pasangan", "ja": "配偶者", "pl": "Współmałżonek"},
    "며느리·사위": {"vi": "Con dâu · con rể", "cs": "Snacha a zeť", "zh_cn": "媳妇‧女婿", "zh": "媳婦‧女婿", "en": "Children's spouses", "fr": "Belle-fille / Gendre", "de": "Schwiegerkinder", "hu": "Meny és vő", "id": "Menantu", "ja": "嫁・婿", "pl": "Synowa / Zięć"},
    "친손(아들의 자녀)": {"vi": "Cháu nội (con của con trai)", "cs": "Vnoučata po synovi", "zh_cn": "孙（儿子的子女）", "zh": "孫（兒子的子女）", "en": "Grandchildren via son", "fr": "Petits-enfants (par le fils)", "de": "Enkel (über den Sohn)", "hu": "Unokák a fiú ágán", "id": "Cucu dari anak laki-laki", "ja": "息子の子（内孫）", "pl": "Wnuki (od syna)"},
    "외손(딸의 자녀)": {"vi": "Cháu ngoại (con của con gái)", "cs": "Vnoučata po dceři", "zh_cn": "外孙（女儿的子女）", "zh": "外孫（女兒的子女）", "en": "Grandchildren via daughter", "fr": "Petits-enfants (par la fille)", "de": "Enkel (über die Tochter)", "hu": "Unokák a lány ágán", "id": "Cucu dari anak perempuan", "ja": "娘の子（外孫）", "pl": "Wnuki (od córki)"},
    "친증손(아들 쪽 손주의 자녀)": {"vi": "Chắt nội (bên con trai)", "cs": "Pravnoučata po synově linii", "zh_cn": "曾孙（儿子那边孙子女的子女）", "zh": "曾孫（兒子那邊孫子女的子女）", "en": "Great-grandchildren via son's line", "fr": "Arrière-petits-enfants (lignée du fils)", "de": "Urenkel (Linie des Sohnes)", "hu": "Dédunokák a fiú ágán", "id": "Cicit dari garis anak laki-laki", "ja": "息子側のひ孫", "pl": "Prawnuki (z linii syna)"},
    "외증손(딸 쪽 손주의 자녀)": {"vi": "Chắt ngoại (bên con gái)", "cs": "Pravnoučata po dceřině linii", "zh_cn": "外曾孙（女儿那边孙子女的子女）", "zh": "外曾孫（女兒那邊孫子女的子女）", "en": "Great-grandchildren via daughter's line", "fr": "Arrière-petits-enfants (lignée de la fille)", "de": "Urenkel (Linie der Tochter)", "hu": "Dédunokák a lány ágán", "id": "Cicit dari garis anak perempuan", "ja": "娘側のひ孫", "pl": "Prawnuki (z linii córki)"},
    "배우자의 부모님": {"vi": "Bố mẹ của vợ/chồng", "cs": "Rodiče manžela/ky", "zh_cn": "配偶的父母", "zh": "配偶的父母", "en": "Spouse's parents", "fr": "Beaux-parents", "de": "Schwiegereltern", "hu": "A házastárs szülei", "id": "Orang tua pasangan", "ja": "配偶者の両親", "pl": "Teściowie"},
    "남편의 부모(아내 입장)": {"vi": "Bố mẹ chồng (theo cách gọi của vợ)", "cs": "Rodiče manžela (z pohledu manželky)", "zh_cn": "丈夫的父母（妻子的立场）", "zh": "丈夫的父母（妻子的立場）", "en": "Husband's parents (from the wife's side)", "fr": "Parents du mari (du point de vue de l'épouse)", "de": "Schwiegereltern (aus Sicht der Ehefrau)", "hu": "A férj szülei (a feleség szemszögéből)", "id": "Orang tua suami (dari sisi istri)", "ja": "夫の両親（妻の立場）", "pl": "Rodzice męża (z punktu widzenia żony)"},
    "아내의 부모(남편 입장)": {"vi": "Bố mẹ vợ (theo cách gọi của chồng)", "cs": "Rodiče manželky (z pohledu manžela)", "zh_cn": "妻子的父母（丈夫的立场）", "zh": "妻子的父母（丈夫的立場）", "en": "Wife's parents (from the husband's side)", "fr": "Parents de l'épouse (du point de vue du mari)", "de": "Schwiegereltern (aus Sicht des Ehemanns)", "hu": "A feleség szülei (a férj szemszögéből)", "id": "Orang tua istri (dari sisi suami)", "ja": "妻の両親（夫の立場）", "pl": "Rodzice żony (z punktu widzenia męża)"},
    "배우자의 형제자매": {"vi": "Anh chị em của vợ/chồng", "cs": "Sourozenci manžela/ky", "zh_cn": "配偶的兄弟姊妹", "zh": "配偶的兄弟姊妹", "en": "Spouse's siblings", "fr": "Beaux-frères et belles-sœurs", "de": "Geschwister des Ehepartners", "hu": "A házastárs testvérei", "id": "Saudara kandung pasangan", "ja": "配偶者の兄弟姉妹", "pl": "Rodzeństwo współmałżonka (szwagrowie/szwagierki)"},
    "남편의 형제자매(아내 입장)": {"vi": "Anh chị em chồng (theo cách gọi của vợ)", "cs": "Sourozenci manžela (z pohledu manželky)", "zh_cn": "丈夫的兄弟姊妹（妻子的立场）", "zh": "丈夫的兄弟姊妹（妻子的立場）", "en": "Husband's siblings (from the wife's side)", "fr": "Frères et sœurs du mari (du point de vue de l'épouse)", "de": "Schwäger/Schwägerinnen (aus Sicht der Ehefrau)", "hu": "A férj testvérei (a feleség szemszögéből)", "id": "Saudara kandung suami (dari sisi istri)", "ja": "夫の兄弟姉妹（妻の立場）", "pl": "Rodzeństwo męża (z punktu widzenia żony)"},
    "아내의 형제자매(남편 입장)": {"vi": "Anh chị em vợ (theo cách gọi của chồng)", "cs": "Sourozenci manželky (z pohledu manžela)", "zh_cn": "妻子的兄弟姊妹（丈夫的立场）", "zh": "妻子的兄弟姊妹（丈夫的立場）", "en": "Wife's siblings (from the husband's side)", "fr": "Frères et sœurs de l'épouse (du point de vue du mari)", "de": "Schwäger/Schwägerinnen (aus Sicht des Ehemanns)", "hu": "A feleség testvérei (a férj szemszögéből)", "id": "Saudara kandung istri (dari sisi suami)", "ja": "妻の兄弟姉妹（夫の立場）", "pl": "Rodzeństwo żony (z punktu widzenia męża)"},
    "형제자매의 배우자": {"vi": "Vợ/chồng của anh chị em", "cs": "Manželé/ky sourozenců", "zh_cn": "兄弟姊妹的配偶", "zh": "兄弟姊妹的配偶", "en": "Siblings' spouses", "fr": "Conjoints des frères et sœurs", "de": "Ehepartner der Geschwister", "hu": "A testvérek házastársai", "id": "Pasangan saudara kandung", "ja": "兄弟姉妹の配偶者", "pl": "Współmałżonkowie rodzeństwa"},
    "오빠·남동생의 아내": {"vi": "Vợ của anh/em trai", "cs": "Manželka staršího/mladšího bratra", "zh_cn": "哥哥‧弟弟的妻子", "zh": "哥哥‧弟弟的妻子", "en": "Older/younger brother's wife", "fr": "Épouse du frère (belle-sœur)", "de": "Ehefrau des Bruders (Schwägerin)", "hu": "A báty/öcs felesége", "id": "Istri kakak/adik laki-laki", "ja": "兄・弟の妻", "pl": "Żona brata (bratowa)"},
    "언니·여동생의 남편": {"vi": "Chồng của chị/em gái", "cs": "Manžel starší/mladší sestry", "zh_cn": "姊姊‧妹妹的丈夫", "zh": "姊姊‧妹妹的丈夫", "en": "Older/younger sister's husband", "fr": "Époux de la sœur (beau-frère)", "de": "Ehemann der Schwester (Schwager)", "hu": "A nővér/húg férje", "id": "Suami kakak/adik perempuan", "ja": "姉・妹の夫", "pl": "Mąż siostry (szwagier)"},
    "자녀의 배우자 쪽 부모": {"vi": "Bố mẹ của vợ/chồng của con", "cs": "Rodiče manželů/ek dětí", "zh_cn": "子女配偶的父母", "zh": "子女配偶的父母", "en": "Children's spouses' parents", "fr": "Parents du gendre ou de la belle-fille (co-beaux-parents)", "de": "Eltern des Schwiegerkindes", "hu": "A gyermekek házastársainak szülei", "id": "Orang tua dari pasangan anak", "ja": "子どもの配偶者の両親", "pl": "Rodzice zięcia lub synowej (współteściowie)"},
    "사돈": {"vi": "Thông gia", "cs": "Rodiče snachy/zetě", "zh_cn": "亲家", "zh": "親家", "en": "Co-parents-in-law", "fr": "Co-beaux-parents", "de": "Gegenschwiegereltern", "hu": "Nászok", "id": "Besan", "ja": "サドン（子の配偶者の親同士）", "pl": "Współteściowie"},
    "증조할아버지": {"vi": "Ông cố nội", "cs": "Pradědeček (z otcovy strany)", "zh_cn": "曾祖父", "zh": "曾祖父", "en": "Great-grandfather (paternal)", "fr": "Arrière-grand-père (paternel)", "de": "Urgroßvater (väterlicherseits)", "hu": "Dédapa (apai ágon)", "id": "Kakek buyut (pihak ayah)", "ja": "曾祖父（父方）", "pl": "Pradziadek (ze strony ojca)"},
    "증조할머니": {"vi": "Bà cố nội", "cs": "Prababička (z otcovy strany)", "zh_cn": "曾祖母", "zh": "曾祖母", "en": "Great-grandmother (paternal)", "fr": "Arrière-grand-mère (paternelle)", "de": "Urgroßmutter (väterlicherseits)", "hu": "Dédanya (apai ágon)", "id": "Nenek buyut (pihak ayah)", "ja": "曾祖母（父方）", "pl": "Prababcia (ze strony ojca)"},
    "외증조할아버지": {"vi": "Ông cố ngoại", "cs": "Pradědeček (z matčiny strany)", "zh_cn": "外曾祖父", "zh": "外曾祖父", "en": "Great-grandfather (maternal)", "fr": "Arrière-grand-père (maternel)", "de": "Urgroßvater (mütterlicherseits)", "hu": "Dédapa (anyai ágon)", "id": "Kakek buyut (pihak ibu)", "ja": "曾祖父（母方）", "pl": "Pradziadek (ze strony matki)"},
    "외증조할머니": {"vi": "Bà cố ngoại", "cs": "Prababička (z matčiny strany)", "zh_cn": "外曾祖母", "zh": "外曾祖母", "en": "Great-grandmother (maternal)", "fr": "Arrière-grand-mère (maternelle)", "de": "Urgroßmutter (mütterlicherseits)", "hu": "Dédanya (anyai ágon)", "id": "Nenek buyut (pihak ibu)", "ja": "曾祖母（母方）", "pl": "Prababcia (ze strony matki)"},
    "할아버지": {"vi": "Ông nội", "cs": "Dědeček (z otcovy strany)", "zh_cn": "爷爷", "zh": "爺爺", "en": "Grandfather (paternal)", "fr": "Grand-père (paternel)", "de": "Großvater (väterlicherseits)", "hu": "Nagyapa (apai ágon)", "id": "Kakek (pihak ayah)", "ja": "祖父（父方）", "pl": "Dziadek (ze strony ojca)"},
    "할머니": {"vi": "Bà nội", "cs": "Babička (z otcovy strany)", "zh_cn": "奶奶", "zh": "奶奶", "en": "Grandmother (paternal)", "fr": "Grand-mère (paternelle)", "de": "Großmutter (väterlicherseits)", "hu": "Nagymama (apai ágon)", "id": "Nenek (pihak ayah)", "ja": "祖母（父方）", "pl": "Babcia (ze strony ojca)"},
    "외할아버지": {"vi": "Ông ngoại", "cs": "Dědeček (z matčiny strany)", "zh_cn": "外公", "zh": "外公", "en": "Grandfather (maternal)", "fr": "Grand-père (maternel)", "de": "Großvater (mütterlicherseits)", "hu": "Nagyapa (anyai ágon)", "id": "Kakek (pihak ibu)", "ja": "祖父（母方）", "pl": "Dziadek (ze strony matki)"},
    "외할머니": {"vi": "Bà ngoại", "cs": "Babička (z matčiny strany)", "zh_cn": "外婆", "zh": "外婆", "en": "Grandmother (maternal)", "fr": "Grand-mère (maternelle)", "de": "Großmutter (mütterlicherseits)", "hu": "Nagymama (anyai ágon)", "id": "Nenek (pihak ibu)", "ja": "祖母（母方）", "pl": "Babcia (ze strony matki)"},
    "아버지": {"vi": "Bố", "cs": "Otec", "zh_cn": "父亲", "zh": "父親", "en": "Father", "fr": "Père", "de": "Vater", "hu": "Apa", "id": "Ayah", "ja": "父", "pl": "Ojciec"},
    "어머니": {"vi": "Mẹ", "cs": "Matka", "zh_cn": "母亲", "zh": "母親", "en": "Mother", "fr": "Mère", "de": "Mutter", "hu": "Anya", "id": "Ibu", "ja": "母", "pl": "Matka"},
    "남동생": {"vi": "Em trai", "cs": "Mladší bratr", "zh_cn": "弟弟", "zh": "弟弟", "en": "Younger brother", "fr": "Petit frère", "de": "Jüngerer Bruder", "hu": "Öcs", "id": "Adik laki-laki", "ja": "弟", "pl": "Młodszy brat"},
    "여동생": {"vi": "Em gái", "cs": "Mladší sestra", "zh_cn": "妹妹", "zh": "妹妹", "en": "Younger sister", "fr": "Petite sœur", "de": "Jüngere Schwester", "hu": "Húg", "id": "Adik perempuan", "ja": "妹", "pl": "Młodsza siostra"},
    "남편": {"vi": "Chồng", "cs": "Manžel", "zh_cn": "丈夫", "zh": "丈夫", "en": "Husband", "fr": "Mari", "de": "Ehemann", "hu": "Férj", "id": "Suami", "ja": "夫", "pl": "Mąż"},
    "아내": {"vi": "Vợ", "cs": "Manželka", "zh_cn": "妻子", "zh": "妻子", "en": "Wife", "fr": "Femme (épouse)", "de": "Ehefrau", "hu": "Feleség", "id": "Istri", "ja": "妻", "pl": "Żona"},
    "아들": {"vi": "Con trai", "cs": "Syn", "zh_cn": "儿子", "zh": "兒子", "en": "Son", "fr": "Fils", "de": "Sohn", "hu": "Fiú", "id": "Anak laki-laki", "ja": "息子", "pl": "Syn"},
    "딸": {"vi": "Con gái", "cs": "Dcera", "zh_cn": "女儿", "zh": "女兒", "en": "Daughter", "fr": "Fille", "de": "Tochter", "hu": "Lány", "id": "Anak perempuan", "ja": "娘", "pl": "Córka"},
    "며느리": {"vi": "Con dâu", "cs": "Snacha", "zh_cn": "媳妇", "zh": "媳婦", "en": "Daughter-in-law", "fr": "Belle-fille", "de": "Schwiegertochter", "hu": "Meny", "id": "Menantu perempuan", "ja": "嫁（息子の妻）", "pl": "Synowa"},
    "사위": {"vi": "Con rể", "cs": "Zeť", "zh_cn": "女婿", "zh": "女婿", "en": "Son-in-law", "fr": "Gendre", "de": "Schwiegersohn", "hu": "Vő", "id": "Menantu laki-laki", "ja": "婿（娘の夫）", "pl": "Zięć"},
    "친손자": {"vi": "Cháu nội trai", "cs": "Vnuk (po synovi)", "zh_cn": "孙子", "zh": "孫子", "en": "Grandson (via son)", "fr": "Petit-fils (par le fils)", "de": "Enkelsohn (vom Sohn)", "hu": "Fiúunoka (a fiú ágán)", "id": "Cucu laki-laki (dari anak laki-laki)", "ja": "孫息子（内孫）", "pl": "Wnuk (od syna)"},
    "친손녀": {"vi": "Cháu nội gái", "cs": "Vnučka (po synovi)", "zh_cn": "孙女", "zh": "孫女", "en": "Granddaughter (via son)", "fr": "Petite-fille (par le fils)", "de": "Enkeltochter (vom Sohn)", "hu": "Lányunoka (a fiú ágán)", "id": "Cucu perempuan (dari anak laki-laki)", "ja": "孫娘（内孫）", "pl": "Wnuczka (od syna)"},
    "외손자": {"vi": "Cháu ngoại trai", "cs": "Vnuk (po dceři)", "zh_cn": "外孙", "zh": "外孫", "en": "Grandson (via daughter)", "fr": "Petit-fils (par la fille)", "de": "Enkelsohn (von der Tochter)", "hu": "Fiúunoka (a lány ágán)", "id": "Cucu laki-laki (dari anak perempuan)", "ja": "孫息子（外孫）", "pl": "Wnuk (od córki)"},
    "외손녀": {"vi": "Cháu ngoại gái", "cs": "Vnučka (po dceři)", "zh_cn": "外孙女", "zh": "外孫女", "en": "Granddaughter (via daughter)", "fr": "Petite-fille (par la fille)", "de": "Enkeltochter (von der Tochter)", "hu": "Lányunoka (a lány ágán)", "id": "Cucu perempuan (dari anak perempuan)", "ja": "孫娘（外孫）", "pl": "Wnuczka (od córki)"},
    "친증손자": {"vi": "Chắt nội trai", "cs": "Pravnuk (po synově linii)", "zh_cn": "曾孙", "zh": "曾孫", "en": "Great-grandson (son's line)", "fr": "Arrière-petit-fils (par le fils)", "de": "Urenkel (vom Sohn)", "hu": "Dédunoka fiú (a fiú ágán)", "id": "Cicit laki-laki (garis anak laki-laki)", "ja": "ひ孫息子（内系）", "pl": "Prawnuk (z linii syna)"},
    "친증손녀": {"vi": "Chắt nội gái", "cs": "Pravnučka (po synově linii)", "zh_cn": "曾孙女", "zh": "曾孫女", "en": "Great-granddaughter (son's line)", "fr": "Arrière-petite-fille (par le fils)", "de": "Urenkelin (vom Sohn)", "hu": "Dédunoka lány (a fiú ágán)", "id": "Cicit perempuan (garis anak laki-laki)", "ja": "ひ孫娘（内系）", "pl": "Prawnuczka (z linii syna)"},
    "외증손자": {"vi": "Chắt ngoại trai", "cs": "Pravnuk (po dceřině linii)", "zh_cn": "外曾孙", "zh": "外曾孫", "en": "Great-grandson (daughter's line)", "fr": "Arrière-petit-fils (par la fille)", "de": "Urenkel (von der Tochter)", "hu": "Dédunoka fiú (a lány ágán)", "id": "Cicit laki-laki (garis anak perempuan)", "ja": "ひ孫息子（外系）", "pl": "Prawnuk (z linii córki)"},
    "외증손녀": {"vi": "Chắt ngoại gái", "cs": "Pravnučka (po dceřině linii)", "zh_cn": "外曾孙女", "zh": "外曾孫女", "en": "Great-granddaughter (daughter's line)", "fr": "Arrière-petite-fille (par la fille)", "de": "Urenkelin (von der Tochter)", "hu": "Dédunoka lány (a lány ágán)", "id": "Cicit perempuan (garis anak perempuan)", "ja": "ひ孫娘（外系）", "pl": "Prawnuczka (z linii córki)"},
    "시아버지(남편의 아버지)": {"vi": "Bố chồng", "cs": "Tchán (manželův otec)", "zh_cn": "公公（丈夫的父亲）", "zh": "公公（丈夫的父親）", "en": "Father-in-law (husband's father)", "fr": "Beau-père (père du mari)", "de": "Schwiegervater (Vater des Ehemanns)", "hu": "Após (a férj apja)", "id": "Ayah mertua (ayah suami)", "ja": "義父（夫の父）", "pl": "Teść (ojciec męża)"},
    "시어머니(남편의 어머니)": {"vi": "Mẹ chồng", "cs": "Tchyně (manželova matka)", "zh_cn": "婆婆（丈夫的母亲）", "zh": "婆婆（丈夫的母親）", "en": "Mother-in-law (husband's mother)", "fr": "Belle-mère (mère du mari)", "de": "Schwiegermutter (Mutter des Ehemanns)", "hu": "Anyós (a férj anyja)", "id": "Ibu mertua (ibu suami)", "ja": "義母（夫の母）", "pl": "Teściowa (matka męża)"},
    "장인(아내의 아버지)": {"vi": "Bố vợ", "cs": "Tchán (manželčin otec)", "zh_cn": "岳父（妻子的父亲）", "zh": "岳父（妻子的父親）", "en": "Father-in-law (wife's father)", "fr": "Beau-père (père de la femme)", "de": "Schwiegervater (Vater der Ehefrau)", "hu": "Após (a feleség apja)", "id": "Ayah mertua (ayah istri)", "ja": "義父（妻の父）", "pl": "Teść (ojciec żony)"},
    "장모(아내의 어머니)": {"vi": "Mẹ vợ", "cs": "Tchyně (manželčina matka)", "zh_cn": "岳母（妻子的母亲）", "zh": "岳母（妻子的母親）", "en": "Mother-in-law (wife's mother)", "fr": "Belle-mère (mère de la femme)", "de": "Schwiegermutter (Mutter der Ehefrau)", "hu": "Anyós (a feleség anyja)", "id": "Ibu mertua (ibu istri)", "ja": "義母（妻の母）", "pl": "Teściowa (matka żony)"},
    "아주버님(남편의 형)": {"vi": "Anh chồng", "cs": "Manželův starší bratr", "zh_cn": "大伯（丈夫的哥哥）", "zh": "大伯（丈夫的哥哥）", "en": "Husband's older brother", "fr": "Beau-frère (grand frère du mari)", "de": "Älterer Bruder des Ehemanns (Schwager)", "hu": "A férj bátyja", "id": "Kakak laki-laki suami", "ja": "夫の兄", "pl": "Szwagier (starszy brat męża)"},
    "손위 시누이(남편의 누나)": {"vi": "Chị chồng", "cs": "Manželova starší sestra", "zh_cn": "大姑（丈夫的姊姊）", "zh": "大姑（丈夫的姊姊）", "en": "Husband's older sister", "fr": "Belle-sœur (grande sœur du mari)", "de": "Ältere Schwester des Ehemanns (Schwägerin)", "hu": "A férj nővére", "id": "Kakak perempuan suami", "ja": "夫の姉", "pl": "Szwagierka (starsza siostra męża)"},
    "시동생(남편의 남동생)": {"vi": "Em trai chồng", "cs": "Manželův mladší bratr", "zh_cn": "小叔（丈夫的弟弟）", "zh": "小叔（丈夫的弟弟）", "en": "Husband's younger brother", "fr": "Beau-frère (petit frère du mari)", "de": "Jüngerer Bruder des Ehemanns (Schwager)", "hu": "A férj öccse", "id": "Adik laki-laki suami", "ja": "夫の弟", "pl": "Szwagier (młodszy brat męża)"},
    "손아래 시누이(남편의 여동생)": {"vi": "Em gái chồng", "cs": "Manželova mladší sestra", "zh_cn": "小姑（丈夫的妹妹）", "zh": "小姑（丈夫的妹妹）", "en": "Husband's younger sister", "fr": "Belle-sœur (petite sœur du mari)", "de": "Jüngere Schwester des Ehemanns (Schwägerin)", "hu": "A férj húga", "id": "Adik perempuan suami", "ja": "夫の妹", "pl": "Szwagierka (młodsza siostra męża)"},
    "손위 처남(아내의 오빠)": {"vi": "Anh vợ", "cs": "Manželčin starší bratr", "zh_cn": "大舅子（妻子的哥哥）", "zh": "大舅子（妻子的哥哥）", "en": "Wife's older brother", "fr": "Beau-frère (grand frère de la femme)", "de": "Älterer Bruder der Ehefrau (Schwager)", "hu": "A feleség bátyja", "id": "Kakak laki-laki istri", "ja": "妻の兄", "pl": "Szwagier (starszy brat żony)"},
    "처형(아내의 언니)": {"vi": "Chị vợ", "cs": "Manželčina starší sestra", "zh_cn": "大姨子（妻子的姊姊）", "zh": "大姨子（妻子的姊姊）", "en": "Wife's older sister", "fr": "Belle-sœur (grande sœur de la femme)", "de": "Ältere Schwester der Ehefrau (Schwägerin)", "hu": "A feleség nővére", "id": "Kakak perempuan istri", "ja": "妻の姉", "pl": "Szwagierka (starsza siostra żony)"},
    "손아래 처남(아내의 남동생)": {"vi": "Em trai vợ", "cs": "Manželčin mladší bratr", "zh_cn": "小舅子（妻子的弟弟）", "zh": "小舅子（妻子的弟弟）", "en": "Wife's younger brother", "fr": "Beau-frère (petit frère de la femme)", "de": "Jüngerer Bruder der Ehefrau (Schwager)", "hu": "A feleség öccse", "id": "Adik laki-laki istri", "ja": "妻の弟", "pl": "Szwagier (młodszy brat żony)"},
    "처제(아내의 여동생)": {"vi": "Em gái vợ", "cs": "Manželčina mladší sestra", "zh_cn": "小姨子（妻子的妹妹）", "zh": "小姨子（妻子的妹妹）", "en": "Wife's younger sister", "fr": "Belle-sœur (petite sœur de la femme)", "de": "Jüngere Schwester der Ehefrau (Schwägerin)", "hu": "A feleség húga", "id": "Adik perempuan istri", "ja": "妻の妹", "pl": "Szwagierka (młodsza siostra żony)"},
    "올케(오빠의 아내)": {"vi": "Chị dâu (vợ của anh trai)", "cs": "Švagrová (manželka staršího bratra)", "zh_cn": "嫂子（哥哥的妻子）", "zh": "嫂子（哥哥的妻子）", "en": "Older brother's wife", "fr": "Belle-sœur (épouse du grand frère)", "de": "Ehefrau des älteren Bruders", "hu": "Sógornő (a báty felesége)", "id": "Kakak ipar (istri kakak laki-laki)", "ja": "兄の妻", "pl": "Bratowa (żona starszego brata)"},
    "올케(남동생의 아내)": {"vi": "Em dâu (vợ của em trai)", "cs": "Švagrová (manželka mladšího bratra)", "zh_cn": "弟妹（弟弟的妻子）", "zh": "弟妹（弟弟的妻子）", "en": "Younger brother's wife", "fr": "Belle-sœur (épouse du petit frère)", "de": "Ehefrau des jüngeren Bruders", "hu": "Sógornő (az öcs felesége)", "id": "Adik ipar (istri adik laki-laki)", "ja": "弟の妻", "pl": "Bratowa (żona młodszego brata)"},
    "형부(언니의 남편)": {"vi": "Anh rể (chồng của chị gái)", "cs": "Švagr (manžel starší sestry)", "zh_cn": "姊夫（姊姊的丈夫）", "zh": "姊夫（姊姊的丈夫）", "en": "Older sister's husband", "fr": "Beau-frère (mari de la grande sœur)", "de": "Ehemann der älteren Schwester", "hu": "Sógor (a nővér férje)", "id": "Kakak ipar (suami kakak perempuan)", "ja": "姉の夫", "pl": "Szwagier (mąż starszej siostry)"},
    "제부(여동생의 남편)": {"vi": "Em rể (chồng của em gái)", "cs": "Švagr (manžel mladší sestry)", "zh_cn": "妹夫（妹妹的丈夫）", "zh": "妹夫（妹妹的丈夫）", "en": "Younger sister's husband", "fr": "Beau-frère (mari de la petite sœur)", "de": "Ehemann der jüngeren Schwester", "hu": "Sógor (a húg férje)", "id": "Adik ipar (suami adik perempuan)", "ja": "妹の夫", "pl": "Szwagier (mąż młodszej siostry)"},
    "사돈(자녀 배우자의 부모)": {"vi": "Thông gia (bố mẹ của vợ/chồng của con)", "cs": "Rodiče snachy/zetě", "zh_cn": "亲家（子女配偶的父母）", "zh": "親家（子女配偶的父母）", "en": "Co-parents-in-law (child's spouse's parents)", "fr": "Co-beaux-parents (parents du conjoint de son enfant)", "de": "Eltern des Schwiegerkindes", "hu": "Nászok (a gyermek házastársának szülei)", "id": "Besan (orang tua pasangan anak)", "ja": "サドン（子の配偶者の親）", "pl": "Współteściowie"},
    "사돈을 맺다": {"vi": "Kết thông gia", "cs": "Stát se příbuznými skrze sňatek dětí", "zh_cn": "结为亲家", "zh": "結為親家", "en": "To become co-parents-in-law", "fr": "S'allier par le mariage de ses enfants", "de": "Verschwägert werden", "hu": "Nászokká válni", "id": "Menjadi besan", "ja": "サドン（姻戚）の関係を結ぶ", "pl": "Spokrewnić się przez ślub dzieci"},
    "사돈어른(바깥사돈)": {"vi": "Ông thông gia", "cs": "Otec snachy/zetě", "zh_cn": "亲家公（男方亲家）", "zh": "親家公（男方親家）", "en": "Male co-parent-in-law", "fr": "Co-beau-père", "de": "Schwiegerkindsvater", "hu": "Násznagy (férfi)", "id": "Besan laki-laki", "ja": "男性側の親家（サドンの夫）", "pl": "Współteść"},
    "안사돈": {"vi": "Bà thông gia", "cs": "Matka snachy/zetě", "zh_cn": "亲家母（女方亲家）", "zh": "親家母（女方親家）", "en": "Female co-parent-in-law", "fr": "Co-belle-mère", "de": "Schwiegerkindsmutter", "hu": "Nászasszony", "id": "Besan perempuan", "ja": "女性側の親家（サドンの妻）", "pl": "Współteściowa"},
    "제3자에게 말할 때": {"vi": "Khi nói với người thứ ba", "cs": "Když o nich mluvíte s někým jiným", "zh_cn": "对第三者提起时", "zh": "對第三者提起時", "en": "When mentioning them to someone else", "fr": "En parlant à un tiers", "de": "Beim Sprechen über Dritte", "hu": "Amikor harmadik személynek említi őket", "id": "Saat menyebut mereka kepada orang lain", "ja": "第三者に話すとき", "pl": "W rozmowie z osobą trzecią"},
    "직접 호칭할 때": {"vi": "Khi gọi trực tiếp", "cs": "Když je oslovujete přímo", "zh_cn": "直接称呼时", "zh": "直接稱呼時", "en": "When addressing them directly", "fr": "En s'adressant directement", "de": "Bei direkter Anrede", "hu": "Amikor közvetlenül megszólítja őket", "id": "Saat menyapa mereka langsung", "ja": "直接呼びかけるとき", "pl": "W bezpośrednim zwrocie"},
    "행복한 삶을 영원히": {"vi": "Vui sống mãi mãi", "cs": "Radujte se ze života navždy!", "zh_cn": "永远享受美好的生命", "zh": "永遠享受美好的生命", "en": "Enjoy Life Forever", "fr": "Vivez pour toujours !", "de": "Glücklich – für immer", "hu": "Boldog élet most és mindörökké!", "id": "Hidup Bahagia Selamanya!", "ja": "いつまでも幸せに暮らせます", "pl": "Już zawsze ciesz się życiem!"},
    "\"행복한 삶을 영원히 누리십시오!\" 성경 공부 과정의 본문 문장이에요. 각 과의 토론 질문과 본문을 실제 발행물 그대로 5개 언어로 대조해 두었어요. 동영상 안내와 \"더 찾아보기\" 자료는 포함하지 않아요.": {"vi": "Đây là các câu trong phần nội dung của khóa học Kinh Thánh \"Vui sống mãi mãi!\". Câu hỏi thảo luận và nội dung của mỗi bài được giữ nguyên như ấn phẩm và đối chiếu bằng 5 ngôn ngữ. Phần hướng dẫn video và mục \"Tìm hiểu thêm\" không được đưa vào.", "cs": "Věty z textu biblického kurzu „Radujte se ze života navždy!“. Otázky k rozboru a hlavní text jsou porovnány ve více jazycích tak, jak byly vydány.", "zh_cn": "《永远享受美好的生命！》圣经课程的正文句子。各课的讨论问题和正文均按出版物原文在多语种间对照。", "zh": "「永遠享受美好的生命！」聖經課程的正文。每一課的討論問題和正文都依照原文，以5種語言對照收錄。不包含影片提示和「更多精彩內容」的資料。", "en": "The body text of the \"Enjoy Life Forever!\" Bible course. Each lesson's discussion questions and text are given exactly as published, aligned across 5 languages. Video cues and the \"Explore\" section are not included.", "fr": "Texte principal du cours biblique « Vivez pour toujours ! ». Les questions de discussion et les paragraphes de chaque leçon sont mis en regard en plusieurs langues selon la publication officielle.", "de": "Der Text des Bibelkurses „Glücklich – für immer!“. Die Diskussionsfragen und Absätze jeder Lektion sind wie in der Publikation in verschiedenen Sprachen gegenübergestellt.", "hu": "Mondatok a „Boldog élet most és mindörökké!” bibliatanulmányozási kurzusból. A megbeszélési kérdések és a főszöveg több nyelven van összehasonlítva.", "id": "Kalimat dari teks kursus pelajaran Alkitab 'Hidup Bahagia Selamanya!'. Pertanyaan diskusi dan teks utama disandingkan dalam berbagai bahasa persis seperti publikasi asli.", "ja": "「いつまでも幸せに暮らせます！」聖書研究コースの本文です。各課の話し合いの質問と本文は、実際の出版物どおりに5つの言語で対照してあります。動画の案内と「見てみよう」の資料は含まれていません。", "pl": "Zdania z tekstu kursu biblijnego „Ciesz się życiem na zawsze!”. Pytania do dyskusji i tekst główny zestawione w wielu językach."},
    ...
    "바둑판": {"vi": "Dạng lưới", "cs": "Mřížka", "zh_cn": "网格", "zh": "網格", "en": "Grid", "fr": "Grille", "de": "Kacheln", "hu": "Rács", "id": "Kisi", "ja": "グリッド", "pl": "Kafelki"},
    "목록": {"vi": "Danh sách", "cs": "Seznam", "zh_cn": "列表", "zh": "列表", "en": "List", "fr": "Liste", "de": "Liste", "hu": "Lista", "id": "Daftar", "ja": "一覧", "pl": "Lista"},
    "곡 번호 또는 제목 검색... (예: 12 또는 사랑)": {"vi": "Tìm số hoặc tên bài hát... (ví dụ: 12 hoặc Yêu thương)", "cs": "Hledat číslo písně nebo název... (např. 12 nebo láska)", "zh_cn": "搜寻歌曲编号或标题... (例: 12 或 愛)", "zh": "搜尋歌曲編號或標題... (例: 12 或 愛)", "en": "Search song number or title... (e.g. 12 or Love)", "fr": "Rechercher le numéro ou le titre du chant... (ex. : 12 ou Amour)", "de": "Liednummer oder Titel suchen... (z. B. 12 oder Liebe)", "hu": "Keresés énekszám vagy cím alapján... (pl. 12 vagy szeretet)", "id": "Cari nomor atau judul lagu... (contoh: 12 atau kasih)", "ja": "番号や曲名で検索... (例: 12 または 愛)", "pl": "Szukaj numeru lub tytułu pieśni... (np. 12 lub Miłość)"},
    "검색 결과가 없습니다.": {"vi": "Không tìm thấy kết quả.", "cs": "Nebyly nalezeny žádné výsledky.", "zh_cn": "找不到搜寻结果。", "zh": "找不到搜尋結果。", "en": "No results found.", "fr": "Aucun résultat trouvé.", "de": "Keine Suchergebnisse.", "hu": "Nincs találat.", "id": "Tidak ada hasil pencarian.", "ja": "検索結果がありません。", "pl": "Brak wyników wyszukiwania."},
    "닫기": {"vi": "Đóng", "cs": "Zavřít", "zh_cn": "关闭", "zh": "關閉", "en": "Close", "fr": "Fermer", "de": "Schließen", "hu": "Bezárás", "id": "Tutup", "ja": "閉じる", "pl": "Zamknij"},
    "전체": {"vi": "Tất cả", "cs": "Vše", "zh_cn": "全部", "zh": "全部", "en": "All", "fr": "Tous", "de": "Alle", "hu": "Összes", "id": "Semua", "ja": "すべて", "pl": "Wszystkie"},
    ...
    "이전": {"vi": "Trước", "cs": "Předchozí", "zh_cn": "上一个", "zh": "上一個", "en": "Previous", "fr": "Précédent", "de": "Zurück", "hu": "Előző", "id": "Sebelumnya", "ja": "前へ", "pl": "Poprzedni"},
    "다음": {"vi": "Tiếp", "cs": "Další", "zh_cn": "下一个", "zh": "下一個", "en": "Next", "fr": "Suivant", "de": "Weiter", "hu": "Következő", "id": "Berikutnya", "ja": "次へ", "pl": "Następny"},
    "왼쪽으로 이동": {"vi": "Di chuyển sang trái", "cs": "Posunout doleva", "zh_cn": "向左移动", "zh": "向左移動", "en": "Move left", "fr": "Déplacer vers la gauche", "de": "Nach links verschieben", "hu": "Mozgatás balra", "id": "Pindah ke kiri", "ja": "左へ移動", "pl": "Przesuń w lewo"},
    "오른쪽으로 이동": {"vi": "Di chuyển sang phải", "cs": "Posunout doprava", "zh_cn": "向右移动", "zh": "向右移動", "en": "Move right", "fr": "Déplacer vers la droite", "de": "Nach rechts verschieben", "hu": "Mozgatás jobbra", "id": "Pindah ke kanan", "ja": "右へ移動", "pl": "Przesuń w prawo"},
    "\"행복한 삶을 영원히 누리십시오!\" 교재의 엑셀 원본 자료를 그대로 옮긴 콘텐츠예요. 72개 항목(1~60과·부별 복습·미디어 자료·참조 자료 등)을 10개 언어로 대조할 수 있어요. [문장] 탭의 같은 이름 콘텐츠와는 다른, 더 완전한 원문 자료예요.": {"vi": "Nội dung được chuyển nguyên từ dữ liệu Excel gốc của giáo trình \"Vui sống mãi mãi!\", gồm 72 mục (bài 1–60, ôn tập từng phần, tài liệu đa phương tiện, chú thích, v.v.) đối chiếu bằng nhiều ngôn ngữ. Đây là nguồn đầy đủ hơn so với nội dung cùng tên ở thẻ [Câu].", "cs": "Kompletní zdrojová data z Excelu ke kurzu „Raduj se ze života navždy!“ — všech 72 položek (lekce 1–60, opakování jednotlivých částí, média, poznámky atd.) srovnaných ve více jazycích. Jde o úplnější zdroj než stejnojmenný obsah na kartě [Věta].", "zh_cn": "这是「尽情享受人生！」教材Excel原始资料的完整内容，涵蓋72个项目（第1~60课、各部复习、多媒体资料、参考资料等），可对照10种语言。与[句子]分页中同名内容不同，这是更完整的原始资料。", "zh": "這是「盡情享受人生！」教材Excel原始資料的完整內容，涵蓋72個項目（第1~60課、各部複習、多媒體資料、參考資料等），可對照10種語言。與[句子]分頁中同名內容不同，這是更完整的原始資料。", "en": "The full Excel source data of the \"Enjoy Life Forever!\" course, covering all 72 items (Lessons 1–60, section reviews, media, endnotes, etc.) aligned across several languages. This is a more complete source than the same-named content under the [Sentence] tab.", "fr": "Les données source Excel complètes du cours « Jouissez de la vie à jamais ! », couvrant les 72 éléments (leçons 1 à 60, révisions de section, contenus multimédias, notes, etc.) alignés sur 10 langues. Il s'agit d'une source plus complète que le contenu du même nom dans l'onglet [Phrases].", "de": "Die vollständigen Excel-Quelldaten des Kurses „Genieße das Leben für immer!“ mit allen 72 Einheiten (Lektionen 1–60, Teil-Wiederholungen, Medien, Anmerkungen usw.) in 10 Sprachen. Dies ist eine vollständigere Quelle als der gleichnamige Inhalt im Tab [Sätze].", "hu": "Az „Élvezd az életet örökké!” tananyag eredeti Excel-adatai változtatás nélkül: mind a 72 tétel (1–60. lecke, részenkénti ismétlések, médiaanyagok, jegyzetek stb.) több nyelven párhuzamosan. Ez teljesebb forrás, mint a [Mondat] fül azonos nevű tartalma.", "id": "Data Excel sumber lengkap dari kursus \"Nikmatilah Kehidupan Selamanya!\", mencakup semua 72 item (Pelajaran 1–60, ulasan setiap bagian, media, catatan, dll.) yang disejajarkan dalam beberapa bahasa. Ini sumber yang lebih lengkap daripada konten bernama sama di tab [Kalimat].", "ja": "「幸せな人生を永遠に」教材のExcel原本データをそのまま収録したコンテンツです。72項目（1～60課・各部の復習・メディア資料・参照資料など）を10言語で対照できます。［文章］タブの同名コンテンツとは異なる、より完全な原本資料です。", "pl": "Pełne dane źródłowe z arkusza Excel dla kursu „Ciesz się życiem na zawsze!”, obejmujące wszystkie 72 pozycje (lekcje 1–60, powtórki poszczególnych części, materiały multimedialne, przypisy itd.) zestawione w 10 językach. To pełniejsze źródło niż treść o tej samej nazwie w zakładce [Zdania]."},
    ...
    "빈도가 많은 순": {"vi": "Tần suất", "cs": "Četnost", "zh_cn": "频率", "zh": "頻率", "en": "Frequency", "fr": "Fréquence", "de": "Häufigkeit", "hu": "Gyakoriság", "id": "Frekuensi", "ja": "頻度順", "pl": "Częstość"},
    ...
    "단자음": {"vi": "Phụ âm đơn", "cs": "Jednoduché souhlásky", "zh_cn": "单辅音", "zh": "單輔音", "en": "Single Consonants", "fr": "Consonnes simples", "de": "Einfache Konsonanten", "hu": "Egyszerű mássalhangzók", "id": "Konsonan Tunggal", "ja": "単子音", "pl": "Spółgłoski pojedyncze"},
    "복자음": {"vi": "Phụ âm ghép", "cs": "Spřežky", "zh_cn": "复合辅音", "zh": "複合輔音", "en": "Consonant Clusters", "fr": "Consonnes composées", "de": "Konsonantenverbindungen", "hu": "Összetett mássalhangzók", "id": "Konsonan Ganda", "ja": "複子音", "pl": "Spółgłoski złożone"},
    "단모음": {"vi": "Nguyên âm đơn", "cs": "Jednoduché samohlásky", "zh_cn": "单元音", "zh": "單元音", "en": "Single Vowels", "fr": "Voyelles simples", "de": "Einfache Vokale", "hu": "Egyszerű magánhangzók", "id": "Vokal Tunggal", "ja": "単母音", "pl": "Samogłoski pojedyncze"},
    "이중모음": {"vi": "Nguyên âm đôi", "cs": "Dvojhlásky", "zh_cn": "双元音", "zh": "雙元音", "en": "Diphthongs", "fr": "Diphtongues", "de": "Diphthonge", "hu": "Kettőshangzók", "id": "Diftong", "ja": "二重母音", "pl": "Dyftongi"},
    "삼중모음": {"vi": "Nguyên âm ba", "cs": "Trojhlásky", "zh_cn": "三合元音", "zh": "三合元音", "en": "Triphthongs", "fr": "Triphtongues", "de": "Triphthonge", "hu": "Hármashangzók", "id": "Triftong", "ja": "三重母音", "pl": "Tryftongi"},
    ...
    "일상회화": {"vi": "Hội thoại hàng ngày", "cs": "Běžná konverzace", "zh_cn": "日常会话", "zh": "日常對話", "en": "Everyday Conversation", "fr": "Conversation quotidienne", "de": "Alltagsgespräche", "hu": "Mindennapi beszélgetés", "id": "Percakapan Sehari-hari", "ja": "日常会話", "pl": "Codzienne rozmowy"},
    ...
    "일시정지": {"vi": "Tạm dừng", "cs": "Pozastavit", "zh_cn": "暂停", "zh": "暫停", "en": "Pause", "fr": "Pause", "de": "Pause", "hu": "Szünet", "id": "Jeda", "ja": "一時停止", "pl": "Pauza"},
    "재생": {"vi": "Phát", "cs": "Přehrát", "zh_cn": "播放", "zh": "播放", "en": "Play", "fr": "Lecture", "de": "Abspielen", "hu": "Lejátszás", "id": "Putar", "ja": "再生", "pl": "Odtwórz"},
    "정답 확인": {"vi": "Kiểm tra đáp án", "cs": "Zkontrolovat odpověď", "zh_cn": "检查答案", "zh": "檢查答案", "en": "Check Answer", "fr": "Vérifier la réponse", "de": "Antwort prüfen", "hu": "Válasz ellenőrzése", "id": "Periksa Jawaban", "ja": "答え合わせ", "pl": "Sprawdź odpowiedź"},
    "다시 시도": {"vi": "Thử lại", "cs": "Zkusit znovu", "zh_cn": "再试一次", "zh": "再試一次", "en": "Try Again", "fr": "Réessayer", "de": "Erneut versuchen", "hu": "Újrapróbálkozás", "id": "Coba Lagi", "ja": "もう一度", "pl": "Spróbuj ponownie"},
    ...
    "목적어": {"vi": "Tân ngữ", "cs": "Předmět", "zh_cn": "宾语", "zh": "賓語", "en": "Object", "fr": "Complément d'objet", "de": "Objekt", "hu": "Tárgy", "id": "Objek", "ja": "目的語", "pl": "Dopełnienie"},
    "목적어 (명사)": {"vi": "Tân ngữ (danh từ)", "cs": "Předmět (podstatné jméno)", "zh_cn": "宾语（名词）", "zh": "賓語（名詞）", "en": "Object (noun)", "fr": "Complément d'objet (nom)", "de": "Objekt (Nomen)", "hu": "Tárgy (főnév)", "id": "Objek (kata benda)", "ja": "目的語（名詞）", "pl": "Dopełnienie (rzeczownik)"},
    "형용사": {"vi": "Tính từ", "cs": "Přídavné jméno", "zh_cn": "形容词", "zh": "形容詞", "en": "Adjective", "fr": "Adjectif", "de": "Adjektiv", "hu": "Melléknév", "id": "Kata Sifat", "ja": "形容詞", "pl": "Przymiotnik"},
    "장소": {"vi": "Nơi chốn", "cs": "Místo", "zh_cn": "地点", "zh": "地點", "en": "Place", "fr": "Lieu", "de": "Ort", "hu": "Hely", "id": "Tempat", "ja": "場所", "pl": "Miejsce"},
    "부정어/시제 (동사 앞에 붙는 말)": {"vi": "Phủ định/thì (từ đứng trước động từ)", "cs": "Zápor/čas (výraz před slovesem)", "zh_cn": "否定词/时态（放在动词前面的词）", "zh": "否定詞/時態（放在動詞前面的詞）", "en": "Negation/tense (words before the verb)", "fr": "Négation/temps (mots placés avant le verbe)", "de": "Verneinung/Zeitform (Wörter vor dem Verb)", "hu": "Tagadás/igeidő (ige előtti szó)", "id": "Negasi/kala (kata sebelum kata kerja)", "ja": "否定語・時制（動詞の前に付く語）", "pl": "Przeczenie/czas (słowa przed czasownikiem)"},
    "조동사/기타 (동사 앞뒤에 붙는 말)": {"vi": "Trợ động từ/khác (từ đứng trước hoặc sau động từ)", "cs": "Pomocné sloveso/ostatní (před či za slovesem)", "zh_cn": "助动词/其他（放在动词前后的词）", "zh": "助動詞/其他（放在動詞前後的詞）", "en": "Auxiliaries/other (words before or after the verb)", "fr": "Auxiliaires/autres (mots avant ou après le verbe)", "de": "Hilfsverben/Sonstiges (Wörter vor oder nach dem Verb)", "hu": "Segédige/egyéb (ige előtt vagy után)", "id": "Kata bantu/lainnya (sebelum atau sesudah kata kerja)", "ja": "助動詞・その他（動詞の前後に付く語）", "pl": "Czasowniki posiłkowe/inne (słowa przed lub po czasowniku)"},
    "기타 수식어": {"vi": "Từ bổ nghĩa khác", "cs": "Ostatní přívlastky", "zh_cn": "其他修饰语", "zh": "其他修飾語", "en": "Other modifiers", "fr": "Autres modificateurs", "de": "Weitere Bestimmungswörter", "hu": "Egyéb módosítók", "id": "Modifikator Lainnya", "ja": "その他の修飾語", "pl": "Inne określenia"},
    "어순 팁": {"vi": "Mẹo về trật tự từ", "cs": "Tip ke slovosledu", "zh_cn": "语序提示", "zh": "語序提示", "en": "Word-order tip", "fr": "Astuce sur l'ordre des mots", "de": "Tipp zur Wortstellung", "hu": "Szórendi tipp", "id": "Tips Susunan Kata", "ja": "語順のヒント", "pl": "Wskazówka dotycząca szyku"},
    "어순 팁:": {"vi": "Mẹo về trật tự từ:", "cs": "Tip ke slovosledu:", "zh_cn": "语序提示：", "zh": "語序提示：", "en": "Word-order tip:", "fr": "Astuce sur l'ordre des mots :", "de": "Tipp zur Wortstellung:", "hu": "Szórendi tipp:", "id": "Tips Susunan Kata:", "ja": "語順のヒント：", "pl": "Wskazówka dotycząca szyku:"},
    "모음 발음 — 이중모음": {"vi": "Phát âm nguyên âm — nguyên âm đôi", "cs": "Výslovnost samohlásek — dvojhlásky", "zh_cn": "元音发音 — 双元音", "zh": "元音發音 — 雙元音", "en": "Vowel Pronunciation — Diphthongs", "fr": "Prononciation des voyelles — diphtongues", "de": "Vokalaussprache — Diphthonge", "hu": "Magánhangzók kiejtése — kettőshangzók", "id": "Pelafalan Vokal — Diftong", "ja": "母音の発音 — 二重母音", "pl": "Wymowa samogłosek — dyftongi"},
    "모음 발음 — 삼중모음": {"vi": "Phát âm nguyên âm — nguyên âm ba", "cs": "Výslovnost samohlásek — trojhlásky", "zh_cn": "元音发音 — 三合元音", "zh": "元音發音 — 三合元音", "en": "Vowel Pronunciation — Triphthongs", "fr": "Prononciation des voyelles — triphtongues", "de": "Vokalaussprache — Triphthonge", "hu": "Magánhangzók kiejtése — hármashangzók", "id": "Pelafalan Vokal — Triftong", "ja": "母音の発音 — 三重母音", "pl": "Wymowa samogłosek — tryftongi"},
    "예: Trung": {"vi": "Ví dụ: Trung", "cs": "např. Trung", "zh_cn": "例如：Trung", "zh": "例：Trung", "en": "e.g. Trung", "fr": "ex. : Trung", "de": "z. B. Trung", "hu": "pl. Trung", "id": "contoh: Trung", "ja": "例：Trung", "pl": "np. Trung"},
    "예: 동식": {"vi": "Ví dụ: Tuấn", "cs": "např. Dongsik", "zh_cn": "例如：东植", "zh": "例：王大明", "en": "e.g. David", "fr": "ex. : Pierre", "de": "z. B. Thomas", "hu": "pl. Dongsik", "id": "contoh: Dongsik", "ja": "例：田中", "pl": "np. Dongsik"},
    "파수대 연구 기사에서 뽑은 예문이에요. 매주 학습한 어휘가 포함된 문장과 그 뜻을 보여줘요.": {"vi": "Các câu ví dụ được chọn từ bài học Tháp Canh, gồm những câu chứa từ vựng đã học mỗi tuần cùng với nghĩa của câu.", "cs": "Příklady vět vybrané ze studijních článků Strážné věže. Zobrazují se věty obsahující probranou slovní zásobu a jejich význam.", "zh_cn": "选自《守望台》研究文章的例句。展示包含每周所学词汇的句子及其含义。", "zh": "這些例句選自《守望台》研究文章，顯示包含每週所學詞彙的句子及其意思。", "en": "Example sentences taken from the Watchtower Study articles, showing sentences that contain each week's vocabulary together with their meaning.", "fr": "Phrases d'exemple tirées des articles d'étude de La Tour de Garde : elles contiennent le vocabulaire de chaque semaine et sont accompagnées de leur sens.", "de": "Beispielsätze aus den Studienartikeln des Wachtturms: Sätze mit dem Wortschatz der jeweiligen Woche samt Bedeutung.", "hu": "Az Őrtorony-tanulmányozási cikkekből kiválasztott példamondatok. Bemutatja a heti tanult szókincset tartalmazó mondatokat és azok jelentését.", "id": "Kalimat contoh yang dipilih dari artikel Pelajaran Menara Pengawal. Menampilkan kalimat yang memuat kosakata yang dipelajari setiap minggu beserta artinya.", "ja": "「ものみの塔」研究記事から選んだ例文です。毎週学ぶ語彙を含む文とその意味を表示します。", "pl": "Przykładowe zdania wybrane z artykułów do studium w Strażnicy. Pokazuje zdania zawierające słownictwo poznane w danym tygodniu wraz z ich znaczeniem."},
    "파수대 연구 기사의 엑셀 원본 자료를 그대로 옮긴 콘텐츠예요. 현재 확정된 주차만 12개 언어로 대조할 수 있어요. 아직 원고가 준비되지 않은 미래 주차는 표시하지 않아요. 옆의 [파수대] 탭(5개 언어, 단어 학습용 예문만 선별한 버전)과는 다른, 더 완전한 원문 자료예요.": {"vi": "Nội dung được chuyển nguyên từ dữ liệu Excel gốc của các bài học Tháp Canh. Chỉ những tuần đã được xác nhận mới có thể đối chiếu bằng 12 ngôn ngữ; các tuần tương lai chưa có bản thảo sẽ không được hiển thị. Đây là nguồn đầy đủ hơn so với thẻ [Tháp Canh] bên cạnh (5 ngôn ngữ, chỉ gồm các câu ví dụ để học từ).", "cs": "Kompletní data z původního souboru aplikace Excel pro studijní články Strážné věže. V 12 jazycích lze porovnávat pouze aktuálně potvrzené týdny.", "zh_cn": "《守望台》研究文章Excel原始资料的完整内容。仅当前确定的周次可在12种语言间对照。", "zh": "這是將《守望台》研究文章的Excel原始資料原樣收錄的內容。目前僅已確定的週次可對照12種語言，尚未準備好稿件的未來週次不會顯示。這是比旁邊的［守望台］分頁（5種語言，僅精選學習單字用例句的版本）更完整的原文資料。", "en": "The Watchtower Study articles' original Excel data, carried over as is. Only weeks that are already confirmed can be compared across 12 languages; future weeks whose text isn't ready yet are not shown. This is a more complete source than the neighboring [Watchtower] tab (5 languages, only example sentences selected for vocabulary study).", "fr": "Les données Excel d'origine des articles d'étude de La Tour de Garde, reprises telles quelles. Seules les semaines déjà confirmées peuvent être comparées dans 12 langues ; les semaines futures dont le texte n'est pas prêt ne sont pas affichées. C'est une source plus complète que l'onglet voisin [La Tour de Garde] (5 langues, uniquement des phrases choisies pour l'étude du vocabulaire).", "de": "Die ursprünglichen Excel-Daten der Wachtturm-Studienartikel, unverändert übernommen. Nur bereits feststehende Wochen lassen sich in 12 Sprachen vergleichen; künftige Wochen, deren Text noch nicht vorliegt, werden nicht angezeigt. Dies ist eine vollständigere Quelle als der benachbarte Tab [Wachtturm] (5 Sprachen, nur ausgewählte Beispielsätze zum Vokabellernen).", "hu": "Az Őrtorony-tanulmányozási cikkek eredeti Excel-fájljának teljes tartalma. 12 nyelven tekinthető meg az eddig megerősített hetek anyaga.", "id": "Konten lengkap dari data sumber Excel asli untuk artikel pelajaran Menara Pengawal. Hanya minggu yang sudah dikonfirmasi saat ini yang dapat dibandingkan dalam 12 bahasa.", "ja": "「ものみの塔」研究記事のExcel原本データをそのまま収録したコンテンツです。現在確定している週のみ12言語で対照できます。原稿がまだ準備されていない今後の週は表示しません。隣の［ものみの塔］タブ（5言語、語彙学習用の例文のみを選んだ版）とは異なる、より完全な原文資料です。", "pl": "Pełna treść oryginalnych danych programu Excel artykułów do studium w Strażnicy. W 12 językach można zestawiać tylko aktualnie potwierdzone tygodnie."},
    "\"베트남어 일상 회화\" 교재 1~13과의 실제 회화문 21편이에요. 베트남어·한국어는 교재 원문 그대로이며, 중국어·영어·일본어는 자연스러운 회화체로 옮겼어요.": {"vi": "21 đoạn hội thoại thực tế từ bài 1–13 của giáo trình \"Hội thoại tiếng Việt hằng ngày\". Tiếng Việt và tiếng Hàn được giữ nguyên như giáo trình; các ngôn ngữ khác được dịch theo văn nói tự nhiên.", "cs": "21 skutečných konverzačních lekcí z lekcí 1–13 učebnice „Vietnamská běžná konverzace“. Texty jsou věrné originálu.", "zh_cn": "选自《越南语日常会话》教材第1~13课的21篇实际对话。越南语和韩语保持教材原样，中文、英语、日语转译为自然口语体。", "zh": "這是《越南語日常會話》教材第1～13課的21篇實際會話。越南語和韓語保持教材原文，中文、英文、日文則譯成自然的口語。", "en": "21 real dialogues from Lessons 1–13 of the \"Everyday Vietnamese Conversation\" textbook. The Vietnamese and Korean are exactly as in the textbook; the other languages are rendered in natural conversational style.", "fr": "21 dialogues réels tirés des leçons 1 à 13 du manuel « Conversation vietnamienne au quotidien ». Le vietnamien et le coréen sont repris tels quels du manuel ; les autres langues sont rendues dans un style de conversation naturel.", "de": "21 echte Dialoge aus den Lektionen 1–13 des Lehrbuchs „Vietnamesische Alltagskonversation“. Vietnamesisch und Koreanisch entsprechen genau dem Lehrbuch; die übrigen Sprachen sind in natürlicher Umgangssprache wiedergegeben.", "hu": "21 valós beszélgetés a „Vietnámi mindennapi beszélgetés” tankönyv 1–13. leckéjéből. A szövegek hűek az eredetihez.", "id": "21 teks percakapan nyata dari Bab 1–13 buku pelajaran 'Percakapan Sehari-hari Bahasa Vietnam'.", "ja": "『ベトナム語日常会話』教材第1～13課の実際の会話文21編です。ベトナム語と韓国語は教材の原文どおりで、中国語・英語・日本語は自然な会話体に訳しています。", "pl": "21 autentycznych dialogów z lekcji 1–13 podręcznika „Wietnamskie rozmowy codzienne”. Teksty są wierne oryginałowi."},
    "\"사람들을 사랑하고 제자로 삼으십시오\" 소책자의 엑셀 원본 자료를 그대로 옮긴 콘텐츠예요. 1~12과와 부록 가·나·다를 12개 언어로 대조할 수 있어요. 옆의 [사람들을 사랑하고 제자로] 탭(5개 언어, 과별 대표 예문만 선별한 버전)과는 다른, 더 완전한 원문 자료예요.": {"vi": "Nội dung được chuyển nguyên từ dữ liệu Excel gốc của sách mỏng \"Yêu thương người khác — Đào tạo môn đồ\". Có thể đối chiếu bài 1–12 và phụ lục A, B, C bằng 12 ngôn ngữ. Đây là nguồn đầy đủ hơn so với thẻ [Yêu thương người khác — Đào tạo môn đồ] bên cạnh (5 ngôn ngữ, chỉ gồm các câu tiêu biểu của mỗi bài).", "cs": "Kompletní data z původního souboru aplikace Excel pro brožuru „Mějte rádi lidi a pomáhejte jim stát se učedníky“. Všech 12 lekcí a dodatků lze porovnávat v 12 jazycích.", "zh_cn": "《用爱心帮助人成为基督徒》册子Excel原始资料的完整内容。第1~12课和附录一、二、三可在12种语言间对照。", "zh": "這是將《用愛心幫助人成為基督徒》冊子的Excel原始資料原樣收錄的內容，可用12種語言對照第1～12課及附錄甲、乙、丙。這是比旁邊的［用愛心幫助人成為基督徒］分頁（5種語言，僅精選各課代表例句的版本）更完整的原文資料。", "en": "The \"Love People—Make Disciples\" brochure's original Excel data, carried over as is. Lessons 1–12 and Appendices A, B, and C can be compared across 12 languages. This is a more complete source than the neighboring [Love People—Make Disciples] tab (5 languages, only representative sentences selected from each lesson).", "fr": "Les données Excel d'origine de la brochure « Aimer les gens et faire des disciples », reprises telles quelles. Les leçons 1 à 12 et les annexes A, B et C peuvent être comparées dans 12 langues. C'est une source plus complète que l'onglet voisin [Aimer les gens et faire des disciples] (5 langues, uniquement des phrases représentatives de chaque leçon).", "de": "Die ursprünglichen Excel-Daten der Broschüre „Menschen lieben — Jünger machen“, unverändert übernommen. Die Lektionen 1–12 und die Anhänge A, B und C lassen sich in 12 Sprachen vergleichen. Dies ist eine vollständigere Quelle als der benachbarte Tab [Menschen lieben — Jünger machen] (5 Sprachen, nur ausgewählte Beispielsätze je Lektion).", "hu": "A „Szeressük az embereket, és tegyük őket tanítványokká” füzet eredeti Excel-fájljának teljes tartalma. Mind a 12 lecke és a függelékek 12 nyelven vethetők össze.", "id": "Konten lengkap dari data sumber Excel asli brosur 'Kasihi Orang dan Buatlah Murid'. Bab 1–12 dan Lampiran A, B, C dapat dibandingkan dalam 12 bahasa.", "ja": "『人々を愛し，弟子を作る』ブロシュアーのExcel原本データをそのまま収録したコンテンツです。第1～12課と付録A・B・Cを12言語で対照できます。隣の［人々を愛し，弟子を作る］タブ（5言語、各課の代表例文のみを選んだ版）とは異なる、より完全な原文資料です。", "pl": "Pełna treść oryginalnych danych programu Excel broszury „Kochaj ludzi i pomagaj im stawać się uczniami”. Wszystkie 12 lekcji i dodatki zestawione w 12 językach."},
    "베트남의 문화, 음식, 풍습, 일상생활에 대한 유용한 이야기예요.": {"vi": "Những câu chuyện hữu ích về văn hóa, ẩm thực, phong tục và đời sống hằng ngày của Việt Nam.", "cs": "Užitečné informace o vietnamské kultuře, jídle, zvycích a každodenním životě.", "zh_cn": "关于越南文化、美食、习俗和日常生活的实用知识介绍。", "zh": "關於越南文化、飲食、風俗和日常生活的實用故事。", "en": "Useful stories about Vietnamese culture, food, customs, and daily life.", "fr": "Des récits utiles sur la culture, la cuisine, les coutumes et la vie quotidienne au Vietnam.", "de": "Nützliche Geschichten über Kultur, Essen, Bräuche und Alltag in Vietnam.", "hu": "Hasznos történetek a vietnámi kultúráról, ételekről, szokásokról és a mindennapi életről.", "id": "Kisah dan informasi bermanfaat tentang budaya, makanan, adat istiadat, dan kehidupan sehari-hari di Vietnam.", "ja": "ベトナムの文化、食べ物、風習、日常生活についての役立つ話です。", "pl": "Przydatne informacje o kulturze, jedzeniu, zwyczajach i życiu codziennym w Wietnamie."},
    "(여)": {"vi": "(nữ)", "cs": "(žena)", "zh_cn": "（女）", "zh": "（女）", "en": "(female)", "fr": "(femme)", "de": "(weiblich)", "hu": "(nő)", "id": "(wanita)", "ja": "（女性）", "pl": "(kobieta)"},
    "글자 수": {"vi": "Số chữ", "cs": "Počet písmen", "zh_cn": "字数", "zh": "字數", "en": "Letter count", "fr": "Nombre de lettres", "de": "Buchstabenzahl", "hu": "Karakterszám", "id": "Jumlah Huruf", "ja": "文字数", "pl": "Liczba liter"},
    "글자순": {"vi": "Theo bảng chữ cái", "cs": "Abecedně", "zh_cn": "按字母顺序", "zh": "按字母順序", "en": "Alphabetical", "fr": "Ordre alphabétique", "de": "Alphabetisch", "hu": "Betűrendben", "id": "Urutan Huruf", "ja": "アルファベット順", "pl": "Alfabetycznie"},
    "기본 순서": {"vi": "Thứ tự mặc định", "cs": "Výchozí pořadí", "zh_cn": "默认顺序", "zh": "預設順序", "en": "Default order", "fr": "Ordre par défaut", "de": "Standardreihenfolge", "hu": "Alapértelmezett sorrend", "id": "Urutan Standar", "ja": "既定の順序", "pl": "Domyślna kolejność"},
    "나이대": {"vi": "Độ tuổi", "cs": "Věková skupina", "zh_cn": "年龄段", "zh": "年齡層", "en": "Age range", "fr": "Tranche d'âge", "de": "Altersgruppe", "hu": "Korosztály", "id": "Kelompok Usia", "ja": "年齢層", "pl": "Przedział wiekowy"},
    "내가 상대방보다 나이가 적음 (동생뻘)": {"vi": "Tôi nhỏ tuổi hơn người đó (như em)", "cs": "Jsem mladší než druhá osoba (jako mladší sourozenec)", "zh_cn": "我比对方年纪小（像弟弟妹妹）", "zh": "我比對方年紀小（像弟弟妹妹）", "en": "I'm younger than them (like a younger sibling)", "fr": "Je suis plus jeune que la personne (comme un cadet)", "de": "Ich bin jünger als die Person (wie ein jüngeres Geschwister)", "hu": "Fiatalabb vagyok a másik félnél (mint egy fiatalabb testvér)", "id": "Saya lebih muda dari lawan bicara (seusia adik)", "ja": "私が相手より年下（弟・妹のような立場）", "pl": "Jestem młodszy od tej osoby (jak młodsze rodzeństwo)"},
    "내가 상대방보다 약간 연장자 (형·누나·오빠·언니뻘)": {"vi": "Tôi hơi lớn tuổi hơn người đó (như anh chị)", "cs": "Jsem o něco starší než druhá osoba (jako starší bratr/sestra)", "zh_cn": "我比对方年长一些（像哥哥姐姐）", "zh": "我比對方年長一些（像哥哥姐姐）", "en": "I'm a bit older than them (like an older sibling)", "fr": "Je suis un peu plus âgé que la personne (comme un aîné)", "de": "Ich bin etwas älter als die Person (wie ein älteres Geschwister)", "hu": "Kissé idősebb vagyok a másik félnél (mint egy idősebb testvér)", "id": "Saya sedikit lebih tua dari lawan bicara (seusia kakak)", "ja": "私が相手より少し年上（兄・姉のような立場）", "pl": "Jestem nieco starszy od tej osoby (jak starsze rodzeństwo)"},
    "\"행복한 삶을 영원히 누리십시오!\" 교재의 엑셀 원본 자료를 그대로 옮긴 콘텐츠예요. 72개 항목(1~60과·부별 복습·미디어 자료·참조 자료 등)을 12개 언어로 대조할 수 있어요. 옆의 [행복한 삶을 영원히] 탭(5개 언어, 문장 단위로 나눈 버전)과는 다른, 더 완전한 원문 자료예요.": {"vi": "Nội dung được chuyển nguyên từ dữ liệu Excel gốc của giáo trình \"Vui sống mãi mãi!\". Có thể đối chiếu 72 mục (bài 1–60, ôn tập từng phần, tài liệu đa phương tiện, chú thích, v.v.) bằng 12 ngôn ngữ. Đây là nguồn đầy đủ hơn so với thẻ [Vui sống mãi mãi] bên cạnh (5 ngôn ngữ, được chia theo từng câu).", "cs": "Kompletní data z původního souboru aplikace Excel pro učebnici „Radujte se ze života navždy!“. Všech 72 položek lze porovnávat ve 12 jazycích.", "zh_cn": "《永远享受美好的生命！》教材Excel原始资料的完整内容。72个项目可在12种语言间对照。", "zh": "這是將《永遠享受美好的生活！》教材的Excel原始資料原樣收錄的內容，可用12種語言對照72個項目（第1～60課、各部複習、多媒體資料、參考資料等）。這是比旁邊的［永遠享受美好的生活］分頁（5種語言，按句子劃分的版本）更完整的原文資料。", "en": "The \"Enjoy Life Forever!\" course's original Excel data, carried over as is. All 72 items (Lessons 1–60, section reviews, media, endnotes, etc.) can be compared across 12 languages. This is a more complete source than the neighboring [Enjoy Life Forever] tab (5 languages, split into individual sentences).", "fr": "Les données Excel d'origine du cours « Vivez heureux pour toujours ! », reprises telles quelles. Les 72 éléments (leçons 1 à 60, révisions de section, contenus multimédias, notes, etc.) peuvent être comparés dans 12 langues. C'est une source plus complète que l'onglet voisin [Vivez heureux pour toujours] (5 langues, découpé phrase par phrase).", "de": "Die ursprünglichen Excel-Daten des Kurses „Glücklich — für immer!“, unverändert übernommen. Alle 72 Einheiten (Lektionen 1–60, Teilwiederholungen, Medien, Anmerkungen usw.) lassen sich in 12 Sprachen vergleichen. Dies ist eine vollständigere Quelle als der benachbarte Tab [Glücklich — für immer] (5 Sprachen, in einzelne Sätze aufgeteilt).", "hu": "A „Boldog élet most és mindörökké!” tankönyv eredeti Excel-fájljának teljes tartalma. Mind a 72 tétel összevethető 12 nyelven.", "id": "Konten lengkap dari data sumber Excel asli buku pelajaran 'Hidup Bahagia Selamanya!'. Semua 72 materi dapat dibandingkan dalam 12 bahasa.", "ja": "『いつまでも幸せに暮らせます！』教材のExcel原本データをそのまま収録したコンテンツです。72項目（第1～60課・各部の復習・メディア資料・参照資料など）を12言語で対照できます。隣の［いつまでも幸せに暮らせます］タブ（5言語、文ごとに分けた版）とは異なる、より完全な原文資料です。", "pl": "Pełna treść oryginalnych danych programu Excel podręcznika „Ciesz się życiem na zawsze!”. Wszystkie 72 pozycje zestawione w 12 językach."},
  ...
  function applySiteCrossLink() {
    ...
    var wrapEl = crossLinkEl.parentNode;
    if (wrapEl) wrapEl.hidden = !!SITE_CROSS_LINK.ko_only && currentLang !== "ko";
  ...
  (function () {
    var shortNamesByLang = {
      en: { curriculum: "Course", pron: "Phonics", bible: "Bible", wizard: "Talks", vocab: "Voca", sentence: "Clauses", grammar: "Usage", review: "Review" },
      de: { curriculum: "Kurs", pron: "Laut", bible: "Bibel", wizard: "Dialog", vocab: "Wortsch.", sentence: "Satz", grammar: "Gramm.", review: "Wdh." },
      fr: { curriculum: "Cours", pron: "Sons", bible: "Bible", wizard: "Dialog", vocab: "Vocab.", sentence: "Phrase", grammar: "Gramm.", review: "Rév." },
      pl: { curriculum: "Kurs", pron: "Wymowa", bible: "Biblia", wizard: "Rozm.", vocab: "Słown.", sentence: "Zdanie", grammar: "Gram.", review: "Powt." },
      cs: { curriculum: "Kurz", pron: "Výsl.", bible: "Bible", wizard: "Dialog", vocab: "Slovn.", sentence: "Věta", grammar: "Gram.", review: "Opak." },
      ...
      hu: { curriculum: "Kurzus", pron: "Kiejt.", bible: "Biblia", wizard: "Beszéd", vocab: "Szók.", sentence: "Mondat", grammar: "Nytan", review: "Ism." },
      id: { curriculum: "Kursus", pron: "Lafal", bible: "Alkitab", wizard: "Dialog", vocab: "Kosa k.", sentence: "Kalimat", grammar: "Tata B.", review: "Ulas" },
    ...
    var shortReviewByLang = {
      en: { song: "Songs", pron: "Phonics", bible: "Bible", wizard: "Talks", vocab: "Voca", sentence: "Clauses", grammar: "Usage" },
      de: { song: "Lieder", pron: "Laut", bible: "Bibel", wizard: "Dialog", vocab: "Wortsch.", sentence: "Satz", grammar: "Gramm." },
      fr: { song: "Chants", pron: "Sons", bible: "Bible", wizard: "Dialog", vocab: "Vocab.", sentence: "Phrase", grammar: "Gramm." },
      pl: { song: "Pieśni", pron: "Wymowa", bible: "Biblia", wizard: "Rozm.", vocab: "Słown.", sentence: "Zdanie", grammar: "Gram." },
      cs: { song: "Písně", pron: "Výsl.", bible: "Bible", wizard: "Dialog", vocab: "Slovn.", sentence: "Věta", grammar: "Gram." },
      hu: { song: "Dalok", pron: "Kiejt.", bible: "Biblia", wizard: "Beszéd", vocab: "Szók.", sentence: "Mondat", grammar: "Nytan" },
      id: { song: "Lagu", pron: "Lafal", bible: "Alkitab", wizard: "Dialog", vocab: "Kosa k.", sentence: "Kalimat", grammar: "Tata B." },
    ...
    // Sub-menu buttons on phone-width screens (< 1000px): short labels, keyed by the button's
    // data-i18n Korean key. The full TU() name is used on desktop and kept as aria-label.
    var SUBTAB_SHORT_NAMES = {
      "발음": {"de": "Laut", "fr": "Sons", "cs": "Výsl."},
      "첫만남": {"en": "1st Talk", "de": "1. Gespräch", "fr": "1er contact", "pl": "1. rozmowa", "cs": "1. rozhovor", "hu": "1. beszélg.", "id": "Kenalan", "vi": "Gặp đầu"},
      "호칭": {"en": "Address", "de": "Anrede", "fr": "Adresse", "pl": "Zwroty", "hu": "Megszólítás", "vi": "Xưng hô"},
      "일상 회화": {"en": "Everyday", "de": "Alltag", "fr": "Quotidien", "pl": "Codzienne", "cs": "Běžná konv.", "hu": "Mindennapi", "id": "Sehari-hari", "vi": "Hằng ngày"},
      "제공 연설": {"de": "Vorschläge", "fr": "Modèles", "pl": "Wzory", "cs": "Vzory", "hu": "Minták", "id": "Khotbah", "vi": "Bài mẫu"},
      "이웃 사람과의 대화": {"en": "Neighbor", "de": "Bibelgespr.", "fr": "Prochain", "pl": "O Biblii", "cs": "Soused", "hu": "Felebarát", "id": "Tetangga", "vi": "Lân cận"},
      "한자음": {"en": "Sino-Viet", "de": "Sino-Viet", "fr": "Sino-Viet", "pl": "Sino-Viet", "cs": "Sino-Viet", "hu": "Sino-Viet", "id": "Sino-Viet"},
      "어순반대": {"en": "Reversed", "de": "Umgekehrt", "fr": "Inversé", "pl": "Odwrócony", "cs": "Obrácený", "hu": "Fordított", "id": "Terbalik", "vi": "Đảo ngữ"},
      "동일음": {"en": "Homophone", "de": "Gleichlaut", "hu": "Azonos"},
      "반의": {"de": "Gegenteil", "hu": "Ellentét"},
      "끝말": {"en": "Chain", "de": "Kette", "fr": "Chaîne", "pl": "Łańcuch", "cs": "Řetězec", "id": "Rantai"},
      "남북 단어": {"en": "N/S Words", "de": "N/S-Wörter", "fr": "Mots N/S", "pl": "Płn/Płd", "cs": "S/J slova", "hu": "É/D szavak", "id": "Kata U/S", "vi": "Từ B/N"},
      "일상 생활": {"de": "Alltag", "fr": "Quotidien", "pl": "Codzienne", "cs": "Každodenní", "hu": "Mindennapi", "id": "Sehari-hari", "vi": "Đời sống"},
      "행복한 삶을 영원히": {"en": "Enjoy Life", "de": "Glücklich", "fr": "Vivez", "pl": "Ciesz się", "cs": "Radujte se", "hu": "Boldog élet", "id": "Hidup Bahagia", "vi": "Vui sống"},
      "사람들을 사랑하고 제자로": {"en": "Love People", "de": "Menschen lieben", "fr": "Aimez les gens", "pl": "Kochaj ludzi", "cs": "Mějte rádi lidi", "hu": "Szeressük", "id": "Kasihi Orang", "vi": "Yêu thương"},
      "파수대": {"fr": "Tour de Garde", "id": "Menara P."},
      "설정": {"de": "Einstell.", "fr": "Réglages", "pl": "Ustaw.", "hu": "Beállít.", "id": "Setelan"},
      "남북 발음": {"en": "N/S Sounds", "de": "N/S-Laute", "fr": "Sons N/S", "pl": "Płn/Płd", "cs": "S/J výsl.", "hu": "É/D kiejtés", "id": "Lafal U/S", "vi": "Bắc/Nam"},
      "요일, 날짜": {"en": "Days", "de": "Tage", "fr": "Jours", "pl": "Dni", "cs": "Dny", "hu": "Napok", "id": "Hari"},
      "달, 계절": {"en": "Months", "de": "Monate", "fr": "Mois", "pl": "Miesiące", "cs": "Měsíce", "hu": "Hónapok", "id": "Bulan", "vi": "Tháng"},
      "일반 문법": {"en": "Grammar", "de": "Grammatik", "fr": "Grammaire", "pl": "Gramatyka", "cs": "Gramatika", "hu": "Nyelvtan", "id": "Tata bahasa", "vi": "Ngữ pháp"},
      "예문": {"de": "Beispiele", "id": "Contoh"},
      "특강": {"en": "Special", "de": "Themen", "fr": "Spécial", "pl": "Specjalna", "cs": "Témata", "hu": "Témák", "id": "Khusus"},
      "범용 언어 생성표": {"en": "Chart", "de": "Tabelle", "fr": "Tableau", "pl": "Tabela", "cs": "Tabulka", "hu": "Táblázat", "id": "Tabel", "vi": "Bảng câu"},
      "문장 생성기": {"en": "Builder", "de": "Generator", "fr": "Générateur", "pl": "Generator", "cs": "Generátor", "hu": "Generátor", "id": "Pembuat", "vi": "Tạo câu"}
    };
    ...
    function syncPrimaryTabLabels() {
      ...
      var phoneWidth = window.innerWidth < 1000;
      document.querySelectorAll(".subtab-row .subtab-btn[data-i18n]").forEach(function (btn) {
        if (btn.closest("#panel-review > .subtab-row:first-child")) return;
        var key = btn.getAttribute("data-i18n");
        var short = phoneWidth && SUBTAB_SHORT_NAMES[key] && SUBTAB_SHORT_NAMES[key][currentLang];
        var fullName = TU(key);
        btn.textContent = short || fullName;
        if (short) btn.setAttribute("aria-label", fullName);
        else btn.removeAttribute("aria-label");
      });
    }
  ...
  // CJK attach the counter word (338회 / 338次 / 338回); the other languages separate it with a space.
  function timesLabel(n) {
    if (currentLang === "en") return n + " " + TU("회") + (n === 1 ? "" : "s");
    if (["ko", "zh", "zh_cn", "ja"].indexOf(currentLang) >= 0) return n + TU("회");
    return n + " " + TU("회");
  }
  ...
  function normalizeReadAllEntry(t) {
    ...
    // ["", text] is an explanation-only step: read in the UI language's voice with no Vietnamese before it.
    if (!vi && !mean) return null;
  ...
  // The place saved by the previous visit, read before anything below saves a new one (start-up
  // code selects default subtabs, which saves). None saved = a truly first visit.
  var SAVED_PLACE_RAW = null;
  try { SAVED_PLACE_RAW = window.localStorage ? window.localStorage.getItem(LAST_PLACE_STORAGE_KEY) : null; } catch (e) { /* no-op */ }
  var IS_FIRST_VISIT = SAVED_PLACE_RAW === null;
  var lastPlaceState = {
    tab: "review",
    subtabs: {},
    scrollY: 0
  ...
  // stored machine translation (GENERAL_PDF_AI_TRANSLATIONS, never Korean). Nothing else -- in particular no Korean.
  function pdfSentenceTr(row) {
    if (!row) return "";
    var src = row.translations && row.translations[currentLang];
    if (src) return src;
  ...
  function renderGeneralPdf() {
    ...
    if (sentRoot) {
      ...
      sentRows.forEach(function (row, rowIndex) {
        var card = document.createElement("article");
        card.className = "curr-card";
        if (row.id) card.dataset.pdfId = row.id;
        card.dataset.anchor = "pdf-sentence-" + (rowIndex + 1);
        ...
        var translated = pdfSentenceTr(row);
        if (translated) {
          var transDiv = document.createElement("div");
          transDiv.className = "card-translation";
          if (!(row.translations && row.translations[currentLang])) transDiv.dataset.translationSource = "ai";
    ...
    if (gramRoot) {
      ...
      // Non-Korean UI: the explanations in these pages are Korean-only source text. The Vietnamese sentences are
      // the content (each with [듣기], plus its meaning when it is one of the [문장] sentences), and the Korean
      // source stays available in a collapsed, labeled "original" block rather than standing in for a translation.
      var koView = currentLang === "ko";
      function normPdfVi(t) { return String(t || "").toLowerCase().replace(/[.!?…,;:"“”'‘’()\s]+/g, " ").trim(); }
      var sentTrByVi = {};
      if (!koView) {
        (GENERAL_PDF.sentences || []).forEach(function (r) {
          var tr = pdfSentenceTr(r);
          if (r.vi && tr) sentTrByVi[normPdfVi(r.vi)] = tr;
        });
      }
      function renderViRowsTo(container, lines) {
        lines.forEach(function (line) {
          if (line.trim().startsWith("단어")) return;
          viRunsOf(line).forEach(function (r) {
            var viRow = document.createElement("div");
            viRow.className = "pdf-vi-row";
            var viSpan = document.createElement("span");
            viSpan.className = "vn";
            viSpan.textContent = r.text;
            viRow.appendChild(viSpan);
            viRow.appendChild(speakButton(r.text));
            var tr = currentLang === "vi" ? "" : sentTrByVi[normPdfVi(r.text)];
            if (tr) {
              var trDiv = document.createElement("div");
              trDiv.className = "pdf-vi-tr";
              trDiv.textContent = tr;
              viRow.appendChild(trDiv);
            }
            container.appendChild(viRow);
          });
        });
      }
      function originalSourceTo(container, lines) {
        var src = document.createElement("details");
        src.className = "pdf-original-source";
        var srcSummary = document.createElement("summary");
        srcSummary.textContent = lines.some(function (l) { return /[가-힣]/.test(l); }) ? TU("원문 (한국어)") : TU("원문");
        src.appendChild(srcSummary);
        var srcBody = document.createElement("div");
        renderLinesTo(srcBody, lines);
        src.appendChild(srcBody);
        container.appendChild(src);
      }
      // Machine translations of a section (GENERAL_PDF_GRAMMAR_AI["<row id>#<section index>"][lang] = {t, b}): b is the
      // whole section -- explanation and example meanings -- in that language, with the Vietnamese kept verbatim
      // inside ⟦ ⟧ so it can be shown with [듣기] and read in the Vietnamese voice.
      var GRAM_AI = (typeof GENERAL_PDF_GRAMMAR_AI !== "undefined" && GENERAL_PDF_GRAMMAR_AI) || {};
      function sectionAi(key, lines) {
        var entry = GRAM_AI[key];
        var tr = entry && entry[currentLang];
        if (!tr || !tr.b) return null;
        // Korean view keeps the Korean source; it only uses a translation for sections that have no Korean at all.
        if (koView && lines.some(function (l) { return /[가-힣]/.test(l); })) return null;
        return tr;
      }
      var MARK_RE = /⟦([^⟧]*)⟧/;
      function renderMarkedTo(container, text) {
        String(text).split("\n").forEach(function (line) {
          if (!line.trim()) return;
          var lineDiv = document.createElement("div");
          lineDiv.className = "pdf-tr-line";
          line.split(MARK_RE).forEach(function (part, i) {
            if (!part) return;
            if (i % 2) {
              var vi = document.createElement("span");
              vi.className = "vn pdf-tr-vi";
              vi.textContent = part;
              lineDiv.appendChild(vi);
              lineDiv.appendChild(speakButton(part));
            } else {
      ...
      function markedReadEntries(text) {
        return readEntriesFromParts(String(text).split("\n").map(function (line) { return line.split(MARK_RE); }));
      }
      function originalReadEntries(lines) {
        return readEntriesFromParts(lines.filter(function (l) { return !l.trim().startsWith("단어"); }).map(function (line) {
          var parts = [], pos = 0;
          viRunsOf(line).forEach(function (r) {
            parts.push(line.slice(pos, r.start), r.text);
            pos = r.end;
          });
      ...
      function sectionReadEntries(lines, ai) {
        if (ai) return markedReadEntries(ai.b);
        if (koView) return originalReadEntries(lines);
        var out = [];
        lines.forEach(function (line) {
          if (line.trim().startsWith("단어")) return;
          viRunsOf(line).forEach(function (r) {
            out.push([r.text, currentLang === "vi" ? "" : (sentTrByVi[normPdfVi(r.text)] || "")]);
          });
        });
        return out;
      }
      function renderSectionBody(container, lines, ai) {
        if (ai) {
          renderMarkedTo(container, ai.b);
          originalSourceTo(container, lines);
          return;
        }
        if (koView) { renderLinesTo(container, lines); return; }
        renderViRowsTo(container, lines);
        originalSourceTo(container, lines);
      }
      // "1. 인사 표현" -> "1. Chào anh." outside Korean: the heading's own Vietnamese, else the section's first sentence.
      function sectionTitleText(title, lines) {
        if (koView || !/[가-힣]/.test(title)) return title;
        var num = (title.match(/^\d+/) || [""])[0];
        var runs = viRunsOf(title);
        var text = runs.length ? runs[0].text : (viTextsOf(lines)[0] || TU("문법"));
  ...
  // [단어] tag on/off: hides every word's tag pills (the filter menu stays). Remembered per browser.
  var wordsShowTags = true;
  try { wordsShowTags = window.localStorage.getItem("vn-word-tags") !== "off"; } catch (e) { /* no-op */ }
  var WORD_TAG_TOGGLE_LABEL = { vi: "Thẻ", cs: "Štítky", zh_cn: "标签", zh: "標籤", en: "Tags", fr: "Tags", de: "Tags", hu: "Címkék", id: "Tag", ja: "タグ", ko: "태그", pl: "Tagi" };
  // [어휘] > [단어] tags: one entry per filter, in menu order. `menu` is the filter-button label,
  // `short` the compact label on each word's own tag pill -- both share one color class
  // (tag-k-<key>). Word-category tags come from UNIFIED_WORDS[].tags (source names mapped by
  // WORD_TAG_KEY); the JW/WT/노래/영원히 source tags from JW_EXTRACTION_DATA occurrence counts.
  var WORD_TAG_DEFS = [
    { key: "all", menu: {"vi": "Tất cả", "cs": "Vše", "zh_cn": "全部", "zh": "全部", "en": "All", "fr": "Tous", "de": "Alle", "hu": "Összes", "id": "Semua", "ja": "すべて", "ko": "전체", "pl": "Wszyst­kie"}, short: {"vi": "Tất cả", "cs": "Vše", "zh_cn": "全部", "zh": "全部", "en": "All", "fr": "Tous", "de": "Alle", "hu": "Össz.", "id": "Semua", "ja": "すべて", "ko": "전체", "pl": "Wsz."} },
    { key: "base", menu: {"vi": "Cơ bản", "cs": "Základ", "zh_cn": "基本", "zh": "基本", "en": "Basic", "fr": "Base", "de": "Basis", "hu": "Alap", "id": "Dasar", "ja": "基本", "ko": "기본", "pl": "Podst."}, short: {"vi": "Cơ bản", "cs": "Zákl.", "zh_cn": "基本", "zh": "基本", "en": "Basic", "fr": "Base", "de": "Basis", "hu": "Alap", "id": "Dasar", "ja": "基本", "ko": "기본", "pl": "Podst."} },
    { key: "freq", menu: {"vi": "Thông dụng", "cs": "Běžné", "zh_cn": "常用", "zh": "常用", "en": "Usual", "fr": "Usuel", "de": "Üblich", "hu": "Gyakori", "id": "Umum", "ja": "常用", "ko": "상용", "pl": "Częste"}, short: {"vi": "T.dụng", "cs": "Běž.", "zh_cn": "常用", "zh": "常用", "en": "Usual", "fr": "Usuel", "de": "Übl.", "hu": "Gyak.", "id": "Umum", "ja": "常用", "ko": "상용", "pl": "Częs."} },
    { key: "theo", menu: {"vi": "Thần quyền", "cs": "Teokr.", "zh_cn": "神治", "zh": "神治", "en": "Theocr.", "fr": "Théocr.", "de": "Theokr.", "hu": "Teokr.", "id": "Teokr.", "ja": "神権", "ko": "신권", "pl": "Teokr."}, short: {"vi": "T.quyền", "cs": "Teokr.", "zh_cn": "神治", "zh": "神治", "en": "Theo.", "fr": "Théo.", "de": "Theo.", "hu": "Teo.", "id": "Teo.", "ja": "神権", "ko": "신권", "pl": "Teo."} },
    { key: "names", menu: {"vi": "Tên riêng", "cs": "Jména", "zh_cn": "人名", "zh": "人名", "en": "Names", "fr": "Noms", "de": "Namen", "hu": "Nevek", "id": "Nama", "ja": "人名", "ko": "인명", "pl": "Imiona"}, short: {"vi": "Tên", "cs": "Jm.", "zh_cn": "人名", "zh": "人名", "en": "Name", "fr": "Nom", "de": "Name", "hu": "Név", "id": "Nama", "ja": "人名", "ko": "인명", "pl": "Imię"} },
    { key: "sino", menu: {"vi": "Hán Việt", "cs": "Sino-Viet", "zh_cn": "汉字", "zh": "漢字", "en": "Sino-Viet", "fr": "Sino-Viet", "de": "Sino-Viet", "hu": "Sino-Viet", "id": "Sino-Viet", "ja": "漢字", "ko": "한자", "pl": "Sino-Viet"}, short: {"vi": "Hán", "cs": "Sino-Viet", "zh_cn": "汉字", "zh": "漢字", "en": "Sino-Viet", "fr": "Sino-Viet", "de": "Sino-Viet", "hu": "Sino-Viet", "id": "Sino-Viet", "ja": "漢字", "ko": "한자", "pl": "Sino-Viet"} },
    { key: "order", menu: {"vi": "Đảo ngữ", "cs": "Obrác.", "zh_cn": "语序", "zh": "語序", "en": "Re­versed", "fr": "Inversé", "de": "Umge­kehrt", "hu": "Fordí­tott", "id": "Terbalik", "ja": "語順", "ko": "어순", "pl": "Odwrot."}, short: {"vi": "Đảo", "cs": "Obr.", "zh_cn": "语序", "zh": "語序", "en": "Reversed", "fr": "Inv.", "de": "Umg.", "hu": "Ford.", "id": "Balik", "ja": "語順", "ko": "어순", "pl": "Odwr."} },
    { key: "homo", menu: {"vi": "Đồng âm", "cs": "Homo­fony", "zh_cn": "同音", "zh": "同音", "en": "Homo­phone", "fr": "Homo­phone", "de": "Homo­phon", "hu": "Homo­fón", "id": "Homo­fon", "ja": "同音", "ko": "동일", "pl": "Homo­fony"}, short: {"vi": "Đ.âm", "cs": "Homof.", "zh_cn": "同音", "zh": "同音", "en": "Homo.", "fr": "Homo.", "de": "Homo.", "hu": "Hom.", "id": "Homo.", "ja": "同音", "ko": "동일", "pl": "Homo."} },
    { key: "ant", menu: {"vi": "Trái nghĩa", "cs": "Anto­nyma", "zh_cn": "反义", "zh": "反義", "en": "Anto­nym", "fr": "Anto­nyme", "de": "Anto­nym", "hu": "Ellen­tét", "id": "Anto­nim", "ja": "反意", "ko": "반의", "pl": "Anto­nimy"}, short: {"vi": "T.nghĩa", "cs": "Ant.", "zh_cn": "反义", "zh": "反義", "en": "Anto.", "fr": "Ant.", "de": "Ant.", "hu": "Ell.", "id": "Anto.", "ja": "反意", "ko": "반의", "pl": "Ant."} },
    { key: "daily", menu: {"vi": "Hằng ngày", "cs": "Denní", "zh_cn": "日常", "zh": "日常", "en": "Every­day", "fr": "Quoti­dien", "de": "Alltag", "hu": "Napi", "id": "Harian", "ja": "日常", "ko": "일상", "pl": "Codzien­ne"}, short: {"vi": "H.ngày", "cs": "Den.", "zh_cn": "日常", "zh": "日常", "en": "Everyday", "fr": "Quot.", "de": "Allt.", "hu": "Napi", "id": "Harian", "ja": "日常", "ko": "일상", "pl": "Codz."} },
    { key: "lff", menu: {"vi": "Vui hưởng", "cs": "Užívej", "zh_cn": "享受", "zh": "享受", "en": "Enjoy Life", "fr": "Vivez", "de": "Glück­lich", "hu": "Élvezd", "id": "Nikmati", "ja": "楽しく", "ko": "행누", "pl": "Ciesz się"}, short: {"vi": "V.hưởng", "cs": "Užív.", "zh_cn": "享受", "zh": "享受", "en": "ELF", "fr": "Viv.", "de": "Glück", "hu": "Élv.", "id": "Nikm.", "ja": "楽しく", "ko": "행누", "pl": "Ciesz"} },
    { key: "song", menu: {"vi": "Bài hát", "cs": "Písně", "zh_cn": "诗歌", "zh": "詩歌", "en": "Songs", "fr": "Can­tiques", "de": "Lieder", "hu": "Énekek", "id": "Lagu", "ja": "歌", "ko": "노래", "pl": "Pieśni"}, short: {"vi": "Hát", "cs": "Píseň", "zh_cn": "诗歌", "zh": "詩歌", "en": "Song", "fr": "Cant.", "de": "Lied", "hu": "Ének", "id": "Lagu", "ja": "歌", "ko": "노래", "pl": "Pieśń"} },
    { key: "jw", menu: {"vi": "JW", "cs": "JW", "zh_cn": "JW", "zh": "JW", "en": "JW", "fr": "JW", "de": "JW", "hu": "JW", "id": "JW", "ja": "JW", "ko": "JW", "pl": "JW"}, short: {"vi": "JW", "cs": "JW", "zh_cn": "JW", "zh": "JW", "en": "JW", "fr": "JW", "de": "JW", "hu": "JW", "id": "JW", "ja": "JW", "ko": "JW", "pl": "JW"} },
    ...
    { key: "elf", menu: {"vi": "Mãi mãi", "cs": "Navždy", "zh_cn": "永远", "zh": "永遠", "en": "Forever", "fr": "Tou­jours", "de": "Für immer", "hu": "Örökké", "id": "Abadi", "ja": "永遠", "ko": "영원히", "pl": "Na zawsze"}, short: {"vi": "Mãi", "cs": "Navž.", "zh_cn": "永远", "zh": "永遠", "en": "Fvr.", "fr": "Touj.", "de": "Imm.", "hu": "Örök", "id": "Abadi", "ja": "永遠", "ko": "영원", "pl": "Zaw."} }
  ];
  var WORD_TAG_KEY = { "기본": "base", "상용": "freq", "신권": "theo", "인명": "names", "한자음": "sino", "어순반대": "order", "동일음": "homo", "반의": "ant", "PDF": "daily", "행누": "lff", "남북": "ns" };
  ...
  function wordTagShortLabel(key) { var d = wordTagDef(key); return d.short[currentLang] || d.short.ko; }
  function wordJwFrequency(w) {
    if (typeof JW_EXTRACTION_DATA === "undefined" || !JW_EXTRACTION_DATA || !JW_EXTRACTION_DATA.vocabFrequencies) return null;
    var jf = JW_EXTRACTION_DATA.vocabFrequencies[w.vi.toLowerCase()] || JW_EXTRACTION_DATA.vocabFrequencies[w.vi];
    return jf && jf.totalOccurrences > 0 ? jf : null;
  }
  // Every tag a word carries, in WORD_TAG_DEFS order, each with its pill text.
  function wordTagEntries(w) {
    var has = {};
    (w.tags || []).forEach(function (t) { if (WORD_TAG_KEY[t]) has[WORD_TAG_KEY[t]] = wordTagShortLabel(WORD_TAG_KEY[t]); });
    if (has.ns && w.dialectNo) has.ns += " " + w.dialectNo;
    var jf = wordJwFrequency(w);
    if (jf) {
      has.jw = "JW " + timesLabel(jf.totalOccurrences);
      var by = jf.bySourceType || {};
      Object.keys(WORD_SOURCE_TAG).forEach(function (key) {
        if (by[WORD_SOURCE_TAG[key]]) has[key] = wordTagShortLabel(key) + " " + by[WORD_SOURCE_TAG[key]];
      });
    }
  ...
  function renderVocabWords(root, q) {
    ...
    if (filterEl) {
      ...
      if (!presentTags[activeWordTag]) activeWordTag = "all";
      var filterHtml = '';
      shownTags.forEach(function (d) {
        var isActive = activeWordTag === d.key;
        filterHtml += '<button type="button" class="tag-filter-btn tag-k-' + d.key + (isActive ? ' active' : '') + '" data-tag="' + escapeAttr(d.key) + '" aria-pressed="' + (isActive ? 'true' : 'false') + '">' + escapeHtml(wordTagMenuLabel(d.key)) + '</button>';
      });
      // Always two rows: JW profiles' 16 tags -> 8 per row, GENERAL's smaller set -> 5 per row.
      filterEl.style.setProperty("--tag-cols", String(Math.max(5, Math.ceil(shownTags.length / 2))));
    ...
    var html = '<div class="chain-note" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:4px;">' +
      '<span>' + TU("총 ") + filtered.length + TU("개 단어") + (activeWordTag !== "all" ? ' (' + wordTagMenuLabel(activeWordTag) + ')' : '') + '</span>' +
      '<button type="button" class="tag-filter-btn word-sort-btn" data-sort="frequency" aria-pressed="' + (wordsSortByFrequency ? 'true' : 'false') + '">' + escapeHtml(TU("빈도가 많은 순")) + '</button>' +
      '<button type="button" class="tag-filter-btn word-tag-toggle" aria-pressed="' + (wordsShowTags ? 'true' : 'false') + '">' +
        escapeHtml((WORD_TAG_TOGGLE_LABEL[currentLang] || WORD_TAG_TOGGLE_LABEL.ko) + (wordsShowTags ? ' ON' : ' OFF')) + '</button>' +
    ...
    slice.forEach(function (w) {
      var mean = getWordMeaning(w);
        html += '<div class="bible-item"' + (w.pdf_id ? ' data-pdf-id="' + escapeAttr(w.pdf_id) + '"' : '') + '><div class="bible-body">' +
          ...
          wordTagEntries(w).map(function (e) { return '<span class="word-tag-pill tag-k-' + e.key + '">' + escapeHtml(e.text) + '</span>'; }).join('') +
          '</div></div>' +
    ...
    root.classList.toggle("hide-word-tags", !wordsShowTags);
    root.querySelector(".word-tag-toggle").addEventListener("click", function () {
      wordsShowTags = !wordsShowTags;
      try { window.localStorage.setItem("vn-word-tags", wordsShowTags ? "on" : "off"); } catch (e) { /* no-op */ }
      renderVocabWords(root, q);
    });
    root.querySelector(".word-sort-btn").addEventListener("click", function () {
  ...
  function renderGrammar() {
    ...
    GRAMMAR_INTRO.forEach(function (sec) {
      introHtml += '<div class="gr-intro-card"><div class="gr-intro-title" style="display:flex;align-items:baseline;justify-content:space-between;gap:8px;flex-wrap:wrap"><span>' + escapeHtml(T(sec.title)) + '</span>' +
        readAllButtonHtml([["", T(sec.title)], ["", T(sec.desc)]].concat(sec.examples.map(function (ex) { return [ex.vi, [T(ex.kr), T(ex.note)].filter(Boolean).join(". ")]; }))) + '</div>' +
    ...
    GRAMMAR_UNITS.forEach(function (u, ui) {
      unitsHtml += '<div class="group-card" data-open="' + (ui === 0 ? "true" : "false") + '" data-syl="gru' + ui + '">' +
        ...
        '<span class="chev"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg></span></button>' +
        readAllButtonHtml([["", T(u.note)]].concat(u.steps.map(function (s) { return [s.vi, T(s.kr)]; }))) + '</div>' +
        '<div class="group-body">';
    ...
    if (a1a2Root && typeof GRAMMAR_A1_A2_PATTERNS !== "undefined" && GRAMMAR_A1_A2_PATTERNS.length) {
      ...
      // pat.meaning / ex.tr carry ko + generated languages (build_app.py); a language missing there shows no
      // meaning line rather than the Korean one.
      GRAMMAR_A1_A2_PATTERNS.forEach(function (pat, pi) {
        var patMeaning = Tstrict(pat.meaning || pat.meaningKo);
        a1a2Html += '<div class="group-card" data-open="false" data-syl="gra1a2_' + pi + '">' +
          '<div class="group-head-row"><button class="group-head"><span><span class="syl vn font-bold">' + escapeHtml(pat.pattern) + '</span> <span class="badge">' + escapeHtml(pat.level) + '</span>' + (patMeaning ? ' - ' + escapeHtml(patMeaning) : '') + '</span>' +
          '<span class="chev"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg></span></button>' +
          readAllButtonHtml([["", patMeaning || ""]].concat(pat.examples.map(function (ex) { return [ex.vi, Tstrict(ex.tr || ex.ko) || ""]; }))) + '</div>' +
          '<div class="group-body"><div class="gr-step-list">';
        pat.examples.forEach(function (ex) {
          var exMeaning = Tstrict(ex.tr || ex.ko);
          a1a2Html += '<div class="gr-step">' +
            '<div class="gr-step-head"><div class="gr-align-vi vn">' + escapeHtml(ex.vi) + '</div>' +
            '<button class="speak-btn" data-speak="' + escapeAttr(ex.vi) + '" aria-label="' + TU("발음 듣기") + '">' + speakIcon() + '</button></div>' +
            (exMeaning ? '<div class="gr-step-kr"><span>' + escapeHtml(exMeaning) + '</span>' +
            '<button type="button" class="speak-btn speak-meaning-btn" data-speak-meaning="' + escapeAttr(exMeaning) + '" aria-label="' + TU("발음 듣기") + '">' + speakIcon() + '</button>' +
            '</div>' : '') + '</div>';
        });
        if (pat.source) {
  ...
  function renderPron() {
    ...
    var winBody = TU(
      ...
      '</ol>') +
      TU('<h4>⚙️ 접근성 &gt; 내레이터에서 고급 음성 데이터 추가하기 (대안)</h4>' +
      ...
      '</ol>') +
      TU('<h4>⚙️ Windows 10에서 베트남어 TTS 추가하기</h4>' +
      '<ol>' +
      '<li>설정 열기: <b>Win + I</b> 단축키를 누릅니다.</li>' +
  ...
  function goToTab(tab, subAttr, subVal, talkNums, vocabRange, anchor) {
    ...
    if (tab === "vocab") {
      if (subVal === "basic") { subVal = "words"; activeWordTag = "base"; }
  ...
  function weekOrdinal(n) {
    var WEEK_ORDINAL = {
      ko: function (n) { return n + "주차"; }, ja: function (n) { return "第" + n + "週"; },
      zh: function (n) { return "第" + n + "週"; }, zh_cn: function (n) { return "第" + n + "周"; },
      cs: function (n) { return n + ". týden"; }, de: function (n) { return "Woche " + n; },
      en: function (n) { return "Week " + n; }, fr: function (n) { return "Semaine " + n; },
      id: function (n) { return "Minggu ke-" + n; }, hu: function (n) { return n + ". hét"; },
      pl: function (n) { return "Tydzień " + n; }, vi: function (n) { return "Tuần " + n; }
    };
    return (WEEK_ORDINAL[currentLang] || WEEK_ORDINAL.ko)(n);
  }
...
/* END SHARED-DISTRIBUTION-ENGINE */
  ...
  function renderCurrWeek16() {
    ...
    html += '</div></div>';
    // GENERAL has no class welcome card (its build emits CURR_WELCOME without a title).
    if (!CURR_WELCOME || !CURR_WELCOME.title) html = htmlBeforeWelcome;
  ...
  function renderCurrCulture() {
    ...
    var CULTURE_CATEGORY_LABELS = {
      ...
      "결혼": { vi: "Hôn nhân", cs: "Svatba", zh_cn: "婚礼", zh: "婚禮", en: "Marriage", fr: "Mariage", de: "Hochzeit", hu: "Házasság", id: "Pernikahan", ja: "結婚", ko: "결혼", pl: "Ślub" },
      "시장과 쇼핑": { vi: "Chợ và mua sắm", cs: "Trh a nakupování", zh_cn: "市场与购物", zh: "市場與購物", en: "Markets & Shopping", fr: "Marchés et achats", de: "Märkte und Einkaufen", hu: "Piac és vásárlás", id: "Pasar dan belanja", ja: "市場と買い物", ko: "시장과 쇼핑", pl: "Targ i zakupy" },
      "날씨와 기후": { vi: "Thời tiết và khí hậu", cs: "Počasí a podnebí", zh_cn: "天气与气候", zh: "天氣與氣候", en: "Weather & Climate", fr: "Météo et climat", de: "Wetter und Klima", hu: "Időjárás és éghajlat", id: "Cuaca dan iklim", ja: "天気と気候", ko: "날씨와 기후", pl: "Pogoda i klimat" },
      "건강과 의료": { vi: "Sức khỏe và y tế", cs: "Zdraví a zdravotnictví", zh_cn: "健康与医疗", zh: "健康與醫療", en: "Health & Medical Care", fr: "Santé et soins", de: "Gesundheit und Medizin", hu: "Egészség és egészségügy", id: "Kesehatan dan layanan medis", ja: "健康と医療", ko: "건강과 의료", pl: "Zdrowie i opieka medyczna" },
      "여가생활": { vi: "Giải trí", cs: "Volný čas", zh_cn: "休闲生活", zh: "休閒生活", en: "Leisure", fr: "Loisirs", de: "Freizeit", hu: "Szabadidő", id: "Waktu luang", ja: "余暇", ko: "여가생활", pl: "Czas wolny" },
      "학교와 교육": { vi: "Trường học và giáo dục", cs: "Škola a vzdělávání", zh_cn: "学校与教育", zh: "學校與教育", en: "School & Education", fr: "École et éducation", de: "Schule und Bildung", hu: "Iskola és oktatás", id: "Sekolah dan pendidikan", ja: "学校と教育", ko: "학교와 교육", pl: "Szkoła i edukacja" },
      "기타 생활문화": { vi: "Văn hóa đời sống khác", cs: "Další každodenní kultura", zh_cn: "其他生活文化", zh: "其他生活文化", en: "Other Everyday Culture", fr: "Autres aspects de la vie quotidienne", de: "Weiteres aus dem Alltag", hu: "Egyéb mindennapi kultúra", id: "Budaya sehari-hari lainnya", ja: "その他の生活文化", ko: "기타 생활문화", pl: "Inne aspekty codziennego życia" }
    };
    var root = document.getElementById("curr-culture-root");
    if (!root) return;
    // Each article is a folding card (the shared .group-card component): the header shows the
    // category and title, the body the rest. Open cards stay open across re-renders; on the
    // first render only the first article is open. data-anchor="culture-<n>" (1-based) is the
    // target of the [과정] shortcuts, which also open the card.
    var openSyls = {};
    var existingOpen = root.querySelectorAll('.group-card[data-open="true"]');
    if (existingOpen.length) existingOpen.forEach(function (c) { openSyls[c.dataset.syl] = true; });
    else if (!root.dataset.rendered) openSyls.culture0 = true;
    root.dataset.rendered = "true";
    function cardOpen(ai, headHtml) {
      return '<div class="group-card culture-fold" data-open="' + (openSyls["culture" + ai] ? "true" : "false") + '" data-syl="culture' + ai + '" data-anchor="culture-' + (ai + 1) + '">' +
    ...
    CULTURE_ARTICLES.forEach(function (a, ai) {
      if (a.keywords || a.summaryKo) {
        // titleTr / summaryTr / learningPointTr / keywords[].tr hold the Korean source plus generated languages
        // (build_app.py); a language missing there gets no line rather than the Korean one.
        ...
        if (cardPoint) {
          html += '<div class="culture-learning-point"><strong>' + TU("핵심 포인트: ") + '</strong>' + escapeHtml(cardPoint) + '</div>';
        }
        if (a.keywords && a.keywords.length) {
          ...
          a.keywords.forEach(function (kw) {
            html += '<div class="culture-keyword-chip">' +
              ...
              (Tstrict(kw.tr || kw.ko) ? '<span class="kw-ko">' + escapeHtml(Tstrict(kw.tr || kw.ko)) + '</span>' : '') +
              '</div>';
          });
          html += '</div>';
        }
  ...
  function sentencePairs(vietnamese, meaning) {
    ...
    if (!viParts.length) {
      ...
      // (e.g. "Ông phạm tội và đẩy nhân loại ..." with "Jesus was also a perfect man."), so the
      // whole passage stays one pair instead -- always a correct match, just longer.
      pairs = [{ vi: viParts.join(" "), kr: meaningParts.length ? meaningParts.join(" ") : String(meaning || "").trim() }];
    }
  ...
  // A paragraph number ("9 Unser ...") is source metadata, not sentence text. It is dropped only
  // when BOTH sides open with the same number, so a sentence that really starts with a
  // numeral ("3 người ..." / "3 Männer ...") on one side only is never touched.
  var PARAGRAPH_NUMBER_RE = /^\s*(\d{1,3})\s+(?=\S)/;
  function stripSharedParagraphNumber(vietnamese, meaning) {
    var viNum = PARAGRAPH_NUMBER_RE.exec(String(vietnamese || ""));
    var meaningNum = PARAGRAPH_NUMBER_RE.exec(String(meaning || ""));
    if (!viNum || !meaningNum || viNum[1] !== meaningNum[1]) return [vietnamese, meaning];
    ...
    DAILY_CONVERSATIONS.forEach(function (conv, ci) {
      ...
      turns.forEach(function (t) {
        html += '<div class="talk-line"><span class="talk-who">' + escapeHtml(dailyWhoLabel(t.who)) + '</span>' +
          ...
          (t.kr ? '<div class="talk-kr"><span class="talk-kr-text">' + escapeHtml(t.kr) + '</span>' +
  ...
  function renderVocabWatchtower(root, q) {
    ...
    // (JEONJU/ULSAN) keep the course-week labels of their class schedule.
    function watchtowerDisplayLabel(sourceWeek) {
      if (document.documentElement.getAttribute("data-site") === "jw") return "";
      if (sourceWeek <= 5) return "";
      // class week per source article (0 = scheduled break)
      var classWeeks = { 6: 1, 7: 2, 8: 3, 9: 4, 10: 0, 11: 5, 12: 6, 13: 7, 14: 0, 15: 8, 16: 9, 17: 0, 18: 10, 19: 11, 20: 12, 21: 13, 22: 14, 23: 15, 24: 16 };
      var classWeek = classWeeks[sourceWeek];
      if (classWeek === 0) return TU("방학");
      return weekOrdinal(classWeek || sourceWeek);
    }
  ...
  (function () {
    ...
    // [복습] > [노래]: one dropdown per 30-song block (1-30, 31-60, ... up to the last song number
    // actually present in SONGS_DATA); each dropdown lists that block's songs individually.
    function getSongRangeGroups() {
      var songs = (typeof SONGS_DATA !== "undefined" && SONGS_DATA) || [];
      var numbers = songs.map(function (s) { return s.number; }).filter(function (n) { return typeof n === "number"; }).sort(function (a, b) { return a - b; });
      var maxNum = numbers.length ? numbers[numbers.length - 1] : 0;
      var groups = [];
      for (var start = 1; start <= maxNum; start += 30) {
        var end = Math.min(start + 29, maxNum);
        groups.push({ scope: start + "-" + end, start: start, end: end, songs: numbers.filter(function (n) { return n >= start && n <= end; }) });
      }
      return groups;
    }
    // [복습] > [문장] > [행복한 삶을 영원히]: the book's own part structure, read from
    // LFF_CONVERSATIONS (each record carries its part; lessons, the part review and the final
    // "ready" unit keep their data order) -- never a hand-written lesson range.
    function getLffPartGroups() {
      var parts = [];
      var byPart = {};
      (typeof LFF_CONVERSATIONS !== "undefined" ? LFF_CONVERSATIONS : []).forEach(function (rec) {
        if (!rec.part) return;
        if (!byPart[rec.part]) { byPart[rec.part] = { part: rec.part, units: [] }; parts.push(byPart[rec.part]); }
        var scope = rec.kind === "lesson" ? "lff:" + rec.num : rec.kind === "review" ? "lffrev:" + rec.part : rec.kind === "ready" ? "lffready" : "";
        if (scope) byPart[rec.part].units.push({ scope: scope, rec: rec });
      });
      return parts;
    }
    function lffScopePart(scope) {
      var found = 0;
      getLffPartGroups().forEach(function (g) {
        if (scope === "lffpart:" + g.part || g.units.some(function (u) { return u.scope === scope; })) found = g.part;
      });
      return found;
    }
    // The dependent-control root of a [문장] review scope: "wt:3" belongs to "wt", "lff:12" /
    // "lffpart:1" / "lffrev:1" / "lffready" to "lff", "lpd:A" to "lpd".
    function sentenceScopeRoot(scope) {
      var s = String(scope || "all");
      if (/^lff(?:$|:|part:|rev:|ready$)/.test(s)) return "lff";
      if (/^lpd(?:$|:)/.test(s)) return "lpd";
      if (/^wt(?:$|:)/.test(s)) return "wt";
      return s;
    }
    var REVIEW_UNIT_FORMATS = {
      part: { vi: "Phần {n}", cs: "Část {n}", zh_cn: "第{n}部分", zh: "第{n}部分", en: "Part {n}", fr: "Partie {n}", de: "Teil {n}", hu: "{n}. rész", id: "Bagian {n}", ja: "第{n}部", ko: "제{n}부", pl: "Część {n}" },
      lesson: { vi: "Bài {n}", cs: "Lekce {n}", zh_cn: "第{n}课", zh: "第{n}課", en: "Lesson {n}", fr: "Leçon {n}", de: "Lektion {n}", hu: "{n}. lecke", id: "Pelajaran {n}", ja: "第{n}課", ko: "{n}과", pl: "Lekcja {n}" },
      ...
      song: { vi: "Bài {n}", cs: "Píseň {n}", zh_cn: "第{n}首", zh: "第{n}首", en: "Song {n}", fr: "Cantique {n}", de: "Lied {n}", hu: "{n}. ének", id: "Lagu {n}", ja: "{n}番", ko: "{n}번", pl: "Pieśń {n}" }
    };
    function reviewUnitLabel(kind, n) {
      var fmt = REVIEW_UNIT_FORMATS[kind];
      return (fmt[currentLang] || fmt.ko).replace("{n}", n);
    }
    ...
    function reviewScopeLabel(scope) {
      ...
      if (lpdAppendixMatch) {
        if (currentLang === "ko") return { A: "부록 가", B: "부록 나", C: "부록 다" }[lpdAppendixMatch[1]];
        return reviewUnitLabel("appendix", lpdAppendixMatch[1]);
      }
      // The Korean button keeps its short form; every other language shows the publication title.
      if (scope === "lpd" && currentLang !== "ko") return TU("사람들을 사랑하고 제자로");
      var lessonMatch = scope && scope.match(/^(lff|lpd):(\d+)$/);
      if (lessonMatch) return reviewUnitLabel("lesson", lessonMatch[2]);
      var lffPartMatch = scope && scope.match(/^lffpart:(\d+)$/);
      if (lffPartMatch) return reviewUnitLabel("part", lffPartMatch[1]);
      if (scope && (/^lffrev:\d+$/.test(scope) || scope === "lffready")) {
        var unitRec = null;
        getLffPartGroups().forEach(function (g) { g.units.forEach(function (u) { if (u.scope === scope) unitRec = u.rec; }); });
        return unitRec ? (T(unitRec.title) || unitRec.title.vi) : scope;
      }
      var m = scope && scope.match(/^(\d+)-(\d+)$/);
      if (m) return m[1] + "–" + m[2];
      if (/^\d+$/.test(scope || "")) return reviewUnitLabel("song", scope);
    ...
    function reviewScopedPool(key, scope) {
      ...
      if (key === "pron") {
        ...
        if (m) {
          ...
          var songNum = parseInt(scope, 10);
          out = allSongs.filter(function (it) { return it.songNo === songNum; });
        } else {
          out = allSongs;
        }
      }
    ...
    // A narrower pick inside one [문장] source (a WT week, an LFF lesson, an LPD lesson) replaces
    // only that source's entry when several sources are multi-selected, and moves it last so it
    // stays the source whose dependent dropdowns are shown.
    function selectSentenceSubscope(newScope) {
      var current = studyState.tabKey === "sentence" ? studyState.scope : "all";
      if (!Array.isArray(current) || current.length < 2) { selectCategory("sentence", newScope); return; }
      var root = sentenceScopeRoot(newScope);
      var next = current.filter(function (s) { return sentenceScopeRoot(s) !== root; });
      next.push(newScope);
      selectCategory("sentence", next);
    }
    // One row: an [전체] droplet button, then one dropdown per group. Each dropdown opens on a
    // placeholder showing its group name; its first real option picks the whole group, the rest
    // pick a single unit. The dropdown that holds the current scope is marked active.
    function renderGroupedDropdownRow(opts) {
      var allActive = opts.selected === opts.allScope;
      var html = '<button type="button" class="subtab-btn review-dd-all" data-review-dd-scope="' + escapeAttr(opts.allScope) + '" aria-selected="' + (allActive ? "true" : "false") + '">' + escapeHtml(TU("전체")) + '</button>';
      opts.groups.forEach(function (g) {
        var inGroup = g.scope === opts.selected || g.units.some(function (u) { return u.scope === opts.selected; });
        var options = '<option value="" disabled hidden' + (inGroup ? '' : ' selected') + '>' + escapeHtml(g.label) + '</option>' +
          '<option value="' + escapeAttr(g.scope) + '"' + (g.scope === opts.selected ? ' selected' : '') + '>' + escapeHtml(g.label + " · " + TU("전체")) + '</option>';
        g.units.forEach(function (u) {
          options += '<option value="' + escapeAttr(u.scope) + '"' + (u.scope === opts.selected ? ' selected' : '') + '>' + escapeHtml(u.label) + '</option>';
        });
        html += '<select class="review-subscope-select review-dd" data-review-dd-group="' + escapeAttr(g.scope) + '" aria-selected="' + (inGroup ? "true" : "false") + '" aria-label="' + escapeAttr(g.label) + '">' + options + '</select>';
      });
      reviewSubscopeEl.classList.add("is-multi");
      reviewSubscopeEl.style.display = "flex";
      reviewSubscopeEl.innerHTML = html;
      reviewSubscopeEl.querySelector(".review-dd-all").addEventListener("click", function () { opts.onPick(opts.allScope); });
      reviewSubscopeEl.querySelectorAll("select.review-dd").forEach(function (sel) {
    ...
    function renderReviewSubscope(key, selectedScope) {
      ...
      reviewSubscopeEl.classList.remove("is-multi");
      var root = key === "sentence" && typeof selectedScope === "string" ? sentenceScopeRoot(selectedScope) : "";
      var isWt = root === "wt";
      var isLff = root === "lff";
      var isLpd = root === "lpd";
      if (key === "song") {
        renderGroupedDropdownRow({
          allScope: "all",
          selected: selectedScope || "all",
          groups: getSongRangeGroups().map(function (g) {
            return { scope: g.scope, label: g.start + "–" + g.end, units: g.songs.map(function (n) { return { scope: String(n), label: reviewUnitLabel("song", n) }; }) };
          }),
          onPick: function (scope) { selectCategory("song", scope); }
        });
        return;
      }
      if (!isWt && !isLff && !isLpd) {
      ...
      if (isLff) {
        renderGroupedDropdownRow({
          ...
          groups: getLffPartGroups().map(function (g) {
            return {
              scope: "lffpart:" + g.part,
              label: reviewUnitLabel("part", g.part),
              units: g.units.map(function (u) { return { scope: u.scope, label: reviewScopeLabel(u.scope) }; })
            };
          }),
          onPick: selectSentenceSubscope
        });
        return;
      }
      if (isLpd) {
        ...
        for (var lesson = 1; lesson <= 12; lesson++) lpdOptions += '<option value="lpd:' + lesson + '"' + (activePamphlet === String(lesson) ? ' selected' : '') + '>' + escapeHtml(reviewUnitLabel("lesson", lesson)) + '</option>';
        ...
        if (lpdSelect) lpdSelect.addEventListener("change", function () { selectSentenceSubscope(lpdSelect.value); });
        return;
      }
      reviewSubscopeEl.style.display = "flex";
      ...
      if (sel) {
        sel.addEventListener("change", function () {
          selectSentenceSubscope(sel.value);
        });
      }
      ...
      if (prevBtn) {
        prevBtn.addEventListener("click", function () {
          if (activeWeek <= 1) {
            selectSentenceSubscope("wt");
          } else {
            selectSentenceSubscope("wt:" + (activeWeek - 1));
          }
        });
      }
    ...
    function renderReviewScopes(key, selectedScope) {
      ...
      var scopes = key === "sentence" ? getSentenceReviewScopes() : (REVIEW_SCOPES[key] || ["all"]);
      ...
      // one's button-level root. The most recently picked source is the one whose dependent
      // dropdowns are shown, so switching sources never leaves the previous source's controls.
      var pickedScopes = (Array.isArray(selectedScope) ? selectedScope : [selectedScope || "all"]).filter(Boolean);
      var rootOf = key === "sentence" ? sentenceScopeRoot : function (s) { return s; };
      var pickedRoots = pickedScopes.map(rootOf);
      reviewScopeEl.innerHTML = scopes.map(function (scope) {
        var isSelected = pickedRoots.indexOf(scope) >= 0;
      ...
      reviewScopeEl.querySelectorAll("[data-review-scope]").forEach(function (btn) {
        btn.addEventListener("click", function () {
          ...
          var current = pickedScopes.filter(function (s) { return s !== "all"; });
          var kept = current.filter(function (s) { return rootOf(s) !== clicked; });
          if (kept.length === current.length) kept.push(clicked);
          selectCategory(key, kept.length ? kept : "all");
        });
      });
      renderReviewSubscope(key, pickedScopes[pickedScopes.length - 1]);
    }
      ...
      studyState.orderPlaced.forEach(function (tok, idx) {
        ...
        chip.addEventListener("click", function (e) {
          ...
          if (selIdx === null || selIdx === undefined) {
            ...
            // Tapping the selected word a second time takes it back out to the word bank
            studyState.orderPlaced.splice(idx, 1);
            studyState.selectedPlacedIndex = null;
            var fbOut = document.getElementById("order-feedback");
            if (fbOut) fbOut.innerHTML = "";
            renderOrderChips();
          } else {
  ...
  // The [발음] > [설정] TTS card for this device (same user-agent signals as IS_MOBILE_UA).
  function ttsGuideDeviceKey() {
  ...
  function goToDefaultPlace(openDeviceGuide) {
    activateTab("pron", false);
    var settingsBtn = document.querySelector('.subtab-btn[data-pron="settings"]');
    if (settingsBtn) settingsBtn.click();
    if (!openDeviceGuide) return;
    var card = document.querySelector('#panel-pron .group-card[data-tts="' + ttsGuideDeviceKey() + '"]');
    if (!card) return;
    card.dataset.open = "true";
    setTimeout(function () { card.scrollIntoView({ block: "start" }); }, 150);
  }
  ...
  (function restoreLastPlace() {
    try {
      ...
      if (saved.subtabs) {
        ...
        // [어휘]'s old per-source subtabs are now [단어] filters.
        if (["basic", "freq", "theo", "names"].indexOf(saved.subtabs.vocab) >= 0) {
          saved.subtabs.vocab = "words";
        }
        var activeSubtab = saved.subtabs[saved.tab];
        if (activeSubtab && !document.querySelector('.subtab-btn[data-' + saved.tab + '="' + activeSubtab + '"]')) {
          goToDefaultPlace(false);
          return;
        }
