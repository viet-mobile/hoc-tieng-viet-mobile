...
CULTURE_ARTICLES = [{'title': {'ko': '베트남의 다양한 면 요리',
  ...
  'paragraphs': [{'ko': '숙주와 소고기, 개운한 국물에 국수가 한 데 어우러져 개운하고 깔끔한 맛을 내는 쌀국수. 쌀국수는 베트남 사람들이 즐겨먹는 음식으로 '
                  ...
                  'en': 'Bean sprouts and beef come together with noodles in a refreshing broth to '
                        'create the clean, refreshing taste of pho. Pho is a dish loved by the '
                        'Vietnamese people; the noodles are somewhat thick and the broth tends to '
                        'be rich. When eating pho, people add various vegetables besides cilantro, '
                        "and in the northern region, it's also common to dip long fried "
                        'breadsticks into the pho.',
                  ...
                  'de': 'Sojasprossen und Rindfleisch verbinden sich mit Reisnudeln in einer '
                        'erfrischenden Brühe zum feinen, klaren Geschmack der Pho. Pho ist das '
                 ...
                 {'ko': '쌀국수는 원래 하노이 등 베트남 북부 지역 음식이었습니다. 북부 지역은 나라의 근간인 농업을 중요시했기 때문에 소의 도축과 고기 '
                  ...
                  'en': 'Pho was originally a dish from Hanoi and other parts of northern Vietnam. '
                        'Because the northern region placed great importance on agriculture as the '
                        'foundation of the nation, it banned the slaughter of cattle and the sale '
                        'of beef. As a result, the broth was made by boiling chicken bones, giving '
                        'it a light, mild flavor.',
                  'ja': 'フォーはもともとハノイなどベトナム北部地域の料理でした。北部地域は国の基盤である農業を重視していたため、牛の屠殺と肉の販売を禁止していました。そのため出汁も鶏の骨を煮込んで作るので、あっさりとした味わいになっています。',
                  'de': 'Ursprünglich stammt Pho aus Hanoi und anderen Regionen Nordvietnams. Da '
                 ...
                 {'ko': '남부 지역의 음식은 주로 단맛이 납니다. 따라서 쌀국수도 국물에서 단맛이 나는 편입니다. 또한 북부와는 다르게 소고기 뼈를 푹 고아 '
                  ...
                  'en': 'Food in the southern region tends to have a sweet taste, so the broth of '
                        'pho there is also somewhat sweet. Also, unlike in the north, the broth is '
                        'made by simmering beef bones for a long time. People not only mix in '
                        'lime, bean sprouts, and various herbs, but also enjoy it with various '
                        'dipping sauces.',
                  'ja': '南部地域の食べ物は主に甘みがあります。そのためフォーのスープも甘みがある方です。また北部とは異なり、牛の骨をじっくり煮込んでスープを作るそうです。ライムやもやし、様々な香草を混ぜて食べるだけでなく、ソースも一緒に添えて食べます。',
                  'de': 'Im Süden Vietnams schmecken Gerichte meist etwas süßlicher, daher hat '
                 ...
                 {'ko': '현재 국내에서도 각양각색의 쌀국수를 맛볼 수 있게 되었는데요, 여러 종류의 소스를 적절히 배합하여 국물과 함께 먹거나, 고기를 찍어 '
                  ...
                  'en': 'Nowadays, it has become possible to enjoy various kinds of pho here in '
                        'Korea as well. The way people mix different sauces to go with the broth, '
                        'or dip meat into them, seems quite similar to pho from southern Vietnam.',
 ...
 {'title': {'ko': '베트남의 전통 의상',
  ...
  'paragraphs': [{'ko': '베트남을 배경으로 한 영화를 떠올려 보면 가장 먼저 생각나는 것이 베트남 전통 의상인 아오자이를 입은 날씬한 여성일 것입니다. '
                  ...
                  'en': 'When you think of a movie set in Vietnam, the first thing that likely '
                        "comes to mind is a slender woman wearing the Ao Dai, Vietnam's "
                        'traditional dress. In Vietnamese, "áo" means "clothing" and "dài" means '
                        '"long" — so the shape of the garment can be understood just from its '
                        'name.',
                 ...
                 {'ko': '아오자이의 상의는 보통 다리까지 내려올 정도로 길고, 하의는 통바지 형태로 되어 있습니다. 언뜻 보면 중국의 치파오와 비슷해 '
                  ...
                  'en': 'The top of the Ao Dai is usually long enough to reach down to the legs, '
                        'while the bottom is worn with wide, straight-cut trousers. At first '
                        'glance it may look similar to the Chinese qipao, but it differs in that '
                        'wide-legged trousers are worn underneath. The Ao Dai is such a delicate '
                        'garment that as many as 18 body measurements are taken to make it. It '
                        "fits snugly to the wearer's body, revealing beautiful body lines, which "
                        'is why it suits the slender build of Vietnamese women so well.',
                  ...
                  'de': 'Das Oberteil des Ao Dai reicht normalerweise bis zu den Beinen hinab, '
                        'während darunter eine weite Hose getragen wird. Auf den ersten Blick '
                        'erinnert es an das chinesische Qipao, unterscheidet sich jedoch durch die '
                 ...
                 {'ko': '베트남의 관공서, 은행, 호텔, 항공사에서의 유니폼, 그리고 결혼식, 입학식, 졸업식 등 특별한 행사가 있을 때 아오자이의 모습을 '
                  ...
                  'en': 'You can often see the Ao Dai worn as uniforms at government offices, '
                        'banks, hotels, and airlines in Vietnam, as well as at special occasions '
                        'such as weddings, entrance ceremonies, and graduation ceremonies.',
                 ...
                 {'ko': '그렇다면 베트남에서 아오자이를 입어보고 싶을 때 꼭 신체 사이즈를 전부 재야 할까요? 그렇지는 않습니다. 요즘은 다양한 사이즈의 '
                  ...
                  'en': 'So, if you want to try wearing an Ao Dai in Vietnam, do you have to have '
                        'all your body measurements taken? Not necessarily. These days there are '
                        'many ready-made products available in various sizes, so anyone can easily '
                        'purchase an Ao Dai that fits them.',
                 ...
                 {'ko': '하늘거리는 아오자이를 입고, 베트남의 예쁜 관광지에서 멋진 사진을 찍어보는 것은 어떨까요? 베트남 여행의 즐거움 중 하나가 될 '
                  ...
                  'en': 'How about wearing a flowing Ao Dai and taking some lovely photos at '
                        "Vietnam's beautiful tourist spots? It will surely be one of the joys of "
 ...
 {'title': {'ko': '오토바이의 나라 베트남',
  ...
  'paragraphs': [{'ko': '"베트남" 하면 바로 오토바이가 떠오를 만큼 "오토바이의 나라"라고 불리는 것은 많은 분들께서 알고 계실 것 같습니다. 베트남의 '
                  ...
                  'en': 'Many of you probably already know that Vietnam is called "the country of '
                        'motorbikes," since the word "Vietnam" immediately brings motorbikes to '
                        "mind. Vietnam's number of motorbikes is so enormous that it ranks in the "
                        'top 5 in the entire world. So why do Vietnamese people rely on motorbikes '
                        'so much?',
                 ...
                 {'ko': '첫 번째는 베트남의 도로 사정 때문입니다. 도로가 좁은 편이고, 일방통행도 많아서 베트남에서는 오토바이를 이용하는 것이 시간도 '
                  ...
                  'en': "The first reason is Vietnam's road conditions. Since the roads tend to be "
                        'narrow and there are many one-way streets, using a motorbike in Vietnam '
                        'saves time and is convenient. The second reason is that cars are '
                        'extremely expensive, so many people rely on motorbikes instead.',
                 ...
                 {'ko': '이러한 이유들로 오토바이가 정말 많은 베트남! 하지만 여행객들에게는 매우 낯선 풍경이 아닐 수 없습니다. 특히 길을 건널 때 '
                  ...
                  'en': 'For these reasons, Vietnam truly has an enormous number of motorbikes! '
                        'But for travelers, this can be a very unfamiliar sight. Especially when '
                        'crossing the street where there is no traffic light or crosswalk, it can '
                        'be quite worrying figuring out where and how to cross. You should never '
                        'run just because a motorbike is coming, trying to cross quickly. If you '
                        'walk slowly and steadily, the motorbikes will skillfully avoid you and '
                        'pass by.',
                  ...
                  'de': 'Aus diesen Gründen prägen Motorroller das Straßenbild Vietnams! Für '
                        'Reisende ist dieser Anblick zunächst ungewohnt. Besonders beim Überqueren '
 ...
 {'title': {'ko': '베트남의 기후',
  ...
  'paragraphs': [{'ko': '베트남의 지형은 긴 S자 형태로, 최남단에서 최북단까지의 거리가 1,750km가 될 정도로 상당히 떨어져 있습니다. 이로 인해 '
                  ...
                  'en': "Vietnam's terrain has a long S-shape, with the distance from the "
                        'southernmost to the northernmost point reaching as much as 1,750km. '
                        'Because of this, the climate differences between regions are very '
                        'pronounced.',
                 ...
                 {'ko': '베트남의 북부 지역은 한국과 비슷하게 사계절이 있습니다. 봄과 가을은 상대적으로 짧은 편이나 겨울에는 눈이 오는 지역도 있을 만큼 '
                  ...
                  'en': 'Northern Vietnam has four distinct seasons, similar to Korea. Spring and '
                        'fall are relatively short, but in winter the temperature drops quite a '
                        "lot — enough that some areas even get snow. It's common to see locals "
                        'walking around in thick jackets.',
                 ...
                 {'ko': '중부 지역 중에는 고원 지대가 있는 지역이 많은데, 이 고원 지대는 이름처럼 높이 위치해 있기 때문에 비교적 서늘한 기후를 '
                  ...
                  'en': 'Many areas in central Vietnam have highland regions, and as the name '
                        'suggests, these highlands sit at higher elevations, giving them a '
                        'relatively cool climate. Because of this cool climate, the region is also '
                        'where many crops, such as Vietnamese coffee, are widely cultivated. With '
                        'weather similar to autumn through early winter in Korea, it is cool and '
                  ...
                  'de': 'In Zentralvietnam gibt es viele Hochebenen, die aufgrund ihrer Höhenlage '
                 ...
                 {'ko': '호찌민시를 중심으로 한 남부 지역은 전형적인 동남아 날씨입니다. 평균 기온은 27~30도이며, 건기와 우기로 계절을 나눌 수 '
                  ...
                  'en': 'The southern region, centered around Ho Chi Minh City, has a typical '
                        'Southeast Asian climate. The average temperature is 27-30°C, and the '
                        'seasons can be divided into a dry season and a rainy season. During the '
                        'dry season, the sun is scorching hot — far beyond anything comparable to '
                        'Korean summers. When the rainy season comes, sudden guerrilla-style '
                        'downpours can occur several times a day, so Vietnamese people always '
                        'carry a raincoat during the rainy season.',
                  ...
                  'de': 'Der Süden rund um Ho-Chi-Minh-Stadt weist ein typisch südostasiatisches '
                        'Tropenklima auf. Die Durchschnittstemperaturen liegen bei 27–30 °C, '
 ...
 {'title': {'ko': '베트남어와 한자',
  ...
  'paragraphs': [{'ko': '베트남어를 공부하시는 분들이라면 신기한 발견을 하셨을 것 같습니다. 바로 베트남어의 60% 정도가 한자 베트남어로 이루어졌다는 '
                  ...
                  'en': "If you're studying Vietnamese, you've probably made an interesting "
                        'discovery — the fact that about 60% of Vietnamese vocabulary is made up '
                        'of Sino-Vietnamese words.',
                 ...
                 {'ko': '베트남은 중국의 영향으로 한자음이 발달되어 있는 언어입니다. 그래서 베트남어의 글자는 로마자로 표기하고 있지만 한자음과 상당히 '
                  ...
                  'en': 'Due to Chinese influence, Vietnamese developed Sino-Vietnamese '
                        'pronunciations. So even though Vietnamese is written using the Roman '
                        'alphabet, there are many parts of it that sound quite similar to Chinese '
                 ...
                 {'ko': '위 단어들을 보시면 발음이 상당히 비슷한 것을 아셨을 텐데요. 물론 베트남어는 성조가 있어서 성조에 따라 그 뜻이 달라지지만 음은 '
                  ...
                  'en': "Looking at the words above, you've probably noticed how similar the "
                        'pronunciations are. Of course, Vietnamese has tones, so the meaning '
                        'changes depending on the tone, but since the base sound is the same, you '
                        "can guess the meaning through sound even for words you're seeing for the "
                        'first time.',
